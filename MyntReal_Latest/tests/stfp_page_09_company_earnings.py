"""STFP Page #9: Company Earnings - Complete Testing"""
import time, os
...
def main():
    print("="*80)
    print(" "*20 + "STFP PAGE #9: COMPANY EARNINGS")
    print("="*80)
    ...
    try:
        login(driver)
        driver.get(f"{BASE_URL}/vgk/company-earnings?user_id=BEV182364369")
        time.sleep(3)
        ...
        print(f"\n✓ Page loaded: {'/vgk/company-earnings' in driver.current_url}")
        print(f"✓ Title present: {'Earnings' in page_source or 'Company' in page_source}")
