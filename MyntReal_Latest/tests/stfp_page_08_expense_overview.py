"""STFP Page #8: Expense Overview - Complete Testing"""
import time, os
...
def main():
    print("="*80)
    print(" "*21 + "STFP PAGE #8: EXPENSE OVERVIEW")
    print("="*80)
    ...
    try:
        login(driver)
        driver.get(f"{BASE_URL}/vgk/expense-overview")
        time.sleep(3)
        ...
        print(f"\n✓ Page loaded: {'/vgk/expense' in driver.current_url}")
        print(f"✓ Title present: {'Expense' in page_source}")
