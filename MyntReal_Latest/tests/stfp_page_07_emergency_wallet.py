"""STFP Page #7: Emergency Wallet - Complete Testing"""
import time, os
...
def main():
    print("="*80)
    print(" "*21 + "STFP PAGE #7: EMERGENCY WALLET")
    print("="*80)
    ...
    try:
        login(driver)
        driver.get(f"{BASE_URL}/vgk/emergency-wallet")
        time.sleep(3)
        ...
        print(f"\n✓ Page loaded: {'/vgk/emergency' in driver.current_url}")
        print(f"✓ Title present: {'Emergency' in page_source or 'Wallet' in page_source}")
