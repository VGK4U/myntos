"""STFP Page #6: Rate Management - Complete Testing"""
import time, os
...
def main():
    print("="*80)
    print(" "*22 + "STFP PAGE #6: RATE MANAGEMENT")
    print("="*80)
    ...
    try:
        login(driver)
        driver.get(f"{BASE_URL}/vgk/rate-configuration")
        time.sleep(3)
        ...
        print(f"\n✓ Page loaded: {'/vgk/rate' in driver.current_url}")
        print(f"✓ Title present: {'Rate' in page_source}")
