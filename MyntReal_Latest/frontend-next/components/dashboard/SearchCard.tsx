...
export default function SearchCard({ onSearch, isSearching, memberInfo }: SearchCardProps) {
  ...
  return (
    <div className="bg-card-start border border-slate-700/50 rounded-lg p-6 shadow-sm mb-6">
        ...
        <div className="w-full md:w-1/2">
          ...
          <form onSubmit={handleSearch} className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-brand-warning text-slate-900 font-medium rounded-md hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-warning focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
