...
export const MENU_MASTER: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { menu_code: "ADD_LEAD", label: "Add Lead", route: "/staff/leads/add-lead", icon: "fas fa-user-plus", audience: ["STAFF"] },
  ...
  },
  {
    ...
    items: [
      ...
      { menu_code: "VGK_MEDIA_MANAGER", label: "Media Manager", route: "/staff/vgk/media", icon: "fas fa-photo-video", audience: ["STAFF"] },
      { menu_code: "VGK_GALLERY", label: "Gallery Manager", route: "/staff/vgk/gallery", icon: "fas fa-images", audience: ["STAFF"] },
    ...
    subSections: [
      {
        ...
        items: [
          { menu_code: "MNR_INCOME_UNIFIED", label: "Income Management", route: "/staff/financials/incomes", audience: ["STAFF"] },
          ...
          { menu_code: "MNR_FIELD_ALLOWANCES", label: "Allowances", route: "/staff/mnr-user/allowances", audience: ["STAFF"] },
          ...
          { menu_code: "MNR_FINANCIAL_STATEMENT", label: "Financial Statement", route: "/staff/financials/statement", audience: ["STAFF"] },
      ...
      },
      {
        ...
        items: [
          ...
          { menu_code: "MNR_USER_PROFILE", label: "My Profile", route: "/staff/mnr-user/profile", icon: "fas fa-user-circle", audience: ["STAFF"] },
          { menu_code: "MNR_USER_COUPONS_MGMT", label: "Coupons Management", route: "/staff/mnr-user/coupons", icon: "fas fa-ticket-alt", audience: ["STAFF"] },
          { menu_code: "MNR_USER_ANNOUNCEMENTS_MGMT", label: "Announcements", route: "/staff/mnr-user/announcements", icon: "fas fa-bullhorn", audience: ["STAFF"] },
      ...
      },
      {
        ...
        items: [
          { menu_code: "MNR_USER_EARNINGS", label: "Earnings", route: "/staff/mnr-user/earnings", audience: ["STAFF"] },
          { menu_code: "MNR_USER_EARNINGS_SUMMARY", label: "Earnings Summary", route: "/staff/mnr-user/earnings-summary", audience: ["STAFF"] },
      ...
      },
      {
        ...
        items: [
          { menu_code: "MNR_USER_PROPERTIES", label: "Properties", route: "/staff/mnr-user/segments/properties", audience: ["STAFF"] },
          { menu_code: "MNR_USER_LEADS", label: "Leads", route: "/staff/mnr-user/segments/leads", audience: ["STAFF"] },
          { menu_code: "MNR_USER_FRANCHISE", label: "Franchise", route: "/staff/mnr-user/segments/franchise", audience: ["STAFF"] }
        ]
      },
      {
        ...
        items: [
          { menu_code: "MNR_USER_VGK4U_DASHBOARD", label: "Dashboard", route: "/staff/mnr-user/segments/vgk4u/dashboard", audience: ["STAFF"] },
          { menu_code: "MNR_USER_REAL_ESTATE", label: "Real Estate", route: "/staff/mnr-user/segments/vgk4u/real-estate", audience: ["STAFF"] },
          { menu_code: "MNR_USER_INSURANCE", label: "Insurance", route: "/staff/mnr-user/segments/vgk4u/insurance", audience: ["STAFF"] },
          { menu_code: "MNR_USER_TRAINING", label: "Training", route: "/staff/mnr-user/segments/vgk4u/training", audience: ["STAFF"] }
        ]
      },
      {
        ...
        items: [
          { menu_code: "MNR_USER_ALL_AWARDS", label: "All Awards", route: "/staff/mnr-user/awards", audience: ["STAFF"] },
  ...
  },
  {
    ...
    items: [
      ...
      { menu_code: "MNR_BANK_WISE_LEADS", label: "Field staff leads", route: "/staff/bank-wise-leads", icon: "fas fa-users-gear", audience: ["STAFF"] },
