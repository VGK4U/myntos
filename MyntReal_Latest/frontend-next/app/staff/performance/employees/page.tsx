  ...
  return (
    <div className="flex flex-col w-full space-y-6 p-8 bg-slate-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-slate-900">Employees Dashboard</h1>
          ...
          <Card className="shadow-sm border-0 ring-1 ring-slate-200">
            ...
            <CardContent className="p-0">
              <div className="min-h-[500px] w-full p-4">
                <GenericDataTable 
                  title="Employees"
                  endpoint="/staff/performance/employees"
                  subtitle="Auto-mapped Premium Enterprise V2 data viewer for /staff/performance/employees"
                />
              </div>
            </CardContent>
          </Card>
