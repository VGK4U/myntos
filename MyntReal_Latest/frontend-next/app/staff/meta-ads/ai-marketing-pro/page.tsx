  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setGeneratedContent("🚀 Discover Your Dream Home in Hyderabad!\n\nAre you looking for the perfect blend of luxury and convenience? MyntReal presents an exclusive collection of premium apartments located in the heart of the city.\n\n✨ Why Choose Us?\n- 24/7 Security & Gated Community\n- Resort-style Amenities\n- Proximity to Top Schools & IT Hubs\n\nDon't miss out on this opportunity. Click the link below to schedule a free site visit today! 👇\n[Link to landing page]");
      }
    } catch (err) {
      console.error(err);
      setGeneratedContent("🚀 Discover Your Dream Home in Hyderabad!\n\nAre you looking for the perfect blend of luxury and convenience? MyntReal presents an exclusive collection of premium apartments located in the heart of the city.\n\n✨ Why Choose Us?\n- 24/7 Security & Gated Community\n- Resort-style Amenities\n- Proximity to Top Schools & IT Hubs\n\nDon't miss out on this opportunity. Click the link below to schedule a free site visit today! 👇\n[Link to landing page]");
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-2 flex flex-col gap-1">
              ...
              >
                <span className="flex items-center gap-2"><PenTool className="w-4 h-4" /> Ad Copy Generator</span>
              </button>
              <button 
              ...
              >
                <span className="flex items-center gap-2"><Users className="w-4 h-4" /> Audience Targeting</span>
              </button>
              <button 
              ...
              >
                <span className="flex items-center gap-2"><LineChart className="w-4 h-4" /> ROI Predictor</span>
              </button>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select className="w-full text-sm border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 px-3 py-2 border bg-white">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 py-1.5 border border-indigo-500 bg-indigo-50 text-indigo-700 rounded text-xs font-medium transition-colors">Professional</button>
                    <button className="flex-1 py-1.5 border border-gray-200 bg-white text-gray-600 rounded text-xs font-medium hover:bg-gray-50 transition-colors">Urgent</button>
                    <button className="flex-1 py-1.5 border border-gray-200 bg-white text-gray-600 rounded text-xs font-medium hover:bg-gray-50 transition-colors">Friendly</button>
                  </div>
                </div>
                ...
                <button 
                  ...
                  disabled={generating}
                  className="w-full py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-lg shadow-sm transition-all text-sm disabled:opacity-70 mt-2 flex items-center justify-center gap-2"
                >
                  {generating ? (
                    <>
        ...
        <div className="lg:col-span-2">
          {activeTab === "copy" && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 h-full flex flex-col min-h-[500px]">
              <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 text-xs font-medium text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors flex items-center gap-1.5">
                    <Copy className="w-3.5 h-3.5" /> Copy
                  </button>
                  <button className="px-3 py-1.5 text-xs font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-1.5">
                    <Send className="w-3.5 h-3.5" /> Send to Meta
                  </button>
                </div>
              </div>
          ...
          {activeTab === "audience" && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 h-full min-h-[500px] p-8 flex flex-col items-center justify-center text-center">
