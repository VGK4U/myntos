...
export default function PricingPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Simulated fetch
        // const res = await fetch('/staff/partners/pricing');
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <header className="flex flex-col md:flex-row md:items-center md:justify-between border-b pb-4 border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Premium Enterprise V2 Dashboard for Pricing Management</p>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center space-x-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-500">Active Pricing Rules</p>
