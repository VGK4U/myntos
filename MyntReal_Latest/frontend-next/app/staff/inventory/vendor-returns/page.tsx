...
export default function VendorReturnsPage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await api.get('/staff/inventory/vendor-returns');
    ...
    <div className="p-6 lg:p-10 max-w-[1600px] mx-auto bg-slate-50 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Vendor Returns Management</h1>
          <p className="text-slate-500 mt-1">Manage and track vendor returns seamlessly.</p>
        </div>
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-16 text-center text-slate-500">
                    ...
                    <p className="font-bold text-slate-700 text-lg mb-1">No vendor returns found</p>
