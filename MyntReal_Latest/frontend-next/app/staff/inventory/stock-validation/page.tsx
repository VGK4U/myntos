...
export default function StockValidationPage() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await api.get('/staff/inventory/stock-validation');
    ...
    <div className="p-6 lg:p-10 max-w-[1600px] mx-auto bg-slate-50 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Stock Validation Management</h1>
          <p className="text-slate-500 mt-1">Manage and track stock validation seamlessly.</p>
        </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          <h2 className="font-bold text-slate-800 flex items-center gap-2">
            Stock Validation Data Explorer
          </h2>
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-16 text-center text-slate-500">
                    ...
                    <p className="font-bold text-slate-700 text-lg mb-1">No stock validation found</p>
