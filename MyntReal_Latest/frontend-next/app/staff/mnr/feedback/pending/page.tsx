...
export default function CustomPage() {
  const { data, error, isLoading } = useSWR('/staff/mnr/feedback/pending', fetcher);
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Pending</h1>
          <p className="text-sm text-gray-500 mt-1">Auto-mapped data viewer for staff/mnr/feedback/pending</p>
        </div>
