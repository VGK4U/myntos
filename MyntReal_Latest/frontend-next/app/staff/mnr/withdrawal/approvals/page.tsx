...
export default function CustomPage() {
  const { data, error, isLoading } = useSWR('/staff/mnr/withdrawal/approvals', fetcher);
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Auto-mapped data viewer for staff/mnr/withdrawal/approvals</p>
        </div>
