...
export default function ConsultantInvoicesPage() {
  ...
  const pageTitle: string = "Consultant Invoices";
  ...
  return (
    <div className="flex flex-col w-full space-y-6 p-8 bg-slate-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-slate-900">Consultant Invoices Dashboard</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Total Consultant Invoices</CardTitle>
            ...
            <CardContent className="p-0">
              <div className="min-h-[500px] w-full p-4">
                <GenericDataTable 
                  ...
                  subtitle="Auto-mapped Premium Enterprise V2 data viewer for /staff/payroll/consultant-invoices"
                />
              </div>
            </CardContent>
          </Card>
