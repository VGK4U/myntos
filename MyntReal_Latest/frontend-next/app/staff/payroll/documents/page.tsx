  ...
  return (
    <div className="flex flex-col w-full space-y-6 p-8 bg-slate-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        <div>
          <h1 className="text-4xl font-bold tracking-tight text-slate-900">Documents Dashboard</h1>
            ...
            <CardContent className="p-0">
              <div className="min-h-[500px] w-full p-4">
                <GenericDataTable 
                  ...
                  subtitle="Auto-mapped Premium Enterprise V2 data viewer for /staff/payroll/documents"
                />
              </div>
            </CardContent>
          </Card>
