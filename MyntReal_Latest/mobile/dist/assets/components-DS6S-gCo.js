...
import{t as v,j as L,d as y,b as _,n as A,r as w}from"./services-hCIPNT8w.js";import{L as x}from"./vendor-B1GRRwIS.js";import{_ as N}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as O}from"./services-gps-DL1AEilI.js";class ${modalEl=null;uiState="CLOSED";currentOptions=null;enteredNumber="";rawNumber="";isPresetNumber=!1;isDtmfOpen=!1;unsubscribeTelephony=null;currentSession=null;floatingPos={x:0,y:0};pillPos={x:0,y:0};isDraggingWindow=!1;isDraggingPill=!1;dragStartPointer={x:0,y:0};dragStartPos={x:0,y:0};hasInitializedPosition=!1;lastNotifiedLeadId=null;constructor(){typeof window<"u"&&(window.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen()&&(this.uiState==="ACTIVE_FLOATING"?this.minimize():this.uiState==="DIALER"&&this.close())}),window.addEventListener("resize",()=>{this.isOpen()&&(this.clampPositions(),this.applyPositions())}))}isOpen(){return this.modalEl!==null&&document.body.contains(this.modalEl)&&this.uiState!=="CLOSED"}getUIState(){return this.uiState}open(e){this.currentOptions=e;const t=(e.phoneNumber||"").replace(/[^\d+]/g,"");this.enteredNumber=t,this.rawNumber=t,this.isPresetNumber=!!t,this.isDtmfOpen=!1,this.hasInitializedPosition=!1,this.unsubscribeTelephony&&this.unsubscribeTelephony(),this.unsubscribeTelephony=v.subscribe(n=>{this.currentSession=n,this.handleTelephonyStateUpdate(n)});const a=v.isCallActive();this.uiState=a?"ACTIVE_FLOATING":"DIALER",this.render(),this.loadLeadContext(e.entityId),e.autoStart&&this.enteredNumber&&this.startCall()}minimize(){this.uiState!=="CLOSED"&&(this.uiState="MINIMIZED",this.updateVisibility())}restore(){this.uiState!=="CLOSED"&&(this.uiState="ACTIVE_FLOATING",this.updateVisibility(),this.updateSessionUI())}close(){if(this.currentSession&&(v.isCallActive()||["connecting","ringing","connected","held"].includes(this.currentSession.state))){this.minimize();return}this.teardown()}forceCloseAndHangup(){this.currentSession&&v.isCallActive()&&v.endCall(),this.teardown()}teardown(){this.unsubscribeTelephony&&(this.unsubscribeTelephony(),this.unsubscribeTelephony=null),this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.uiState="CLOSED",this.currentOptions=null,this.currentSession=null,this.hasInitializedPosition=!1,this.lastNotifiedLeadId=null}handleTelephonyStateUpdate(e){if(!this.modalEl||!document.body.contains(this.modalEl))if(e.state!=="idle")this.render();else return;if(v.isCallActive()){this.uiState==="DIALER"&&(this.uiState="ACTIVE_FLOATING");const a=Number(this.currentOptions?.entityId);a&&(this.currentOptions?.entityType==="lead"||!this.currentOptions?.entityType)&&this.lastNotifiedLeadId!==a&&(this.lastNotifiedLeadId=a,L.notifyCallActive(a))}else if(this.lastNotifiedLeadId=null,e.state==="ended"){this.uiState="ENDED_SUMMARY";const a=this.currentOptions,n=e.durationSeconds||0;L.clearCallActive(),a?.entityId&&window.dispatchEvent(new CustomEvent("myntos:lead-call-ended",{detail:{leadId:a.entityId,name:a.name,phoneNumber:a.phoneNumber,durationSeconds:n,categoryName:a.categoryName,status:a.status}})),setTimeout(()=>{this.uiState==="ENDED_SUMMARY"&&this.teardown()},1600)}else if(e.state==="idle"&&this.uiState!=="DIALER"){L.clearCallActive(),this.teardown();return}this.updateVisibility(),this.updateSessionUI()}maskPhone(e){if(!e)return"—";const t=e.replace(/\D/g,"");if(t.length<6)return e;const a=t.slice(-10);return y.isMR10001()?a.length===10?`+91 ${a.slice(0,5)} ${a.slice(5)}`:e:`+91 ${a.slice(0,2)}••••${a.slice(-4)}`}getDialInputDisplay(){return!y.isMR10001()&&this.isPresetNumber&&this.enteredNumber?this.maskPhone(this.enteredNumber):this.enteredNumber}formatDuration(e){const t=Math.floor(e/60).toString().padStart(2,"0"),a=(e%60).toString().padStart(2,"0");return`${t}:${a}`}initPositions(){if(this.hasInitializedPosition||typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=Math.max(12,Math.round((e-a)/2)),o=Math.max(20,Math.round((t-n)/2));this.floatingPos={x:i,y:o},this.pillPos={x:Math.max(12,e-260),y:Math.max(20,t-100)},this.hasInitializedPosition=!0}clampPositions(){if(typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=12,o=Math.max(12,e-a-12),p=12,s=Math.max(12,t-n-12);this.floatingPos.x=Math.min(Math.max(this.floatingPos.x,i),o),this.floatingPos.y=Math.min(Math.max(this.floatingPos.y,p),s);const r=240,l=54,d=12,c=Math.max(12,e-r-12),h=12,u=Math.max(12,t-l-12);this.pillPos.x=Math.min(Math.max(this.pillPos.x,d),c),this.pillPos.y=Math.min(Math.max(this.pillPos.y,h),u)}applyPositions(){const e=this.modalEl?.querySelector("#spModalDialog");e&&(this.uiState==="ACTIVE_FLOATING"||this.uiState==="DIALER")&&(e.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`);const t=this.modalEl?.querySelector("#spMinimizedPill");t&&this.uiState==="MINIMIZED"&&(t.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`)}render(){this.modalEl&&this.modalEl.remove(),this.initPositions(),this.clampPositions();const{name:e,entityType:t}=this.currentOptions||{},a=e||"Customer Lead",n=t?t.toUpperCase():"LEAD";this.modalEl=document.createElement("div"),this.modalEl.id="myntosCentralSoftphoneModal",this.modalEl.style.cssText=`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab;a?w.navigate(t,{tab:a}):w.navigate(t),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await y.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){try{const e=await _.get("/staff/menu-settings/my-menus?unified=true");if(e.success&&e.data&&e.data.sidebar_tree){this.staffMenuTree=e.data.sidebar_tree,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_menu_tree_cache",JSON.stringify(this.staffMenuTree))}catch{}this.updateUI()}}catch(e){console.error("Failed to load dynamic staff menus:",e)}}filterMenusForRole(e,t,a=!1){const i=y.getAuthState().user||{},o=(i.emp_code||i.employee_code||"").toString().toUpperCase().trim(),p=["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(o);if(t&&!p)return e;const s=new Set(["SAAS","SAAS_MANAGEMENT","SAAS CONFIGURATION","CONFIGURATION","SYSTEM_CONFIGURATION","SYSTEM CONFIG","META_ADS","META ADS","VENDOR_MANAGEMENT","VENDOR MANAGEMENT","VENDORS","HR","HR_MANAGEMENT","ZYNOVA","ZYNOVA_REAL_ESTATE","MNR","MNR_USER_SIDEBAR","MNR USER SIDEBAR","MNR_USER","MNR USER"]);a||(s.add("ACCOUNTS"),s.add("ACCOUNTS_EARNINGS"),s.add("ACCOUNTS & EARNINGS"),s.add("FINANCE"),s.add("FINANCE & EARNINGS"),s.add("FINANCE_EARNINGS"),s.add("ACCOUNTS_MANAGEMENT"));const r=new Set(["EXECUTIVE_DASHBOARD","CATEGORY_LEADS_MASTER","SAAS_CONFIG","SYSTEM_CONFIG"]);(!t||p)&&(r.add("LEADS_MASTER"),r.add("STAFF_LEADS"),r.add("staff_leads")),a||(r.add("PAYROLL_PROFILE"),r.add("SALARY_SLIPS"),r.add("EXPENSE_ENTRIES"));const l=[];for(const d of e){const c=(d.section_code||"").toUpperCase().trim(),h=(d.section_label||"").toUpperCase().trim();if(s.has(c)||s.has(h))continue;let u=d.items;u&&u.length>0&&(u=u.filter(b=>{const S=(b.menu_code||"").toUpperCase().trim();return!r.has(S)}));let f=d.subSections;f&&f.length>0&&(f=f.map(b=>({...b,items:b.items.filter(S=>{const k=(S.menu_code||"").toUpperCase().trim();return!r.has(k)})})).filter(b=>b.items.length>0));const m=u&&u.length>0,g=f&&f.length>0;(m||g)&&l.push({...d,items:m?u:void 0,subSections:g?f:void 0})}return l}getStaffMenuMaster(){if(!this.staffMenuTree)return B;const e={EXECUTIVE_DASHBOARD:1,staff_executive_dashboard:1,mnr_executive_dashboard:1,MNR_BANK_WISE_LEADS:2,BANK_WISE_LEADS:2,staff_bank_wise_leads:2,CATEGORY_LEADS_MASTER:3,mnr_leads_master:3,staff_mnr_leads_master:3,SOLAR_LEADS:4,staff_solar_leads:4,mnr_solar_leads:4,EV_B2B_LEADS:5,staff_ev_b2b_leads:5,mnr_ev_b2b_leads:5,EV_B2C_LEADS:6,staff_ev_b2c_leads:6,mnr_ev_b2c_leads:6,EV_SPARES_LEADS:7,staff_ev_spares_leads:7,mnr_ev_spares_leads:7,ZYN_REAL_ESTATE:8,staff_real_dreams_leads:8,mnr_real_dreams_leads:8,ZYN_INSURANCE:9,staff_insurance_leads:9,mnr_insurance_leads:9,ETC_LEADS:10,staff_etc_leads:10,mnr_etc_leads:10,MNR_LEADS:11,staff_mnr_leads:11,mnr_category_leads:11,AUTO_DIALER:12,staff_auto_dialer:12,"auto-dialer":12},t={MY_CRM_DASHBOARD:1,staff_crm_dashboard:1,"staff-crm":1,MY_LEADS:2,staff_my_leads:2,"staff-my-leads":2,AUTO_DIALER:3,staff_auto_dialer:3,staff_dialer:3,"auto-dialer":3,SOFTPHONE:4,staff_softphone:4,softphone:4,CALLING_PAGE:4,calling:4,"phone-dialpad":4,BANK_WISE_LEADS:5,staff_bank_wise_leads:5,"staff-bank-wise-leads":5,TEAM_LEADS:6,staff_team_leads:6,"staff-team-leads":6,WHATSAPP_CENTER:7,staff_crm_whatsapp_inbox:7,"staff-whatsapp":7,CALL_TRACKING:8,call_tracking_dashboard:8,"staff-call-tracking":8,OPERATOR_CALLS:9,staff_operator_calls:9,"operator-calls":9,VGK_TEAM_MEMBERS:10,staff_vgk_members:10,"staff-vgk-members":10,STAFF_LEADS:11,staff_leads:11,LEADS_MASTER:11,leads_master:11},a=new Map,n=[],i=(s,r,l,d)=>{const c=P[l]||P[l?.replace(/\/$/,"")]||(l?l.replace(/^\/staff\//,"").replace(/\//g,"-"):null);if(!c)return null;const u=y.getAuthState().user||{},f=(u.emp_code||u.employee_code||"").toString().toUpperCase().trim();if(["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(f)&&(c==="staff-leads"||l&&l.toLowerCase()==="/staff/leads"||s&&["staff_leads","STAFF_LEADS","LEADS_MASTER","staff_leads_master"].includes(s)))return null;let m=r;(!m||m==="None"||m.trim()==="")&&(m=(s||"").replace(/^staff_|^_staff_|^mnr_/i,"").replace(/_/g," ").replace(/\b\w/g,C=>C.toUpperCase()));const g=(s||"").toUpperCase(),b=(l||"").toLowerCase();g.includes("AUTO_DIALER")||b.includes("auto-dialer")||b==="/staff/dialer"||g==="STAFF_AUTO_DIALER"||g==="AUTO_DIALER"||g==="STAFF_DIALER"||g==="DIALER"?m="Auto Dialer":g.includes("BANK_WISE_LEADS")||b.includes("bank-wise-leads")?m="Field staff leads":g.includes("REAL_DREAMS")||b.includes("real-dreams-leads")?m="Real Dreams Leads":g.includes("ETC_LEADS")||b.includes("etc-leads")?m="ETC Training Students":g.includes("CATEGORY_LEADS_MASTER")||g.includes("MNR_LEADS_MASTER")||b.includes("mnr-leads-master")?m="Category Lead Master":g.includes("WHATSAPP")||b.includes("whatsapp")?m="WhatsApp Center":g.includes("SOFTPHONE")||g==="PHONE_DIALPAD"||g==="CALLING_PAGE"||b.includes("softphone")||b.includes("calling")||b.includes("phone-dialpad")?m="Calling & Softphone":(g.includes("VGK_TEAM_MEMBERS")||g==="STAFF_VGK_MEMBERS"||b.includes("vgk/members"))&&(m="VGK Channel Partners");const S=d||(m.includes("WhatsApp")?"fab fa-whatsapp":m.includes("Auto Dialer")?"fas fa-phone-volume":m.includes("Softphone")||m.includes("Calling")?"fas fa-headset":m.includes("VGK")||m.includes("Channel")?"fas fa-users":m.includes("Field")?"fas fa-users-gear":"fas fa-file-alt"),k=m.includes("WhatsApp")?"color: #25d366;":m.includes("Auto Dialer")||m.includes("Softphone")||m.includes("Calling")?"color: #38bdf8;":m.includes("VGK")||m.includes("Channel")?"color: #7c3aed;":"",M=`<i class="${S}" style="margin-right: 8px; width: 18px; text-align: center; ${k}"></i>`;return{menu_code:s,label:`${M}${m}`,route:c}};for(const s of this.staffMenuTree){if(s.id==="progress"||s.section_id==="progress"||(s.title||"").toUpperCase()==="PROGRESS")continue;const r=[],l=[];if(s.items)for(const d of s.items){const c=i(d.menu_code,d.menu_name||d.label||d.name||d.title,d.route_path,d.menu_icon);c&&r.push(c)}if(s.subSections)for(const d of s.subSections){const c=[];if(d.items)for(const u of d.items){const f=i(u.menu_code,u.menu_name||u.label||u.name||u.title,u.route_path,u.menu_icon);f&&c.push(f)}let h=d.title||d.name||d.id||"Subsection";(h==="None"||!h)&&(h=(d.id||"").replace(/^staff_|^vm_/i,"").replace(/_/g," ").replace(/\b\w/g,u=>u.toUpperCase())),c.length>0&&l.push({sub_section_code:d.id||d.section_id||"sub",sub_section_label:h,items:c})}if(r.length>0||l.length>0){let d=(s.id||s.section_id||"other").toString().trim(),c=(s.title||s.name||"Other").toString().trim();(c==="None"||!c)&&(c=d.replace(/_/g," ").replace(/\b\w/g,f=>f.toUpperCase()));const h=d.toLowerCase(),u=c.toUpperCase();if((h==="mynt_real"||h==="myntreal"||h==="workflows"||u==="MYNT REAL"||u==="MYNTREAL"||u==="WORK FLOWS"||u==="WORKFLOWS")&&(d="WORKFLOWS",c="WORK FLOWS"),(h==="crm"||h==="crm_module"||h==="crm_leads"||h==="crm & leads"||u.includes("CRM"))&&(d="CRM_MODULE",c="CRM & LEADS"),a.has(d)){const f=a.get(d);if(r.length>0){f.items=f.items||[];const m=new Set(f.items.map(g=>g.menu_code));for(const g of r)m.has(g.menu_code)||(f.items.push(g),m.add(g.menu_code))}l.length>0&&(f.subSections=f.subSections||[],f.subSections.push(...l))}else n.push(d),a.set(d,{section_code:d,section_label:c,order:d==="CRM_MODULE"?4:s.order!==void 0?s.order:999,items:r.length>0?r:void 0,subSections:l.length>0?l:void 0})}}let o=a.get("CRM_MODULE")||a.get("CRM_LEADS")||a.get("crm")||a.get("CRM");if(o||(o={section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[]},a.set("CRM_MODULE",o),n.push("CRM_MODULE")),o){if(o.items=o.items||[],!o.items.some(l=>l.route==="auto-dialer"||l.menu_code&&(l.menu_code.toUpperCase().includes("AUTO_DIALER")||l.menu_code.toUpperCase().includes("DIALER"))))o.items.push({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"auto-dialer"});else for(const l of o.items)(l.route==="auto-dialer"||l.menu_code&&(l.menu_code.toUpperCase().includes("AUTO_DIALER")||l.menu_code.toUpperCase().includes("DIALER")))&&(l.label='<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer');o.items.some(l=>l.route==="softphone"||l.menu_code&&(l.menu_code.toUpperCase().includes("SOFTPHONE")||l.menu_code.toUpperCase().includes("CALLING")))||o.items.push({menu_code:"SOFTPHONE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Calling & Softphone',route:"softphone"})}const p=n.map(s=>a.get(s));p.sort((s,r)=>s.order-r.order);for(const s of p)s.section_code==="WORKFLOWS"&&s.items&&s.items.sort((r,l)=>(e[r.menu_code]||99)-(e[l.menu_code]||99)),s.section_code==="CRM_MODULE"&&s.items&&s.items.sort((r,l)=>(t[r.menu_code]||t[r.route]||99)-(t[l.menu_code]||t[l.route]||99));return p}open(){if(this.isOpen)return;A.getPortal()==="staff"&&!this.isStaffMenuLoaded&&this.loadStaffMenus(),this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden"}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let I=null;function G(){return I||(I=new H),I}class T{static render(e){let{title:t,showBack:a=!1,showLogout:n=!1,rightAction:i,subtitle:o,showMenu:p}=e;const s=A.getPortal(),r=w.getCurrentRoute(),l=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(r);if(p===void 0&&(p=l||!a),s==="vgk"&&(n=!0,!o)){const c=y.getAuthState().user||{},h=c.name||c.partner_name||"",u=c.partner_code||"";(h||u)&&(o=u?`${h} (${u})`:h)}return`
