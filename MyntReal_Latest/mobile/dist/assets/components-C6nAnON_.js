...
import{v,j as R,d as b,b as S,r as A,t as k,a as V}from"./services-DUR7QWIj.js";import{L as w}from"./vendor-B1GRRwIS.js";import{_ as N}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as U}from"./services-gps-CTBFZN6t.js";class H{modalEl=null;uiState="CLOSED";currentOptions=null;enteredNumber="";rawNumber="";isPresetNumber=!1;isDtmfOpen=!1;unsubscribeTelephony=null;currentSession=null;floatingPos={x:0,y:0};pillPos={x:0,y:0};isDraggingWindow=!1;isDraggingPill=!1;dragStartPointer={x:0,y:0};dragStartPos={x:0,y:0};hasInitializedPosition=!1;lastNotifiedLeadId=null;constructor(){typeof window<"u"&&(window.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen()&&(this.uiState==="ACTIVE_FLOATING"?this.minimize():this.uiState==="DIALER"&&this.close())}),window.addEventListener("resize",()=>{this.isOpen()&&(this.clampPositions(),this.applyPositions())}))}isOpen(){return this.modalEl!==null&&document.body.contains(this.modalEl)&&this.uiState!=="CLOSED"}getUIState(){return this.uiState}open(e){this.currentOptions=e;const t=(e.phoneNumber||"").replace(/[^\d+]/g,"");this.enteredNumber=t,this.rawNumber=t,this.isPresetNumber=!!t,this.isDtmfOpen=!1,this.hasInitializedPosition=!1,this.unsubscribeTelephony&&this.unsubscribeTelephony(),this.unsubscribeTelephony=v.subscribe(n=>{this.currentSession=n,this.handleTelephonyStateUpdate(n)});const a=v.isCallActive();this.uiState=a?"ACTIVE_FLOATING":"DIALER",this.render(),this.loadLeadContext(e.entityId),e.autoStart&&this.enteredNumber&&this.startCall()}minimize(){this.uiState!=="CLOSED"&&(this.uiState="MINIMIZED",this.updateVisibility())}restore(){this.uiState!=="CLOSED"&&(this.uiState="ACTIVE_FLOATING",this.updateVisibility(),this.updateSessionUI())}close(){if(this.currentSession&&(v.isCallActive()||["connecting","ringing","connected","held"].includes(this.currentSession.state))){this.minimize();return}this.teardown()}forceCloseAndHangup(){this.currentSession&&v.isCallActive()&&v.endCall(),this.teardown()}teardown(){this.unsubscribeTelephony&&(this.unsubscribeTelephony(),this.unsubscribeTelephony=null),this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.uiState="CLOSED",this.currentOptions=null,this.currentSession=null,this.hasInitializedPosition=!1,this.lastNotifiedLeadId=null}handleTelephonyStateUpdate(e){if(!this.modalEl||!document.body.contains(this.modalEl))if(e.state!=="idle")this.render();else return;if(v.isCallActive()){this.uiState==="DIALER"&&(this.uiState="ACTIVE_FLOATING");const a=Number(this.currentOptions?.entityId);a&&(this.currentOptions?.entityType==="lead"||!this.currentOptions?.entityType)&&this.lastNotifiedLeadId!==a&&(this.lastNotifiedLeadId=a,R.notifyCallActive(a))}else if(this.lastNotifiedLeadId=null,e.state==="ended"){this.uiState="ENDED_SUMMARY";const a=this.currentOptions,n=e.durationSeconds||0;R.clearCallActive(),a?.entityId&&window.dispatchEvent(new CustomEvent("myntos:lead-call-ended",{detail:{leadId:a.entityId,name:a.name,phoneNumber:a.phoneNumber,durationSeconds:n,categoryName:a.categoryName,status:a.status}})),setTimeout(()=>{this.uiState==="ENDED_SUMMARY"&&this.teardown()},1600)}else if(e.state==="idle"&&this.uiState!=="DIALER"){R.clearCallActive(),this.teardown();return}this.updateVisibility(),this.updateSessionUI()}maskPhone(e){if(!e)return"—";const t=e.replace(/\D/g,"");if(t.length<6)return e;const a=t.slice(-10);return b.isMR10001()?a.length===10?`+91 ${a.slice(0,5)} ${a.slice(5)}`:e:`+91 ${a.slice(0,2)}••••${a.slice(-4)}`}getDialInputDisplay(){return!b.isMR10001()&&this.isPresetNumber&&this.enteredNumber?this.maskPhone(this.enteredNumber):this.enteredNumber}formatDuration(e){const t=Math.floor(e/60).toString().padStart(2,"0"),a=(e%60).toString().padStart(2,"0");return`${t}:${a}`}initPositions(){if(this.hasInitializedPosition||typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=Math.max(12,Math.round((e-a)/2)),o=Math.max(20,Math.round((t-n)/2));this.floatingPos={x:i,y:o},this.pillPos={x:Math.max(12,e-260),y:Math.max(20,t-100)},this.hasInitializedPosition=!0}clampPositions(){if(typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=12,o=Math.max(12,e-a-12),p=12,s=Math.max(12,t-n-12);this.floatingPos.x=Math.min(Math.max(this.floatingPos.x,i),o),this.floatingPos.y=Math.min(Math.max(this.floatingPos.y,p),s);const r=240,c=54,l=12,d=Math.max(12,e-r-12),h=12,u=Math.max(12,t-c-12);this.pillPos.x=Math.min(Math.max(this.pillPos.x,l),d),this.pillPos.y=Math.min(Math.max(this.pillPos.y,h),u)}applyPositions(){const e=this.modalEl?.querySelector("#spModalDialog");e&&(this.uiState==="ACTIVE_FLOATING"||this.uiState==="DIALER")&&(e.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`);const t=this.modalEl?.querySelector("#spMinimizedPill");t&&this.uiState==="MINIMIZED"&&(t.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`)}render(){this.modalEl&&this.modalEl.remove(),this.initPositions(),this.clampPositions();const{name:e,entityType:t}=this.currentOptions||{},a=e||"Customer Lead",n=t?t.toUpperCase():"LEAD";this.modalEl=document.createElement("div"),this.modalEl.id="myntosCentralSoftphoneModal",this.modalEl.style.cssText=`
    ...
    `,document.body.appendChild(this.modalEl),this.attachEventListeners(),this.attachDragListeners(),this.updateVisibility(),this.updateSessionUI()}attachDragListeners(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spFloatingHeader"),t=this.modalEl.querySelector("#spModalDialog");if(e&&t){e.addEventListener("pointerdown",i=>{const o=i.target;if(!(o&&o.closest("button, input, a"))){this.isDraggingWindow=!0,this.dragStartPointer={x:i.clientX,y:i.clientY},this.dragStartPos={x:this.floatingPos.x,y:this.floatingPos.y};try{e.setPointerCapture(i.pointerId)}catch{}i.preventDefault(),i.stopPropagation()}}),e.addEventListener("pointermove",i=>{if(!this.isDraggingWindow)return;const o=i.clientX-this.dragStartPointer.x,p=i.clientY-this.dragStartPointer.y;this.floatingPos={x:this.dragStartPos.x+o,y:this.dragStartPos.y+p},this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`});const n=i=>{if(this.isDraggingWindow){this.isDraggingWindow=!1;try{e.releasePointerCapture(i.pointerId)}catch{}this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`}};e.addEventListener("pointerup",n),e.addEventListener("pointercancel",n)}const a=this.modalEl.querySelector("#spMinimizedPill");if(a){let n=!1;a.addEventListener("pointerdown",o=>{const p=o.target;if(!(p&&p.closest("#spPillRestoreBtn"))){this.isDraggingPill=!0,n=!1,this.dragStartPointer={x:o.clientX,y:o.clientY},this.dragStartPos={x:this.pillPos.x,y:this.pillPos.y};try{a.setPointerCapture(o.pointerId)}catch{}o.preventDefault(),o.stopPropagation()}}),a.addEventListener("pointermove",o=>{if(!this.isDraggingPill)return;const p=o.clientX-this.dragStartPointer.x,s=o.clientY-this.dragStartPointer.y;(Math.abs(p)>3||Math.abs(s)>3)&&(n=!0),this.pillPos={x:this.dragStartPos.x+p,y:this.dragStartPos.y+s},this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`});const i=o=>{if(this.isDraggingPill){this.isDraggingPill=!1;try{a.releasePointerCapture(o.pointerId)}catch{}this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`,n||this.restore()}};a.addEventListener("pointerup",i),a.addEventListener("pointercancel",i)}}attachEventListeners(){if(!this.modalEl)return;this.modalEl.querySelector("#spModalBackdrop")?.addEventListener("click",()=>{this.uiState==="DIALER"&&this.close()}),this.modalEl.querySelector("#spMinimizeBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.minimize()}),this.modalEl.querySelector("#spCloseBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.close()}),this.modalEl.querySelector("#spPillRestoreBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.restore()});const e=this.modalEl.querySelector("#spDialInput");e?.addEventListener("input",t=>{this.enteredNumber=t.target.value,this.rawNumber="",this.isPresetNumber=!1,this.updateCallerPhoneDisplay()}),this.modalEl.querySelector("#spBackspaceBtn")?.addEventListener("click",()=>{if(this.isPresetNumber){this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1),this.updateCallerPhoneDisplay();return}this.enteredNumber.length>0&&(this.enteredNumber=this.enteredNumber.slice(0,-1),e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),v.playKeyTone())}),this.modalEl.querySelectorAll(".sp-num-btn").forEach(t=>{t.addEventListener("click",a=>{const n=a.currentTarget.getAttribute("data-key");this.isPresetNumber&&(this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1)),n&&this.enteredNumber.length<15&&(this.enteredNumber+=n,e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),v.playKeyTone())})}),this.modalEl.querySelector("#spMainDialBtn")?.addEventListener("click",()=>{this.startCall()}),this.modalEl.querySelector("#spDirectSimBtn")?.addEventListener("click",()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}v.triggerDirectSimCall(this.enteredNumber)}),this.modalEl.querySelector("#spMyOperatorBtn")?.addEventListener("click",async()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}try{const t=this.currentOptions?.entityId?parseInt(String(this.currentOptions.entityId)):null;await v.triggerMyOperatorCall(this.enteredNumber,t),alert(`MyOperator call dispatched to ${this.enteredNumber}! Your office line will ring shortly.`)}catch(t){this.showError(`MyOperator error: ${t.message}`)}}),this.modalEl.querySelector("#spBtnMute")?.addEventListener("click",()=>{v.toggleMute()}),this.modalEl.querySelector("#spBtnSpeaker")?.addEventListener("click",()=>{v.toggleSpeaker()}),this.modalEl.querySelector("#spInCallVolumeSlider")?.addEventListener("input",t=>{const a=parseFloat(t.target.value)/100;v.setVolume(a)}),this.modalEl.querySelector("#spBtnHold")?.addEventListener("click",()=>{v.toggleHold()}),this.modalEl.querySelector("#spBtnKeypad")?.addEventListener("click",()=>{this.isDtmfOpen=!this.isDtmfOpen;const t=this.modalEl?.querySelector("#spDtmfGrid");t&&(t.style.display=this.isDtmfOpen?"grid":"none")}),this.modalEl.querySelectorAll(".sp-dtmf-btn").forEach(t=>{t.addEventListener("click",a=>{const n=a.currentTarget.getAttribute("data-dtmf");n&&v.sendDTMF(n)})}),this.modalEl.querySelector("#spBtnHangup")?.addEventListener("click",()=>{v.endCall()})}updateVisibility(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spModalBackdrop"),t=this.modalEl.querySelector("#spModalDialog"),a=this.modalEl.querySelector("#spMinimizedPill"),n=this.modalEl.querySelector("#spInCallView"),i=this.modalEl.querySelector("#spDialerView");this.uiState==="DIALER"?(e&&(e.style.display="block"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="block"),n&&(n.style.display="none")):this.uiState==="ACTIVE_FLOATING"?(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="flex")):this.uiState==="MINIMIZED"?(e&&(e.style.display="none"),t&&(t.style.display="none"),a&&(a.style.display="flex")):this.uiState==="ENDED_SUMMARY"&&(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="flex"))}updateCallerPhoneDisplay(){const e=this.modalEl?.querySelector("#spCallerPhoneDisplay");e&&(e.textContent=this.maskPhone(this.enteredNumber))}showError(e){const t=this.modalEl?.querySelector("#spErrorBanner");t&&(t.textContent=e,t.style.display="block")}hideError(){const e=this.modalEl?.querySelector("#spErrorBanner");e&&(e.style.display="none")}async startCall(){v.prepareAudioOnUserGesture(),this.hideError();const e=this.rawNumber||this.enteredNumber;if(!e){this.showError("Please enter a destination phone number.");return}const t=this.currentOptions?.name||"Contact Lead",a=this.currentOptions?.entityId||null;this.uiState="ACTIVE_FLOATING",this.updateVisibility();const n=await v.startCall(e,t,a);!n.success&&n.error&&(n.error==="A call is already in progress."?console.warn("[SoftphoneModal] Duplicate dial prevented; ignoring duplicate error toast"):this.showError(n.error))}updateSessionUI(){if(!this.modalEl||!this.currentSession)return;const e=this.currentSession.contactName||this.currentOptions?.name||"Contact Lead",t=this.currentSession.destinationPhone||this.enteredNumber,a=this.formatDuration(this.currentSession.durationSeconds),n=this.modalEl.querySelector("#spActiveCallerName");n&&(n.textContent=e);const i=this.modalEl.querySelector("#spActiveCallerPhone");i&&(i.textContent=this.maskPhone(t));const o=this.modalEl.querySelector("#spCallTimerDisplay");o&&(o.textContent=a);const p=this.modalEl.querySelector("#spPillCallerName");p&&(p.textContent=e);const s=this.modalEl.querySelector("#spPillTimerDisplay");s&&(s.textContent=a);const r=this.modalEl.querySelector("#spCallStateBadge");r&&(this.currentSession.state==="connected"?(r.textContent="🟢 Connected",r.style.background="#22c55e",r.style.color="#ffffff"):this.currentSession.state==="ringing"?(r.textContent="📞 Ringing...",r.style.background="#38bdf8",r.style.color="#000000"):this.currentSession.state==="connecting"?(r.textContent="⏳ Connecting...",r.style.background="#f59e0b",r.style.color="#000000"):this.currentSession.state==="ended"&&(r.textContent="🛑 Call Ended",r.style.background="#ef4444",r.style.color="#ffffff"));const c=this.modalEl.querySelector("#spBtnMute");c&&(c.style.background=this.currentSession.isMuted?"rgba(239,68,68,0.6)":"rgba(255,255,255,0.1)",c.style.borderColor=this.currentSession.isMuted?"#ef4444":"rgba(255,255,255,0.2)");const l=this.modalEl.querySelector("#spBtnSpeaker");l&&(l.style.background=this.currentSession.isSpeaker?"rgba(56,189,248,0.6)":"rgba(255,255,255,0.1)",l.style.borderColor=this.currentSession.isSpeaker?"#38bdf8":"rgba(255,255,255,0.2)");const d=this.modalEl.querySelector("#spBtnHold");d&&(d.style.background=this.currentSession.isHeld?"rgba(245,158,11,0.6)":"rgba(255,255,255,0.1)",d.style.borderColor=this.currentSession.isHeld?"#f59e0b":"rgba(255,255,255,0.2)")}async loadLeadContext(e){const t=this.modalEl?.querySelector("#spLeadContextBox");if(!t)return;if(this.currentOptions?.categoryName){const n=this.modalEl?.querySelector("#spMobileCatBadge");n&&(n.textContent=this.currentOptions.categoryName);const i=this.modalEl?.querySelector("#spHeaderCatBadge");i&&(i.textContent=`🏷️ ${this.currentOptions.categoryName}`,i.style.display="inline-block")}if(this.currentOptions?.status){const n=this.modalEl?.querySelector("#spMobileStatus");n&&(n.textContent=this.currentOptions.status.toUpperCase());const i=this.modalEl?.querySelector("#spHeaderStatusBadge");i&&(i.textContent=`📌 ${this.currentOptions.status}`,i.style.display="inline-block")}let a=e;if(!a&&this.currentOptions?.phoneNumber)try{const n=this.currentOptions.phoneNumber.replace(/\D/g,"").slice(-10);if(n.length>=10){const i=await S.get(`/telephony/calls/${n}/customer-history`),o=i?.data??i;o?.lead?.id&&(a=o.lead.id)}}catch(n){console.warn("[SoftphoneModal] Lead lookup by phone notice:",n)}if(!a){this.currentOptions?.categoryName||this.currentOptions?.status?t.style.display="block":t.style.display="none";return}try{const n=await S.get(`/crm/dialer/lead/${a}/detail`),i=n.data??n;if(!i||!i.lead)return;const o=i.lead;t.style.display="block";const p=this.modalEl?.querySelector("#spMobileCatBadge");p&&(p.textContent=o.category_name||"General");const s=this.modalEl?.querySelector("#spHeaderCatBadge");s&&(s.textContent=`🏷️ ${o.category_name||"General"}`,s.style.display="inline-block");const r=this.modalEl?.querySelector("#spMobileSource");r&&(r.textContent=o.source||"—");const c=this.modalEl?.querySelector("#spMobileCompany");c&&(c.textContent=o.company_name||"—");const l=this.modalEl?.querySelector("#spMobileStatus");l&&(l.textContent=(o.status||"—").toUpperCase(),l.style.color=o.status==="won"?"#22c55e":o.status==="lost"?"#ef4444":"#38bdf8");const d=this.modalEl?.querySelector("#spHeaderStatusBadge");d&&(d.textContent=`📌 ${o.status||"New"}`,d.style.display="inline-block");const h=this.modalEl?.querySelector("#spHeaderTempBadge");h&&(o.is_hot_lead?(h.textContent="🔥 HOT LEAD",h.style.background="rgba(239, 68, 68, 0.2)",h.style.color="#ef4444",h.style.border="1px solid rgba(239, 68, 68, 0.4)",h.style.display="inline-block"):o.is_fresh_lead?(h.textContent="🌱 FRESH LEAD",h.style.background="rgba(16, 185, 129, 0.2)",h.style.color="#10b981",h.style.border="1px solid rgba(16, 185, 129, 0.4)",h.style.display="inline-block"):h.style.display="none");const u=this.modalEl?.querySelector("#spMobileStatusUpdated");u&&(u.textContent=o.status_updated_at?new Date(o.status_updated_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"—");const f=this.modalEl?.querySelector("#spMobileBudget");f&&(f.textContent=o.budget_display||"—");const y=this.modalEl?.querySelector("#spMobileLastInteraction");y&&(y.textContent=o.last_interaction_date?new Date(o.last_interaction_date).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const E=this.modalEl?.querySelector("#spMobileInteractedBy");E&&(E.textContent=o.last_interacted_by||"—");const g=this.modalEl?.querySelector("#spMobileLastDialed");g&&(g.textContent=o.last_dialed_at?new Date(o.last_dialed_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const x=this.modalEl?.querySelector("#spMobileReqRow"),_=this.modalEl?.querySelector("#spMobileRequirements");x&&_&&(o.requirements?(_.textContent=o.requirements,x.style.display="block"):x.style.display="none");const M=this.modalEl?.querySelector("#spMobileNotesSection"),L=this.modalEl?.querySelector("#spMobileRecentNotes");if(M&&L){const I=(i.notes||[]).slice(0,2);I.length>0?(L.innerHTML=I.map($=>`<div>• ${$.note}</div>`).join(""),M.style.display="block"):M.style.display="none"}}catch(n){console.warn("[SoftphoneModal] Could not fetch lead context:",n)}}}const le=new H,D={"/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"staff-task-tracker","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/vgk/members":"staff-vgk-members","/staff_vgk_members.html":"staff-vgk-members","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"category-leads-master","/staff/real-dreams-leads":"category-leads-master","/staff/insurance-leads":"category-leads-master","/staff/ev-b2b-leads":"category-leads-master","/staff/ev-b2c-leads":"category-leads-master","/staff/ev-spares-leads":"category-leads-master","/staff/etc-leads":"category-leads-master","/staff/mnr-leads":"category-leads-master","/staff/mnr-leads-master":"category-leads-master","/staff/executive-dashboard":"executive-dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/configuration/catalog":"digital-catalog","/staff/catalog-library":"digital-catalog","/staff/catalog":"digital-catalog","/catalog-library":"digital-catalog","catalog-library":"digital-catalog","/staff/catalog-library.html":"digital-catalog","/catalog-library.html":"digital-catalog","/catalog":"digital-catalog",catalog:"digital-catalog","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"auto-dialer","/staff/softphone":"softphone","/staff/calling-page":"softphone","/staff/calling":"softphone","/staff/phone-dialpad":"softphone","/staff/softphone-hub":"softphone","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},z=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],G=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],O=[{section_code:"ATTENDANCE",section_label:"ATTENDANCE",order:1,items:[{menu_code:"IN_OUT_TIME",label:"In/Out Time",route:"attendance"},{menu_code:"MY_LEAVES",label:"My Leaves",route:"leaves"},{menu_code:"LEAVE_APPROVALS",label:"Leave Approvals",route:"staff-leave-approvals"},{menu_code:"IN_OUT_RECORDS_ADMIN",label:"In/Out Records - Admin",route:"team-attendance"},{menu_code:"ATTENDANCE_RECORDS",label:"Attendance Records",route:"staff-attendance-sheet"},{menu_code:"ATTENDANCE_DASHBOARD",label:"Attendance Dashboard",route:"staff-attendance-reports"},{menu_code:"EXCEPTION_APPROVALS",label:"Exception Approvals",route:"staff-attendance-exceptions"},{menu_code:"ATTENDANCE_COMPUTATION",label:"Attendance Computation",route:"staff-attendance-computation"}]},{section_code:"TASK_MANAGEMENT",section_label:"TASK MANAGEMENT",order:3,items:[{menu_code:"ASSIGNED_BY_ME",label:"Assigned By Me",route:"tasks-assigned"},{menu_code:"ASSIGNED_TO_ME",label:"Assigned To Me",route:"tasks-received"},{menu_code:"TEAM_ACTIVITIES",label:"Team Activities",route:"staff-team-activities"},{menu_code:"TASK_TRACKER",label:"Task Dashboard",route:"staff-task-tracker"},{menu_code:"TASK_REVIEWS",label:"Task Reviews",route:"staff-task-reviews"}]},{section_code:"KRA_MANAGEMENT",section_label:"KRA MANAGEMENT",order:4,items:[{menu_code:"MY_KRAS",label:"My KRAs",route:"kras"},{menu_code:"KRA_TEMPLATES",label:"KRA Templates",route:"staff-kra-templates"},{menu_code:"KRA_TRACKING_SHEET",label:"KRA Tracking Sheet",route:"staff-kra-tracking"},{menu_code:"KRA_REVIEW",label:"KRA Review",route:"staff-kra-review"}]},{section_code:"TIMESHEET",section_label:"TIMESHEET",order:5,items:[{menu_code:"MY_TIMESHEET",label:"My Timesheet",route:"timesheet"},{menu_code:"TIMESHEET_APPROVAL",label:"Timesheet Approval",route:"staff-timesheet-approval"}]},{section_code:"JOURNEY_TRACKING",section_label:"JOURNEY TRACKING",order:6,items:[{menu_code:"MY_JOURNEYS",label:"My Journeys",route:"journeys"},{menu_code:"TEAM_JOURNEYS",label:"Team Journeys",route:"team-journeys"},{menu_code:"ALL_JOURNEYS",label:"All Journeys",route:"staff-all-journeys"},{menu_code:"VGK4U_JOURNEYS",label:"VGK4U Journeys",route:"staff-vgk4u-journeys"}]},{section_code:"REIMBURSEMENT",section_label:"REIMBURSEMENT",order:7,items:[{menu_code:"MY_REIMBURSEMENT_CLAIMS",label:"My Reimbursement Claims",route:"reimbursements"},{menu_code:"REIMBURSEMENT_APPROVALS",label:"Reimbursement Approvals",route:"staff-reimbursement-approvals"}]},{section_code:"ACCOUNTS_EARNINGS",section_label:"FINANCE & EARNINGS",order:8,items:[{menu_code:"MY_EARNINGS",label:"My Earnings",route:"staff-my-incentives"},{menu_code:"PAYROLL_PROFILE",label:"Payroll Profile",route:"staff-payroll-profile"},{menu_code:"SALARY_SLIPS",label:"Salary Slips",route:"staff-salary-slips"}]},{section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[{menu_code:"MY_CRM_DASHBOARD",label:"CRM Dashboard",route:"staff-crm"},{menu_code:"MY_LEADS",label:"My Leads",route:"staff-my-leads"},{menu_code:"DIGITAL_CATALOG",label:"Digital Catalog",route:"digital-catalog"},{menu_code:"AUTO_DIALER",label:"Auto Dialer",route:"auto-dialer"},{menu_code:"SOFTPHONE",label:"Calling & Softphone",route:"softphone"},{menu_code:"BANK_WISE_LEADS",label:"Field staff leads",route:"staff-bank-wise-leads"},{menu_code:"TEAM_LEADS",label:"Team Leads",route:"staff-team-leads"},{menu_code:"LEADS_MASTER",label:"Staff Leads",route:"staff-leads"},{menu_code:"VGK_TEAM_MEMBERS",label:"VGK Channel Partners",route:"staff-vgk-members"}]},{section_code:"WORKFLOWS",section_label:"WORK FLOWS",order:10,items:[{menu_code:"EXECUTIVE_DASHBOARD",label:"Executive Dashboard",route:"executive-dashboard"},{menu_code:"MNR_BANK_WISE_LEADS",label:"Field Sales",route:"staff-bank-wise-leads"},{menu_code:"CATEGORY_LEADS_MASTER",label:"Category Leads Master",route:"category-leads-master"},{menu_code:"SOLAR_LEADS",label:"Solar Leads",route:"category-leads-master",tab:"solar"},{menu_code:"EV_B2B_LEADS",label:"EV B2B Leads",route:"category-leads-master",tab:"ev-b2b"},{menu_code:"EV_B2C_LEADS",label:"EV B2C Leads",route:"category-leads-master",tab:"ev-b2c"},{menu_code:"EV_SPARES_LEADS",label:"EV Spares Leads",route:"category-leads-master",tab:"ev-spares"},{menu_code:"ZYN_REAL_ESTATE",label:"Real Dreams Leads",route:"category-leads-master",tab:"real-dreams"},{menu_code:"ZYN_INSURANCE",label:"Insurance Leads",route:"category-leads-master",tab:"insurance"},{menu_code:"ETC_LEADS",label:"ETC Leads",route:"category-leads-master",tab:"etc"},{menu_code:"MNR_LEADS",label:"MNR Leads",route:"category-leads-master",tab:"mnr"}]},{section_code:"OPERATIONS",section_label:"OPERATIONS",order:11,items:[{menu_code:"CALL_TRACKING",label:"Call Tracking",route:"staff-call-tracking"},{menu_code:"VENDORS",label:"Vendors",route:"staff-vendors"},{menu_code:"ZYN",label:"Zynova Real Estate",route:"zynova-real-estate"},{menu_code:"ZYNOVA",label:"VGK4U",route:"staff-zynova"},{menu_code:"ZYN_INSURANCE",label:"Zynova Insurance",route:"zynova-insurance"}]}],F=[];class K{container=null;overlay=null;isOpen=!1;expandedSections=new Set;staffMenuTree=null;isStaffMenuLoaded=!1;constructor(){try{const e=localStorage.getItem("mnr_staff_menu_tree_cache");e&&(this.staffMenuTree=JSON.parse(e),this.isStaffMenuLoaded=!0)}catch{}this.createElements(),this.loadStaffMenus(),window.addEventListener("logout",()=>{this.staffMenuTree=null,this.isStaffMenuLoaded=!1;try{localStorage.removeItem("mnr_staff_menu_tree_cache")}catch{}this.updateUI()}),window.addEventListener("auth-changed",()=>{this.isStaffMenuLoaded=!1,this.loadStaffMenus()})}createElements(){if(this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),!document.getElementById("myntos-drawer-styles")){const e=document.createElement("style");e.id="myntos-drawer-styles",e.textContent=`
      ...
      `,document.head.appendChild(e)}this.attachEventListeners()}render(){const e=A.getPortal(),t=e==="vgk",n=b.getAuthState().user||{},i=(n.role_code||n.role?.role_code||n.user_type||"").toString().toLowerCase().trim(),o=(n.role_name||n.role?.role_name||"").toString().toUpperCase().trim(),p=(n.staff_type||"").toString().toUpperCase().trim(),s=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin","manager","director","admin"].includes(i)||i.includes("vgk")||i.includes("manager")||i.includes("lead")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER"].includes(o)||o.includes("VGK")||o.includes("MANAGER")||["VGK4U","VGK4U SUPREME"].includes(p)||!!(n.is_manager||n.is_admin||n.is_super_admin);let r=z;if(t)r=G;else if(e==="staff"){const u=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(i)||i.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(o)||o.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(p);n.staff_type==="FREELANCER"&&n.freelancer_access_mode==="only_leads"?r=[]:r=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...u?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i> Auto Dialer',route:"auto-dialer"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling & Softphone',route:"softphone"}]}const c=["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(u=>i.includes(u))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(u=>o.includes(u))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(u=>p.includes(u))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(u=>(n.department||n.department_name||"").toString().toUpperCase().includes(u)),l=s||c,d=t?F:e==="staff"?this.getStaffMenuMaster():O,h=e==="staff"?this.filterMenusForRole(d,s,l):d;return`
      ...
      <div class="drawer-content">
        ...
        <!-- Section menus -->
        ${h.map(u=>this.renderSection(u)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab;a?k.navigate(t,{tab:a}):k.navigate(t),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await b.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){try{const e=await S.get("/staff/menu-settings/my-menus?unified=true");if(e.success&&e.data&&e.data.sidebar_tree){this.staffMenuTree=e.data.sidebar_tree,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_menu_tree_cache",JSON.stringify(this.staffMenuTree))}catch{}this.updateUI()}}catch(e){console.error("Failed to load dynamic staff menus:",e)}}filterMenusForRole(e,t,a=!1){const i=b.getAuthState().user||{},o=(i.emp_code||i.employee_code||"").toString().toUpperCase().trim(),p=["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(o);if(t&&!p)return e;const s=new Set(["SAAS","SAAS_MANAGEMENT","SAAS CONFIGURATION","CONFIGURATION","SYSTEM_CONFIGURATION","SYSTEM CONFIG","META_ADS","META ADS","VENDOR_MANAGEMENT","VENDOR MANAGEMENT","VENDORS","HR","HR_MANAGEMENT","ZYNOVA","ZYNOVA_REAL_ESTATE","MNR","MNR_USER_SIDEBAR","MNR USER SIDEBAR","MNR_USER","MNR USER"]);a||(s.add("ACCOUNTS"),s.add("ACCOUNTS_EARNINGS"),s.add("ACCOUNTS & EARNINGS"),s.add("FINANCE"),s.add("FINANCE & EARNINGS"),s.add("FINANCE_EARNINGS"),s.add("ACCOUNTS_MANAGEMENT"));const r=new Set(["EXECUTIVE_DASHBOARD","CATEGORY_LEADS_MASTER","SAAS_CONFIG","SYSTEM_CONFIG"]);(!t||p)&&(r.add("LEADS_MASTER"),r.add("STAFF_LEADS"),r.add("staff_leads")),a||(r.add("PAYROLL_PROFILE"),r.add("SALARY_SLIPS"),r.add("EXPENSE_ENTRIES"));const c=[];for(const l of e){const d=(l.section_code||"").toUpperCase().trim(),h=(l.section_label||"").toUpperCase().trim();if(s.has(d)||s.has(h))continue;let u=l.items;u&&u.length>0&&(u=u.filter(g=>{const x=(g.menu_code||"").toUpperCase().trim();return!r.has(x)}));let f=l.subSections;f&&f.length>0&&(f=f.map(g=>({...g,items:g.items.filter(x=>{const _=(x.menu_code||"").toUpperCase().trim();return!r.has(_)})})).filter(g=>g.items.length>0));const y=u&&u.length>0,E=f&&f.length>0;(y||E)&&c.push({...l,items:y?u:void 0,subSections:E?f:void 0})}return c}getStaffMenuMaster(){if(!this.staffMenuTree)return O;const e={EXECUTIVE_DASHBOARD:1,MNR_EXECUTIVE_DASHBOARD:1,staff_executive_dashboard:1,mnr_executive_dashboard:1,MNR_BANK_WISE_LEADS:2,BANK_WISE_LEADS:2,staff_bank_wise_leads:2,CATEGORY_LEADS_MASTER:3,MNR_LEADS_MASTER:3,mnr_leads_master:3,staff_mnr_leads_master:3,SOLAR_LEADS:4,MNR_SOLAR_LEADS:4,staff_solar_leads:4,mnr_solar_leads:4,EV_B2B_LEADS:5,MNR_EV_B2B_LEADS:5,staff_ev_b2b_leads:5,mnr_ev_b2b_leads:5,EV_B2C_LEADS:6,MNR_EV_B2C_LEADS:6,staff_ev_b2c_leads:6,mnr_ev_b2c_leads:6,EV_SPARES_LEADS:7,MNR_EV_SPARES_LEADS:7,staff_ev_spares_leads:7,mnr_ev_spares_leads:7,ZYN_REAL_ESTATE:8,MNR_REAL_DREAMS_LEADS:8,staff_real_dreams_leads:8,mnr_real_dreams_leads:8,ZYN_INSURANCE:9,MNR_INSURANCE_LEADS:9,staff_insurance_leads:9,mnr_insurance_leads:9,ETC_LEADS:10,MNR_ETC_LEADS:10,staff_etc_leads:10,mnr_etc_leads:10,MNR_LEADS:11,staff_mnr_leads:11,mnr_category_leads:11,AUTO_DIALER:12,staff_auto_dialer:12,"auto-dialer":12},t={MY_CRM_DASHBOARD:1,staff_crm_dashboard:1,"staff-crm":1,MY_LEADS:2,staff_my_leads:2,"staff-my-leads":2,AUTO_DIALER:3,staff_auto_dialer:3,staff_dialer:3,"auto-dialer":3,SOFTPHONE:4,staff_softphone:4,softphone:4,CALLING_PAGE:4,calling:4,"phone-dialpad":4,BANK_WISE_LEADS:5,staff_bank_wise_leads:5,"staff-bank-wise-leads":5,TEAM_LEADS:6,staff_team_leads:6,"staff-team-leads":6,WHATSAPP_CENTER:7,staff_crm_whatsapp_inbox:7,"staff-whatsapp":7,CALL_TRACKING:8,call_tracking_dashboard:8,"staff-call-tracking":8,OPERATOR_CALLS:9,staff_operator_calls:9,"operator-calls":9,VGK_TEAM_MEMBERS:10,staff_vgk_members:10,"staff-vgk-members":10,STAFF_LEADS:11,staff_leads:11,LEADS_MASTER:11,leads_master:11},a=new Map,n=[],i=(s,r,c,l)=>{let d=D[c]||D[c?.replace(/\/$/,"")]||(c?c.replace(/^\/staff\//,"").replace(/\//g,"-"):null);const h=(s||"").toUpperCase(),u=(c||"").toLowerCase();if((h.includes("CATALOG")||u.includes("catalog"))&&(d="digital-catalog"),!d)return null;const y=b.getAuthState().user||{},E=(y.emp_code||y.employee_code||"").toString().toUpperCase().trim();if(["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(E)&&(d==="staff-leads"||c&&c.toLowerCase()==="/staff/leads"||s&&["staff_leads","STAFF_LEADS","LEADS_MASTER","staff_leads_master"].includes(s)))return null;let g=r;(!g||g==="None"||g.trim()==="")&&(g=(s||"").replace(/^staff_|^_staff_|^mnr_/i,"").replace(/_/g," ").replace(/\b\w/g,I=>I.toUpperCase())),h.includes("AUTO_DIALER")||u.includes("auto-dialer")||u==="/staff/dialer"||h==="STAFF_AUTO_DIALER"||h==="AUTO_DIALER"||h==="STAFF_DIALER"||h==="DIALER"?g="Auto Dialer":h.includes("BANK_WISE_LEADS")||u.includes("bank-wise-leads")?g="Field Sales":h.includes("REAL_DREAMS")||u.includes("real-dreams-leads")?g="Real Dreams Leads":h.includes("ETC_LEADS")||u.includes("etc-leads")?g="ETC Training Students":h.includes("CATEGORY_LEADS_MASTER")||h.includes("MNR_LEADS_MASTER")||u.includes("mnr-leads-master")?g="Category Lead Master":h.includes("EXECUTIVE_DASHBOARD")||u.includes("executive-dashboard")?g="Executive Dashboard":h.includes("WHATSAPP")||u.includes("whatsapp")?g="WhatsApp Center":h.includes("SOFTPHONE")||h==="PHONE_DIALPAD"||h==="CALLING_PAGE"||u.includes("softphone")||u.includes("calling")||u.includes("phone-dialpad")?g="Calling & Softphone":h.includes("VGK_TEAM_MEMBERS")||h==="STAFF_VGK_MEMBERS"||u.includes("vgk/members")?g="VGK Channel Partners":(h.includes("CATALOG")||u.includes("catalog"))&&(g="Digital Catalog");let x;h.includes("SOLAR_LEADS")||u.includes("solar-leads")?x="solar":h.includes("EV_B2B")||u.includes("ev-b2b")?x="ev-b2b":h.includes("EV_B2C")||u.includes("ev-b2c")?x="ev-b2c":h.includes("EV_SPARES")||u.includes("ev-spares")?x="ev-spares":h.includes("REAL_DREAMS")||h.includes("ZYN_REAL_ESTATE")||u.includes("real-dreams-leads")?x="real-dreams":h.includes("INSURANCE")||h.includes("ZYN_INSURANCE")||u.includes("insurance-leads")?x="insurance":h.includes("ETC_LEADS")||u.includes("etc-leads")?x="etc":(h.includes("MNR_LEADS")||u.includes("mnr-leads"))&&(x="mnr");const _=l||(g.includes("WhatsApp")?"fab fa-whatsapp":g.includes("Auto Dialer")?"fas fa-phone-volume":g.includes("Softphone")||g.includes("Calling")?"fas fa-headset":g.includes("VGK")||g.includes("Channel")?"fas fa-users":g.includes("Field")||g.includes("Sales")?"fas fa-users-gear":g.includes("Catalog")?"fas fa-book-open":"fas fa-file-alt"),M=g.includes("WhatsApp")?"color: #25d366;":g.includes("Auto Dialer")||g.includes("Softphone")||g.includes("Calling")?"color: #38bdf8;":g.includes("VGK")||g.includes("Channel")?"color: #7c3aed;":g.includes("Catalog")?"color: #10b981;":"",L=`<i class="${_}" style="margin-right: 8px; width: 18px; text-align: center; ${M}"></i>`;return{menu_code:s,label:`${L}${g}`,route:d,tab:x}};for(const s of this.staffMenuTree){if(s.id==="progress"||s.section_id==="progress"||(s.title||"").toUpperCase()==="PROGRESS")continue;const r=[],c=[];if(s.items)for(const l of s.items){const d=i(l.menu_code,l.menu_name||l.label||l.name||l.title,l.route_path,l.menu_icon);d&&r.push(d)}if(s.subSections)for(const l of s.subSections){const d=[];if(l.items)for(const u of l.items){const f=i(u.menu_code,u.menu_name||u.label||u.name||u.title,u.route_path,u.menu_icon);f&&d.push(f)}let h=l.title||l.name||l.id||"Subsection";(h==="None"||!h)&&(h=(l.id||"").replace(/^staff_|^vm_/i,"").replace(/_/g," ").replace(/\b\w/g,u=>u.toUpperCase())),d.length>0&&c.push({sub_section_code:l.id||l.section_id||"sub",sub_section_label:h,items:d})}if(r.length>0||c.length>0){let l=(s.id||s.section_id||"other").toString().trim(),d=(s.title||s.name||"Other").toString().trim();(d==="None"||!d)&&(d=l.replace(/_/g," ").replace(/\b\w/g,f=>f.toUpperCase()));const h=l.toLowerCase(),u=d.toUpperCase();if((h==="mynt_real"||h==="myntreal"||h==="workflows"||u==="MYNT REAL"||u==="MYNTREAL"||u==="WORK FLOWS"||u==="WORKFLOWS")&&(l="WORKFLOWS",d="WORK FLOWS"),(h==="crm"||h==="crm_module"||h==="crm_leads"||h==="crm & leads"||u.includes("CRM"))&&(l="CRM_MODULE",d="CRM & LEADS"),a.has(l)){const f=a.get(l);if(r.length>0){f.items=f.items||[];const y=new Set(f.items.map(E=>E.menu_code));for(const E of r)y.has(E.menu_code)||(f.items.push(E),y.add(E.menu_code))}c.length>0&&(f.subSections=f.subSections||[],f.subSections.push(...c))}else n.push(l),a.set(l,{section_code:l,section_label:d,order:l==="CRM_MODULE"?4:s.order!==void 0?s.order:999,items:r.length>0?r:void 0,subSections:c.length>0?c:void 0})}}let o=a.get("CRM_MODULE")||a.get("CRM_LEADS")||a.get("crm")||a.get("CRM");if(o||(o={section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[]},a.set("CRM_MODULE",o),n.push("CRM_MODULE")),o){if(o.items=o.items||[],!o.items.some(l=>l.route==="auto-dialer"||l.menu_code&&(l.menu_code.toUpperCase().includes("AUTO_DIALER")||l.menu_code.toUpperCase().includes("DIALER"))))o.items.push({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"auto-dialer"});else for(const l of o.items)(l.route==="auto-dialer"||l.menu_code&&(l.menu_code.toUpperCase().includes("AUTO_DIALER")||l.menu_code.toUpperCase().includes("DIALER")))&&(l.label='<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer');o.items.some(l=>l.route==="softphone"||l.menu_code&&(l.menu_code.toUpperCase().includes("SOFTPHONE")||l.menu_code.toUpperCase().includes("CALLING")))||o.items.push({menu_code:"SOFTPHONE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Calling & Softphone',route:"softphone"}),o.items.some(l=>l.route==="digital-catalog"||l.menu_code&&l.menu_code.toUpperCase().includes("CATALOG"))||o.items.push({menu_code:"DIGITAL_CATALOG",label:'<i class="fas fa-book-open" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Digital Catalog',route:"digital-catalog"})}const p=n.map(s=>a.get(s));p.sort((s,r)=>s.order-r.order);for(const s of p)s.section_code==="WORKFLOWS"&&s.items&&s.items.sort((r,c)=>(e[r.menu_code]||99)-(e[c.menu_code]||99)),s.section_code==="CRM_MODULE"&&s.items&&s.items.sort((r,c)=>(t[r.menu_code]||t[r.route]||99)-(t[c.menu_code]||t[c.route]||99));return p}open(){if(this.isOpen)return;A.getPortal()==="staff"&&!this.isStaffMenuLoaded&&this.loadStaffMenus(),this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden"}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let T=null;function W(){return T||(T=new K),T}class P{static render(e){let{title:t,showBack:a=!1,showLogout:n=!1,rightAction:i,subtitle:o,showMenu:p}=e;const s=A.getPortal(),r=k.getCurrentRoute(),c=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(r);if(p===void 0&&(p=c||!a),s==="vgk"&&(n=!0,!o)){const d=b.getAuthState().user||{},h=d.name||d.partner_name||"",u=d.partner_code||"";(h||u)&&(o=u?`${h} (${u})`:h)}return`
    ...
    `}static getPortalDashboard(){const e=A.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t,showBack:a=!1,rightAction:n,showLogout:i=!1}=e;t===void 0&&(t=!!document.getElementById("hamburgerBtn")),A.getPortal()==="vgk"&&(i=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{W().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{k.goBack()||k.navigate(P.getPortalDashboard())}),n&&document.getElementById("headerActionBtn")?.addEventListener("click",n.onClick),i&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await b.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{k.goBack()||k.navigate(P.getPortalDashboard())})}}class de{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
...
పై లింక్ ఓపెన్ చేసి మీ ఇంటి కరెంట్ బిల్లుకు సరిపోయే ప్లాన్ మరియు సేవింగ్స్ కాలిక్యులేట్ చేసుకోగలరు.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to calculate your recommended capacity, savings & instant quotation.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करें और अपनी मासिक बचत की गणना करें।`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
ఉచిత VIP సైట్ విజిట్ కోసం సంప్రదించండి.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Complimentary chauffeur AC cab pickup available for site visits!`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
ई-कॉमर्स पर प्लॉट्स देखें: https://www.myntreal.com/ecom?vertical=real-dreams`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
పై లింక్ క్లిక్ చేసి మోడల్-వైజ్ ధరలు, స్పెసిఫికేషన్లు & అధికారిక వీడియో చూడగలరు. ఉచిత టెస్ట్ డ్రైవ్ బుక్ చేసుకోండి!`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to explore model-wise prices, interactive savings calculator & official video showcase. Book your free test ride today!`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके मॉडल-वाइज कीमतें और वीडियो देखें। आज ही फ्री टेस्ट ड्राइव बुक करें!`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
పై లింక్ క్లిక్ చేసి B2B ఫ్లీట్ మోడల్స్ మరియు ROI కాలిక్యులేటర్ చూడండి.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to review vehicle specifications & calculate fleet ROI.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके कमर्शियल वाहन विवरण देखें।`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
24 గంటల్లో దేశవ్యాప్త డెలివరీ & అధికారిక GST ఇన్వాయిసింగ్.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Immediate 24-Hour Pan-India Dispatch | Full GST Invoicing.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
ई-कॉमर्स पर ऑर्डर करने के लिए: https://www.myntreal.com/ecom?vertical=ev&category=spares`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
పై లింక్ క్లిక్ చేసి సిలబస్ మరియు తదుపరి బ్యాచ్ వివరాలు చూడండి.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to view curriculum, batch dates & reserve your seat.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके बैच डेट्स और सीट रिजर्व करें।`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
மேலே உள்ள இணைப்பைக் கிளிக் செய்து பாடத்திட்டம் மற்றும் சேர்க்கை விவரங்களை அறிக.`}},insurance:{name:"Comprehensive Insurance Advisory",btnLabel:"Insurance",segmentSlug:"insurance",catalogSlug:"comprehensive-insurance-advisory",brochureUrl:"/public/hub/Assets/myntreal_insurance_guide.pdf",desc:"Sends Insurance catalog with complete risk protection for EV fleets, solar rooftop plants, health & life.",messages:{te:(m,e)=>`నమస్కారం ${m} గారు! 🙏
...
పై లింక్ ద్వారా ప్రీమియం కాలిక్యులేట్ చేసుకోండి మరియు తక్షణ పాలసీ పొందండి.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to calculate customized premiums and issue policies on spot.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके बीमा योजनाओं की तुलना करें और कोटेशन पाएं।`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
పై లింక్ క్లిక్ చేసి పూర్తి ప్రాస్పెక్టస్, ROI మోడల్ & వివరాలు చూడగలరు.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to review complete deliverables, financial models & territory rights.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके पूरी जानकारी और आरओआई मॉडल देखें।`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
పై లింక్ క్లిక్ చేసి పూర్తి హోల్‌సేల్ కాస్ట్ షీట్ & ROI వివరాలు వెంటనే చూడగలరు.`,en:(m,e)=>`Namaskaram ${m}! 🙏
...
Click the link above to review wholesale cost sheets & calculate your net returns.`,hi:(m,e)=>`नमस्ते ${m} जी! 🙏
...
कृपया तुरंत ऊपर दिए गए लिंक पर क्लिक करके पूरी कॉस्ट शीट देखें।`,ta:(m,e)=>`வணக்கம் ${m}! 🙏
...
మీకు అనుకూలమైన సమయంలో దయచేసి ఇక్కడ మెసేజ్ చేయండి లేదా కాల్ బ్యాక్ చేయగలరు!`}}applyVerticalQuick(e){const t=this.getVerticalQuickMessage(e),a=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=t+a,n.focus())}onDigitalCatalogSelect(e){e&&C[e]&&(this.selectedCatalogKey=e);const t=C[this.selectedCatalogKey]||C.solar,a=document.getElementById("uwaDigitalCatDesc");a&&(a.textContent=t.desc);const n=document.getElementById("uwaDigitalCatBtnLabel");n&&(n.textContent=`Insert Personalized ${t.btnLabel||t.name} Catalog Link`)}getDigitalCatalogMessage(e,t){const a=C[e]||C.solar,n=(this.currentOptions?.name||"Customer").trim();let i="https://www.myntreal.com";if(typeof window<"u"&&window.location&&window.location.origin){const c=window.location.origin;c.includes("localhost")||c.includes("127.0.0.1")||c.includes("0.0.0.0")||c.includes("192.168.")||c.includes("10.0.")||c.includes(":8000")||c.includes(":5000")||c.includes(":5173")||c.includes(":3000")||c.includes("capacitor")||(i=c)}let o=`${i}/catalog/${a.segmentSlug}/${a.catalogSlug}?lang=${encodeURIComponent(t||"te")}`;e==="hub_pricing"&&!o.includes("exp=")&&(o+=`&exp=${Math.floor(Date.now()/1e3)+86400}`);const p=(t||"te").toLowerCase(),s=a.messages&&a.messages[p]?a.messages[p]:a.messages&&a.messages.en;let r="";if(typeof s=="function"?r=s(n,o):r=`Namaskaram ${n}! Here is your catalog link:
👉 ${o}`,a.brochureUrl&&!r.includes(".pdf")){const c=a.brochureUrl.startsWith("http")?a.brochureUrl:i+(a.brochureUrl.startsWith("/")?"":"/")+a.brochureUrl;r+=`

${p==="te"?"📄 *అధికారిక PDF బ్రోచర్ (డైరెక్ట్ డౌన్‌లోడ్):*":p==="hi"?"📄 *आधिकारिक पीडीएफ ब्रोशर (डाउनलोड लिंक):*":p==="ta"?"📄 *அதிகாரப்பூர்வ PDF ப்ரோஷர் (பதிவிறக்கம்):*":"📄 *Official PDF Brochure (Direct Download):*"}
👉 ${c}`}return r}applyDigitalCatalog(e){e&&(this.selectedCatalogLang=e,this.modalEl?.querySelectorAll(".uwa-cat-lang-btn")?.forEach(p=>{const s=p.getAttribute("data-lang")===e;p.style.background=s?"#16a34a":"#fff",p.style.color=s?"#fff":"#334155",p.style.borderColor=s?"#16a34a":"#cbd5e1",p.style.fontWeight=s?"700":"600"}));const t=document.getElementById("uwaDigitalCatSel");t&&t.value&&(this.selectedCatalogKey=t.value);const a=this.getDigitalCatalogMessage(this.selectedCatalogKey,this.selectedCatalogLang),n=this.getSenderSignature(),i=document.getElementById("uwaMessageText");i&&(i.value=a+n,i.focus())}detectCatalogKey(){if(this.currentOptions?.catalogKey&&C[this.currentOptions.catalogKey])return this.currentOptions.catalogKey;const e=(this.currentOptions?.context||"").toLowerCase(),t=(this.currentOptions?.segment||"").toLowerCase();return e.includes("solar")||t==="solar"?"solar":e.includes("real")||e.includes("property")||e.includes("estate")||t==="myntreal_real"?"real_estate":e.includes("spare")||t==="ev_spares"?"ev_spares":e.includes("cargo")||e.includes("fleet")||e.includes("b2b")||t==="ev_b2b"?"ev_b2b":e.includes("ev")||e.includes("zynova")||e.includes("vehicle")||t==="ev_b2c"?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")||t==="etc_training"?"etc_training":e.includes("insur")||e.includes("policy")||e.includes("care")?"insurance":e.includes("pricing")||e.includes("margin")||e.includes("commercial")||t==="hub_pricing"?"hub_pricing":e.includes("hub")||e.includes("franchise")?"industrial_hub":"solar"}async loadCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;t.innerHTML='<option value="">— Loading templates… —</option>',a&&(a.style.display="none");const n=this.activeMode==="scanned"?"scanned":"company";let i=`/whatsapp-config/templates?mode=${encodeURIComponent(n)}`;try{const o=await S.get(i),p=o?.templates||o?.data||o||[];this.allCanonicalTemplates=Array.isArray(p)?p:[],this.filterCanonicalTemplates(e)}catch{t.innerHTML='<option value="">— Error loading templates —</option>'}}filterCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;const n=document.getElementById("uwaCanonicalSeg"),i=document.getElementById("uwaCanonicalCat"),o=document.getElementById("uwaCanonicalSearch"),p=(n?.value||"").toLowerCase().trim(),s=(i?.value||"").toUpperCase().trim(),r=(o?.value||"").toLowerCase().trim();let c=this.allCanonicalTemplates||[];if(p&&(c=c.filter(d=>(d.segment||"").toLowerCase()===p)),s&&(c=c.filter(d=>(d.category||"").toUpperCase()===s)),r&&(c=c.filter(d=>{const h=(d.template_name||d.name||"").toLowerCase(),u=(d.body_text||d.content||d.body||"").toLowerCase(),f=(d.slug||"").toLowerCase();return h.includes(r)||u.includes(r)||f.includes(r)})),this.canonicalTemplates=c,!c.length){t.innerHTML=`
      ...
      `,a&&(a.style.display="block"),this.onCanonicalTplChange();return}a&&(a.style.display="none");let l=`<option value="">— Select template (${c.length} available) —</option>`;l+='<option value="__create_new__" style="color:#16a34a; font-weight:700;">➕ Create / Add Template for this Segment...</option>',c.forEach(d=>{const h=d.segment?`[${d.segment}] `:"";l+=`<option value="${d.id}">${h}${this.escapeHtml(d.template_name||d.name||"Template #"+d.id)} (${d.category||"MARKETING"})</option>`}),t.innerHTML=l,e&&(t.value=String(e),this.onCanonicalTplChange())}toggleAddTemplateCard(e){const t=document.getElementById("uwaAddTplCard");if(!t)return;const a=t.style.display!=="none",n=e!==void 0?e:!a;if(t.style.display=n?"block":"none",n){const i=document.getElementById("uwaCanonicalSeg")?.value||this.detectSegment(),o=document.getElementById("uwaNewTplSeg");o&&i&&(o.value=i),document.getElementById("uwaNewTplName")?.focus()}}async saveNewTemplate(){const e=document.getElementById("uwaNewTplName"),t=document.getElementById("uwaNewTplSeg"),a=document.getElementById("uwaNewTplBody"),n=document.getElementById("uwaSaveNewTplBtn"),i=(e?.value||"").trim(),o=t?.value||"general",p=(a?.value||"").trim();if(!i){this.showFeedback("Please enter a template name.","error");return}if(!p){this.showFeedback("Please enter the template message body.","error");return}n&&(n.disabled=!0);const s=i.toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,40);try{const r=await S.post("/whatsapp-config/templates",{name:i,slug:s,category:"MARKETING",segment:o,body_text:p,language:"en",usage_scope:"all"});if(r?.success){this.showFeedback(`✅ Template "${i}" created & approved for WhatsApp API!`,"success"),this.toggleAddTemplateCard(!1),e&&(e.value=""),a&&(a.value="");const c=document.getElementById("uwaCanonicalSeg");c&&(c.value=o);const l=r.template?.id||r.id||s;await this.loadCanonicalTemplates(l)}else this.showFeedback(r?.error||"Failed to create template","error")}catch(r){this.showFeedback(`Error creating template: ${r.message||"Server error"}`,"error")}finally{n&&(n.disabled=!1)}}detectSegment(){if(this.currentOptions?.segment)return this.currentOptions.segment;const e=(this.currentOptions?.context||"").toLowerCase();return e.includes("solar")?"solar":e.includes("real")||e.includes("property")||e.includes("estate")?"myntreal_real":e.includes("spare")?"EV_SPARES":e.includes("ev")||e.includes("vehicle")||e.includes("zynova")?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")?"etc_training":e.includes("partner")?"partner":e.includes("staff")?"staff":e.includes("vgk")?"vgk":"general"}onCanonicalTplChange(){const e=document.getElementById("uwaCanonicalTpl"),t=document.getElementById("uwaCanonicalVarsWrap"),a=document.getElementById("uwaCanonicalVarsBox"),n=e?.value;if(n==="__create_new__"){this.toggleAddTemplateCard(!0),e.value="";return}if(!n){t&&(t.style.display="none"),a&&(a.innerHTML="");return}const i=this.canonicalTemplates.find(s=>String(s.id)===String(n)||String(s.slug)===String(n));if(!i)return;this.selectedCanonicalBody=i.body_text||i.content||i.body||"";const o=this.selectedCanonicalBody.match(/\{\{(\d+)\}\}/g)||[],p=[];if(o.forEach(s=>{const r=s.replace(/[\{\}]/g,"");p.includes(r)||p.push(r)}),p.sort((s,r)=>Number(s)-Number(r)),p.length&&a&&t){t.style.display="block";let s="";p.forEach(r=>{const c=r==="1"&&this.currentOptions?.name||"";s+=`
          <div style="display:flex; align-items:center; gap:8px; margin-bottom:6px;">
            <label style="font-size:11px; font-weight:700; width:28px; color:#475569;">#${r}</label>
            <input type="text" class="uwa-canonical-var-inp" data-var-idx="${r}" value="${this.escapeHtml(c)}" placeholder="Value for {{${r}}}" style="flex:1; font-size:12px; border:1px solid #cbd5e1; border-radius:6px; padding:4px 8px;" />
          </div>
        `}),a.innerHTML=s,a.querySelectorAll(".uwa-canonical-var-inp").forEach(r=>{r.addEventListener("input",()=>this.buildCanonicalPreview())})}else t&&(t.style.display="none"),a&&(a.innerHTML="");this.buildCanonicalPreview()}buildCanonicalPreview(){let e=this.selectedCanonicalBody||"";(e.match(/\{\{(\d+)\}\}/g)||[]).forEach(i=>{const o=i.replace(/[\{\}]/g,""),s=document.querySelector(`.uwa-canonical-var-inp[data-var-idx="${o}"]`)?.value||`{{${o}}}`;e=e.replace(new RegExp(`\\{\\{${o}\\}\\}`,"g"),s)});const a=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&e&&(n.value=e+a)}open(e){this.currentOptions=e,this.activeMode="meta_api",this.render()}close(){this.modalEl&&(this.modalEl.remove(),this.modalEl=null)}render(){if(this.close(),!this.currentOptions)return;const{phone:e,name:t,context:a,defaultMessage:n,catalogKey:i}=this.currentOptions,o=(e||"").replace(/\D/g,"").slice(-10),p=this.getSenderSignature(),s=(n||(i?this.getDigitalCatalogMessage(i,this.selectedCatalogLang):this.getVerticalQuickMessage("thanks_connecting")))+p;this.modalEl=document.createElement("div"),this.modalEl.id="unifiedWAModal",this.modalEl.className="uwa-modal-backdrop",this.modalEl.innerHTML=`
      <div class="uwa-modal-sheet">
        ...
        <div class="uwa-header">
          <div class="uwa-header-info">
            ...
            <div class="uwa-recipient-sub">
              <strong>${this.escapeHtml(t||"Customer")}</strong> · ${this.maskPhone(o)}
        ...
        <textarea id="uwaMessageText" class="uwa-textarea" rows="7" placeholder="Type your WhatsApp message...">${this.escapeHtml(s)}</textarea>
...
`);e.textContent=h}async executeShare(e){const t=document.getElementById("usmStaffSelect"),a=parseInt(t?.value||"0",10);if(!a){alert("Please select a staff member to share details with."),t?.focus();return}const n=this.staffList.find(d=>d.id===a);if(!n){alert("Selected staff member is invalid.");return}const i=document.getElementById("usmFollowupType")?.value||"secondary_followup",o=document.getElementById("usmNotes")?.value.trim()||"",p=document.getElementById("usmAssignCheck")?.checked||!1,s=this.currentOptions;if(!s)return;const r=document.getElementById("usmCombinedBtn"),c=document.getElementById("usmCrmOnlyBtn"),l=document.getElementById("usmWaOnlyBtn");[r,c,l].forEach(d=>{d&&(d.disabled=!0)});try{let d="",h="";if(e==="crm_only"||e==="combined"||p){const f={target_staff_id:a,followup_type:i,notes:o,assign_as_secondary:p},y=await S.post(`/crm/leads/${s.leadId}/share-details`,f);if(y&&y.success)d=y.wa_url||"",h=y.wa_message||"",s.onShared&&s.onShared(y);else throw new Error(y?.detail||y?.message||"Failed to assign lead in CRM")}if(e==="wa_only"||e==="combined"){if(!d){const f=(n.phone||"").replace(/\D/g,"").slice(-10);if(!f)alert(`Colleague ${n.name} does not have a valid mobile number for WhatsApp.`);else{const y=document.getElementById("usmMessagePreview")?.textContent||"";d=`https://wa.me/91${f}?text=${encodeURIComponent(y)}`}}d&&window.open(d,"_blank")}const u=e==="crm_only"?`Lead successfully assigned to ${n.name} in CRM!`:e==="wa_only"?`WhatsApp launched for ${n.name}!`:`Lead assigned in CRM and WhatsApp opened for ${n.name}!`;alert(`✅ ${u}`),this.close()}catch(d){console.error("[UnifiedShareLeadModal] Share failed:",d),alert(`⚠️ Could not complete lead share: ${d.message||d}`)}finally{[r,c,l].forEach(d=>{d&&(d.disabled=!1)})}}}const pe=new q,Y=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],Z=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],X=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class Q{container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("partnerDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;k.navigate(t),this.close()})}),document.getElementById("partnerLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await b.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const he=new te;class ge{container;constructor(e){this.container=e}render(){const t=b.getAuthState().user?.portal||"staff",a=k.getTabRoutes(t),n=k.getCurrentRoute();this.container.innerHTML=`
    ...
    `,this.attachListeners()}attachListeners(){this.container.querySelectorAll(".tab-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-route");t&&k.navigate(t)})})}getIcon(e){const t={home:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      </svg>`};return t[e]||t.home}}class ae{isShowing=!1;unsubscribe=null;checkInterval=null;init(){this.unsubscribe&&this.unsubscribe(),this.checkInterval&&clearInterval(this.checkInterval),this.unsubscribe=S.onSessionExpired(e=>{console.log("[SessionBanner] Session expired detected, endpoint:",e),b.getAuthState().isLoggedIn&&this.show()}),this.checkInterval=setInterval(()=>{if(!b.getAuthState().isLoggedIn){this.isShowing&&this.hide();return}const t=U.getTrackingStatus();t.isSessionExpired&&!this.isShowing?this.show():!t.isSessionExpired&&this.isShowing&&this.hide()},2e3)}cleanup(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null),this.hide()}show(){if(!b.getAuthState().isLoggedIn||this.isShowing||document.getElementById("globalSessionBanner"))return;this.isShowing=!0;const e=document.createElement("div");e.id="globalSessionBanner",e.className="global-session-banner",e.innerHTML=`
