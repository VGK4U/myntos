...
class UnifiedWAModal {
  ...
  private getSenderSignature(): string {
    ...
    const isSysAdmin = code === 'MR10001' || fullName.toUpperCase().includes('SYSTEM ADMINISTRATOR');
