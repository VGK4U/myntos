...
public class BackgroundLocationService extends Service {
    ...
    public static final String ACTION_START = "com.myntos.mobile.START_TRACKING";
    public static final String ACTION_STOP = "com.myntos.mobile.STOP_TRACKING";
    public static final String ACTION_UPDATE_INTERVAL = "com.myntos.mobile.UPDATE_INTERVAL";
