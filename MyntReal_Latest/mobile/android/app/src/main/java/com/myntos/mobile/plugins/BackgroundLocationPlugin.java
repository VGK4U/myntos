...
public class BackgroundLocationPlugin extends Plugin {
    ...
    public static final String ACTION_LOCATION_UPDATE = "com.myntos.mobile.LOCATION_UPDATE";
    public static final String ACTION_SERVICE_STATUS = "com.myntos.mobile.SERVICE_STATUS";
