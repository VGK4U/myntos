...
VERSION_LABEL = f'v2.4.25-upcoming-dialer-journey-live-push-parity-{TIMESTAMP}'
...
eb.create_application_version(
    ...
    Description='MyntOS v2.4.25: Auto dialer upcoming work-ahead, journey live telemetry, push tokens migration, 180d session, 4-platform parity'[:190],
