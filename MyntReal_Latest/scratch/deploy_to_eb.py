...
VERSION_LABEL = f'v2.4.24-journey-gps-table-freeze-parity-{TIMESTAMP}'
...
eb.create_application_version(
    ...
    Description='MyntOS v2.4.24: GPS journey background telemetry bridge, mobile table freeze fix & touch scroll, Android push fix, 4-platform parity'[:190],
