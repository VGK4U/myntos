...
VERSION_LABEL = f'v2.4.8-production-release-{TIMESTAMP}'
...
eb.create_application_version(
    ...
    Description='MyntOS v2.4.8: GUC Telugu WhatsApp confirmation & queue fallback, dialer phone normalization, and universal Share Lead 4-platform parity'[:190],
