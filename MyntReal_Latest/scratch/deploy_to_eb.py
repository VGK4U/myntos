...
VERSION_LABEL = f'v2.3.5-production-release-{TIMESTAMP}'
...
eb.create_application_version(
    ...
    Description='MyntOS v2.3.5: WhatsApp Port 5002 Reverse Proxy, Mutyala Lovaraju Photo & VGK Auto Proper-Casing',
