...
VERSION_LABEL = f'v2.4.2-production-release-{TIMESTAMP}'
...
eb.create_application_version(
    ...
    Description='MyntOS v2.4.2: StaffHeader scoping fix, leads master SDOC hoist Safari TDZ fix, and 4-platform parity',
