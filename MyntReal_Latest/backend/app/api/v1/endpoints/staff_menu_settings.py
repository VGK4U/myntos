...
CANONICAL_MENU_REGISTRY = [
    ...
    {
        'menu_code': 'crm_whatsapp_bot_hub',
        'menu_name': 'WhatsApp Bot Hub',
        'menu_description': 'WhatsApp Bot Management Hub — live conversations, auto-messages, mobile sent delivery logs',
        'route_path': '/staff/crm/whatsapp-bot',
        'menu_category': 'crm',
        'menu_icon': 'fab fa-whatsapp',
        'display_order': 50,
        'is_default_visible': True,
