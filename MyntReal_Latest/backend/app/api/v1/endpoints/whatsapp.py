...
def get_wa_scheduler_status(
    ...
    jobs = [
        ...
        },
        {
            ...
            "schedule": "Every 2 Hours (10:00 AM - 10:00 PM IST / Active)",
            "next_run": "Today 10:00 AM IST" if now_ist.hour < 10 else ("Today 12:00 PM IST" if now_ist.hour < 12 else ("Today 02:00 PM IST" if now_ist.hour < 14 else ("Today 04:00 PM IST" if now_ist.hour < 16 else ("Today 06:00 PM IST" if now_ist.hour < 18 else ("Today 08:00 PM IST" if now_ist.hour < 20 else ("Today 10:00 PM IST" if now_ist.hour < 22 else "Tomorrow 10:00 AM IST"))))))),
