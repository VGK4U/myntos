...
export function buildTrackPoint(input) {
    ...
    let speed_kmh = null;
    if (previousPoint) {
        distance_from_last_m = calculateHaversineDistance(previousPoint.latitude, previousPoint.longitude, rawPosition.latitude, rawPosition.longitude);
        speed_kmh = calculateSpeed(previousPoint.latitude, previousPoint.longitude, previousPoint.timestamp, rawPosition.latitude, rawPosition.longitude, timestamp);
...
export function createStartTrackPoint(rawPosition, batteryPct) {
...
//# sourceMappingURL=track-point-builder.js.map