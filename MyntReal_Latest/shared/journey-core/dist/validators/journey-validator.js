...
import { TRANSPORT_MAX_SPEEDS_KMH } from './wvv-validator.js';
...
export function validateJourneyForEnd(journey) {
    const errors = [];
...
export function calculateWVVComplianceRatio(trackPoints) {
    if (trackPoints.length === 0)
        return 0;
    const compliantCount = trackPoints.filter(p => p.is_wvv_compliant).length;
    return compliantCount / trackPoints.length;
}
export function shouldInvalidateJourney(trackPoints, transportMode) {
...
//# sourceMappingURL=journey-validator.js.map