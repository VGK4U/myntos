...
const createRVZHTML = (title, content, sessionToken = '') => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>${title} - RVZ Supreme Admin</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* RVZ-specific accent color (gold/amber) */
        .rvz-accent { color: #d97706; }
        .rvz-bg { background: linear-gradient(135deg, #d97706 0%, #f59e0b 100%); }
        ...
        /* Button styles - RVZ uses amber accent */
        .btn-primary { 
...
<body class="has-unified-header">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            StaffSidebar.injectUnifiedHeader('unifiedHeader', '${escapeJSServer(title)}', 'fas fa-gem');
            
            console.log('[DC-RVZ] Unified layout initialized');
        });
    </script>
    
    <!-- Global Variables for RVZ Pages -->
    <script>
        ...
        try {
            ...
            console.error('[DC-RVZ] Error loading user data:', e); 
        }
    </script>
...
module.exports = { createRVZHTML, BUILD_ID };
