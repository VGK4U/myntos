// Finance Admin HTML Template Module
...
const createFinanceAdminHTML = (title, content, sessionToken = '') => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>${title} - Finance Admin</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Header - Green/Emerald theme for Finance Admin */
        .top-header { 
        ...
        .dropdown-item-custom { 
            ...
            display: flex !important; align-items: center; gap: 10px; border-border: 1px solid #eee;
        }
        ...
        .card-header { background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: white; border-radius: 12px 12px 0 0 !important; }
...
<body>
        ...
        (async () => {
            ...
            try {
                ...
                if (user) {
                    ...
                    const userName = user.name || user.full_name || user.display_name || 'Finance Admin';
                    if (displayNameEl) {
                    ...
                    console.log('[DC-Header] Finance info loaded:', userName, '(' + userId + ')');
                }
            } catch (err) {
    ...
    <div class="top-header">
        <div class="header-left">
            ...
            <div class="header-logo">💰 Finance Admin Panel</div>
        </div>
        <div class="header-right">
            ...
            <div class="profile-dropdown">
                ...
                <div class="dropdown-menu-custom" id="profileMenu">
                    <a href="/finance/dashboard" class="dropdown-item-custom">
    ...
    <div class="sidebar" id="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-item">
                <a href="/finance/dashboard" class="sidebar-link">
                    <i class="fas fa-tachometer-alt"></i> Dashboard
                </a>
            </li>
            
            <!-- Income Approval Group - Finance Level -->
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-income-approval')">
                    <span><i class="fas fa-clipboard-check"></i> 💰 Income Approval</span>
                    <i class="fas fa-chevron-down" id="financeadmin-income-approval-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-income-approval-items">
                    <li><a href="/admin/income-verified" class="sidebar-link">✅ Finance Queue (Process Payment)</a></li>
            ...
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-functions')">
                    <span><i class="fas fa-calculator"></i> Finance Admin Functions</span>
                    <i class="fas fa-chevron-down" id="financeadmin-functions-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-functions-items">
                    <li><a href="/finance/awards/payment-processing" class="sidebar-link">💰 Payment Processing</a></li>
                    <li><a href="/finance/gift-wise-status" class="sidebar-link">📊 Gift-Wise Status</a></li>
                    <li><a href="/finance/kyc-approval" class="sidebar-link">✅ KYC Approval (Step 2)</a></li>
                    <li><a href="/profile-view" class="sidebar-link">🏦 Bank Approval (Step 2)</a></li>
                    ...
                    <li><a href="/finance/pins" class="sidebar-link">🔑 PIN Approvals (Key Approver)</a></li>
                    <li><a href="/user/withdrawals" class="sidebar-link">💸 Withdrawals</a></li>
                    <li><a href="/finance/expenses" class="sidebar-link">📝 Expense Management</a></li>
                    <li><a href="/finance-admin/tds-management" class="sidebar-link">📊 TDS Management</a></li>
                    <li><a href="/finance/reports" class="sidebar-link">📈 Financial Reports</a></li>
            ...
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-coupons')">
                    <span><i class="fas fa-ticket-alt"></i> Coupon Modules</span>
                    <i class="fas fa-chevron-down" id="financeadmin-coupons-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-coupons-items">
            ...
            <!-- Members Group -->
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-members')">
                    <span><i class="fas fa-users"></i> Members</span>
                    <i class="fas fa-chevron-down" id="financeadmin-members-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-members-items">
            ...
            <!-- Earnings Group -->
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-earnings')">
                    <span><i class="fas fa-dollar-sign"></i> Earnings</span>
                    <i class="fas fa-chevron-down" id="financeadmin-earnings-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-earnings-items">
            ...
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-transfers')">
                    <span><i class="fas fa-university"></i> Bank Transfers</span>
                    <i class="fas fa-chevron-down" id="financeadmin-transfers-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-transfers-items">
                    <li><a href="/finance/withdrawal/transfers" class="sidebar-link">📤 Transfer Queue</a></li>
                    <li><a href="/finance/withdrawal/history" class="sidebar-link">📜 Transfer History</a></li>
                </ul>
            </li>
            
            <!-- Awards & Bonanza Group -->
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-awards')">
                    <span><i class="fas fa-trophy"></i> Awards & Bonanza</span>
                    <i class="fas fa-chevron-down" id="financeadmin-awards-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-awards-items">
            ...
            <!-- RVZ Earnings Group -->
            <li class="sidebar-item">
                <div class="menu-group-header" onclick="toggleMenuGroup('financeadmin-rvz')">
                    <span><i class="fas fa-gem"></i> RVZ Earnings</span>
                    <i class="fas fa-chevron-down" id="financeadmin-rvz-chevron"></i>
                </div>
                <ul class="menu-group-items" id="financeadmin-rvz-items">
...
module.exports = { createFinanceAdminHTML, BUILD_ID };
