const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./services-1e_H7WTk.js","./vendor-capacitor-plugins-DTPsYLMi.js","./vendor-capacitor-core-zwN_Y1fq.js","./vendor-B1GRRwIS.js"])))=>i.map(i=>d[i]);
import{v as x,j as $,d as v,b as I,r as T,t as A,M as F,a as K}from"./services-1e_H7WTk.js";import{L as M}from"./vendor-B1GRRwIS.js";import{_ as z}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as q}from"./services-gps-BtW8mese.js";class j{modalEl=null;uiState="CLOSED";currentOptions=null;enteredNumber="";rawNumber="";isPresetNumber=!1;isDtmfOpen=!1;unsubscribeTelephony=null;currentSession=null;floatingPos={x:0,y:0};pillPos={x:0,y:0};isDraggingWindow=!1;isDraggingPill=!1;dragStartPointer={x:0,y:0};dragStartPos={x:0,y:0};hasInitializedPosition=!1;lastNotifiedLeadId=null;constructor(){typeof window<"u"&&(window.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen()&&(this.uiState==="ACTIVE_FLOATING"?this.minimize():this.uiState==="DIALER"&&this.close())}),window.addEventListener("resize",()=>{this.isOpen()&&(this.clampPositions(),this.applyPositions())}))}isOpen(){return this.modalEl!==null&&document.body.contains(this.modalEl)&&this.uiState!=="CLOSED"}getUIState(){return this.uiState}open(e){this.currentOptions=e;const t=(e.phoneNumber||"").replace(/[^\d+]/g,"");this.enteredNumber=t,this.rawNumber=t,this.isPresetNumber=!!t,this.isDtmfOpen=!1,this.hasInitializedPosition=!1,this.unsubscribeTelephony&&this.unsubscribeTelephony(),this.unsubscribeTelephony=x.subscribe(n=>{this.currentSession=n,this.handleTelephonyStateUpdate(n)});const a=x.isCallActive();this.uiState=a?"ACTIVE_FLOATING":"DIALER",this.render(),this.loadLeadContext(e.entityId),e.autoStart&&this.enteredNumber&&this.startCall()}minimize(){this.uiState!=="CLOSED"&&(this.uiState="MINIMIZED",this.updateVisibility())}restore(){this.uiState!=="CLOSED"&&(this.uiState="ACTIVE_FLOATING",this.updateVisibility(),this.updateSessionUI())}close(){if(this.currentSession&&(x.isCallActive()||["connecting","ringing","connected","held"].includes(this.currentSession.state))){this.minimize();return}this.teardown()}forceCloseAndHangup(){this.currentSession&&x.isCallActive()&&x.endCall(),this.teardown()}teardown(){this.unsubscribeTelephony&&(this.unsubscribeTelephony(),this.unsubscribeTelephony=null),this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.uiState="CLOSED",this.currentOptions=null,this.currentSession=null,this.hasInitializedPosition=!1,this.lastNotifiedLeadId=null}handleTelephonyStateUpdate(e){if(!this.modalEl||!document.body.contains(this.modalEl))if(e.state!=="idle")this.render();else return;if(x.isCallActive()){this.uiState==="DIALER"&&(this.uiState="ACTIVE_FLOATING");const a=Number(this.currentOptions?.entityId);a&&(this.currentOptions?.entityType==="lead"||!this.currentOptions?.entityType)&&this.lastNotifiedLeadId!==a&&(this.lastNotifiedLeadId=a,$.notifyCallActive(a))}else if(this.lastNotifiedLeadId=null,e.state==="ended"){this.uiState="ENDED_SUMMARY";const a=this.currentOptions,n=e.durationSeconds||0;$.clearCallActive(),a?.entityId&&window.dispatchEvent(new CustomEvent("myntos:lead-call-ended",{detail:{leadId:a.entityId,name:a.name,phoneNumber:a.phoneNumber,durationSeconds:n,categoryName:a.categoryName,status:a.status}})),setTimeout(()=>{this.uiState==="ENDED_SUMMARY"&&this.teardown()},1600)}else if(e.state==="idle"&&this.uiState!=="DIALER"){$.clearCallActive(),this.teardown();return}this.updateVisibility(),this.updateSessionUI()}maskPhone(e){if(!e)return"—";const t=e.replace(/\D/g,"");if(t.length<6)return e;const a=t.slice(-10);return v.isMR10001()?a.length===10?`+91 ${a.slice(0,5)} ${a.slice(5)}`:e:`+91 ${a.slice(0,2)}••••${a.slice(-4)}`}getDialInputDisplay(){return!v.isMR10001()&&this.isPresetNumber&&this.enteredNumber?this.maskPhone(this.enteredNumber):this.enteredNumber}formatDuration(e){const t=Math.floor(e/60).toString().padStart(2,"0"),a=(e%60).toString().padStart(2,"0");return`${t}:${a}`}initPositions(){if(this.hasInitializedPosition||typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=Math.max(12,Math.round((e-a)/2)),s=Math.max(20,Math.round((t-n)/2));this.floatingPos={x:i,y:s},this.pillPos={x:Math.max(12,e-260),y:Math.max(20,t-100)},this.hasInitializedPosition=!0}clampPositions(){if(typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=12,s=Math.max(12,e-a-12),l=12,r=Math.max(12,t-n-12);this.floatingPos.x=Math.min(Math.max(this.floatingPos.x,i),s),this.floatingPos.y=Math.min(Math.max(this.floatingPos.y,l),r);const d=240,o=54,u=12,p=Math.max(12,e-d-12),m=12,f=Math.max(12,t-o-12);this.pillPos.x=Math.min(Math.max(this.pillPos.x,u),p),this.pillPos.y=Math.min(Math.max(this.pillPos.y,m),f)}applyPositions(){const e=this.modalEl?.querySelector("#spModalDialog");e&&(this.uiState==="ACTIVE_FLOATING"||this.uiState==="DIALER")&&(e.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`);const t=this.modalEl?.querySelector("#spMinimizedPill");t&&this.uiState==="MINIMIZED"&&(t.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`)}render(){this.modalEl&&this.modalEl.remove(),this.initPositions(),this.clampPositions();const{name:e,entityType:t}=this.currentOptions||{},a=e||"Customer Lead",n=t?t.toUpperCase():"LEAD";this.modalEl=document.createElement("div"),this.modalEl.id="myntosCentralSoftphoneModal",this.modalEl.style.cssText=`
    ...
    `,document.body.appendChild(this.modalEl),this.attachEventListeners(),this.attachDragListeners(),this.updateVisibility(),this.updateSessionUI()}attachDragListeners(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spFloatingHeader"),t=this.modalEl.querySelector("#spModalDialog");if(e&&t){e.addEventListener("pointerdown",i=>{const s=i.target;if(!(s&&s.closest("button, input, a"))){this.isDraggingWindow=!0,this.dragStartPointer={x:i.clientX,y:i.clientY},this.dragStartPos={x:this.floatingPos.x,y:this.floatingPos.y};try{e.setPointerCapture(i.pointerId)}catch{}i.preventDefault(),i.stopPropagation()}}),e.addEventListener("pointermove",i=>{if(!this.isDraggingWindow)return;const s=i.clientX-this.dragStartPointer.x,l=i.clientY-this.dragStartPointer.y;this.floatingPos={x:this.dragStartPos.x+s,y:this.dragStartPos.y+l},this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`});const n=i=>{if(this.isDraggingWindow){this.isDraggingWindow=!1;try{e.releasePointerCapture(i.pointerId)}catch{}this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`}};e.addEventListener("pointerup",n),e.addEventListener("pointercancel",n)}const a=this.modalEl.querySelector("#spMinimizedPill");if(a){let n=!1;a.addEventListener("pointerdown",s=>{const l=s.target;if(!(l&&l.closest("#spPillRestoreBtn"))){this.isDraggingPill=!0,n=!1,this.dragStartPointer={x:s.clientX,y:s.clientY},this.dragStartPos={x:this.pillPos.x,y:this.pillPos.y};try{a.setPointerCapture(s.pointerId)}catch{}s.preventDefault(),s.stopPropagation()}}),a.addEventListener("pointermove",s=>{if(!this.isDraggingPill)return;const l=s.clientX-this.dragStartPointer.x,r=s.clientY-this.dragStartPointer.y;(Math.abs(l)>3||Math.abs(r)>3)&&(n=!0),this.pillPos={x:this.dragStartPos.x+l,y:this.dragStartPos.y+r},this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`});const i=s=>{if(this.isDraggingPill){this.isDraggingPill=!1;try{a.releasePointerCapture(s.pointerId)}catch{}this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`,n||this.restore()}};a.addEventListener("pointerup",i),a.addEventListener("pointercancel",i)}}attachEventListeners(){if(!this.modalEl)return;this.modalEl.querySelector("#spModalBackdrop")?.addEventListener("click",()=>{this.uiState==="DIALER"&&this.close()}),this.modalEl.querySelector("#spMinimizeBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.minimize()}),this.modalEl.querySelector("#spCloseBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.close()}),this.modalEl.querySelector("#spPillRestoreBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.restore()});const e=this.modalEl.querySelector("#spDialInput");e?.addEventListener("input",t=>{this.enteredNumber=t.target.value,this.rawNumber="",this.isPresetNumber=!1,this.updateCallerPhoneDisplay()}),this.modalEl.querySelector("#spBackspaceBtn")?.addEventListener("click",()=>{if(this.isPresetNumber){this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1),this.updateCallerPhoneDisplay();return}this.enteredNumber.length>0&&(this.enteredNumber=this.enteredNumber.slice(0,-1),e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),x.playKeyTone())}),this.modalEl.querySelectorAll(".sp-num-btn").forEach(t=>{t.addEventListener("click",a=>{const n=a.currentTarget.getAttribute("data-key");this.isPresetNumber&&(this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1)),n&&this.enteredNumber.length<15&&(this.enteredNumber+=n,e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),x.playKeyTone())})}),this.modalEl.querySelector("#spMainDialBtn")?.addEventListener("click",()=>{this.startCall()}),this.modalEl.querySelector("#spDirectSimBtn")?.addEventListener("click",()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}x.triggerDirectSimCall(this.enteredNumber)}),this.modalEl.querySelector("#spMyOperatorBtn")?.addEventListener("click",async()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}try{const t=this.currentOptions?.entityId?parseInt(String(this.currentOptions.entityId)):null;await x.triggerMyOperatorCall(this.enteredNumber,t),alert(`MyOperator call dispatched to ${this.enteredNumber}! Your office line will ring shortly.`)}catch(t){this.showError(`MyOperator error: ${t.message}`)}}),this.modalEl.querySelector("#spBtnMute")?.addEventListener("click",()=>{x.toggleMute()}),this.modalEl.querySelector("#spBtnSpeaker")?.addEventListener("click",()=>{x.toggleSpeaker()}),this.modalEl.querySelector("#spInCallVolumeSlider")?.addEventListener("input",t=>{const a=parseFloat(t.target.value)/100;x.setVolume(a)}),this.modalEl.querySelector("#spBtnHold")?.addEventListener("click",()=>{x.toggleHold()}),this.modalEl.querySelector("#spBtnKeypad")?.addEventListener("click",()=>{this.isDtmfOpen=!this.isDtmfOpen;const t=this.modalEl?.querySelector("#spDtmfGrid");t&&(t.style.display=this.isDtmfOpen?"grid":"none")}),this.modalEl.querySelectorAll(".sp-dtmf-btn").forEach(t=>{t.addEventListener("click",a=>{const n=a.currentTarget.getAttribute("data-dtmf");n&&x.sendDTMF(n)})}),this.modalEl.querySelector("#spBtnHangup")?.addEventListener("click",()=>{x.endCall()})}updateVisibility(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spModalBackdrop"),t=this.modalEl.querySelector("#spModalDialog"),a=this.modalEl.querySelector("#spMinimizedPill"),n=this.modalEl.querySelector("#spInCallView"),i=this.modalEl.querySelector("#spDialerView");this.uiState==="DIALER"?(e&&(e.style.display="block"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="block"),n&&(n.style.display="none")):this.uiState==="ACTIVE_FLOATING"?(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="flex")):this.uiState==="MINIMIZED"?(e&&(e.style.display="none"),t&&(t.style.display="none"),a&&(a.style.display="flex")):this.uiState==="ENDED_SUMMARY"&&(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="flex"))}updateCallerPhoneDisplay(){const e=this.modalEl?.querySelector("#spCallerPhoneDisplay");e&&(e.textContent=this.maskPhone(this.enteredNumber))}showError(e){const t=this.modalEl?.querySelector("#spErrorBanner");t&&(t.textContent=e,t.style.display="block")}hideError(){const e=this.modalEl?.querySelector("#spErrorBanner");e&&(e.style.display="none")}async startCall(){x.prepareAudioOnUserGesture(),this.hideError();const e=this.rawNumber||this.enteredNumber;if(!e){this.showError("Please enter a destination phone number.");return}const t=this.currentOptions?.name||"Contact Lead",a=this.currentOptions?.entityId||null;this.uiState="ACTIVE_FLOATING",this.updateVisibility();const n=await x.startCall(e,t,a);!n.success&&n.error&&(n.error==="A call is already in progress."?console.warn("[SoftphoneModal] Duplicate dial prevented; ignoring duplicate error toast"):this.showError(n.error))}updateSessionUI(){if(!this.modalEl||!this.currentSession)return;const e=this.currentSession.contactName||this.currentOptions?.name||"Contact Lead",t=this.currentSession.destinationPhone||this.enteredNumber,a=this.formatDuration(this.currentSession.durationSeconds),n=this.modalEl.querySelector("#spActiveCallerName");n&&(n.textContent=e);const i=this.modalEl.querySelector("#spActiveCallerPhone");i&&(i.textContent=this.maskPhone(t));const s=this.modalEl.querySelector("#spCallTimerDisplay");s&&(s.textContent=a);const l=this.modalEl.querySelector("#spPillCallerName");l&&(l.textContent=e);const r=this.modalEl.querySelector("#spPillTimerDisplay");r&&(r.textContent=a);const d=this.modalEl.querySelector("#spCallStateBadge");d&&(this.currentSession.state==="connected"?(d.textContent="🟢 Connected",d.style.background="#22c55e",d.style.color="#ffffff"):this.currentSession.state==="ringing"?(d.textContent="📞 Ringing...",d.style.background="#38bdf8",d.style.color="#000000"):this.currentSession.state==="connecting"?(d.textContent="⏳ Connecting...",d.style.background="#f59e0b",d.style.color="#000000"):this.currentSession.state==="ended"&&(d.textContent="🛑 Call Ended",d.style.background="#ef4444",d.style.color="#ffffff"));const o=this.modalEl.querySelector("#spBtnMute");o&&(o.style.background=this.currentSession.isMuted?"rgba(239,68,68,0.6)":"rgba(255,255,255,0.1)",o.style.borderColor=this.currentSession.isMuted?"#ef4444":"rgba(255,255,255,0.2)");const u=this.modalEl.querySelector("#spBtnSpeaker");u&&(u.style.background=this.currentSession.isSpeaker?"rgba(56,189,248,0.6)":"rgba(255,255,255,0.1)",u.style.borderColor=this.currentSession.isSpeaker?"#38bdf8":"rgba(255,255,255,0.2)");const p=this.modalEl.querySelector("#spBtnHold");p&&(p.style.background=this.currentSession.isHeld?"rgba(245,158,11,0.6)":"rgba(255,255,255,0.1)",p.style.borderColor=this.currentSession.isHeld?"#f59e0b":"rgba(255,255,255,0.2)")}async loadLeadContext(e){const t=this.modalEl?.querySelector("#spLeadContextBox");if(!t)return;if(this.currentOptions?.categoryName){const n=this.modalEl?.querySelector("#spMobileCatBadge");n&&(n.textContent=this.currentOptions.categoryName);const i=this.modalEl?.querySelector("#spHeaderCatBadge");i&&(i.textContent=`🏷️ ${this.currentOptions.categoryName}`,i.style.display="inline-block")}if(this.currentOptions?.status){const n=this.modalEl?.querySelector("#spMobileStatus");n&&(n.textContent=this.currentOptions.status.toUpperCase());const i=this.modalEl?.querySelector("#spHeaderStatusBadge");i&&(i.textContent=`📌 ${this.currentOptions.status}`,i.style.display="inline-block")}let a=e;if(!a&&this.currentOptions?.phoneNumber)try{const n=this.currentOptions.phoneNumber.replace(/\D/g,"").slice(-10);if(n.length>=10){const i=await I.get(`/telephony/calls/${n}/customer-history`),s=i?.data??i;s?.lead?.id&&(a=s.lead.id)}}catch(n){console.warn("[SoftphoneModal] Lead lookup by phone notice:",n)}if(!a){this.currentOptions?.categoryName||this.currentOptions?.status?t.style.display="block":t.style.display="none";return}try{const n=await I.get(`/crm/dialer/lead/${a}/detail`),i=n.data??n;if(!i||!i.lead)return;const s=i.lead;t.style.display="block";const l=this.modalEl?.querySelector("#spMobileCatBadge");l&&(l.textContent=s.category_name||"General");const r=this.modalEl?.querySelector("#spHeaderCatBadge");r&&(r.textContent=`🏷️ ${s.category_name||"General"}`,r.style.display="inline-block");const d=this.modalEl?.querySelector("#spMobileSource");d&&(d.textContent=s.source||"—");const o=this.modalEl?.querySelector("#spMobileCompany");o&&(o.textContent=s.company_name||"—");const u=this.modalEl?.querySelector("#spMobileStatus");u&&(u.textContent=(s.status||"—").toUpperCase(),u.style.color=s.status==="won"?"#22c55e":s.status==="lost"?"#ef4444":"#38bdf8");const p=this.modalEl?.querySelector("#spHeaderStatusBadge");p&&(p.textContent=`📌 ${s.status||"New"}`,p.style.display="inline-block");const m=this.modalEl?.querySelector("#spHeaderTempBadge");m&&(s.is_hot_lead?(m.textContent="🔥 HOT LEAD",m.style.background="rgba(239, 68, 68, 0.2)",m.style.color="#ef4444",m.style.border="1px solid rgba(239, 68, 68, 0.4)",m.style.display="inline-block"):s.is_fresh_lead?(m.textContent="🌱 FRESH LEAD",m.style.background="rgba(16, 185, 129, 0.2)",m.style.color="#10b981",m.style.border="1px solid rgba(16, 185, 129, 0.4)",m.style.display="inline-block"):m.style.display="none");const f=this.modalEl?.querySelector("#spMobileStatusUpdated");f&&(f.textContent=s.status_updated_at?new Date(s.status_updated_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"—");const w=this.modalEl?.querySelector("#spMobileBudget");w&&(w.textContent=s.budget_display||"—");const _=this.modalEl?.querySelector("#spMobileLastInteraction");_&&(_.textContent=s.last_interaction_date?new Date(s.last_interaction_date).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const B=this.modalEl?.querySelector("#spMobileInteractedBy");B&&(B.textContent=s.last_interacted_by||"—");const R=this.modalEl?.querySelector("#spMobileLastDialed");R&&(R.textContent=s.last_dialed_at?new Date(s.last_dialed_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const g=this.modalEl?.querySelector("#spMobileReqRow"),C=this.modalEl?.querySelector("#spMobileRequirements");g&&C&&(s.requirements?(C.textContent=s.requirements,g.style.display="block"):g.style.display="none");const k=this.modalEl?.querySelector("#spMobileNotesSection"),E=this.modalEl?.querySelector("#spMobileRecentNotes");if(k&&E){const S=(i.notes||[]).slice(0,2);S.length>0?(E.innerHTML=S.map(b=>`<div>• ${b.note}</div>`).join(""),k.style.display="block"):k.style.display="none"}}catch(n){console.warn("[SoftphoneModal] Could not fetch lead context:",n)}}}const fe=new j,H={"/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"staff-task-tracker","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/team-live-tracker":"staff-team-live-tracker","/staff/team-location-tracker":"staff-team-live-tracker","/staff/all-location-tracker":"staff-all-location-tracker","/staff/all-location-history":"staff-all-location-tracker","team-live-tracker":"staff-team-live-tracker","all-location-tracker":"staff-all-location-tracker","/staff/vgk/members":"staff-vgk-members","/staff_vgk_members.html":"staff-vgk-members","/staff/incentives/vgk4u":"staff-incentives-vgk4u","/staff/vgk4u/real-estate":"staff-vgk4u-real-estate","/staff/vgk4u/insurance":"staff-vgk4u-insurance","/staff/vgk4u/etc-students":"staff-vgk4u-real-estate","/staff/incentives/points":"staff-incentives-points","/staff/incentives/approvals":"staff-incentives-approvals","/staff/vgk/income":"staff-vgk-income","/staff/vgk/income-unified":"vgk-income-unified","/staff/vgk/coupons/available":"staff-vgk-coupons","/staff/vgk/promo-codes":"staff-vgk-promo-codes","/staff/vgk/bonanza-management":"vgk-bonanza-rewards","/staff/vgk/bonanza-claims":"vgk-bonanza-rewards","/staff/vgk/vendors":"staff-vgk-vendors","/staff/vgk/vendor-categories":"staff-vgk-vendors","/staff/vgk/vendor-products":"staff-vgk-vendors","/staff/vgk/vendor-transactions":"staff-vgk-vendors","/staff/vgk/cash-income/sales":"staff-vgk-income","/staff/vgk/cash-income/accounts":"staff-vgk-income","/staff/vgk/wallet":"vgk-points-balance","/staff/vgk/config":"staff-vgk-members","/staff/vgk/partner-kyc-review":"staff-kyc-approvals","/staff/vgk/my-registrations":"vgk-my-registrations","/staff/vgk/media":"vgk-member-hub","/staff/vgk4u/purchase-orders":"staff-service-procurement","/rvz/real-dreams/marketplace":"real-dreams-marketplace","/rvz/real-dreams":"real-dreams-marketplace","/rvz/real-dreams/partners":"real-dreams-marketplace","/rvz/real-dreams-partners":"real-dreams-marketplace","/rvz/real-dreams/properties":"real-dreams-marketplace","/rvz/real-dreams-properties":"real-dreams-marketplace","/rvz/real-dreams-dashboard":"real-dreams-marketplace","/staff/mnr/real-dreams/marketplace":"real-dreams-marketplace","/staff/mnr/real-dreams":"real-dreams-marketplace","/staff/mnr/real-dreams/partners":"real-dreams-marketplace","/staff/mnr/real-dreams/properties":"real-dreams-marketplace","/staff/mnr/real-dreams-dashboard":"real-dreams-marketplace","/real-dreams/marketplace":"real-dreams-marketplace","/real-dreams/compare":"real-dreams-marketplace","/real-dreams/property":"real-dreams-marketplace","/staff/zynova/direct":"vgk-direct-summary","/staff/zynova/matching":"vgk-matching-summary","/staff/zynova/guru":"vgk-guru-summary","/staff/zynova/ved":"vgk-ved-summary","/staff/zynova/wallet":"vgk-points-balance","/staff/zynova/withdrawals":"vgk-points-balance","/staff/zynova/points":"vgk-points-balance","/staff/kra-status":"kras","/staff/timesheet":"timesheet","/staff/progress":"progress","/vgk/birthdays":"vgk-birthdays","/vgk/top-earners":"vgk-top-earners","/vgk/awards":"vgk-awards","/vgk/my-registrations":"vgk-my-registrations","/vgk/bonanza-rewards":"vgk-bonanza-rewards","/vgk/points-balance":"vgk-points-balance","/vgk/member-hub":"vgk-member-hub","/vgk/settings":"vgk-settings","/vgk/bank-details":"vgk-bank-details","/vgk/profile-edit":"vgk-profile-edit","/vgk/kyc":"vgk-kyc","/vgk/feedback":"vgk-feedback","/vgk/announcements":"vgk-announcements","/vgk/my-announcements":"vgk-my-announcements","/vgk/coupon-activate":"vgk-coupon-activate","/vgk/coupon-progress":"vgk-coupon-progress","/vgk/coupon-transfer":"vgk-coupon-transfer","/vgk/income-unified":"vgk-income-unified","/vgk/daywise-income":"vgk-daywise-income","/vgk/income-types":"vgk-income-types","/vgk/direct-summary":"vgk-direct-summary","/vgk/matching-summary":"vgk-matching-summary","/vgk/guru-summary":"vgk-guru-summary","/vgk/ved-summary":"vgk-ved-summary","/vgk/ev-benefits":"vgk-ev-benefits","/vgk/ev-discount":"vgk-ev-discount","/vgk/franchise-earnings":"vgk-franchise-earnings","/vgk/insurance":"vgk-insurance","/vgk/training":"vgk-training","/vgk/coupon-benefits":"vgk-coupon-benefits","/vgk/my-submissions":"vgk-my-submissions","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/field-sales":"staff-bank-wise-leads","/field-sales":"staff-bank-wise-leads","field-sales":"staff-bank-wise-leads","bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"category-leads-master","/staff/real-dreams-leads":"category-leads-master","/staff/insurance-leads":"category-leads-master","/staff/ev-b2b-leads":"category-leads-master","/staff/ev-b2c-leads":"category-leads-master","/staff/ev-spares-leads":"category-leads-master","/staff/etc-leads":"category-leads-master","/staff/mnr-leads":"category-leads-master","/staff/mnr-leads-master":"category-leads-master","/staff/executive-dashboard":"executive-dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/configuration/catalog":"digital-catalog","/staff/catalog-library":"digital-catalog","/staff/catalog":"digital-catalog","/catalog-library":"digital-catalog","catalog-library":"digital-catalog","/staff/catalog-library.html":"digital-catalog","/catalog-library.html":"digital-catalog","/catalog":"digital-catalog",catalog:"digital-catalog","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"auto-dialer","/staff/softphone":"softphone","/staff/calling-page":"softphone","/staff/calling":"softphone","/staff/phone-dialpad":"softphone","/staff/softphone-hub":"softphone","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},W={"/staff/solar-leads":"solar","/staff/ev-b2b-leads":"ev-b2b","/staff/ev-b2c-leads":"ev-b2c","/staff/ev-spares-leads":"ev-spares","/staff/real-dreams-leads":"real-dreams","/staff/insurance-leads":"insurance","/staff/etc-leads":"etc","/staff/mnr-leads":"mnr"},Y=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],Z=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],Q=[{section_code:"EARNINGS",section_label:"EARNINGS & INCOME",order:1,items:[{menu_code:"VGK_INCOME_UNIFIED",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Income Dashboard',route:"vgk-income-unified"},{menu_code:"VGK_DAYWISE_INCOME",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Daywise Income',route:"vgk-daywise-income"},{menu_code:"VGK_DIRECT_SUMMARY",label:'<i class="fas fa-users" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>Direct (L1)',route:"vgk-direct-summary"},{menu_code:"VGK_MATCHING_SUMMARY",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>Matching (L2)',route:"vgk-matching-summary"},{menu_code:"VGK_GURU_SUMMARY",label:'<i class="fas fa-graduation-cap" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Guru Summary',route:"vgk-guru-summary"},{menu_code:"VGK_VED_SUMMARY",label:'<i class="fas fa-brain" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Ved Summary',route:"vgk-ved-summary"},{menu_code:"VGK_FRANCHISE_EARNINGS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center; color: #14b8a6;"></i>Franchise Earnings',route:"vgk-franchise-earnings"}]},{section_code:"PROGRAMS",section_label:"PROGRAMS & BENEFITS",order:2,items:[{menu_code:"VGK_EV_BENEFITS",label:'<i class="fas fa-charging-station" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>EV Benefits',route:"vgk-ev-benefits"},{menu_code:"VGK_EV_DISCOUNT",label:'<i class="fas fa-percent" style="margin-right: 8px; width: 18px; text-align: center; color: #06b6d4;"></i>EV Discount',route:"vgk-ev-discount"},{menu_code:"VGK_INSURANCE",label:'<i class="fas fa-shield-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Insurance Policy',route:"vgk-insurance"},{menu_code:"VGK_TRAINING",label:'<i class="fas fa-chalkboard-teacher" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>Training Program',route:"vgk-training"},{menu_code:"VGK_BONANZA_REWARDS",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bonanza Rewards',route:"vgk-bonanza-rewards"},{menu_code:"VGK_AWARDS",label:'<i class="fas fa-award" style="margin-right: 8px; width: 18px; text-align: center; color: #eab308;"></i>Awards & Milestones',route:"vgk-awards"}]},{section_code:"COUPONS_PINS",section_label:"COUPONS & PINS",order:3,items:[{menu_code:"VGK_COUPON_ACTIVATE",label:'<i class="fas fa-key" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>PIN Activation',route:"vgk-coupon-activate"},{menu_code:"VGK_COUPON_PROGRESS",label:'<i class="fas fa-tasks" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Coupon Progress',route:"vgk-coupon-progress"},{menu_code:"VGK_COUPON_TRANSFER",label:'<i class="fas fa-exchange-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Coupon Transfer',route:"vgk-coupon-transfer"},{menu_code:"VGK_COUPON_BENEFITS",label:'<i class="fas fa-gift" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Coupon Benefits',route:"vgk-coupon-benefits"}]},{section_code:"PROFILE_SECURITY",section_label:"MY ACCOUNT",order:4,items:[{menu_code:"VGK_PROFILE_EDIT",label:'<i class="fas fa-user-edit" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Edit Profile',route:"vgk-profile-edit"},{menu_code:"VGK_KYC",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>KYC Verification',route:"vgk-kyc"},{menu_code:"VGK_BANK_DETAILS",label:'<i class="fas fa-university" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bank Details',route:"vgk-bank-details"},{menu_code:"VGK_POINTS_BALANCE",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center; color: #eab308;"></i>Points Balance',route:"vgk-points-balance"},{menu_code:"VGK_FEEDBACK",label:'<i class="fas fa-comment-dots" style="margin-right: 8px; width: 18px; text-align: center; color: #06b6d4;"></i>Feedback',route:"vgk-feedback"},{menu_code:"VGK_SETTINGS",label:'<i class="fas fa-cog" style="margin-right: 8px; width: 18px; text-align: center; color: #64748b;"></i>Settings',route:"vgk-settings"}]},{section_code:"COMMUNITY",section_label:"COMMUNITY & TEAM",order:5,items:[{menu_code:"VGK_TOP_EARNERS",label:'<i class="fas fa-medal" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Top Earners',route:"vgk-top-earners"},{menu_code:"VGK_BIRTHDAYS",label:'<i class="fas fa-birthday-cake" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Birthdays',route:"vgk-birthdays"},{menu_code:"VGK_ANNOUNCEMENTS",label:'<i class="fas fa-bullhorn" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Announcements',route:"vgk-announcements"},{menu_code:"VGK_MY_REGISTRATIONS",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>My Registrations',route:"vgk-my-registrations"},{menu_code:"VGK_MY_SUBMISSIONS",label:'<i class="fas fa-file-invoice" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>My Submissions',route:"vgk-my-submissions"}]}];class X{container=null;overlay=null;isOpen=!1;expandedSections=new Set;allowedPaths="*";isSupremeStaff=!1;isStaffMenuLoaded=!1;constructor(){try{if(localStorage.getItem("mnr_staff_is_supreme_cache")==="true")this.isSupremeStaff=!0,this.allowedPaths="*",this.isStaffMenuLoaded=!0;else{const t=localStorage.getItem("mnr_staff_allowed_paths_cache");if(t){const a=JSON.parse(t);Array.isArray(a)&&(this.allowedPaths=new Set(a),this.isStaffMenuLoaded=!0)}}}catch{}this.createElements(),this.loadStaffMenus(),window.addEventListener("logout",()=>{this.allowedPaths="*",this.isSupremeStaff=!1,this.isStaffMenuLoaded=!1;try{localStorage.removeItem("mnr_staff_allowed_paths_cache"),localStorage.removeItem("mnr_staff_is_supreme_cache"),localStorage.removeItem("mnr_staff_menu_tree_cache")}catch{}this.updateUI()}),window.addEventListener("auth-changed",()=>{this.isStaffMenuLoaded=!1,this.loadStaffMenus()})}createElements(){if(this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),!document.getElementById("myntos-drawer-styles")){const e=document.createElement("style");e.id="myntos-drawer-styles",e.textContent=`
      ...
      `,document.head.appendChild(e)}this.attachEventListeners()}render(){const e=T.getPortal(),t=e==="vgk",n=v.getAuthState().user||{},i=(n.role_code||n.role?.role_code||n.user_type||"").toString().toLowerCase().trim(),s=(n.role_name||n.role?.role_name||"").toString().toUpperCase().trim(),l=(n.staff_type||"").toString().toUpperCase().trim();["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin","manager","director","admin"].includes(i)||i.includes("vgk")||i.includes("manager")||i.includes("lead")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER"].includes(s)||s.includes("VGK")||s.includes("MANAGER")||["VGK4U","VGK4U SUPREME"].includes(l)||(n.is_manager||n.is_admin||n.is_super_admin);let r=Y;if(t)r=Z;else if(e==="staff"){const o=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(i)||i.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(s)||s.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(l);n.staff_type==="FREELANCER"&&n.freelancer_access_mode==="only_leads"?r=[]:r=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...o?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i> Auto Dialer',route:"auto-dialer"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling & Softphone',route:"softphone"}]}["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(o=>i.includes(o))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(o=>s.includes(o))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(o=>l.includes(o))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(o=>(n.department||n.department_name||"").toString().toUpperCase().includes(o));const d=t?Q:this.getStaffMenuMaster();return`
      ...
      <div class="drawer-content">
        ...
        <div class="top-menu-items">
          ${r.map(o=>`
            <div class="menu-item top-item" data-route="${o.route}" ${o.tab?`data-tab="${o.tab}"`:""}>
              <span class="menu-label">${o.label}</span>
            </div>
          `).join("")}
        </div>
        <!-- Section menus -->
        ${d.map(o=>this.renderSection(o)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab,n=(e.querySelector(".menu-label")?.textContent||"").trim();let i=H[t]||H[t.replace(/\/$/,"")];!i&&!t.startsWith("/")&&(i=t),i?a?A.navigate(i,{tab:a}):A.navigate(i):A.navigate("embed-view",{url:t,title:n||"Staff Portal",tab:a||""}),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await v.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){const t=v.getAuthState().user||{},a=(t.staff_type||"").toString().toUpperCase().trim(),n=(t.emp_code||t.employee_code||"").toString().toUpperCase().trim(),i=(t.role_code||t.role?.role_code||t.user_type||"").toString().toLowerCase().trim(),s=(t.role_name||t.role?.role_name||"").toString().toUpperCase().trim(),l=["VGK4U_SUPREME","RVZ_SUPREME","VGK4U","VGK4U SUPREME","VGK4U_EA","KEY_LEADERSHIP","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER","DIRECTOR","SUPER_ADMIN","ADMIN"];if(l.includes(a)||["MR10018","MR10001","MR10016","MR10025"].includes(n)||["key_leadership","vgk4u","ea","vgk4u_supreme","executive_admin","manager","director","admin","super_admin"].includes(i)||l.includes(s)||(t.is_manager||t.is_admin||t.is_super_admin)){this.isSupremeStaff=!0,this.allowedPaths="*",this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_is_supreme_cache","true")}catch{}this.updateUI();return}try{const r=await I.get("/staff/menu-settings/my-menus?unified=true");if(r.success&&r.data){const d=r.data.menus||[],o=new Set(d.map(u=>u.route_path).filter(u=>!!u));o.add("/staff/whatsapp-center"),o.add("/staff/crm/whatsapp-inbox"),o.add("/staff/crm/whatsapp-bot"),o.add("/staff/softphone-center"),o.add("/staff/softphone-hub"),o.add("/staff/softphone"),o.add("/staff/dialer"),o.add("/staff/auto-dialer"),o.add("/staff/my-leads"),o.add("/staff/configuration/catalog"),o.add("/staff/catalog-library"),o.add("/staff/catalog"),this.allowedPaths=o,this.isSupremeStaff=!1,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_is_supreme_cache","false"),localStorage.setItem("mnr_staff_allowed_paths_cache",JSON.stringify(Array.from(o)))}catch{}this.updateUI()}}catch(r){console.error("Failed to load dynamic staff menus:",r),this.allowedPaths="*",this.updateUI()}}getItemIcon(e,t){const a=(e||"").toUpperCase(),n=(t||"").toLowerCase();return a.includes("WHATSAPP")||n.includes("whatsapp")?"fab fa-whatsapp":a.includes("AUTO_DIALER")||n.includes("auto dialer")?"fas fa-phone-volume":a.includes("SOFTPHONE")||n.includes("calling")||n.includes("softphone")?"fas fa-headset":a.includes("CATALOG")||n.includes("catalog")?"fas fa-book-open":a.includes("FIELD_SALES")||n.includes("field sales")||a.includes("BANK_WISE_LEADS")?"fas fa-users-gear":a.includes("SOLAR")||n.includes("solar")?"fas fa-solar-panel":a.includes("EV_")||n.includes("ev ")?"fas fa-car":a.includes("INSURANCE")||n.includes("care")||n.includes("insurance")?"fas fa-shield-alt":a.includes("REAL_DREAMS")||a.includes("REAL_ESTATE")||n.includes("real dreams")||n.includes("real estate")||n.includes("property")?"fas fa-building":a.includes("ETC")||n.includes("training")||n.includes("student")?"fas fa-graduation-cap":a.includes("BONANZA")||n.includes("bonanza")?"fas fa-trophy":a.includes("COUPON")||a.includes("PIN")||n.includes("coupon")||n.includes("pin")?"fas fa-ticket-alt":a.includes("PROMO")||n.includes("promo")?"fas fa-tags":a.includes("VENDOR")||n.includes("vendor")?"fas fa-store":a.includes("WALLET")||n.includes("wallet")?"fas fa-wallet":a.includes("INCOME")||n.includes("earnings")||n.includes("income")?"fas fa-hand-holding-usd":a.includes("POINTS")||n.includes("points")?"fas fa-coins":a.includes("APPROVAL")||n.includes("approval")?"fas fa-clipboard-check":a.includes("KYC")||n.includes("kyc")?"fas fa-id-card":a.includes("TRANSACTION")||n.includes("transaction")?"fas fa-receipt":a.includes("MEMBER")||a.includes("TEAM")||n.includes("member")||n.includes("team")?"fas fa-users":a.includes("ATTENDANCE")||n.includes("attendance")?"fas fa-clock":a.includes("LEAVE")||n.includes("leave")?"fas fa-calendar-times":a.includes("TASK")||n.includes("task")?"fas fa-tasks":a.includes("KRA")||n.includes("kra")?"fas fa-chart-line":a.includes("JOURNEY")||n.includes("journey")?"fas fa-route":a.includes("TICKET")||n.includes("ticket")||n.includes("service")?"fas fa-tools":"fas fa-circle"}getItemIconColor(e,t){const a=(e||"").toUpperCase(),n=(t||"").toLowerCase();return a.includes("WHATSAPP")||n.includes("whatsapp")?"color: #25d366;":a.includes("AUTO_DIALER")||n.includes("auto dialer")||a.includes("SOFTPHONE")||n.includes("softphone")?"color: #38bdf8;":a.includes("CATALOG")||n.includes("catalog")?"color: #10b981;":a.includes("FIELD_SALES")||n.includes("field sales")||a.includes("BANK_WISE_LEADS")?"color: #38bdf8;":a.includes("SOLAR")||n.includes("solar")?"color: #f59e0b;":a.includes("EV_")||n.includes("ev ")?"color: #10b981;":a.includes("INSURANCE")||n.includes("care")||n.includes("insurance")?"color: #059669;":a.includes("REAL_DREAMS")||a.includes("REAL_ESTATE")||n.includes("real dreams")||n.includes("property")?"color: #2563eb;":a.includes("ETC")||n.includes("training")?"color: #8b5cf6;":a.includes("BONANZA")||n.includes("bonanza")?"color: #f59e0b;":a.includes("COUPON")||a.includes("PIN")||n.includes("coupon")||n.includes("pin")?"color: #6366f1;":a.includes("PROMO")||n.includes("promo")?"color: #ec4899;":a.includes("VENDOR")||n.includes("vendor")?"color: #0284c7;":a.includes("WALLET")||n.includes("wallet")||a.includes("INCOME")||n.includes("earnings")||n.includes("income")?"color: #10b981;":a.includes("POINTS")||n.includes("points")?"color: #f59e0b;":a.includes("APPROVAL")||n.includes("approval")?"color: #10b981;":a.includes("KYC")||n.includes("kyc")?"color: #3b82f6;":a.includes("TRANSACTION")||n.includes("transaction")?"color: #0284c7;":a.includes("MEMBER")||a.includes("TEAM")||n.includes("member")||n.includes("team")?"color: #7c3aed;":""}getStaffMenuMaster(){const t=v.getAuthState().user||{},a=(t.emp_code||t.employee_code||"").toString().toUpperCase().trim(),n=(t.role_code||t.role?.role_code||t.user_type||"").toString().toLowerCase().trim(),i=(t.role_name||t.role?.role_name||"").toString().toUpperCase().trim(),s=(t.staff_type||"").toString().toUpperCase().trim(),l=["VGK4U_SUPREME","RVZ_SUPREME","VGK4U","VGK4U SUPREME","VGK4U_EA","KEY_LEADERSHIP","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER","DIRECTOR","SUPER_ADMIN","ADMIN"],r=["MR10018","MR10001","MR10025","MR10016"].includes(a)||["SAAS_SEGMENT_ADMIN","SUPER_ADMIN","VGK4U_SUPREME"].includes(s)||["super_admin","saas_segment_admin","tenant_admin","key_leadership","vgk4u"].includes(n),d=this.isSupremeStaff||l.includes(s)||["MR10018","MR10001","MR10016","MR10025"].includes(a)||["key_leadership","vgk4u","ea","vgk4u_supreme"].includes(n)||!!(t.is_manager||t.is_admin||t.is_super_admin),o=["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(g=>n.includes(g))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(g=>i.includes(g))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(g=>s.includes(g))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(g=>(t.department||t.department_name||"").toString().toUpperCase().includes(g)),u=d||o,p=["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(a),f=s&&["MYNT_REAL","MN_STAFF","VGK4U","INTERNAL","STAFF","ADMIN","HR","MANAGER","EXECUTIVE","FIELD_EXECUTIVE","SUPER_ADMIN","FREELANCER"].includes(s),w=t?.base_company_id&&[1,2,3,4,88].includes(Number(t.base_company_id)),_=!r&&!f&&!w&&(s==="TENANT_ADMIN"||s==="SAAS_CLIENT"||s==="SAAS_TENANT"||t?.company_segment==="SEGMENT_B_SAAS"),B=g=>{if(!d&&this.allowedPaths!=="*"){const b=g.route.replace(/\/$/,"");if(!(["/staff/dialer","/staff/auto-dialer","/staff/softphone","/staff/whatsapp-center","/staff/configuration/catalog","/staff/catalog-library","/staff/catalog","/staff/bank-wise-leads","/staff/field-sales","/staff/my-leads"].includes(g.route)||g.route.startsWith("/staff/vgk/"))&&!this.allowedPaths.has(g.route)&&!this.allowedPaths.has(b))return null}if(g.route==="/staff/configuration/razorpay"||g.route==="/staff/configuration/a1top"){const b=t.emp_code||t.employee_code||t.employee_id||"",h=(t.department||t.department_name||"").toLowerCase();if(!(b==="MR10001"||h==="accounts"))return null}if(p&&(g.route==="/staff/leads"||g.menu_code==="STAFF_LEADS"||g.menu_code==="LEADS_MASTER"))return null;const C=g.route,k=g.label;let E=W[g.route];if(!E){const b=(g.menu_code||"").toUpperCase();b.includes("SOLAR_LEADS")?E="solar":b.includes("EV_B2B")?E="ev-b2b":b.includes("EV_B2C")?E="ev-b2c":b.includes("EV_SPARES")?E="ev-spares":b.includes("REAL_DREAMS")||b.includes("ZYN_REAL_ESTATE")?E="real-dreams":b.includes("INSURANCE")||b.includes("ZYN_INSURANCE")?E="insurance":b.includes("ETC_LEADS")?E="etc":b.includes("MNR_LEADS")&&(E="mnr")}let S="";if(!k.startsWith("<i class=")){const b=g.icon||this.getItemIcon(g.menu_code,k),h=this.getItemIconColor(g.menu_code,k);S=`<i class="${b}" style="margin-right: 8px; width: 18px; text-align: center; ${h}"></i>`}return{menu_code:g.menu_code,label:`${S}${k}`,route:C,tab:E}},R=[];for(const g of F){if(g.section_code==="PROGRESS")continue;const C=(g.section_code||"").toUpperCase(),k=(g.section_label||"").toUpperCase(),E=C==="VGK_SAAS"||C==="MYNTOS_SAAS"||k.includes("MYNTOS SAAS")||k.includes("SAAS");if(_&&["MNR","MYNT","VGK","META","CONFIG","NOT IN USE","NOT_IN_USE","PARTNER","INTERNAL"].some(y=>C.includes(y)||k.includes(y))&&!E||!u&&(C.includes("ACCOUNT")||k.includes("ACCOUNT")||C.includes("FINANCE")))continue;if(r){if(a!=="MR10001"&&a!=="MR10025"&&["META","INTERNAL"].some(y=>C.includes(y)||k.includes(y)))continue}else if(["META","CONFIG","SAAS","INTERNAL"].some(y=>C.includes(y)||k.includes(y))){if(this.allowedPaths!=="*"&&this.allowedPaths instanceof Set){const y=this.allowedPaths;if(![...(g.items||[]).map(L=>L.route),...(g.subSections||[]).flatMap(L=>L.items.map(G=>G.route))].some(L=>y.has(L)||y.has(L.replace(/\/$/,""))))continue}else if(!d)continue}if(a==="MR10018"&&["NOT IN USE","NOT_IN_USE","MNR","NDA","ZYNOVA","ZINOVA"].some(y=>(C.includes(y)||k.includes(y))&&!E)||C==="NOT_IN_USE"||k==="NOT IN USE")continue;const S=[],b=[];if(g.items)for(const h of g.items){const y=B(h);y&&S.push(y)}if(C==="CRM_LEADS"&&(S.some(h=>h.route==="auto-dialer"||h.route==="/staff/dialer")||S.push({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"/staff/dialer"}),S.some(h=>h.route==="softphone"||h.route==="/staff/softphone")||S.push({menu_code:"SOFTPHONE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Calling & Softphone',route:"/staff/softphone"}),S.some(h=>h.route==="digital-catalog"||h.route==="/staff/catalog-library"||h.route==="/staff/configuration/catalog")||S.push({menu_code:"DIGITAL_CATALOG",label:'<i class="fas fa-book-open" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Digital Catalog',route:"/staff/catalog-library"})),g.subSections)for(const h of g.subSections){const y=[];for(const U of h.items){const N=B(U);N&&y.push(N)}y.length>0&&b.push({sub_section_code:h.sub_section_code,sub_section_label:h.sub_section_label,items:y})}(S.length>0||b.length>0)&&R.push({section_code:g.section_code,section_label:g.section_label,order:g.order,items:S.length>0?S:void 0,subSections:b.length>0?b:void 0})}return R}open(){if(this.isOpen)return;T.getPortal()==="staff"&&!this.isStaffMenuLoaded&&this.loadStaffMenus(),this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden"}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let D=null;function J(){return D||(D=new X),D}class V{static render(e){let{title:t,showBack:a=!1,showLogout:n=!1,rightAction:i,subtitle:s,showMenu:l}=e;const r=T.getPortal(),d=A.getCurrentRoute(),o=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(d);if(l===void 0&&(l=o||!a),r==="vgk"&&(n=!0,!s)){const p=v.getAuthState().user||{},m=p.name||p.partner_name||"",f=p.partner_code||"";(m||f)&&(s=f?`${m} (${f})`:m)}return`
    ...
    `}static getPortalDashboard(){const e=T.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t,showBack:a=!1,rightAction:n,showLogout:i=!1}=e;t===void 0&&(t=!!document.getElementById("hamburgerBtn")),T.getPortal()==="vgk"&&(i=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{J().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{A.goBack()||A.navigate(V.getPortalDashboard())}),n&&document.getElementById("headerActionBtn")?.addEventListener("click",n.onClick),i&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await v.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{A.goBack()||A.navigate(V.getPortalDashboard())})}}class he{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
...
முழு விலை மற்றும் வருவாய் விவரங்களை அறிய மேலே உள்ள இணைப்பை கிளிக் செய்யவும்.`}}};class ee{modalEl=null;currentOptions=null;activeMode="scanned";selectedCatalogKey="solar";selectedCatalogLang="te";allCanonicalTemplates=[];canonicalTemplates=[];selectedCanonicalBody="";getSenderSignature(){const t=v.getAuthState().user||{},a=t.full_name||t.name||`${t.first_name||""} ${t.last_name||""}`.trim()||"Staff";let n=t.extension||t.ext||(typeof window<"u"?window.__STAFF_EXTENSION__:null);if(!n&&t.emp_code){const i=String(t.emp_code).match(/(\d{2,4})$/);i&&(n=i[1].replace(/^0+/,"")||i[1])}return n&&String(n).trim()&&!["none","null","undefined","n/a"].includes(String(n).trim().toLowerCase())?`
...
మీకు అనుకూలమైన సమయంలో దయచేసి ఇక్కడ మెసేజ్ చేయండి లేదా కాల్ బ్యాక్ చేయగలరు!`}}applyVerticalQuick(e){const t=this.getVerticalQuickMessage(e),a=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=t+a,n.focus())}onDigitalCatalogSelect(e){e&&P[e]&&(this.selectedCatalogKey=e);const t=P[this.selectedCatalogKey]||P.solar,a=document.getElementById("uwaDigitalCatDesc");a&&(a.textContent=t.desc);const n=document.getElementById("uwaDigitalCatBtnLabel");n&&(n.textContent=`Insert Personalized ${t.btnLabel||t.name} Catalog Link`)}getDigitalCatalogMessage(e,t){const a=P[e]||P.solar,n=(this.currentOptions?.name||"Customer").trim();let i="https://www.myntreal.com";if(typeof window<"u"&&window.location&&window.location.origin){const o=window.location.origin;o.includes("localhost")||o.includes("127.0.0.1")||o.includes("0.0.0.0")||o.includes("192.168.")||o.includes("10.0.")||o.includes(":8000")||o.includes(":5000")||o.includes(":5173")||o.includes(":3000")||o.includes("capacitor")||(i=o)}let s=`${i}/catalog/${a.segmentSlug}/${a.catalogSlug}?lang=${encodeURIComponent(t||"te")}`;e==="hub_pricing"&&!s.includes("exp=")&&(s+=`&exp=${Math.floor(Date.now()/1e3)+86400}`);const l=(t||"te").toLowerCase(),r=a.messages&&a.messages[l]?a.messages[l]:a.messages&&a.messages.en;let d="";if(typeof r=="function"?d=r(n,s):d=`Namaskaram ${n}! Here is your catalog link:
👉 ${s}`,a.brochureUrl&&!d.includes(".pdf")){const o=a.brochureUrl.startsWith("http")?a.brochureUrl:i+(a.brochureUrl.startsWith("/")?"":"/")+a.brochureUrl;d+=`
...
👉 ${o}`}return d}applyDigitalCatalog(e){e&&(this.selectedCatalogLang=e,this.modalEl?.querySelectorAll(".uwa-cat-lang-btn")?.forEach(l=>{const r=l.getAttribute("data-lang")===e;l.style.background=r?"#16a34a":"#fff",l.style.color=r?"#fff":"#334155",l.style.borderColor=r?"#16a34a":"#cbd5e1",l.style.fontWeight=r?"700":"600"}));const t=document.getElementById("uwaDigitalCatSel");t&&t.value&&(this.selectedCatalogKey=t.value);const a=this.getDigitalCatalogMessage(this.selectedCatalogKey,this.selectedCatalogLang),n=this.getSenderSignature(),i=document.getElementById("uwaMessageText");i&&(i.value=a+n,i.focus())}detectCatalogKey(){if(this.currentOptions?.catalogKey&&P[this.currentOptions.catalogKey])return this.currentOptions.catalogKey;const e=(this.currentOptions?.context||"").toLowerCase(),t=(this.currentOptions?.segment||"").toLowerCase();return e.includes("solar")||t==="solar"?"solar":e.includes("real")||e.includes("property")||e.includes("estate")||t==="myntreal_real"?"real_estate":e.includes("spare")||t==="ev_spares"?"ev_spares":e.includes("cargo")||e.includes("fleet")||e.includes("b2b")||t==="ev_b2b"?"ev_b2b":e.includes("ev")||e.includes("zynova")||e.includes("vehicle")||t==="ev_b2c"?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")||t==="etc_training"?"etc_training":e.includes("insur")||e.includes("policy")||e.includes("care")?"insurance":e.includes("pricing")||e.includes("margin")||e.includes("commercial")||t==="hub_pricing"?"hub_pricing":e.includes("hub")||e.includes("franchise")?"industrial_hub":"solar"}async loadCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;t.innerHTML='<option value="">— Loading templates… —</option>',a&&(a.style.display="none");const n=this.activeMode==="scanned"?"scanned":"company";let i=`/whatsapp-config/templates?mode=${encodeURIComponent(n)}`;try{const s=await I.get(i),l=s?.templates||s?.data||s||[];this.allCanonicalTemplates=Array.isArray(l)?l:[],this.filterCanonicalTemplates(e)}catch{t.innerHTML='<option value="">— Error loading templates —</option>'}}filterCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;const n=document.getElementById("uwaCanonicalSeg"),i=document.getElementById("uwaCanonicalCat"),s=document.getElementById("uwaCanonicalSearch"),l=(n?.value||"").toLowerCase().trim(),r=(i?.value||"").toUpperCase().trim(),d=(s?.value||"").toLowerCase().trim();let o=this.allCanonicalTemplates||[];if(l&&(o=o.filter(p=>(p.segment||"").toLowerCase()===l)),r&&(o=o.filter(p=>(p.category||"").toUpperCase()===r)),d&&(o=o.filter(p=>{const m=(p.template_name||p.name||"").toLowerCase(),f=(p.body_text||p.content||p.body||"").toLowerCase(),w=(p.slug||"").toLowerCase();return m.includes(d)||f.includes(d)||w.includes(d)})),this.canonicalTemplates=o,!o.length){t.innerHTML=`
      ...
      `,a&&(a.style.display="block"),this.onCanonicalTplChange();return}a&&(a.style.display="none");let u=`<option value="">— Select template (${o.length} available) —</option>`;u+='<option value="__create_new__" style="color:#16a34a; font-weight:700;">➕ Create / Add Template for this Segment...</option>',o.forEach(p=>{const m=p.segment?`[${p.segment}] `:"";u+=`<option value="${p.id}">${m}${this.escapeHtml(p.template_name||p.name||"Template #"+p.id)} (${p.category||"MARKETING"})</option>`}),t.innerHTML=u,e&&(t.value=String(e),this.onCanonicalTplChange())}toggleAddTemplateCard(e){const t=document.getElementById("uwaAddTplCard");if(!t)return;const a=t.style.display!=="none",n=e!==void 0?e:!a;if(t.style.display=n?"block":"none",n){const i=document.getElementById("uwaCanonicalSeg")?.value||this.detectSegment(),s=document.getElementById("uwaNewTplSeg");s&&i&&(s.value=i),document.getElementById("uwaNewTplName")?.focus()}}async saveNewTemplate(){const e=document.getElementById("uwaNewTplName"),t=document.getElementById("uwaNewTplSeg"),a=document.getElementById("uwaNewTplBody"),n=document.getElementById("uwaSaveNewTplBtn"),i=(e?.value||"").trim(),s=t?.value||"general",l=(a?.value||"").trim();if(!i){this.showFeedback("Please enter a template name.","error");return}if(!l){this.showFeedback("Please enter the template message body.","error");return}n&&(n.disabled=!0);const r=i.toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,40);try{const d=await I.post("/whatsapp-config/templates",{name:i,slug:r,category:"MARKETING",segment:s,body_text:l,language:"en",usage_scope:"all"});if(d?.success){this.showFeedback(`✅ Template "${i}" created & approved for WhatsApp API!`,"success"),this.toggleAddTemplateCard(!1),e&&(e.value=""),a&&(a.value="");const o=document.getElementById("uwaCanonicalSeg");o&&(o.value=s);const u=d.template?.id||d.id||r;await this.loadCanonicalTemplates(u)}else this.showFeedback(d?.error||"Failed to create template","error")}catch(d){this.showFeedback(`Error creating template: ${d.message||"Server error"}`,"error")}finally{n&&(n.disabled=!1)}}detectSegment(){if(this.currentOptions?.segment)return this.currentOptions.segment;const e=(this.currentOptions?.context||"").toLowerCase();return e.includes("solar")?"solar":e.includes("real")||e.includes("property")||e.includes("estate")?"myntreal_real":e.includes("spare")?"EV_SPARES":e.includes("ev")||e.includes("vehicle")||e.includes("zynova")?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")?"etc_training":e.includes("partner")?"partner":e.includes("staff")?"staff":e.includes("vgk")?"vgk":"general"}onCanonicalTplChange(){const e=document.getElementById("uwaCanonicalTpl"),t=document.getElementById("uwaCanonicalVarsWrap"),a=document.getElementById("uwaCanonicalVarsBox"),n=e?.value;if(n==="__create_new__"){this.toggleAddTemplateCard(!0),e.value="";return}if(!n){t&&(t.style.display="none"),a&&(a.innerHTML="");return}this.activeMode!=="scanned"&&(this.activeMode="scanned",this.updateModeUI());const i=this.canonicalTemplates.find(r=>String(r.id)===String(n)||String(r.slug)===String(n));if(!i)return;this.selectedCanonicalBody=i.body_text||i.content||i.body||"";const s=this.selectedCanonicalBody.match(/\{\{(\d+)\}\}/g)||[],l=[];if(s.forEach(r=>{const d=r.replace(/[\{\}]/g,"");l.includes(d)||l.push(d)}),l.sort((r,d)=>Number(r)-Number(d)),l.length&&a&&t){t.style.display="block";let r="";l.forEach(d=>{const o=d==="1"&&this.currentOptions?.name||"";r+=`
          <div style="display:flex; align-items:center; gap:8px; margin-bottom:6px;">
            <label style="font-size:11px; font-weight:700; width:28px; color:#475569;">#${d}</label>
            <input type="text" class="uwa-canonical-var-inp" data-var-idx="${d}" value="${this.escapeHtml(o)}" placeholder="Value for {{${d}}}" style="flex:1; font-size:12px; border:1px solid #cbd5e1; border-radius:6px; padding:4px 8px;" />
          </div>
        `}),a.innerHTML=r,a.querySelectorAll(".uwa-canonical-var-inp").forEach(d=>{d.addEventListener("input",()=>this.buildCanonicalPreview())})}else t&&(t.style.display="none"),a&&(a.innerHTML="");this.buildCanonicalPreview()}buildCanonicalPreview(){let e=this.selectedCanonicalBody||"";(e.match(/\{\{(\d+)\}\}/g)||[]).forEach(i=>{const s=i.replace(/[\{\}]/g,""),r=document.querySelector(`.uwa-canonical-var-inp[data-var-idx="${s}"]`)?.value||`{{${s}}}`;e=e.replace(new RegExp(`\\{\\{${s}\\}\\}`,"g"),r)});const a=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&e&&(n.value=e+a)}open(e){this.currentOptions=e,this.activeMode="scanned",this.render()}close(){this.modalEl&&(this.modalEl.remove(),this.modalEl=null)}render(){if(this.close(),!this.currentOptions)return;const{phone:e,name:t,context:a,defaultMessage:n,catalogKey:i}=this.currentOptions,s=(e||"").replace(/\D/g,"").slice(-10),l=this.getSenderSignature(),r=(n||(i?this.getDigitalCatalogMessage(i,this.selectedCatalogLang):this.getVerticalQuickMessage("thanks_connecting")))+l;this.modalEl=document.createElement("div"),this.modalEl.id="unifiedWAModal",this.modalEl.className="uwa-modal-backdrop",this.modalEl.innerHTML=`
      <div class="uwa-modal-sheet">
        ...
        <textarea id="uwaMessageText" class="uwa-textarea" rows="7" placeholder="Type your WhatsApp message...">${this.escapeHtml(r)}</textarea>
...
`);e.textContent=m}async executeShare(e){const t=document.getElementById("usmStaffSelect"),a=parseInt(t?.value||"0",10);if(!a){alert("Please select a staff member to share details with."),t?.focus();return}const n=this.staffList.find(p=>p.id===a);if(!n){alert("Selected staff member is invalid.");return}const i=document.getElementById("usmFollowupType")?.value||"secondary_followup",s=document.getElementById("usmNotes")?.value.trim()||"",l=document.getElementById("usmAssignCheck")?.checked||!1,r=this.currentOptions;if(!r)return;const d=document.getElementById("usmCombinedBtn"),o=document.getElementById("usmCrmOnlyBtn"),u=document.getElementById("usmWaOnlyBtn");[d,o,u].forEach(p=>{p&&(p.disabled=!0)});try{let p="",m="";if(e==="crm_only"||e==="combined"||l){const w={target_staff_id:a,followup_type:i,notes:s,assign_as_secondary:l},_=await I.post(`/crm/leads/${r.leadId}/share-details`,w);if(_&&_.success)p=_.wa_url||"",m=_.wa_message||"",r.onShared&&r.onShared(_);else throw new Error(_?.detail||_?.message||"Failed to assign lead in CRM")}if(e==="wa_only"||e==="combined"){if(!p){const w=(n.phone||"").replace(/\D/g,"").slice(-10);if(!w)alert(`Colleague ${n.name} does not have a valid mobile number for WhatsApp.`);else{const _=document.getElementById("usmMessagePreview")?.textContent||"";p=`https://wa.me/91${w}?text=${encodeURIComponent(_)}`}}p&&window.open(p,"_blank")}const f=e==="crm_only"?`Lead successfully assigned to ${n.name} in CRM!`:e==="wa_only"?`WhatsApp launched for ${n.name}!`:`Lead assigned in CRM and WhatsApp opened for ${n.name}!`;alert(`✅ ${f}`),this.close()}catch(p){console.error("[UnifiedShareLeadModal] Share failed:",p),alert(`⚠️ Could not complete lead share: ${p.message||p}`)}finally{[d,o,u].forEach(p=>{p&&(p.disabled=!1)})}}}const ye=new te,ae=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],ne=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],ie=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class se{container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
      ...
      <div class="mnr-drawer-content">
        ...
        <!-- Section menus -->
        ${ne.map(n=>this.renderSection(n)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("mnrDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;A.navigate(t),this.close()})}),document.getElementById("mnrLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await v.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const ve=new se;class xe{config;constructor(e){this.config=e}render(){if(this.config.loading)return`
      ...
      `;const e=n=>this.config.sortColumn===n?this.config.sortDirection==="asc"?" ↑":" ↓":"",t=this.config.columns.map(n=>{const i=n.sortable!==!1,s=e(n.key),l=n.width?`width: ${n.width};`:"",r=i?`data-sort-column="${n.key}"`:"";return`<th style="${l}${i?"cursor: pointer;":""}" ${r}>${n.label}${s}</th>`}).join(""),a=this.config.data.map(n=>`<tr>${this.config.columns.map(s=>{const l=n[s.key];return`<td>${s.render?s.render(l,n):l??"-"}</td>`}).join("")}</tr>`).join("");return`
    ...
    `,this.attachListeners()}attachListeners(){this.container.querySelectorAll(".tab-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-route");t&&A.navigate(t)})})}getIcon(e){const t={home:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      </svg>`};return t[e]||t.home}}class de{isShowing=!1;unsubscribe=null;checkInterval=null;init(){this.unsubscribe&&this.unsubscribe(),this.checkInterval&&clearInterval(this.checkInterval),this.unsubscribe=I.onSessionExpired(e=>{console.log("[SessionBanner] Session expired detected, endpoint:",e),v.getAuthState().isLoggedIn||this.show()}),this.checkInterval=setInterval(()=>{if(v.getAuthState().isLoggedIn){this.isShowing&&this.hide();return}const t=q.getTrackingStatus();t.isSessionExpired&&!this.isShowing?this.show():!t.isSessionExpired&&this.isShowing&&this.hide()},5e3)}cleanup(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null),this.hide()}show(){if(!v.getAuthState().isLoggedIn||this.isShowing||document.getElementById("globalSessionBanner"))return;this.isShowing=!0;const e=document.createElement("div");e.id="globalSessionBanner",e.className="global-session-banner",e.innerHTML=`
