...
import{l as y,d as h,r as b,b as x}from"./services-CMR4lQb8.js";import{L as m}from"./vendor-B1GRRwIS.js";import{_ as E}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as A}from"./services-gps-Bqyw-iqJ.js";const M={"/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"staff-task-tracker","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"staff-leads","/staff/real-dreams-leads":"zynova-real-estate","/staff/insurance-leads":"zynova-insurance","/staff/ev-b2b-leads":"staff-leads","/staff/ev-b2c-leads":"staff-leads","/staff/ev-spares-leads":"staff-leads","/staff/etc-leads":"staff-training-videos","/staff/mnr-leads":"staff-leads","/staff/mnr-leads-master":"staff-leads","/staff/executive-dashboard":"dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"auto-dialer","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},L=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],I=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],S=[{section_code:"ATTENDANCE",section_label:"ATTENDANCE",order:1,items:[{menu_code:"IN_OUT_TIME",label:"In/Out Time",route:"attendance"},{menu_code:"MY_LEAVES",label:"My Leaves",route:"leaves"},{menu_code:"LEAVE_APPROVALS",label:"Leave Approvals",route:"staff-leave-approvals"},{menu_code:"IN_OUT_RECORDS_ADMIN",label:"In/Out Records - Admin",route:"team-attendance"},{menu_code:"ATTENDANCE_RECORDS",label:"Attendance Records",route:"staff-attendance-sheet"},{menu_code:"ATTENDANCE_DASHBOARD",label:"Attendance Dashboard",route:"staff-attendance-reports"},{menu_code:"EXCEPTION_APPROVALS",label:"Exception Approvals",route:"staff-attendance-exceptions"},{menu_code:"ATTENDANCE_COMPUTATION",label:"Attendance Computation",route:"staff-attendance-computation"}]},{section_code:"TASK_MANAGEMENT",section_label:"TASK MANAGEMENT",order:3,items:[{menu_code:"ASSIGNED_BY_ME",label:"Assigned By Me",route:"tasks-assigned"},{menu_code:"ASSIGNED_TO_ME",label:"Assigned To Me",route:"tasks-received"},{menu_code:"TEAM_ACTIVITIES",label:"Team Activities",route:"staff-team-activities"},{menu_code:"TASK_TRACKER",label:"Task Dashboard",route:"staff-task-tracker"},{menu_code:"TASK_REVIEWS",label:"Task Reviews",route:"staff-task-reviews"}]},{section_code:"KRA_MANAGEMENT",section_label:"KRA MANAGEMENT",order:4,items:[{menu_code:"MY_KRAS",label:"My KRAs",route:"kras"},{menu_code:"KRA_TEMPLATES",label:"KRA Templates",route:"staff-kra-templates"},{menu_code:"KRA_TRACKING_SHEET",label:"KRA Tracking Sheet",route:"staff-kra-tracking"},{menu_code:"KRA_REVIEW",label:"KRA Review",route:"staff-kra-review"}]},{section_code:"TIMESHEET",section_label:"TIMESHEET",order:5,items:[{menu_code:"MY_TIMESHEET",label:"My Timesheet",route:"timesheet"},{menu_code:"TIMESHEET_APPROVAL",label:"Timesheet Approval",route:"staff-timesheet-approval"}]},{section_code:"JOURNEY_TRACKING",section_label:"JOURNEY TRACKING",order:6,items:[{menu_code:"MY_JOURNEYS",label:"My Journeys",route:"journeys"},{menu_code:"TEAM_JOURNEYS",label:"Team Journeys",route:"team-journeys"},{menu_code:"ALL_JOURNEYS",label:"All Journeys",route:"staff-all-journeys"},{menu_code:"VGK4U_JOURNEYS",label:"VGK4U Journeys",route:"staff-vgk4u-journeys"}]},{section_code:"REIMBURSEMENT",section_label:"REIMBURSEMENT",order:7,items:[{menu_code:"MY_REIMBURSEMENT_CLAIMS",label:"My Reimbursement Claims",route:"reimbursements"},{menu_code:"REIMBURSEMENT_APPROVALS",label:"Reimbursement Approvals",route:"staff-reimbursement-approvals"}]},{section_code:"ACCOUNTS_EARNINGS",section_label:"FINANCE & EARNINGS",order:8,items:[{menu_code:"MY_EARNINGS",label:"My Earnings",route:"staff-my-incentives"},{menu_code:"PAYROLL_PROFILE",label:"Payroll Profile",route:"staff-payroll-profile"},{menu_code:"SALARY_SLIPS",label:"Salary Slips",route:"staff-salary-slips"}]},{section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:9,items:[{menu_code:"MY_LEADS",label:"My Leads",route:"staff-my-leads"},{menu_code:"LEADS_MASTER",label:"Leads Master",route:"staff-leads"},{menu_code:"BANK_WISE_LEADS",label:"Field staff leads",route:"staff-bank-wise-leads"},{menu_code:"TEAM_LEADS",label:"Team Leads",route:"staff-team-leads"},{menu_code:"AUTO_DIALER",label:"Auto Dialer",route:"auto-dialer"}]},{section_code:"WORKFLOWS",section_label:"WORK FLOWS",order:10,items:[{menu_code:"MNR_BANK_WISE_LEADS",label:"Field Sales",route:"staff-bank-wise-leads"},{menu_code:"SOLAR_LEADS",label:"Solar Leads",route:"staff-leads"},{menu_code:"ZYN_REAL_ESTATE",label:"Real Dreams Leads",route:"zynova-real-estate"},{menu_code:"EV_B2B_LEADS",label:"EV B2B Leads",route:"staff-leads"},{menu_code:"EV_B2C_LEADS",label:"EV B2C Leads",route:"staff-leads"},{menu_code:"EV_SPARES_LEADS",label:"EV Spares Leads",route:"staff-leads"},{menu_code:"ZYN_INSURANCE",label:"Insurance Leads",route:"zynova-insurance"},{menu_code:"ETC_LEADS",label:"ETC Leads",route:"staff-training-videos"},{menu_code:"MNR_LEADS",label:"MNR Leads",route:"staff-leads"},{menu_code:"EXECUTIVE_DASHBOARD",label:"Executive Dashboard",route:"dashboard"},{menu_code:"CATEGORY_LEADS_MASTER",label:"Category Leads Master",route:"staff-leads"}]},{section_code:"OPERATIONS",section_label:"OPERATIONS",order:11,items:[{menu_code:"CALL_TRACKING",label:"Call Tracking",route:"staff-call-tracking"},{menu_code:"VENDORS",label:"Vendors",route:"staff-vendors"},{menu_code:"ZYN",label:"Zynova Real Estate",route:"zynova-real-estate"},{menu_code:"ZYNOVA",label:"VGK4U",route:"staff-zynova"},{menu_code:"ZYN_INSURANCE",label:"Zynova Insurance",route:"zynova-insurance"}]}],R=[];class C{container=null;overlay=null;isOpen=!1;expandedSections=new Set;staffMenuTree=null;isStaffMenuLoaded=!1;constructor(){this.createElements(),window.addEventListener("logout",()=>{this.staffMenuTree=null,this.isStaffMenuLoaded=!1})}createElements(){this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}render(){const e=y.getPortal(),t=e==="vgk";let a=L;if(t)a=I;else if(e==="staff"){const i=h.getAuthState().user||{},d=(i.role_code||i.role?.role_code||"").toString().toLowerCase().trim(),r=(i.role_name||i.role?.role_name||"").toString().toUpperCase().trim(),o=(i.staff_type||"").toString().toUpperCase().trim(),l=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(d)||d.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(r)||r.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(o);i.staff_type==="FREELANCER"&&i.freelancer_access_mode==="only_leads"?a=[]:a=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...l?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-phone-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling Page',route:"auto-dialer"}]}const s=t?R:e==="staff"?this.getStaffMenuMaster():S;return`
      ...
      <div class="drawer-content">
        ...
        <div class="top-menu-items">
          ${a.map(n=>`
            <div class="menu-item top-item" data-route="${n.route}" ${n.tab?`data-tab="${n.tab}"`:""}>
              <span class="menu-label">${n.label}</span>
            </div>
          `).join("")}
        </div>
        <!-- Section menus -->
        ${s.map(n=>this.renderSection(n)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab;a?b.navigate(t,{tab:a}):b.navigate(t),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await h.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){if(!this.isStaffMenuLoaded)try{const e=await x.get("/staff/menu-settings/my-menus?unified=true");e.success&&e.data&&e.data.sidebar_tree&&(this.staffMenuTree=e.data.sidebar_tree,this.isStaffMenuLoaded=!0,this.updateUI())}catch(e){console.error("Failed to load dynamic staff menus:",e)}}getStaffMenuMaster(){if(!this.staffMenuTree)return S;const e={MNR_BANK_WISE_LEADS:1,BANK_WISE_LEADS:1,staff_bank_wise_leads:1,SOLAR_LEADS:2,staff_solar_leads:2,mnr_solar_leads:2,ZYN_REAL_ESTATE:3,staff_real_dreams_leads:3,mnr_real_dreams_leads:3,EV_B2B_LEADS:4,staff_ev_b2b_leads:4,mnr_ev_b2b_leads:4,EV_B2C_LEADS:5,staff_ev_b2c_leads:5,mnr_ev_b2c_leads:5,EV_SPARES_LEADS:6,staff_ev_spares_leads:6,mnr_ev_spares_leads:6,ZYN_INSURANCE:7,staff_insurance_leads:7,mnr_insurance_leads:7,ETC_LEADS:8,staff_etc_leads:8,mnr_etc_leads:8,MNR_LEADS:9,staff_mnr_leads:9,mnr_category_leads:9,EXECUTIVE_DASHBOARD:10,staff_executive_dashboard:10,mnr_executive_dashboard:10,CATEGORY_LEADS_MASTER:11,mnr_leads_master:11,staff_mnr_leads_master:11},t=new Map,a=[],s=(i,d,r,o)=>{if(i==="CRM_WA_INBOX"||i==="WHATSAPP_CENTER"||r==="/staff/whatsapp-center"||r==="/staff/whatsapp")return null;const l=M[r];if(!l)return null;let c=d||"";const u=(i||"").toUpperCase(),p=(r||"").toLowerCase();u.includes("BANK_WISE_LEADS")||p.includes("bank-wise-leads")?c="Field Sales":(u.includes("REAL_DREAMS")||p.includes("real-dreams-leads"))&&(c="Real Dreams Leads");const g=`<i class="${o||(c==="Field Sales"?"fas fa-users-gear":"fas fa-file-alt")}" style="margin-right: 8px; width: 18px; text-align: center;"></i>`;return{menu_code:i,label:`${g}${c}`,route:l}};for(const i of this.staffMenuTree){if(i.id==="progress"||i.section_id==="progress"||(i.title||"").toUpperCase()==="PROGRESS")continue;const d=[],r=[];if(i.items)for(const o of i.items){const l=s(o.menu_code,o.menu_name||o.label||o.name,o.route_path,o.menu_icon);l&&d.push(l)}if(i.subSections)for(const o of i.subSections){const l=[];if(o.items)for(const c of o.items){const u=s(c.menu_code,c.menu_name||c.label||c.name,c.route_path,c.menu_icon);u&&l.push(u)}l.length>0&&r.push({sub_section_code:o.id||o.section_id||"sub",sub_section_label:o.title||"Subsection",items:l})}if(d.length>0||r.length>0){let o=(i.id||i.section_id||"other").toString().trim(),l=(i.title||i.name||"Other").toString().trim();const c=o.toLowerCase(),u=l.toUpperCase();if((c==="mynt_real"||c==="myntreal"||c==="workflows"||u==="MYNT REAL"||u==="MYNTREAL"||u==="WORK FLOWS"||u==="WORKFLOWS")&&(o="WORKFLOWS",l="WORK FLOWS"),t.has(o)){const p=t.get(o);if(d.length>0){p.items=p.items||[];const f=new Set(p.items.map(g=>g.menu_code));for(const g of d)f.has(g.menu_code)||(p.items.push(g),f.add(g.menu_code))}r.length>0&&(p.subSections=p.subSections||[],p.subSections.push(...r))}else a.push(o),t.set(o,{section_code:o,section_label:l,order:i.order!==void 0?i.order:999,items:d.length>0?d:void 0,subSections:r.length>0?r:void 0})}}const n=a.map(i=>t.get(i));n.sort((i,d)=>i.order-d.order);for(const i of n)i.section_code==="WORKFLOWS"&&i.items&&i.items.sort((d,r)=>(e[d.menu_code]||99)-(e[r.menu_code]||99));return n}open(){if(this.isOpen)return;this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden",y.getPortal()==="staff"&&this.loadStaffMenus()}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let k=null;function T(){return k||(k=new C),k}class _{static render(e){let{title:t,showBack:a=!1,showLogout:s=!1,rightAction:n,subtitle:i,showMenu:d}=e;const r=y.getPortal(),o=b.getCurrentRoute(),l=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(o);if(d===void 0&&(d=l||!a),r==="vgk"&&(s=!0,!i)){const u=h.getAuthState().user||{},p=u.name||u.partner_name||"",f=u.partner_code||"";(p||f)&&(i=f?`${p} (${f})`:p)}return`
      <header class="page-header" style="display: flex; align-items: center; justify-content: space-between; padding: 12px 16px; background: #0f172a; border-bottom: 1px solid #1e293b; position: sticky; top: 0; z-index: 100;">
        <div class="header-left" style="display: flex; align-items: center; gap: 10px;">
          ...
          <div class="header-title-wrapper" style="display:flex; flex-direction:column; gap:2px">
            ...
            ${i?`<span class="header-subtitle" style="font-size:11px; color:rgba(255,255,255,0.65); font-weight:500">${i}</span>`:""}
          </div>
        </div>
    ...
    `}static getPortalDashboard(){const e=y.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t=!1,showBack:a=!1,rightAction:s,showLogout:n=!1}=e;y.getPortal()==="vgk"&&(n=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{T().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{b.goBack()||b.navigate(_.getPortalDashboard())}),s&&document.getElementById("headerActionBtn")?.addEventListener("click",s.onClick),n&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await h.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{b.goBack()||b.navigate(_.getPortalDashboard())})}}class F{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
...
${n} | MyntReal Workflows`}open(e){this.currentOptions=e,this.activeMode="scanned",this.render()}close(){this.modalEl&&(this.modalEl.remove(),this.modalEl=null)}render(){if(this.close(),!this.currentOptions)return;const{phone:e,name:t,context:a,defaultMessage:s}=this.currentOptions,n=(e||"").replace(/\D/g,"").slice(-10),i=this.getSenderSignature(),d=(s||w.greeting.text)+i;this.modalEl=document.createElement("div"),this.modalEl.id="unifiedWAModal",this.modalEl.className="uwa-modal-backdrop",this.modalEl.innerHTML=`
      <div class="uwa-modal-sheet">
        ...
        <div class="uwa-chips-row">
          ${Object.entries(w).map(([r,o])=>`
            <button class="uwa-chip-btn" data-tpl-key="${r}">
              ${o.label}
            </button>
          `).join("")}
        </div>
        ...
        <textarea id="uwaMessageText" class="uwa-textarea" rows="7" placeholder="Type your WhatsApp message...">${this.escapeHtml(d)}</textarea>
    ...
    `,document.body.appendChild(this.modalEl),this.attachEvents()}attachEvents(){this.modalEl&&(document.getElementById("uwaCloseBtn")?.addEventListener("click",()=>this.close()),document.getElementById("uwaCancelBtn")?.addEventListener("click",()=>this.close()),document.getElementById("uwaModeScannedBtn")?.addEventListener("click",()=>{this.activeMode="scanned",this.updateModeUI()}),document.getElementById("uwaModeMetaBtn")?.addEventListener("click",()=>{this.activeMode="meta_api",this.updateModeUI()}),this.modalEl.querySelectorAll(".uwa-chip-btn").forEach(e=>{e.addEventListener("click",t=>{const a=t.currentTarget.dataset.tplKey;if(a&&w[a]){const s=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=w[a].text+s,n.focus())}})}),document.getElementById("uwaSendBtn")?.addEventListener("click",()=>this.handleSend()))}updateModeUI(){const e=document.getElementById("uwaModeScannedBtn"),t=document.getElementById("uwaModeMetaBtn"),a=document.getElementById("uwaSendBtnLabel"),s=document.getElementById("uwaSendBtn");this.activeMode==="scanned"?(e?.classList.add("active"),t?.classList.remove("active"),a&&(a.textContent="Send via Scan WhatsApp"),s&&(s.style.background="#16a34a")):(e?.classList.remove("active"),t?.classList.add("active"),a&&(a.textContent="Send via WhatsApp API"),s&&(s.style.background="#2563eb"))}async handleSend(){if(!this.currentOptions)return;const e=document.getElementById("uwaMessageText"),t=document.getElementById("uwaSendBtn"),a=document.getElementById("uwaSendBtnLabel");let s=(e?.value||"").trim();if(!s){this.showFeedback("Please enter a message to send.","error");return}const n=this.getSenderSignature();s.indexOf("Regards,")===-1&&s.indexOf("MyntReal")===-1&&(s=s+n);const{phone:i,name:d,leadId:r}=this.currentOptions,o=(i||"").replace(/\D/g,"").slice(-10);if(!o||o.length<10){this.showFeedback("Invalid recipient phone number.","error");return}if(t&&(t.disabled=!0),this.activeMode==="meta_api"){a&&(a.innerHTML='<i class="fas fa-spinner fa-spin me-1"></i> Sending via Meta API...'),this.showFeedback("Dispatching via WhatsApp Cloud API...","info");try{const l=r&&r!=="new"?r:"direct",c=await x.post(`/whatsapp-config/crm-lead-send/${l}`,{phone:o,custom_message:s,send_mode:"company"});if(c.success)a&&(a.innerHTML='<i class="fas fa-check me-1"></i> Sent Successfully ✓'),this.showFeedback("✅ Dispatched via WhatsApp Meta Cloud API (Signed & Tracked)","success"),setTimeout(()=>this.close(),2500);else{const u=c.error||c.data?.reason||"Meta API not available. Switching to Scan WhatsApp...";this.showFeedback(`⚠️ ${u}`,"error"),setTimeout(()=>{this.activeMode="scanned",this.updateModeUI(),this.handleSend()},1500)}}catch(l){console.warn("[UnifiedWAModal] Meta API failed, fallback to scan:",l),this.showFeedback(`⚠️ Meta API failed: ${l.message||"Error"}. Falling back to Scan WhatsApp...`,"error"),setTimeout(()=>{this.activeMode="scanned",this.updateModeUI(),this.handleSend()},1500)}return}a&&(a.innerHTML='<i class="fas fa-spinner fa-spin me-1"></i> Sending via Common Bot...'),this.showFeedback("Connecting to Common Scan WhatsApp Bot on Port 5002...","info");try{const l=await x.post("/whatsapp/send-message",{recipient:o,message:s,recipient_type:"individual",recipient_name:d||"Customer",lead_id:r||null});if(l.success)a&&(a.innerHTML='<i class="fas fa-check me-1"></i> Sent Successfully ✓'),this.showFeedback(`✅ Dispatched via Scan WhatsApp (Common Number)! Sender: ${this.escapeHtml(h.getAuthState().user?.full_name||"Staff")}`,"success"),setTimeout(()=>this.close(),2500);else{const c=l.error||"Failed to dispatch via WhatsApp Gateway. Please verify the common QR bot is scanned.";this.showFeedback(`❌ ${c}`,"error"),t&&(t.disabled=!1),a&&(a.textContent="Retry Send")}}catch(l){console.error("[UnifiedWAModal] Send error:",l),this.showFeedback(`❌ Network error: ${l.message||"Server unreachable"}`,"error"),t&&(t.disabled=!1),a&&(a.textContent="Retry Send")}}showFeedback(e,t){const a=document.getElementById("uwaFeedbackBox");a&&(a.style.display="block",a.className=`uwa-feedback-box ${t}`,a.innerHTML=e)}escapeHtml(e){const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return(e||"").replace(/[&<>"']/g,a=>t[a])}}const Y=new B,P=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],N=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],O=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class ${container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
      ...
      <div class="mnr-drawer-content">
        ...
        <!-- Section menus -->
        ${N.map(s=>this.renderSection(s)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("mnrDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;b.navigate(t),this.close()})}),document.getElementById("mnrLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await h.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const q=new $;class Z{config;constructor(e){this.config=e}render(){if(this.config.loading)return`
      ...
      `;const e=s=>this.config.sortColumn===s?this.config.sortDirection==="asc"?" ↑":" ↓":"",t=this.config.columns.map(s=>{const n=s.sortable!==!1,i=e(s.key),d=s.width?`width: ${s.width};`:"",r=n?`data-sort-column="${s.key}"`:"";return`<th style="${d}${n?"cursor: pointer;":""}" ${r}>${s.label}${i}</th>`}).join(""),a=this.config.data.map(s=>`<tr>${this.config.columns.map(i=>{const d=s[i.key];return`<td>${i.render?i.render(d,s):d??"-"}</td>`}).join("")}</tr>`).join("");return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("partnerDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;b.navigate(t),this.close()})}),document.getElementById("partnerLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await h.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const J=new U;class X{container;constructor(e){this.container=e}render(){const t=h.getAuthState().user?.portal||"staff",a=b.getTabRoutes(t),s=b.getCurrentRoute();this.container.innerHTML=`
    ...
    `,this.attachListeners()}attachListeners(){this.container.querySelectorAll(".tab-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-route");t&&b.navigate(t)})})}getIcon(e){const t={home:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      </svg>`};return t[e]||t.home}}class H{isShowing=!1;unsubscribe=null;checkInterval=null;init(){this.unsubscribe&&this.unsubscribe(),this.checkInterval&&clearInterval(this.checkInterval),this.unsubscribe=x.onSessionExpired(e=>{console.log("[SessionBanner] Session expired detected, endpoint:",e),h.getAuthState().isLoggedIn&&this.show()}),this.checkInterval=setInterval(()=>{if(!h.getAuthState().isLoggedIn){this.isShowing&&this.hide();return}const t=A.getTrackingStatus();t.isSessionExpired&&!this.isShowing?this.show():!t.isSessionExpired&&this.isShowing&&this.hide()},2e3)}cleanup(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null),this.hide()}show(){if(!h.getAuthState().isLoggedIn||this.isShowing||document.getElementById("globalSessionBanner"))return;this.isShowing=!0;const e=document.createElement("div");e.id="globalSessionBanner",e.className="global-session-banner",e.innerHTML=`
    ...
    `,document.body.appendChild(a),setTimeout(()=>{document.getElementById("globalReAuthPassword")?.focus()},100),document.getElementById("closeGlobalReAuthModal")?.addEventListener("click",()=>a.remove()),document.getElementById("cancelGlobalReAuth")?.addEventListener("click",()=>a.remove()),document.getElementById("submitGlobalReAuth")?.addEventListener("click",()=>this.submitReAuth()),document.getElementById("globalReAuthPassword")?.addEventListener("keypress",s=>{s.key==="Enter"&&this.submitReAuth()})}async submitReAuth(){const e=document.getElementById("globalReAuthUserId"),t=document.getElementById("globalReAuthPassword"),a=document.getElementById("globalReAuthError"),s=document.getElementById("submitGlobalReAuth");if(!t)return;const n=e?.value||"",i=t.value;if(!i){a&&(a.textContent="Please enter your password",a.style.display="block");return}s&&(s.disabled=!0,s.textContent="Logging in...");try{const r=h.getAuthState().user?.portal||"staff",o=await h.loginWithPassword(n,i,r);if(o.success){document.getElementById("globalReAuthModal")?.remove(),this.hide();const{offlineQueueService:l}=await E(async()=>{const{offlineQueueService:f}=await import("./services-CMR4lQb8.js").then(g=>g.k);return{offlineQueueService:f}},__vite__mapDeps([0,1,2,3]),import.meta.url);l.getStatus().pendingCount>0&&console.log("[SessionBanner] Re-auth successful, queued data will sync automatically"),console.log("[SessionBanner] Refreshing current page after successful re-auth");const{routerService:u}=await E(async()=>{const{routerService:f}=await import("./services-CMR4lQb8.js").then(g=>g.n);return{routerService:f}},__vite__mapDeps([0,1,2,3]),import.meta.url),p=u.getCurrentRoute();u.navigate(p,!1)}else a&&(a.textContent=o.error||"Login failed. Please try again.",a.style.display="block")}catch(d){a&&(a.textContent=d.message||"An error occurred",a.style.display="block")}finally{s&&(s.disabled=!1,s.textContent="Login")}}}const Q=new H;class z{container;fab=null;modal=null;messages=[];conversationHistory=[];isOpen=!1;isLoading=!1;constructor(){this.container=document.createElement("div"),this.container.id="vgk-mobile-root",document.body.appendChild(this.container),this.render()}getEndpoint(){const e=y.getPortal();return"/api/v1/ai/command/process"}render(){if(!this.getEndpoint())return;this.container.innerHTML=`
      <style>
        #vgk-mobile-fab {
    ...
    `,this.fab=this.container.querySelector("#vgk-mobile-fab"),this.modal=this.container.querySelector("#vgk-mobile-modal"),this.attachFabDrag(),this.container.querySelector("#vgk-close-btn")?.addEventListener("click",()=>this.close());const t=this.container.querySelector("#vgk-text-input");this.container.querySelector("#vgk-send-btn")?.addEventListener("click",()=>{t.value.trim()&&(this.send(t.value.trim()),t.value="")}),t?.addEventListener("keypress",a=>{a.key==="Enter"&&t.value.trim()&&(this.send(t.value.trim()),t.value="")}),this.container.querySelector("#vgk-mic-btn")?.addEventListener("click",()=>this.startVoice(t)),this.pushMessage("assistant","Hi! I'm VGK Assistant. How can I help you today?")}attachFabDrag(){if(!this.fab)return;let e=!1,t=0,a=0,s=0,n=0,i=!1;const d=l=>{const c=l.touches[0];t=c.clientX,a=c.clientY;const u=this.fab.getBoundingClientRect();s=u.left,n=u.top,e=!0,i=!1},r=l=>{if(!e)return;const c=l.touches[0],u=c.clientX-t,p=c.clientY-a;if(Math.abs(u)>5||Math.abs(p)>5){i=!0;const f=Math.max(10,Math.min(window.innerWidth-60,s+u)),g=Math.max(60,Math.min(window.innerHeight-100,n+p));this.fab.style.left=`${f}px`,this.fab.style.top=`${g}px`,this.fab.style.right="auto",this.fab.style.bottom="auto"}},o=()=>{e=!1,i||this.open()};this.fab.addEventListener("touchstart",d,{passive:!0}),this.fab.addEventListener("touchmove",r,{passive:!0}),this.fab.addEventListener("touchend",o),this.fab.addEventListener("click",l=>{i?(l.preventDefault(),l.stopPropagation()):this.open()})}open(){this.modal?.classList.add("open"),this.isOpen=!0,this.scrollToBottom()}close(){this.modal?.classList.remove("open"),this.isOpen=!1}pushMessage(e,t){this.messages.push({role:e,text:t}),this.renderMessages()}renderMessages(){const e=this.container.querySelector("#vgk-messages");e&&(e.innerHTML=this.messages.map(t=>`<div class="vgk-bubble ${t.role}">${t.text.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}</div>`).join(""),this.isLoading&&(e.innerHTML+='<div class="vgk-typing"><div class="vgk-dot"></div><div class="vgk-dot"></div><div class="vgk-dot"></div></div>'),this.scrollToBottom())}scrollToBottom(){const e=this.container.querySelector("#vgk-messages");e&&(e.scrollTop=e.scrollHeight)}async send(e){if(this.isLoading)return;this.pushMessage("user",e),this.isLoading=!0,this.renderMessages();const t=this.getEndpoint();if(!t){this.pushMessage("assistant","Not available for this portal."),this.isLoading=!1;return}try{const a=await x.getToken(),n=await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:JSON.stringify({user_message:e,conversation_history:this.conversationHistory.slice(-20),language:"en",company_id:null,allowed_intents:null})})).json();if(n.reply_text){if(this.conversationHistory.push({role:"user",text:e}),this.conversationHistory.push({role:"assistant",text:n.reply_text}),this.conversationHistory.length>20&&(this.conversationHistory=this.conversationHistory.slice(-20)),this.pushMessage("assistant",n.reply_text),n.speak_text&&"speechSynthesis"in window){const i=new SpeechSynthesisUtterance(n.speak_text);i.lang="en-IN",i.rate=1,window.speechSynthesis.speak(i)}}else this.pushMessage("assistant",n.detail||"Something went wrong.")}catch{this.pushMessage("assistant","Could not reach VGK server. Please try again.")}this.isLoading=!1,this.renderMessages()}startVoice(e){const t=window.SpeechRecognition||window.webkitSpeechRecognition;if(!t){alert("Voice input not supported on this device.");return}const a=this.container.querySelector("#vgk-mic-btn"),s=new t;s.lang="en-IN",s.continuous=!1,s.interimResults=!1,s.onstart=()=>a.classList.add("recording"),s.onresult=n=>{const i=n.results[0][0].transcript;e.value=i},s.onend=()=>a.classList.remove("recording"),s.onerror=()=>a.classList.remove("recording"),s.start()}}function ee(){const v=y.getPortal();(v==="staff"||v==="partner")&&new z}export{X as B,F as L,Z as M,_ as P,T as g,ee as i,q as m,J as p,Q as s,Y as u};
