const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./services-BmWKyE03.js","./vendor-capacitor-plugins-DTPsYLMi.js","./vendor-capacitor-core-zwN_Y1fq.js","./vendor-B1GRRwIS.js"])))=>i.map(i=>d[i]);
import{v,j as T,d as y,b as S,r as A,t as k,a as $}from"./services-BmWKyE03.js";import{L as w}from"./vendor-B1GRRwIS.js";import{_ as D}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as U}from"./services-gps-Bx_MKh_P.js";class G{modalEl=null;uiState="CLOSED";currentOptions=null;enteredNumber="";rawNumber="";isPresetNumber=!1;isDtmfOpen=!1;unsubscribeTelephony=null;currentSession=null;floatingPos={x:0,y:0};pillPos={x:0,y:0};isDraggingWindow=!1;isDraggingPill=!1;dragStartPointer={x:0,y:0};dragStartPos={x:0,y:0};hasInitializedPosition=!1;lastNotifiedLeadId=null;constructor(){typeof window<"u"&&(window.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen()&&(this.uiState==="ACTIVE_FLOATING"?this.minimize():this.uiState==="DIALER"&&this.close())}),window.addEventListener("resize",()=>{this.isOpen()&&(this.clampPositions(),this.applyPositions())}))}isOpen(){return this.modalEl!==null&&document.body.contains(this.modalEl)&&this.uiState!=="CLOSED"}getUIState(){return this.uiState}open(e){this.currentOptions=e;const t=(e.phoneNumber||"").replace(/[^\d+]/g,"");this.enteredNumber=t,this.rawNumber=t,this.isPresetNumber=!!t,this.isDtmfOpen=!1,this.hasInitializedPosition=!1,this.unsubscribeTelephony&&this.unsubscribeTelephony(),this.unsubscribeTelephony=v.subscribe(i=>{this.currentSession=i,this.handleTelephonyStateUpdate(i)});const a=v.isCallActive();this.uiState=a?"ACTIVE_FLOATING":"DIALER",this.render(),this.loadLeadContext(e.entityId),e.autoStart&&this.enteredNumber&&this.startCall()}minimize(){this.uiState!=="CLOSED"&&(this.uiState="MINIMIZED",this.updateVisibility())}restore(){this.uiState!=="CLOSED"&&(this.uiState="ACTIVE_FLOATING",this.updateVisibility(),this.updateSessionUI())}close(){if(this.currentSession&&(v.isCallActive()||["connecting","ringing","connected","held"].includes(this.currentSession.state))){this.minimize();return}this.teardown()}forceCloseAndHangup(){this.currentSession&&v.isCallActive()&&v.endCall(),this.teardown()}teardown(){this.unsubscribeTelephony&&(this.unsubscribeTelephony(),this.unsubscribeTelephony=null),this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.uiState="CLOSED",this.currentOptions=null,this.currentSession=null,this.hasInitializedPosition=!1,this.lastNotifiedLeadId=null}handleTelephonyStateUpdate(e){if(!this.modalEl||!document.body.contains(this.modalEl))if(e.state!=="idle")this.render();else return;if(v.isCallActive()){this.uiState==="DIALER"&&(this.uiState="ACTIVE_FLOATING");const a=Number(this.currentOptions?.entityId);a&&(this.currentOptions?.entityType==="lead"||!this.currentOptions?.entityType)&&this.lastNotifiedLeadId!==a&&(this.lastNotifiedLeadId=a,T.notifyCallActive(a))}else if(this.lastNotifiedLeadId=null,e.state==="ended"){this.uiState="ENDED_SUMMARY";const a=this.currentOptions,i=e.durationSeconds||0;T.clearCallActive(),a?.entityId&&window.dispatchEvent(new CustomEvent("myntos:lead-call-ended",{detail:{leadId:a.entityId,name:a.name,phoneNumber:a.phoneNumber,durationSeconds:i,categoryName:a.categoryName,status:a.status}})),setTimeout(()=>{this.uiState==="ENDED_SUMMARY"&&this.teardown()},1600)}else if(e.state==="idle"&&this.uiState!=="DIALER"){T.clearCallActive(),this.teardown();return}this.updateVisibility(),this.updateSessionUI()}maskPhone(e){if(!e)return"—";const t=e.replace(/\D/g,"");if(t.length<6)return e;const a=t.slice(-10);return y.isMR10001()?a.length===10?`+91 ${a.slice(0,5)} ${a.slice(5)}`:e:`+91 ${a.slice(0,2)}••••${a.slice(-4)}`}getDialInputDisplay(){return!y.isMR10001()&&this.isPresetNumber&&this.enteredNumber?this.maskPhone(this.enteredNumber):this.enteredNumber}formatDuration(e){const t=Math.floor(e/60).toString().padStart(2,"0"),a=(e%60).toString().padStart(2,"0");return`${t}:${a}`}initPositions(){if(this.hasInitializedPosition||typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),i=440,n=Math.max(12,Math.round((e-a)/2)),s=Math.max(20,Math.round((t-i)/2));this.floatingPos={x:n,y:s},this.pillPos={x:Math.max(12,e-260),y:Math.max(20,t-100)},this.hasInitializedPosition=!0}clampPositions(){if(typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),i=440,n=12,s=Math.max(12,e-a-12),c=12,l=Math.max(12,t-i-12);this.floatingPos.x=Math.min(Math.max(this.floatingPos.x,n),s),this.floatingPos.y=Math.min(Math.max(this.floatingPos.y,c),l);const o=240,d=54,m=12,r=Math.max(12,e-o-12),h=12,p=Math.max(12,t-d-12);this.pillPos.x=Math.min(Math.max(this.pillPos.x,m),r),this.pillPos.y=Math.min(Math.max(this.pillPos.y,h),p)}applyPositions(){const e=this.modalEl?.querySelector("#spModalDialog");e&&(this.uiState==="ACTIVE_FLOATING"||this.uiState==="DIALER")&&(e.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`);const t=this.modalEl?.querySelector("#spMinimizedPill");t&&this.uiState==="MINIMIZED"&&(t.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`)}render(){this.modalEl&&this.modalEl.remove(),this.initPositions(),this.clampPositions();const{name:e,entityType:t}=this.currentOptions||{},a=e||"Customer Lead",i=t?t.toUpperCase():"LEAD";this.modalEl=document.createElement("div"),this.modalEl.id="myntosCentralSoftphoneModal",this.modalEl.style.cssText=`
          ...
          <div id="spInCallView" style="display: ${this.uiState==="ACTIVE_FLOATING"||this.uiState==="ENDED_SUMMARY"?"flex":"none"} !important; position: absolute !important; inset: 0 !important; background: linear-gradient(180deg, #0f172a 0%, #1e293b 100%) !important; color: #ffffff !important; padding: 18px 16px !important; z-index: 20 !important; flex-direction: column !important; justify-content: space-between !important; align-items: center !important;">
            ...
            <div style="display: flex !important; flex-direction: column !important; align-items: center !important; gap: 12px !important; width: 100% !important;">
              ...
              <div id="spInCallVolumeWrap" style="display: flex !important; align-items: center !important; justify-content: center !important; gap: 8px !important; width: 100% !important; max-width: 220px !important; padding: 4px 10px !important; background: rgba(255,255,255,0.06) !important; border-radius: 12px !important; border: 1px solid rgba(255,255,255,0.1) !important; box-sizing: border-box !important;">
                ...
                <input id="spInCallVolumeSlider" type="range" min="0" max="100" value="${Math.round(v.getVolume()*100)}" style="width: 100% !important; height: 4px !important; accent-color: #38bdf8 !important; cursor: pointer !important;" title="Adjust call volume" />
                <span style="color: #94a3b8 !important; font-size: 11px !important;">🔊</span>
              </div>
    ...
    `,document.body.appendChild(this.modalEl),this.attachEventListeners(),this.attachDragListeners(),this.updateVisibility(),this.updateSessionUI()}attachDragListeners(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spFloatingHeader"),t=this.modalEl.querySelector("#spModalDialog");if(e&&t){e.addEventListener("pointerdown",n=>{const s=n.target;if(!(s&&s.closest("button, input, a"))){this.isDraggingWindow=!0,this.dragStartPointer={x:n.clientX,y:n.clientY},this.dragStartPos={x:this.floatingPos.x,y:this.floatingPos.y};try{e.setPointerCapture(n.pointerId)}catch{}n.preventDefault(),n.stopPropagation()}}),e.addEventListener("pointermove",n=>{if(!this.isDraggingWindow)return;const s=n.clientX-this.dragStartPointer.x,c=n.clientY-this.dragStartPointer.y;this.floatingPos={x:this.dragStartPos.x+s,y:this.dragStartPos.y+c},this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`});const i=n=>{if(this.isDraggingWindow){this.isDraggingWindow=!1;try{e.releasePointerCapture(n.pointerId)}catch{}this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`}};e.addEventListener("pointerup",i),e.addEventListener("pointercancel",i)}const a=this.modalEl.querySelector("#spMinimizedPill");if(a){let i=!1;a.addEventListener("pointerdown",s=>{const c=s.target;if(!(c&&c.closest("#spPillRestoreBtn"))){this.isDraggingPill=!0,i=!1,this.dragStartPointer={x:s.clientX,y:s.clientY},this.dragStartPos={x:this.pillPos.x,y:this.pillPos.y};try{a.setPointerCapture(s.pointerId)}catch{}s.preventDefault(),s.stopPropagation()}}),a.addEventListener("pointermove",s=>{if(!this.isDraggingPill)return;const c=s.clientX-this.dragStartPointer.x,l=s.clientY-this.dragStartPointer.y;(Math.abs(c)>3||Math.abs(l)>3)&&(i=!0),this.pillPos={x:this.dragStartPos.x+c,y:this.dragStartPos.y+l},this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`});const n=s=>{if(this.isDraggingPill){this.isDraggingPill=!1;try{a.releasePointerCapture(s.pointerId)}catch{}this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`,i||this.restore()}};a.addEventListener("pointerup",n),a.addEventListener("pointercancel",n)}}attachEventListeners(){if(!this.modalEl)return;this.modalEl.querySelector("#spModalBackdrop")?.addEventListener("click",()=>{this.uiState==="DIALER"&&this.close()}),this.modalEl.querySelector("#spMinimizeBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.minimize()}),this.modalEl.querySelector("#spCloseBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.close()}),this.modalEl.querySelector("#spPillRestoreBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.restore()});const e=this.modalEl.querySelector("#spDialInput");e?.addEventListener("input",t=>{this.enteredNumber=t.target.value,this.rawNumber="",this.isPresetNumber=!1,this.updateCallerPhoneDisplay()}),this.modalEl.querySelector("#spBackspaceBtn")?.addEventListener("click",()=>{if(this.isPresetNumber){this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1),this.updateCallerPhoneDisplay();return}this.enteredNumber.length>0&&(this.enteredNumber=this.enteredNumber.slice(0,-1),e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),v.playKeyTone())}),this.modalEl.querySelectorAll(".sp-num-btn").forEach(t=>{t.addEventListener("click",a=>{const i=a.currentTarget.getAttribute("data-key");this.isPresetNumber&&(this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1)),i&&this.enteredNumber.length<15&&(this.enteredNumber+=i,e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),v.playKeyTone())})}),this.modalEl.querySelector("#spMainDialBtn")?.addEventListener("click",()=>{this.startCall()}),this.modalEl.querySelector("#spDirectSimBtn")?.addEventListener("click",()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}v.triggerDirectSimCall(this.enteredNumber)}),this.modalEl.querySelector("#spMyOperatorBtn")?.addEventListener("click",async()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}try{const t=this.currentOptions?.entityId?parseInt(String(this.currentOptions.entityId)):null;await v.triggerMyOperatorCall(this.enteredNumber,t),alert(`MyOperator call dispatched to ${this.enteredNumber}! Your office line will ring shortly.`)}catch(t){this.showError(`MyOperator error: ${t.message}`)}}),this.modalEl.querySelector("#spBtnMute")?.addEventListener("click",()=>{v.toggleMute()}),this.modalEl.querySelector("#spBtnSpeaker")?.addEventListener("click",()=>{v.toggleSpeaker()}),this.modalEl.querySelector("#spInCallVolumeSlider")?.addEventListener("input",t=>{const a=parseFloat(t.target.value)/100;v.setVolume(a)}),this.modalEl.querySelector("#spBtnHold")?.addEventListener("click",()=>{v.toggleHold()}),this.modalEl.querySelector("#spBtnKeypad")?.addEventListener("click",()=>{this.isDtmfOpen=!this.isDtmfOpen;const t=this.modalEl?.querySelector("#spDtmfGrid");t&&(t.style.display=this.isDtmfOpen?"grid":"none")}),this.modalEl.querySelectorAll(".sp-dtmf-btn").forEach(t=>{t.addEventListener("click",a=>{const i=a.currentTarget.getAttribute("data-dtmf");i&&v.sendDTMF(i)})}),this.modalEl.querySelector("#spBtnHangup")?.addEventListener("click",()=>{v.endCall()})}updateVisibility(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spModalBackdrop"),t=this.modalEl.querySelector("#spModalDialog"),a=this.modalEl.querySelector("#spMinimizedPill"),i=this.modalEl.querySelector("#spInCallView"),n=this.modalEl.querySelector("#spDialerView");this.uiState==="DIALER"?(e&&(e.style.display="block"),t&&(t.style.display="block"),a&&(a.style.display="none"),n&&(n.style.display="block"),i&&(i.style.display="none")):this.uiState==="ACTIVE_FLOATING"?(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="flex")):this.uiState==="MINIMIZED"?(e&&(e.style.display="none"),t&&(t.style.display="none"),a&&(a.style.display="flex")):this.uiState==="ENDED_SUMMARY"&&(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="flex"))}updateCallerPhoneDisplay(){const e=this.modalEl?.querySelector("#spCallerPhoneDisplay");e&&(e.textContent=this.maskPhone(this.enteredNumber))}showError(e){const t=this.modalEl?.querySelector("#spErrorBanner");t&&(t.textContent=e,t.style.display="block")}hideError(){const e=this.modalEl?.querySelector("#spErrorBanner");e&&(e.style.display="none")}async startCall(){v.prepareAudioOnUserGesture(),this.hideError();const e=this.rawNumber||this.enteredNumber;if(!e){this.showError("Please enter a destination phone number.");return}const t=this.currentOptions?.name||"Contact Lead",a=this.currentOptions?.entityId||null;this.uiState="ACTIVE_FLOATING",this.updateVisibility();const i=await v.startCall(e,t,a);!i.success&&i.error&&(i.error==="A call is already in progress."?console.warn("[SoftphoneModal] Duplicate dial prevented; ignoring duplicate error toast"):this.showError(i.error))}updateSessionUI(){if(!this.modalEl||!this.currentSession)return;const e=this.currentSession.contactName||this.currentOptions?.name||"Contact Lead",t=this.currentSession.destinationPhone||this.enteredNumber,a=this.formatDuration(this.currentSession.durationSeconds),i=this.modalEl.querySelector("#spActiveCallerName");i&&(i.textContent=e);const n=this.modalEl.querySelector("#spActiveCallerPhone");n&&(n.textContent=this.maskPhone(t));const s=this.modalEl.querySelector("#spCallTimerDisplay");s&&(s.textContent=a);const c=this.modalEl.querySelector("#spPillCallerName");c&&(c.textContent=e);const l=this.modalEl.querySelector("#spPillTimerDisplay");l&&(l.textContent=a);const o=this.modalEl.querySelector("#spCallStateBadge");o&&(this.currentSession.state==="connected"?(o.textContent="🟢 Connected",o.style.background="#22c55e",o.style.color="#ffffff"):this.currentSession.state==="ringing"?(o.textContent="📞 Ringing...",o.style.background="#38bdf8",o.style.color="#000000"):this.currentSession.state==="connecting"?(o.textContent="⏳ Connecting...",o.style.background="#f59e0b",o.style.color="#000000"):this.currentSession.state==="ended"&&(o.textContent="🛑 Call Ended",o.style.background="#ef4444",o.style.color="#ffffff"));const d=this.modalEl.querySelector("#spBtnMute");d&&(d.style.background=this.currentSession.isMuted?"rgba(239,68,68,0.6)":"rgba(255,255,255,0.1)",d.style.borderColor=this.currentSession.isMuted?"#ef4444":"rgba(255,255,255,0.2)");const m=this.modalEl.querySelector("#spBtnSpeaker");m&&(m.style.background=this.currentSession.isSpeaker?"rgba(56,189,248,0.6)":"rgba(255,255,255,0.1)",m.style.borderColor=this.currentSession.isSpeaker?"#38bdf8":"rgba(255,255,255,0.2)");const r=this.modalEl.querySelector("#spBtnHold");r&&(r.style.background=this.currentSession.isHeld?"rgba(245,158,11,0.6)":"rgba(255,255,255,0.1)",r.style.borderColor=this.currentSession.isHeld?"#f59e0b":"rgba(255,255,255,0.2)")}async loadLeadContext(e){const t=this.modalEl?.querySelector("#spLeadContextBox");if(!t)return;if(this.currentOptions?.categoryName){const i=this.modalEl?.querySelector("#spMobileCatBadge");i&&(i.textContent=this.currentOptions.categoryName);const n=this.modalEl?.querySelector("#spHeaderCatBadge");n&&(n.textContent=`🏷️ ${this.currentOptions.categoryName}`,n.style.display="inline-block")}if(this.currentOptions?.status){const i=this.modalEl?.querySelector("#spMobileStatus");i&&(i.textContent=this.currentOptions.status.toUpperCase());const n=this.modalEl?.querySelector("#spHeaderStatusBadge");n&&(n.textContent=`📌 ${this.currentOptions.status}`,n.style.display="inline-block")}let a=e;if(!a&&this.currentOptions?.phoneNumber)try{const i=this.currentOptions.phoneNumber.replace(/\D/g,"").slice(-10);if(i.length>=10){const n=await S.get(`/telephony/calls/${i}/customer-history`),s=n?.data??n;s?.lead?.id&&(a=s.lead.id)}}catch(i){console.warn("[SoftphoneModal] Lead lookup by phone notice:",i)}if(!a){this.currentOptions?.categoryName||this.currentOptions?.status?t.style.display="block":t.style.display="none";return}try{const i=await S.get(`/crm/dialer/lead/${a}/detail`),n=i.data??i;if(!n||!n.lead)return;const s=n.lead;t.style.display="block";const c=this.modalEl?.querySelector("#spMobileCatBadge");c&&(c.textContent=s.category_name||"General");const l=this.modalEl?.querySelector("#spHeaderCatBadge");l&&(l.textContent=`🏷️ ${s.category_name||"General"}`,l.style.display="inline-block");const o=this.modalEl?.querySelector("#spMobileSource");o&&(o.textContent=s.source||"—");const d=this.modalEl?.querySelector("#spMobileCompany");d&&(d.textContent=s.company_name||"—");const m=this.modalEl?.querySelector("#spMobileStatus");m&&(m.textContent=(s.status||"—").toUpperCase(),m.style.color=s.status==="won"?"#22c55e":s.status==="lost"?"#ef4444":"#38bdf8");const r=this.modalEl?.querySelector("#spHeaderStatusBadge");r&&(r.textContent=`📌 ${s.status||"New"}`,r.style.display="inline-block");const h=this.modalEl?.querySelector("#spHeaderTempBadge");h&&(s.is_hot_lead?(h.textContent="🔥 HOT LEAD",h.style.background="rgba(239, 68, 68, 0.2)",h.style.color="#ef4444",h.style.border="1px solid rgba(239, 68, 68, 0.4)",h.style.display="inline-block"):s.is_fresh_lead?(h.textContent="🌱 FRESH LEAD",h.style.background="rgba(16, 185, 129, 0.2)",h.style.color="#10b981",h.style.border="1px solid rgba(16, 185, 129, 0.4)",h.style.display="inline-block"):h.style.display="none");const p=this.modalEl?.querySelector("#spMobileStatusUpdated");p&&(p.textContent=s.status_updated_at?new Date(s.status_updated_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"—");const g=this.modalEl?.querySelector("#spMobileBudget");g&&(g.textContent=s.budget_display||"—");const b=this.modalEl?.querySelector("#spMobileLastInteraction");b&&(b.textContent=s.last_interaction_date?new Date(s.last_interaction_date).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const _=this.modalEl?.querySelector("#spMobileInteractedBy");_&&(_.textContent=s.last_interacted_by||"—");const x=this.modalEl?.querySelector("#spMobileLastDialed");x&&(x.textContent=s.last_dialed_at?new Date(s.last_dialed_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const f=this.modalEl?.querySelector("#spMobileReqRow"),E=this.modalEl?.querySelector("#spMobileRequirements");f&&E&&(s.requirements?(E.textContent=s.requirements,f.style.display="block"):f.style.display="none");const M=this.modalEl?.querySelector("#spMobileNotesSection"),I=this.modalEl?.querySelector("#spMobileRecentNotes");if(M&&I){const L=(n.notes||[]).slice(0,2);L.length>0?(I.innerHTML=L.map(R=>`<div>• ${R.note}</div>`).join(""),M.style.display="block"):M.style.display="none"}}catch(i){console.warn("[SoftphoneModal] Could not fetch lead context:",i)}}}const le=new G,O={"/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"staff-task-tracker","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/vgk/members":"staff-vgk-members","/staff_vgk_members.html":"staff-vgk-members","/staff/incentives/vgk4u":"staff-incentives-vgk4u","/staff/vgk4u/real-estate":"staff-vgk4u-real-estate","/staff/vgk4u/insurance":"staff-vgk4u-insurance","/staff/vgk4u/etc-students":"staff-vgk4u-real-estate","/staff/incentives/points":"staff-incentives-points","/staff/incentives/approvals":"staff-incentives-approvals","/staff/vgk/income":"staff-vgk-income","/staff/vgk/income-unified":"vgk-income-unified","/staff/vgk/coupons/available":"staff-vgk-coupons","/staff/vgk/promo-codes":"staff-vgk-promo-codes","/staff/vgk/bonanza-management":"vgk-bonanza-rewards","/staff/vgk/bonanza-claims":"vgk-bonanza-rewards","/staff/vgk/vendors":"staff-vgk-vendors","/staff/vgk/vendor-categories":"staff-vgk-vendors","/staff/vgk/vendor-products":"staff-vgk-vendors","/staff/vgk/vendor-transactions":"staff-vgk-vendors","/staff/vgk/cash-income/sales":"staff-vgk-income","/staff/vgk/cash-income/accounts":"staff-vgk-income","/staff/vgk/wallet":"vgk-points-balance","/staff/vgk/config":"staff-vgk-members","/staff/vgk/partner-kyc-review":"staff-kyc-approvals","/staff/vgk/my-registrations":"vgk-my-registrations","/staff/vgk/media":"vgk-member-hub","/staff/vgk4u/purchase-orders":"staff-service-procurement","/rvz/real-dreams/marketplace":"real-dreams-marketplace","/rvz/real-dreams":"real-dreams-marketplace","/rvz/real-dreams/partners":"real-dreams-marketplace","/rvz/real-dreams-partners":"real-dreams-marketplace","/rvz/real-dreams/properties":"real-dreams-marketplace","/rvz/real-dreams-properties":"real-dreams-marketplace","/rvz/real-dreams-dashboard":"real-dreams-marketplace","/staff/mnr/real-dreams/marketplace":"real-dreams-marketplace","/real-dreams/marketplace":"real-dreams-marketplace","/real-dreams/compare":"real-dreams-marketplace","/real-dreams/property":"real-dreams-marketplace","/vgk/birthdays":"vgk-birthdays","/vgk/top-earners":"vgk-top-earners","/vgk/awards":"vgk-awards","/vgk/my-registrations":"vgk-my-registrations","/vgk/bonanza-rewards":"vgk-bonanza-rewards","/vgk/points-balance":"vgk-points-balance","/vgk/member-hub":"vgk-member-hub","/vgk/settings":"vgk-settings","/vgk/bank-details":"vgk-bank-details","/vgk/profile-edit":"vgk-profile-edit","/vgk/kyc":"vgk-kyc","/vgk/feedback":"vgk-feedback","/vgk/announcements":"vgk-announcements","/vgk/my-announcements":"vgk-my-announcements","/vgk/coupon-activate":"vgk-coupon-activate","/vgk/coupon-progress":"vgk-coupon-progress","/vgk/coupon-transfer":"vgk-coupon-transfer","/vgk/income-unified":"vgk-income-unified","/vgk/daywise-income":"vgk-daywise-income","/vgk/income-types":"vgk-income-types","/vgk/direct-summary":"vgk-direct-summary","/vgk/matching-summary":"vgk-matching-summary","/vgk/guru-summary":"vgk-guru-summary","/vgk/ved-summary":"vgk-ved-summary","/vgk/ev-benefits":"vgk-ev-benefits","/vgk/ev-discount":"vgk-ev-discount","/vgk/franchise-earnings":"vgk-franchise-earnings","/vgk/insurance":"vgk-insurance","/vgk/training":"vgk-training","/vgk/coupon-benefits":"vgk-coupon-benefits","/vgk/my-submissions":"vgk-my-submissions","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/field-sales":"staff-bank-wise-leads","/field-sales":"staff-bank-wise-leads","field-sales":"staff-bank-wise-leads","bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"category-leads-master","/staff/real-dreams-leads":"category-leads-master","/staff/insurance-leads":"category-leads-master","/staff/ev-b2b-leads":"category-leads-master","/staff/ev-b2c-leads":"category-leads-master","/staff/ev-spares-leads":"category-leads-master","/staff/etc-leads":"category-leads-master","/staff/mnr-leads":"category-leads-master","/staff/mnr-leads-master":"category-leads-master","/staff/executive-dashboard":"executive-dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/configuration/catalog":"digital-catalog","/staff/catalog-library":"digital-catalog","/staff/catalog":"digital-catalog","/catalog-library":"digital-catalog","catalog-library":"digital-catalog","/staff/catalog-library.html":"digital-catalog","/catalog-library.html":"digital-catalog","/catalog":"digital-catalog",catalog:"digital-catalog","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"auto-dialer","/staff/softphone":"softphone","/staff/calling-page":"softphone","/staff/calling":"softphone","/staff/phone-dialpad":"softphone","/staff/softphone-hub":"softphone","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},z=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],H=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],V=[{section_code:"ATTENDANCE",section_label:"ATTENDANCE",order:1,items:[{menu_code:"IN_OUT_TIME",label:"In/Out Time",route:"attendance"},{menu_code:"MY_LEAVES",label:"My Leaves",route:"leaves"},{menu_code:"LEAVE_APPROVALS",label:"Leave Approvals",route:"staff-leave-approvals"},{menu_code:"IN_OUT_RECORDS_ADMIN",label:"In/Out Records - Admin",route:"team-attendance"},{menu_code:"ATTENDANCE_RECORDS",label:"Attendance Records",route:"staff-attendance-sheet"},{menu_code:"ATTENDANCE_DASHBOARD",label:"Attendance Dashboard",route:"staff-attendance-reports"},{menu_code:"EXCEPTION_APPROVALS",label:"Exception Approvals",route:"staff-attendance-exceptions"},{menu_code:"ATTENDANCE_COMPUTATION",label:"Attendance Computation",route:"staff-attendance-computation"}]},{section_code:"TASK_MANAGEMENT",section_label:"TASK MANAGEMENT",order:3,items:[{menu_code:"ASSIGNED_BY_ME",label:"Assigned By Me",route:"tasks-assigned"},{menu_code:"ASSIGNED_TO_ME",label:"Assigned To Me",route:"tasks-received"},{menu_code:"TEAM_ACTIVITIES",label:"Team Activities",route:"staff-team-activities"},{menu_code:"TASK_TRACKER",label:"Task Dashboard",route:"staff-task-tracker"},{menu_code:"TASK_REVIEWS",label:"Task Reviews",route:"staff-task-reviews"}]},{section_code:"KRA_MANAGEMENT",section_label:"KRA MANAGEMENT",order:4,items:[{menu_code:"MY_KRAS",label:"My KRAs",route:"kras"},{menu_code:"KRA_TEMPLATES",label:"KRA Templates",route:"staff-kra-templates"},{menu_code:"KRA_TRACKING_SHEET",label:"KRA Tracking Sheet",route:"staff-kra-tracking"},{menu_code:"KRA_REVIEW",label:"KRA Review",route:"staff-kra-review"}]},{section_code:"TIMESHEET",section_label:"TIMESHEET",order:5,items:[{menu_code:"MY_TIMESHEET",label:"My Timesheet",route:"timesheet"},{menu_code:"TIMESHEET_APPROVAL",label:"Timesheet Approval",route:"staff-timesheet-approval"}]},{section_code:"JOURNEY_TRACKING",section_label:"JOURNEY TRACKING",order:6,items:[{menu_code:"MY_JOURNEYS",label:"My Journeys",route:"journeys"},{menu_code:"TEAM_JOURNEYS",label:"Team Journeys",route:"team-journeys"},{menu_code:"ALL_JOURNEYS",label:"All Journeys",route:"staff-all-journeys"},{menu_code:"VGK4U_JOURNEYS",label:"VGK4U Journeys",route:"staff-vgk4u-journeys"}]},{section_code:"REIMBURSEMENT",section_label:"REIMBURSEMENT",order:7,items:[{menu_code:"MY_REIMBURSEMENT_CLAIMS",label:"My Reimbursement Claims",route:"reimbursements"},{menu_code:"REIMBURSEMENT_APPROVALS",label:"Reimbursement Approvals",route:"staff-reimbursement-approvals"}]},{section_code:"ACCOUNTS_EARNINGS",section_label:"FINANCE & EARNINGS",order:8,items:[{menu_code:"MY_EARNINGS",label:"My Earnings",route:"staff-my-incentives"},{menu_code:"PAYROLL_PROFILE",label:"Payroll Profile",route:"staff-payroll-profile"},{menu_code:"SALARY_SLIPS",label:"Salary Slips",route:"staff-salary-slips"}]},{section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[{menu_code:"MY_CRM_DASHBOARD",label:"CRM Dashboard",route:"staff-crm"},{menu_code:"MY_LEADS",label:"My Leads",route:"staff-my-leads"},{menu_code:"DIGITAL_CATALOG",label:"Digital Catalog",route:"digital-catalog"},{menu_code:"AUTO_DIALER",label:"Auto Dialer",route:"auto-dialer"},{menu_code:"SOFTPHONE",label:"Calling & Softphone",route:"softphone"},{menu_code:"BANK_WISE_LEADS",label:"Field staff leads",route:"staff-bank-wise-leads"},{menu_code:"TEAM_LEADS",label:"Team Leads",route:"staff-team-leads"},{menu_code:"LEADS_MASTER",label:"Staff Leads",route:"staff-leads"},{menu_code:"VGK_TEAM_MEMBERS",label:"VGK Channel Partners",route:"staff-vgk-members"}]},{section_code:"WORKFLOWS",section_label:"WORK FLOWS",order:10,items:[{menu_code:"EXECUTIVE_DASHBOARD",label:"Executive Dashboard",route:"executive-dashboard"},{menu_code:"MNR_BANK_WISE_LEADS",label:"Field Sales",route:"staff-bank-wise-leads"},{menu_code:"CATEGORY_LEADS_MASTER",label:"Category Leads Master",route:"category-leads-master"},{menu_code:"SOLAR_LEADS",label:"Solar Leads",route:"category-leads-master",tab:"solar"},{menu_code:"EV_B2B_LEADS",label:"EV B2B Leads",route:"category-leads-master",tab:"ev-b2b"},{menu_code:"EV_B2C_LEADS",label:"EV B2C Leads",route:"category-leads-master",tab:"ev-b2c"},{menu_code:"EV_SPARES_LEADS",label:"EV Spares Leads",route:"category-leads-master",tab:"ev-spares"},{menu_code:"ZYN_REAL_ESTATE",label:"Real Dreams Leads",route:"category-leads-master",tab:"real-dreams"},{menu_code:"ZYN_INSURANCE",label:"Insurance Leads",route:"category-leads-master",tab:"insurance"},{menu_code:"ETC_LEADS",label:"ETC Leads",route:"category-leads-master",tab:"etc"},{menu_code:"MNR_LEADS",label:"MNR Leads",route:"category-leads-master",tab:"mnr"}]},{section_code:"OPERATIONS",section_label:"OPERATIONS",order:11,items:[{menu_code:"CALL_TRACKING",label:"Call Tracking",route:"staff-call-tracking"},{menu_code:"VENDORS",label:"Vendors",route:"staff-vendors"},{menu_code:"ZYN",label:"Zynova Real Estate",route:"zynova-real-estate"},{menu_code:"ZYNOVA",label:"VGK4U",route:"staff-zynova"},{menu_code:"ZYN_INSURANCE",label:"Zynova Insurance",route:"zynova-insurance"}]},{section_code:"VGK4U",section_label:"VGK4U",order:16,subSections:[{sub_section_code:"real-dreams",sub_section_label:"VGK4U Property",items:[{menu_code:"REAL_DREAMS_MARKETPLACE",label:'<i class="fas fa-building" style="margin-right: 8px; width: 18px; text-align: center; color: #2563eb;"></i>Property Marketplace',route:"real-dreams-marketplace"},{menu_code:"VGK4U_REAL_ESTATE",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center; color: #2563eb;"></i>VGK Real Dreams (ZR)',route:"staff-vgk4u-real-estate"},{menu_code:"VGK4U_INSURANCE",label:'<i class="fas fa-shield-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #059669;"></i>VGK Care (ZC)',route:"staff-vgk4u-insurance"}]},{sub_section_code:"zy-member-earnings",sub_section_label:"VGK4U Earnings",items:[{menu_code:"INCENTIVES_VGK4U",label:'<i class="fas fa-users" style="margin-right: 8px; width: 18px; text-align: center; color: #7c3aed;"></i>All VGK4U Members',route:"staff-incentives-vgk4u"},{menu_code:"INCENTIVES_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>MNR Points',route:"staff-incentives-points"},{menu_code:"INCENTIVES_APPROVALS",label:'<i class="fas fa-clipboard-check" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Incentive Approvals',route:"staff-incentives-approvals"}]}]},{section_code:"VGK_TEAM",section_label:"VGK TEAM",order:21,subSections:[{sub_section_code:"vgk_team_management",sub_section_label:"VGK Team Management",items:[{menu_code:"VGK_TEAM_MEMBERS",label:'<i class="fas fa-users" style="margin-right: 8px; width: 18px; text-align: center; color: #7c3aed;"></i>VGK Channel Partners',route:"staff-vgk-members"},{menu_code:"VGK_INCOME",label:'<i class="fas fa-hand-holding-usd" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>VGK Income Management',route:"staff-vgk-income"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>VGK PIN Activation',route:"staff-vgk-coupons"},{menu_code:"VGK_PROMO_CODES",label:'<i class="fas fa-tags" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>VGK Promo Codes',route:"staff-vgk-promo-codes"}]},{sub_section_code:"vgk_bonanza",sub_section_label:"VGK Bonanza",items:[{menu_code:"VGK_BONANZA_MGMT",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bonanza Management',route:"vgk-bonanza-rewards"}]}]},{section_code:"VENDOR_MANAGEMENT",section_label:"VENDOR MANAGEMENT",order:22,items:[{menu_code:"VM_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center; color: #0284c7;"></i>Vendor Master',route:"staff-vgk-vendors"}]}],F=[{section_code:"EARNINGS",section_label:"EARNINGS & INCOME",order:1,items:[{menu_code:"VGK_INCOME_UNIFIED",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Income Dashboard',route:"vgk-income-unified"},{menu_code:"VGK_DAYWISE_INCOME",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Daywise Income',route:"vgk-daywise-income"},{menu_code:"VGK_DIRECT_SUMMARY",label:'<i class="fas fa-users" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>Direct (L1)',route:"vgk-direct-summary"},{menu_code:"VGK_MATCHING_SUMMARY",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>Matching (L2)',route:"vgk-matching-summary"},{menu_code:"VGK_GURU_SUMMARY",label:'<i class="fas fa-graduation-cap" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Guru Summary',route:"vgk-guru-summary"},{menu_code:"VGK_VED_SUMMARY",label:'<i class="fas fa-brain" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Ved Summary',route:"vgk-ved-summary"},{menu_code:"VGK_FRANCHISE_EARNINGS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center; color: #14b8a6;"></i>Franchise Earnings',route:"vgk-franchise-earnings"}]},{section_code:"PROGRAMS",section_label:"PROGRAMS & BENEFITS",order:2,items:[{menu_code:"VGK_EV_BENEFITS",label:'<i class="fas fa-charging-station" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>EV Benefits',route:"vgk-ev-benefits"},{menu_code:"VGK_EV_DISCOUNT",label:'<i class="fas fa-percent" style="margin-right: 8px; width: 18px; text-align: center; color: #06b6d4;"></i>EV Discount',route:"vgk-ev-discount"},{menu_code:"VGK_INSURANCE",label:'<i class="fas fa-shield-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Insurance Policy',route:"vgk-insurance"},{menu_code:"VGK_TRAINING",label:'<i class="fas fa-chalkboard-teacher" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>Training Program',route:"vgk-training"},{menu_code:"VGK_BONANZA_REWARDS",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bonanza Rewards',route:"vgk-bonanza-rewards"},{menu_code:"VGK_AWARDS",label:'<i class="fas fa-award" style="margin-right: 8px; width: 18px; text-align: center; color: #eab308;"></i>Awards & Milestones',route:"vgk-awards"}]},{section_code:"COUPONS_PINS",section_label:"COUPONS & PINS",order:3,items:[{menu_code:"VGK_COUPON_ACTIVATE",label:'<i class="fas fa-key" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>PIN Activation',route:"vgk-coupon-activate"},{menu_code:"VGK_COUPON_PROGRESS",label:'<i class="fas fa-tasks" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Coupon Progress',route:"vgk-coupon-progress"},{menu_code:"VGK_COUPON_TRANSFER",label:'<i class="fas fa-exchange-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Coupon Transfer',route:"vgk-coupon-transfer"},{menu_code:"VGK_COUPON_BENEFITS",label:'<i class="fas fa-gift" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Coupon Benefits',route:"vgk-coupon-benefits"}]},{section_code:"PROFILE_SECURITY",section_label:"MY ACCOUNT",order:4,items:[{menu_code:"VGK_PROFILE_EDIT",label:'<i class="fas fa-user-edit" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Edit Profile',route:"vgk-profile-edit"},{menu_code:"VGK_KYC",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>KYC Verification',route:"vgk-kyc"},{menu_code:"VGK_BANK_DETAILS",label:'<i class="fas fa-university" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bank Details',route:"vgk-bank-details"},{menu_code:"VGK_POINTS_BALANCE",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center; color: #eab308;"></i>Points Balance',route:"vgk-points-balance"},{menu_code:"VGK_FEEDBACK",label:'<i class="fas fa-comment-dots" style="margin-right: 8px; width: 18px; text-align: center; color: #06b6d4;"></i>Feedback',route:"vgk-feedback"},{menu_code:"VGK_SETTINGS",label:'<i class="fas fa-cog" style="margin-right: 8px; width: 18px; text-align: center; color: #64748b;"></i>Settings',route:"vgk-settings"}]},{section_code:"COMMUNITY",section_label:"COMMUNITY & TEAM",order:5,items:[{menu_code:"VGK_TOP_EARNERS",label:'<i class="fas fa-medal" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Top Earners',route:"vgk-top-earners"},{menu_code:"VGK_BIRTHDAYS",label:'<i class="fas fa-birthday-cake" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Birthdays',route:"vgk-birthdays"},{menu_code:"VGK_ANNOUNCEMENTS",label:'<i class="fas fa-bullhorn" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Announcements',route:"vgk-announcements"},{menu_code:"VGK_MY_REGISTRATIONS",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>My Registrations',route:"vgk-my-registrations"},{menu_code:"VGK_MY_SUBMISSIONS",label:'<i class="fas fa-file-invoice" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>My Submissions',route:"vgk-my-submissions"}]}];class K{container=null;overlay=null;isOpen=!1;expandedSections=new Set;staffMenuTree=null;isStaffMenuLoaded=!1;constructor(){try{const e=localStorage.getItem("mnr_staff_menu_tree_cache");e&&(this.staffMenuTree=JSON.parse(e),this.isStaffMenuLoaded=!0)}catch{}this.createElements(),this.loadStaffMenus(),window.addEventListener("logout",()=>{this.staffMenuTree=null,this.isStaffMenuLoaded=!1;try{localStorage.removeItem("mnr_staff_menu_tree_cache")}catch{}this.updateUI()}),window.addEventListener("auth-changed",()=>{this.isStaffMenuLoaded=!1,this.loadStaffMenus()})}createElements(){if(this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),!document.getElementById("myntos-drawer-styles")){const e=document.createElement("style");e.id="myntos-drawer-styles",e.textContent=`
      ...
      `,document.head.appendChild(e)}this.attachEventListeners()}render(){const e=A.getPortal(),t=e==="vgk",i=y.getAuthState().user||{},n=(i.role_code||i.role?.role_code||i.user_type||"").toString().toLowerCase().trim(),s=(i.role_name||i.role?.role_name||"").toString().toUpperCase().trim(),c=(i.staff_type||"").toString().toUpperCase().trim(),l=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin","manager","director","admin"].includes(n)||n.includes("vgk")||n.includes("manager")||n.includes("lead")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER"].includes(s)||s.includes("VGK")||s.includes("MANAGER")||["VGK4U","VGK4U SUPREME"].includes(c)||!!(i.is_manager||i.is_admin||i.is_super_admin);let o=z;if(t)o=H;else if(e==="staff"){const p=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(n)||n.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(s)||s.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(c);i.staff_type==="FREELANCER"&&i.freelancer_access_mode==="only_leads"?o=[]:o=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...p?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i> Auto Dialer',route:"auto-dialer"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling & Softphone',route:"softphone"}]}const d=["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(p=>n.includes(p))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(p=>s.includes(p))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(p=>c.includes(p))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(p=>(i.department||i.department_name||"").toString().toUpperCase().includes(p)),m=l||d,r=t?F:e==="staff"?this.getStaffMenuMaster():V,h=e==="staff"?this.filterMenusForRole(r,l,m):r;return`
      ...
      <div class="drawer-content">
        ...
        <!-- Section menus -->
        ${h.map(p=>this.renderSection(p)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab;a?k.navigate(t,{tab:a}):k.navigate(t),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await y.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){try{const e=await S.get("/staff/menu-settings/my-menus?unified=true");if(e.success&&e.data&&e.data.sidebar_tree){this.staffMenuTree=e.data.sidebar_tree,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_menu_tree_cache",JSON.stringify(this.staffMenuTree))}catch{}this.updateUI()}}catch(e){console.error("Failed to load dynamic staff menus:",e)}}filterMenusForRole(e,t,a=!1){const n=y.getAuthState().user||{},s=(n.emp_code||n.employee_code||"").toString().toUpperCase().trim(),c=["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(s);if(t&&!c)return e;const l=new Set(["SAAS","SAAS_MANAGEMENT","SAAS CONFIGURATION","CONFIGURATION","SYSTEM_CONFIGURATION","SYSTEM CONFIG","META_ADS","META ADS","VENDOR_MANAGEMENT","VENDOR MANAGEMENT","VENDORS","HR","HR_MANAGEMENT","ZYNOVA","ZYNOVA_REAL_ESTATE","MNR","MNR_USER_SIDEBAR","MNR USER SIDEBAR","MNR_USER","MNR USER"]);a||(l.add("ACCOUNTS"),l.add("ACCOUNTS_EARNINGS"),l.add("ACCOUNTS & EARNINGS"),l.add("FINANCE"),l.add("FINANCE & EARNINGS"),l.add("FINANCE_EARNINGS"),l.add("ACCOUNTS_MANAGEMENT"));const o=new Set(["EXECUTIVE_DASHBOARD","CATEGORY_LEADS_MASTER","SAAS_CONFIG","SYSTEM_CONFIG"]);(!t||c)&&(o.add("LEADS_MASTER"),o.add("STAFF_LEADS"),o.add("staff_leads")),a||(o.add("PAYROLL_PROFILE"),o.add("SALARY_SLIPS"),o.add("EXPENSE_ENTRIES"));const d=[];for(const m of e){const r=(m.section_code||"").toUpperCase().trim(),h=(m.section_label||"").toUpperCase().trim();if(l.has(r)||l.has(h))continue;let p=m.items;p&&p.length>0&&(p=p.filter(x=>{const f=(x.menu_code||"").toUpperCase().trim();return!o.has(f)}));let g=m.subSections;g&&g.length>0&&(g=g.map(x=>({...x,items:x.items.filter(f=>{const E=(f.menu_code||"").toUpperCase().trim();return!o.has(E)})})).filter(x=>x.items.length>0));const b=p&&p.length>0,_=g&&g.length>0;(b||_)&&d.push({...m,items:b?p:void 0,subSections:_?g:void 0})}return d}getStaffMenuMaster(){if(!this.staffMenuTree)return V;const e={EXECUTIVE_DASHBOARD:1,MNR_EXECUTIVE_DASHBOARD:1,staff_executive_dashboard:1,mnr_executive_dashboard:1,MNR_BANK_WISE_LEADS:2,BANK_WISE_LEADS:2,staff_bank_wise_leads:2,"staff-bank-wise-leads":2,FIELD_SALES:2,MNR_FIELD_SALES:2,staff_field_sales:2,"field-sales":2,CATEGORY_LEADS_MASTER:3,MNR_LEADS_MASTER:3,mnr_leads_master:3,staff_mnr_leads_master:3,SOLAR_LEADS:4,MNR_SOLAR_LEADS:4,staff_solar_leads:4,mnr_solar_leads:4,EV_B2B_LEADS:5,MNR_EV_B2B_LEADS:5,staff_ev_b2b_leads:5,mnr_ev_b2b_leads:5,EV_B2C_LEADS:6,MNR_EV_B2C_LEADS:6,staff_ev_b2c_leads:6,mnr_ev_b2c_leads:6,EV_SPARES_LEADS:7,MNR_EV_SPARES_LEADS:7,staff_ev_spares_leads:7,mnr_ev_spares_leads:7,ZYN_REAL_ESTATE:8,MNR_REAL_DREAMS_LEADS:8,staff_real_dreams_leads:8,mnr_real_dreams_leads:8,ZYN_INSURANCE:9,MNR_INSURANCE_LEADS:9,staff_insurance_leads:9,mnr_insurance_leads:9,ETC_LEADS:10,MNR_ETC_LEADS:10,staff_etc_leads:10,mnr_etc_leads:10,MNR_LEADS:11,staff_mnr_leads:11,mnr_category_leads:11,AUTO_DIALER:12,staff_auto_dialer:12,"auto-dialer":12},t={MY_CRM_DASHBOARD:1,staff_crm_dashboard:1,"staff-crm":1,MY_LEADS:2,staff_my_leads:2,"staff-my-leads":2,AUTO_DIALER:3,staff_auto_dialer:3,staff_dialer:3,"auto-dialer":3,SOFTPHONE:4,staff_softphone:4,softphone:4,CALLING_PAGE:4,calling:4,"phone-dialpad":4,BANK_WISE_LEADS:5,staff_bank_wise_leads:5,"staff-bank-wise-leads":5,TEAM_LEADS:6,staff_team_leads:6,"staff-team-leads":6,WHATSAPP_CENTER:7,staff_crm_whatsapp_inbox:7,"staff-whatsapp":7,CALL_TRACKING:8,call_tracking_dashboard:8,"staff-call-tracking":8,OPERATOR_CALLS:9,staff_operator_calls:9,"operator-calls":9,VGK_TEAM_MEMBERS:10,staff_vgk_members:10,"staff-vgk-members":10,STAFF_LEADS:11,staff_leads:11,LEADS_MASTER:11,leads_master:11},a=new Map,i=[],n=(o,d,m,r)=>{let h=O[m]||O[m?.replace(/\/$/,"")]||(m?m.replace(/^\/staff\//,"").replace(/\//g,"-"):null);const p=(o||"").toUpperCase(),g=(m||"").toLowerCase();if((p.includes("CATALOG")||g.includes("catalog"))&&(h="digital-catalog"),!h)return null;const _=y.getAuthState().user||{},x=(_.emp_code||_.employee_code||"").toString().toUpperCase().trim();if(["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(x)&&(h==="staff-leads"||m&&m.toLowerCase()==="/staff/leads"||o&&["staff_leads","STAFF_LEADS","LEADS_MASTER","staff_leads_master"].includes(o)))return null;let f=d;(!f||f==="None"||f.trim()==="")&&(f=(o||"").replace(/^staff_|^_staff_|^mnr_/i,"").replace(/_/g," ").replace(/\b\w/g,R=>R.toUpperCase())),p.includes("AUTO_DIALER")||g.includes("auto-dialer")||g==="/staff/dialer"||p==="STAFF_AUTO_DIALER"||p==="AUTO_DIALER"||p==="STAFF_DIALER"||p==="DIALER"?f="Auto Dialer":p.includes("BANK_WISE_LEADS")||g.includes("bank-wise-leads")||g.includes("field-sales")||p.includes("FIELD_SALES")?(f="Field Sales",h="staff-bank-wise-leads"):p.includes("REAL_DREAMS")||g.includes("real-dreams-leads")?f="Real Dreams Leads":p.includes("ETC_LEADS")||g.includes("etc-leads")?f="ETC Training Students":p.includes("CATEGORY_LEADS_MASTER")||p.includes("MNR_LEADS_MASTER")||g.includes("mnr-leads-master")?f="Category Lead Master":p.includes("EXECUTIVE_DASHBOARD")||g.includes("executive-dashboard")?f="Executive Dashboard":p.includes("WHATSAPP")||g.includes("whatsapp")?f="WhatsApp Center":p.includes("SOFTPHONE")||p==="PHONE_DIALPAD"||p==="CALLING_PAGE"||g.includes("softphone")||g.includes("calling")||g.includes("phone-dialpad")?f="Calling & Softphone":p.includes("VGK_TEAM_MEMBERS")||p==="STAFF_VGK_MEMBERS"||g.includes("vgk/members")?f="VGK Channel Partners":p.includes("CATALOG")||g.includes("catalog")?f="Digital Catalog":p.includes("INCENTIVES_VGK4U")||g.includes("incentives/vgk4u")?f="All VGK4U Members":p.includes("VGK4U_REAL_ESTATE")||g.includes("vgk4u/real-estate")?f="VGK Real Dreams (ZR)":p.includes("VGK4U_INSURANCE")||g.includes("vgk4u/insurance")?f="VGK Care (ZC)":p.includes("INCENTIVES_POINTS")||g.includes("incentives/points")?f="MNR Points":p.includes("INCENTIVES_APPROVALS")||g.includes("incentives/approvals")?f="Incentive Approvals":p.includes("VGK_INCOME")||g.includes("vgk/income")?f="VGK Income Management":p.includes("VGK_COUPONS")||g.includes("vgk/coupons")?f="VGK PIN Activation":p.includes("VGK_PROMO_CODES")||g.includes("vgk/promo-codes")?f="VGK Promo Codes":p.includes("VGK_VENDORS")||g.includes("vgk/vendors")?f="Vendor Management":(p.includes("REAL_DREAMS_MARKETPLACE")||g.includes("real-dreams/marketplace")||g.includes("real-dreams-marketplace"))&&(f="Property Marketplace");let E;p.includes("SOLAR_LEADS")||g.includes("solar-leads")?E="solar":p.includes("EV_B2B")||g.includes("ev-b2b")?E="ev-b2b":p.includes("EV_B2C")||g.includes("ev-b2c")?E="ev-b2c":p.includes("EV_SPARES")||g.includes("ev-spares")?E="ev-spares":p.includes("REAL_DREAMS")||p.includes("ZYN_REAL_ESTATE")||g.includes("real-dreams-leads")?E="real-dreams":p.includes("INSURANCE")||p.includes("ZYN_INSURANCE")||g.includes("insurance-leads")?E="insurance":p.includes("ETC_LEADS")||g.includes("etc-leads")?E="etc":(p.includes("MNR_LEADS")||g.includes("mnr-leads"))&&(E="mnr");const M=r||(f.includes("WhatsApp")?"fab fa-whatsapp":f.includes("Auto Dialer")?"fas fa-phone-volume":f.includes("Softphone")||f.includes("Calling")?"fas fa-headset":f.includes("Real Dreams")||f.includes("Property")?"fas fa-building":f.includes("Insurance")||f.includes("Care")?"fas fa-shield-alt":f.includes("Points")?"fas fa-coins":f.includes("Approvals")?"fas fa-clipboard-check":f.includes("PIN")||f.includes("Coupon")?"fas fa-ticket-alt":f.includes("Promo")?"fas fa-tags":f.includes("Vendor")?"fas fa-store":f.includes("Income")?"fas fa-hand-holding-usd":f.includes("VGK")||f.includes("Channel")?"fas fa-users":f.includes("Field")||f.includes("Sales")?"fas fa-users-gear":f.includes("Catalog")?"fas fa-book-open":"fas fa-file-alt"),I=f.includes("WhatsApp")?"color: #25d366;":f.includes("Auto Dialer")||f.includes("Softphone")||f.includes("Calling")?"color: #38bdf8;":f.includes("Real Dreams")||f.includes("Property")?"color: #2563eb;":f.includes("Insurance")||f.includes("Care")?"color: #059669;":f.includes("Points")?"color: #f59e0b;":f.includes("PIN")||f.includes("Coupon")?"color: #6366f1;":f.includes("Promo")?"color: #ec4899;":f.includes("VGK")||f.includes("Channel")?"color: #7c3aed;":f.includes("Catalog")?"color: #10b981;":"",L=`<i class="${M}" style="margin-right: 8px; width: 18px; text-align: center; ${I}"></i>`;return{menu_code:o,label:`${L}${f}`,route:h,tab:E}};for(const o of this.staffMenuTree){if(o.id==="progress"||o.section_id==="progress"||(o.title||"").toUpperCase()==="PROGRESS")continue;const d=[],m=[];if(o.items)for(const r of o.items){const h=n(r.menu_code,r.menu_name||r.label||r.name||r.title,r.route_path,r.menu_icon);h&&d.push(h)}if(o.subSections)for(const r of o.subSections){const h=[];if(r.items)for(const g of r.items){const b=n(g.menu_code,g.menu_name||g.label||g.name||g.title,g.route_path,g.menu_icon);b&&h.push(b)}let p=r.title||r.name||r.id||"Subsection";(p==="None"||!p)&&(p=(r.id||"").replace(/^staff_|^vm_/i,"").replace(/_/g," ").replace(/\b\w/g,g=>g.toUpperCase())),h.length>0&&m.push({sub_section_code:r.id||r.section_id||"sub",sub_section_label:p,items:h})}if(d.length>0||m.length>0){let r=(o.id||o.section_id||"other").toString().trim(),h=(o.title||o.name||"Other").toString().trim();(h==="None"||!h)&&(h=r.replace(/_/g," ").replace(/\b\w/g,b=>b.toUpperCase()));const p=r.toLowerCase(),g=h.toUpperCase();if((p==="mynt_real"||p==="myntreal"||p==="workflows"||g==="MYNT REAL"||g==="MYNTREAL"||g==="WORK FLOWS"||g==="WORKFLOWS")&&(r="WORKFLOWS",h="WORK FLOWS"),(p==="crm"||p==="crm_module"||p==="crm_leads"||p==="crm & leads"||g.includes("CRM"))&&(r="CRM_MODULE",h="CRM & LEADS"),a.has(r)){const b=a.get(r);if(d.length>0){b.items=b.items||[];const _=new Set(b.items.map(x=>x.menu_code));for(const x of d)_.has(x.menu_code)||(b.items.push(x),_.add(x.menu_code))}m.length>0&&(b.subSections=b.subSections||[],b.subSections.push(...m))}else i.push(r),a.set(r,{section_code:r,section_label:h,order:r==="CRM_MODULE"?4:o.order!==void 0?o.order:999,items:d.length>0?d:void 0,subSections:m.length>0?m:void 0})}}let s=a.get("CRM_MODULE")||a.get("CRM_LEADS")||a.get("crm")||a.get("CRM");if(s||(s={section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[]},a.set("CRM_MODULE",s),i.push("CRM_MODULE")),s){if(s.items=s.items||[],!s.items.some(r=>r.route==="auto-dialer"||r.menu_code&&(r.menu_code.toUpperCase().includes("AUTO_DIALER")||r.menu_code.toUpperCase().includes("DIALER"))))s.items.push({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"auto-dialer"});else for(const r of s.items)(r.route==="auto-dialer"||r.menu_code&&(r.menu_code.toUpperCase().includes("AUTO_DIALER")||r.menu_code.toUpperCase().includes("DIALER")))&&(r.label='<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer');s.items.some(r=>r.route==="softphone"||r.menu_code&&(r.menu_code.toUpperCase().includes("SOFTPHONE")||r.menu_code.toUpperCase().includes("CALLING")))||s.items.push({menu_code:"SOFTPHONE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Calling & Softphone',route:"softphone"}),s.items.some(r=>r.route==="digital-catalog"||r.menu_code&&r.menu_code.toUpperCase().includes("CATALOG"))||s.items.push({menu_code:"DIGITAL_CATALOG",label:'<i class="fas fa-book-open" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Digital Catalog',route:"digital-catalog"})}let c=a.get("WORKFLOWS");if(c||(c={section_code:"WORKFLOWS",section_label:"WORK FLOWS",order:10,items:[]},a.set("WORKFLOWS",c),i.push("WORKFLOWS")),c)if(c.items=c.items||[],!c.items.some(d=>d.route==="staff-bank-wise-leads"||d.menu_code&&(d.menu_code.toUpperCase().includes("BANK_WISE_LEADS")||d.menu_code.toUpperCase().includes("FIELD_SALES"))))c.items.push({menu_code:"MNR_BANK_WISE_LEADS",label:'<i class="fas fa-users-gear" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Field Sales',route:"staff-bank-wise-leads"});else for(const d of c.items)(d.route==="staff-bank-wise-leads"||d.menu_code&&(d.menu_code.toUpperCase().includes("BANK_WISE_LEADS")||d.menu_code.toUpperCase().includes("FIELD_SALES")))&&(d.label='<i class="fas fa-users-gear" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Field Sales');const l=i.map(o=>a.get(o));l.sort((o,d)=>o.order-d.order);for(const o of l)o.section_code==="WORKFLOWS"&&o.items&&o.items.sort((d,m)=>(e[d.menu_code]||99)-(e[m.menu_code]||99)),o.section_code==="CRM_MODULE"&&o.items&&o.items.sort((d,m)=>(t[d.menu_code]||t[d.route]||99)-(t[m.menu_code]||t[m.route]||99));return l}open(){if(this.isOpen)return;A.getPortal()==="staff"&&!this.isStaffMenuLoaded&&this.loadStaffMenus(),this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden"}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let N=null;function W(){return N||(N=new K),N}class B{static render(e){let{title:t,showBack:a=!1,showLogout:i=!1,rightAction:n,subtitle:s,showMenu:c}=e;const l=A.getPortal(),o=k.getCurrentRoute(),d=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(o);if(c===void 0&&(c=d||!a),l==="vgk"&&(i=!0,!s)){const r=y.getAuthState().user||{},h=r.name||r.partner_name||"",p=r.partner_code||"";(h||p)&&(s=p?`${h} (${p})`:h)}return`
    ...
    `}static getPortalDashboard(){const e=A.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t,showBack:a=!1,rightAction:i,showLogout:n=!1}=e;t===void 0&&(t=!!document.getElementById("hamburgerBtn")),A.getPortal()==="vgk"&&(n=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{W().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{k.goBack()||k.navigate(B.getPortalDashboard())}),i&&document.getElementById("headerActionBtn")?.addEventListener("click",i.onClick),n&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await y.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{k.goBack()||k.navigate(B.getPortalDashboard())})}}class de{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
...
పై లింక్ ఓపెన్ చేసి మీ ఇంటి కరెంట్ బిల్లుకు సరిపోయే ప్లాన్ మరియు సేవింగ్స్ కాలిక్యులేట్ చేసుకోగలరు.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to calculate your recommended capacity, savings & instant quotation.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करें और अपनी मासिक बचत की गणना करें।`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
ఉచిత VIP సైట్ విజిట్ కోసం సంప్రదించండి.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Complimentary chauffeur AC cab pickup available for site visits!`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
ई-कॉमर्स पर प्लॉट्स देखें: https://www.myntreal.com/ecom?vertical=real-dreams`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
పై లింక్ క్లిక్ చేసి మోడల్-వైజ్ ధరలు, స్పెసిఫికేషన్లు & అధికారిక వీడియో చూడగలరు. ఉచిత టెస్ట్ డ్రైవ్ బుక్ చేసుకోండి!`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to explore model-wise prices, interactive savings calculator & official video showcase. Book your free test ride today!`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके मॉडल-वाइज कीमतें और वीडियो देखें। आज ही फ्री टेस्ट ड्राइव बुक करें!`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
పై లింక్ క్లిక్ చేసి B2B ఫ్లీట్ మోడల్స్ మరియు ROI కాలిక్యులేటర్ చూడండి.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to review vehicle specifications & calculate fleet ROI.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके कमर्शियल वाहन विवरण देखें।`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
24 గంటల్లో దేశవ్యాప్త డెలివరీ & అధికారిక GST ఇన్వాయిసింగ్.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Immediate 24-Hour Pan-India Dispatch | Full GST Invoicing.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
ई-कॉमर्स पर ऑर्डर करने के लिए: https://www.myntreal.com/ecom?vertical=ev&category=spares`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
పై లింక్ క్లిక్ చేసి సిలబస్ మరియు తదుపరి బ్యాచ్ వివరాలు చూడండి.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to view curriculum, batch dates & reserve your seat.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके बैच डेट्स और सीट रिजर्व करें।`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
மேலே உள்ள இணைப்பைக் கிளிக் செய்து பாடத்திட்டம் மற்றும் சேர்க்கை விவரங்களை அறிக.`}},insurance:{name:"Comprehensive Insurance Advisory",btnLabel:"Insurance",segmentSlug:"insurance",catalogSlug:"comprehensive-insurance-advisory",brochureUrl:"/public/hub/Assets/myntreal_insurance_guide.pdf",desc:"Sends Insurance catalog with complete risk protection for EV fleets, solar rooftop plants, health & life.",messages:{te:(u,e)=>`నమస్కారం ${u} గారు! 🙏
...
పై లింక్ ద్వారా ప్రీమియం కాలిక్యులేట్ చేసుకోండి మరియు తక్షణ పాలసీ పొందండి.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to calculate customized premiums and issue policies on spot.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके बीमा योजनाओं की तुलना करें और कोटेशन पाएं।`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
పై లింక్ క్లిక్ చేసి పూర్తి ప్రాస్పెక్టస్, ROI మోడల్ & వివరాలు చూడగలరు.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to review complete deliverables, financial models & territory rights.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके पूरी जानकारी और आरओआई मॉडल देखें।`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
పై లింక్ క్లిక్ చేసి పూర్తి హోల్‌సేల్ కాస్ట్ షీట్ & ROI వివరాలు వెంటనే చూడగలరు.`,en:(u,e)=>`Namaskaram ${u}! 🙏
...
Click the link above to review wholesale cost sheets & calculate your net returns.`,hi:(u,e)=>`नमस्ते ${u} जी! 🙏
...
कृपया तुरंत ऊपर दिए गए लिंक पर क्लिक करके पूरी कॉस्ट शीट देखें।`,ta:(u,e)=>`வணக்கம் ${u}! 🙏
...
మీకు అనుకూలమైన సమయంలో దయచేసి ఇక్కడ మెసేజ్ చేయండి లేదా కాల్ బ్యాక్ చేయగలరు!`}}applyVerticalQuick(e){const t=this.getVerticalQuickMessage(e),a=this.getSenderSignature(),i=document.getElementById("uwaMessageText");i&&(i.value=t+a,i.focus())}onDigitalCatalogSelect(e){e&&C[e]&&(this.selectedCatalogKey=e);const t=C[this.selectedCatalogKey]||C.solar,a=document.getElementById("uwaDigitalCatDesc");a&&(a.textContent=t.desc);const i=document.getElementById("uwaDigitalCatBtnLabel");i&&(i.textContent=`Insert Personalized ${t.btnLabel||t.name} Catalog Link`)}getDigitalCatalogMessage(e,t){const a=C[e]||C.solar,i=(this.currentOptions?.name||"Customer").trim();let n="https://www.myntreal.com";if(typeof window<"u"&&window.location&&window.location.origin){const d=window.location.origin;d.includes("localhost")||d.includes("127.0.0.1")||d.includes("0.0.0.0")||d.includes("192.168.")||d.includes("10.0.")||d.includes(":8000")||d.includes(":5000")||d.includes(":5173")||d.includes(":3000")||d.includes("capacitor")||(n=d)}let s=`${n}/catalog/${a.segmentSlug}/${a.catalogSlug}?lang=${encodeURIComponent(t||"te")}`;e==="hub_pricing"&&!s.includes("exp=")&&(s+=`&exp=${Math.floor(Date.now()/1e3)+86400}`);const c=(t||"te").toLowerCase(),l=a.messages&&a.messages[c]?a.messages[c]:a.messages&&a.messages.en;let o="";if(typeof l=="function"?o=l(i,s):o=`Namaskaram ${i}! Here is your catalog link:
👉 ${s}`,a.brochureUrl&&!o.includes(".pdf")){const d=a.brochureUrl.startsWith("http")?a.brochureUrl:n+(a.brochureUrl.startsWith("/")?"":"/")+a.brochureUrl;o+=`

${c==="te"?"📄 *అధికారిక PDF బ్రోచర్ (డైరెక్ట్ డౌన్‌లోడ్):*":c==="hi"?"📄 *आधिकारिक पीडीएफ ब्रोशर (डाउनलोड लिंक):*":c==="ta"?"📄 *அதிகாரப்பூர்வ PDF ப்ரோஷர் (பதிவிறக்கம்):*":"📄 *Official PDF Brochure (Direct Download):*"}
👉 ${d}`}return o}applyDigitalCatalog(e){e&&(this.selectedCatalogLang=e,this.modalEl?.querySelectorAll(".uwa-cat-lang-btn")?.forEach(c=>{const l=c.getAttribute("data-lang")===e;c.style.background=l?"#16a34a":"#fff",c.style.color=l?"#fff":"#334155",c.style.borderColor=l?"#16a34a":"#cbd5e1",c.style.fontWeight=l?"700":"600"}));const t=document.getElementById("uwaDigitalCatSel");t&&t.value&&(this.selectedCatalogKey=t.value);const a=this.getDigitalCatalogMessage(this.selectedCatalogKey,this.selectedCatalogLang),i=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=a+i,n.focus())}detectCatalogKey(){if(this.currentOptions?.catalogKey&&C[this.currentOptions.catalogKey])return this.currentOptions.catalogKey;const e=(this.currentOptions?.context||"").toLowerCase(),t=(this.currentOptions?.segment||"").toLowerCase();return e.includes("solar")||t==="solar"?"solar":e.includes("real")||e.includes("property")||e.includes("estate")||t==="myntreal_real"?"real_estate":e.includes("spare")||t==="ev_spares"?"ev_spares":e.includes("cargo")||e.includes("fleet")||e.includes("b2b")||t==="ev_b2b"?"ev_b2b":e.includes("ev")||e.includes("zynova")||e.includes("vehicle")||t==="ev_b2c"?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")||t==="etc_training"?"etc_training":e.includes("insur")||e.includes("policy")||e.includes("care")?"insurance":e.includes("pricing")||e.includes("margin")||e.includes("commercial")||t==="hub_pricing"?"hub_pricing":e.includes("hub")||e.includes("franchise")?"industrial_hub":"solar"}async loadCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;t.innerHTML='<option value="">— Loading templates… —</option>',a&&(a.style.display="none");const i=this.activeMode==="scanned"?"scanned":"company";let n=`/whatsapp-config/templates?mode=${encodeURIComponent(i)}`;try{const s=await S.get(n),c=s?.templates||s?.data||s||[];this.allCanonicalTemplates=Array.isArray(c)?c:[],this.filterCanonicalTemplates(e)}catch{t.innerHTML='<option value="">— Error loading templates —</option>'}}filterCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;const i=document.getElementById("uwaCanonicalSeg"),n=document.getElementById("uwaCanonicalCat"),s=document.getElementById("uwaCanonicalSearch"),c=(i?.value||"").toLowerCase().trim(),l=(n?.value||"").toUpperCase().trim(),o=(s?.value||"").toLowerCase().trim();let d=this.allCanonicalTemplates||[];if(c&&(d=d.filter(r=>(r.segment||"").toLowerCase()===c)),l&&(d=d.filter(r=>(r.category||"").toUpperCase()===l)),o&&(d=d.filter(r=>{const h=(r.template_name||r.name||"").toLowerCase(),p=(r.body_text||r.content||r.body||"").toLowerCase(),g=(r.slug||"").toLowerCase();return h.includes(o)||p.includes(o)||g.includes(o)})),this.canonicalTemplates=d,!d.length){t.innerHTML=`
      ...
      `,a&&(a.style.display="block"),this.onCanonicalTplChange();return}a&&(a.style.display="none");let m=`<option value="">— Select template (${d.length} available) —</option>`;m+='<option value="__create_new__" style="color:#16a34a; font-weight:700;">➕ Create / Add Template for this Segment...</option>',d.forEach(r=>{const h=r.segment?`[${r.segment}] `:"";m+=`<option value="${r.id}">${h}${this.escapeHtml(r.template_name||r.name||"Template #"+r.id)} (${r.category||"MARKETING"})</option>`}),t.innerHTML=m,e&&(t.value=String(e),this.onCanonicalTplChange())}toggleAddTemplateCard(e){const t=document.getElementById("uwaAddTplCard");if(!t)return;const a=t.style.display!=="none",i=e!==void 0?e:!a;if(t.style.display=i?"block":"none",i){const n=document.getElementById("uwaCanonicalSeg")?.value||this.detectSegment(),s=document.getElementById("uwaNewTplSeg");s&&n&&(s.value=n),document.getElementById("uwaNewTplName")?.focus()}}async saveNewTemplate(){const e=document.getElementById("uwaNewTplName"),t=document.getElementById("uwaNewTplSeg"),a=document.getElementById("uwaNewTplBody"),i=document.getElementById("uwaSaveNewTplBtn"),n=(e?.value||"").trim(),s=t?.value||"general",c=(a?.value||"").trim();if(!n){this.showFeedback("Please enter a template name.","error");return}if(!c){this.showFeedback("Please enter the template message body.","error");return}i&&(i.disabled=!0);const l=n.toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,40);try{const o=await S.post("/whatsapp-config/templates",{name:n,slug:l,category:"MARKETING",segment:s,body_text:c,language:"en",usage_scope:"all"});if(o?.success){this.showFeedback(`✅ Template "${n}" created & approved for WhatsApp API!`,"success"),this.toggleAddTemplateCard(!1),e&&(e.value=""),a&&(a.value="");const d=document.getElementById("uwaCanonicalSeg");d&&(d.value=s);const m=o.template?.id||o.id||l;await this.loadCanonicalTemplates(m)}else this.showFeedback(o?.error||"Failed to create template","error")}catch(o){this.showFeedback(`Error creating template: ${o.message||"Server error"}`,"error")}finally{i&&(i.disabled=!1)}}detectSegment(){if(this.currentOptions?.segment)return this.currentOptions.segment;const e=(this.currentOptions?.context||"").toLowerCase();return e.includes("solar")?"solar":e.includes("real")||e.includes("property")||e.includes("estate")?"myntreal_real":e.includes("spare")?"EV_SPARES":e.includes("ev")||e.includes("vehicle")||e.includes("zynova")?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")?"etc_training":e.includes("partner")?"partner":e.includes("staff")?"staff":e.includes("vgk")?"vgk":"general"}onCanonicalTplChange(){const e=document.getElementById("uwaCanonicalTpl"),t=document.getElementById("uwaCanonicalVarsWrap"),a=document.getElementById("uwaCanonicalVarsBox"),i=e?.value;if(i==="__create_new__"){this.toggleAddTemplateCard(!0),e.value="";return}if(!i){t&&(t.style.display="none"),a&&(a.innerHTML="");return}const n=this.canonicalTemplates.find(l=>String(l.id)===String(i)||String(l.slug)===String(i));if(!n)return;this.selectedCanonicalBody=n.body_text||n.content||n.body||"";const s=this.selectedCanonicalBody.match(/\{\{(\d+)\}\}/g)||[],c=[];if(s.forEach(l=>{const o=l.replace(/[\{\}]/g,"");c.includes(o)||c.push(o)}),c.sort((l,o)=>Number(l)-Number(o)),c.length&&a&&t){t.style.display="block";let l="";c.forEach(o=>{const d=o==="1"&&this.currentOptions?.name||"";l+=`
          <div style="display:flex; align-items:center; gap:8px; margin-bottom:6px;">
            <label style="font-size:11px; font-weight:700; width:28px; color:#475569;">#${o}</label>
            <input type="text" class="uwa-canonical-var-inp" data-var-idx="${o}" value="${this.escapeHtml(d)}" placeholder="Value for {{${o}}}" style="flex:1; font-size:12px; border:1px solid #cbd5e1; border-radius:6px; padding:4px 8px;" />
          </div>
        `}),a.innerHTML=l,a.querySelectorAll(".uwa-canonical-var-inp").forEach(o=>{o.addEventListener("input",()=>this.buildCanonicalPreview())})}else t&&(t.style.display="none"),a&&(a.innerHTML="");this.buildCanonicalPreview()}buildCanonicalPreview(){let e=this.selectedCanonicalBody||"";(e.match(/\{\{(\d+)\}\}/g)||[]).forEach(n=>{const s=n.replace(/[\{\}]/g,""),l=document.querySelector(`.uwa-canonical-var-inp[data-var-idx="${s}"]`)?.value||`{{${s}}}`;e=e.replace(new RegExp(`\\{\\{${s}\\}\\}`,"g"),l)});const a=this.getSenderSignature(),i=document.getElementById("uwaMessageText");i&&e&&(i.value=e+a)}open(e){this.currentOptions=e,this.activeMode="meta_api",this.render()}close(){this.modalEl&&(this.modalEl.remove(),this.modalEl=null)}render(){if(this.close(),!this.currentOptions)return;const{phone:e,name:t,context:a,defaultMessage:i,catalogKey:n}=this.currentOptions,s=(e||"").replace(/\D/g,"").slice(-10),c=this.getSenderSignature(),l=(i||(n?this.getDigitalCatalogMessage(n,this.selectedCatalogLang):this.getVerticalQuickMessage("thanks_connecting")))+c;this.modalEl=document.createElement("div"),this.modalEl.id="unifiedWAModal",this.modalEl.className="uwa-modal-backdrop",this.modalEl.innerHTML=`
      <div class="uwa-modal-sheet">
        ...
        <div class="uwa-chips-row">
          ${Object.entries(P).map(([h,p])=>`
            <button class="uwa-chip-btn" data-tpl-key="${h}">
              ${p.label}
            </button>
          `).join("")}
        </div>
        ...
        <textarea id="uwaMessageText" class="uwa-textarea" rows="7" placeholder="Type your WhatsApp message...">${this.escapeHtml(l)}</textarea>
...
`);e.textContent=h}async executeShare(e){const t=document.getElementById("usmStaffSelect"),a=parseInt(t?.value||"0",10);if(!a){alert("Please select a staff member to share details with."),t?.focus();return}const i=this.staffList.find(r=>r.id===a);if(!i){alert("Selected staff member is invalid.");return}const n=document.getElementById("usmFollowupType")?.value||"secondary_followup",s=document.getElementById("usmNotes")?.value.trim()||"",c=document.getElementById("usmAssignCheck")?.checked||!1,l=this.currentOptions;if(!l)return;const o=document.getElementById("usmCombinedBtn"),d=document.getElementById("usmCrmOnlyBtn"),m=document.getElementById("usmWaOnlyBtn");[o,d,m].forEach(r=>{r&&(r.disabled=!0)});try{let r="",h="";if(e==="crm_only"||e==="combined"||c){const g={target_staff_id:a,followup_type:n,notes:s,assign_as_secondary:c},b=await S.post(`/crm/leads/${l.leadId}/share-details`,g);if(b&&b.success)r=b.wa_url||"",h=b.wa_message||"",l.onShared&&l.onShared(b);else throw new Error(b?.detail||b?.message||"Failed to assign lead in CRM")}if(e==="wa_only"||e==="combined"){if(!r){const g=(i.phone||"").replace(/\D/g,"").slice(-10);if(!g)alert(`Colleague ${i.name} does not have a valid mobile number for WhatsApp.`);else{const b=document.getElementById("usmMessagePreview")?.textContent||"";r=`https://wa.me/91${g}?text=${encodeURIComponent(b)}`}}r&&window.open(r,"_blank")}const p=e==="crm_only"?`Lead successfully assigned to ${i.name} in CRM!`:e==="wa_only"?`WhatsApp launched for ${i.name}!`:`Lead assigned in CRM and WhatsApp opened for ${i.name}!`;alert(`✅ ${p}`),this.close()}catch(r){console.error("[UnifiedShareLeadModal] Share failed:",r),alert(`⚠️ Could not complete lead share: ${r.message||r}`)}finally{[o,d,m].forEach(r=>{r&&(r.disabled=!1)})}}}const pe=new q,Y=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],Z=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],X=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class Q{container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("mnrDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;k.navigate(t),this.close()})}),document.getElementById("mnrLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await y.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const ue=new Q;class me{config;constructor(e){this.config=e}render(){if(this.config.loading)return`
      ...
      `;const e=i=>this.config.sortColumn===i?this.config.sortDirection==="asc"?" ↑":" ↓":"",t=this.config.columns.map(i=>{const n=i.sortable!==!1,s=e(i.key),c=i.width?`width: ${i.width};`:"",l=n?`data-sort-column="${i.key}"`:"";return`<th style="${c}${n?"cursor: pointer;":""}" ${l}>${i.label}${s}</th>`}).join(""),a=this.config.data.map(i=>`<tr>${this.config.columns.map(s=>{const c=i[s.key];return`<td>${s.render?s.render(c,i):c??"-"}</td>`}).join("")}</tr>`).join("");return`
    ...
    `,document.head.appendChild(e)}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',package:'<line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/>',tool:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||this.user?.partner_name||"Partner",t=this.user?.partner_id||this.user?.partner_code||"PARTNER",a=this.user?.partner_type||this.user?.type||"Partner";return`
      ...
      <div class="partner-drawer-content">
        ...
        ${ee.map(n=>this.renderSection(n)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("partnerDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;k.navigate(t),this.close()})}),document.getElementById("partnerLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await y.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const ge=new te;class fe{container;constructor(e){this.container=e}render(){const t=y.getAuthState().user?.portal||"staff",a=k.getTabRoutes(t),i=k.getCurrentRoute();this.container.innerHTML=`
    ...
    `,this.attachListeners()}attachListeners(){this.container.querySelectorAll(".tab-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-route");t&&k.navigate(t)})})}getIcon(e){const t={home:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      </svg>`};return t[e]||t.home}}class ae{isShowing=!1;unsubscribe=null;checkInterval=null;init(){this.unsubscribe&&this.unsubscribe(),this.checkInterval&&clearInterval(this.checkInterval),this.unsubscribe=S.onSessionExpired(e=>{console.log("[SessionBanner] Session expired detected, endpoint:",e),y.getAuthState().isLoggedIn&&this.show()}),this.checkInterval=setInterval(()=>{if(!y.getAuthState().isLoggedIn){this.isShowing&&this.hide();return}const t=U.getTrackingStatus();t.isSessionExpired&&!this.isShowing?this.show():!t.isSessionExpired&&this.isShowing&&this.hide()},2e3)}cleanup(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null),this.hide()}show(){if(!y.getAuthState().isLoggedIn||this.isShowing||document.getElementById("globalSessionBanner"))return;this.isShowing=!0;const e=document.createElement("div");e.id="globalSessionBanner",e.className="global-session-banner",e.innerHTML=`
