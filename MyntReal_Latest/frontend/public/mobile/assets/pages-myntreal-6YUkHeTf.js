import{b as i}from"./services-9VcN4JBG.js";import{P as s}from"./components-B2-g8MlQ.js";class l{container;properties=[];loading=!0;filter="all";constructor(t){this.container=t}async init(){this.render(),await this.loadProperties()}async loadProperties(){this.loading=!0,this.updateContent();try{const t=await i.get("/real-dreams/public/listings");t.success&&t.data&&(this.properties=t.data.properties||t.data||[])}catch(t){console.error("[MyntRealProperties] Failed to load:",t)}this.loading=!1,this.updateContent()}render(){this.container.innerHTML=`
