...
import{l as x,d as m,r as g,b as w}from"./services-DWLf0qYm.js";import{L as f}from"./vendor-B1GRRwIS.js";import{_ as S}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as R}from"./services-gps-CtY7ru9J.js";const A={"/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"staff-task-tracker","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"staff-leads","/staff/real-dreams-leads":"zynova-real-estate","/staff/insurance-leads":"zynova-insurance","/staff/ev-b2b-leads":"staff-leads","/staff/ev-b2c-leads":"staff-leads","/staff/ev-spares-leads":"staff-leads","/staff/etc-leads":"staff-training-videos","/staff/mnr-leads":"staff-leads","/staff/mnr-leads-master":"staff-leads","/staff/executive-dashboard":"dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"softphone","/staff/softphone":"softphone","/staff/calling-page":"softphone","/staff/calling":"softphone","/staff/phone-dialpad":"softphone","/staff/softphone-hub":"softphone","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},C=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],T=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],M=[{section_code:"ATTENDANCE",section_label:"ATTENDANCE",order:1,items:[{menu_code:"IN_OUT_TIME",label:"In/Out Time",route:"attendance"},{menu_code:"MY_LEAVES",label:"My Leaves",route:"leaves"},{menu_code:"LEAVE_APPROVALS",label:"Leave Approvals",route:"staff-leave-approvals"},{menu_code:"IN_OUT_RECORDS_ADMIN",label:"In/Out Records - Admin",route:"team-attendance"},{menu_code:"ATTENDANCE_RECORDS",label:"Attendance Records",route:"staff-attendance-sheet"},{menu_code:"ATTENDANCE_DASHBOARD",label:"Attendance Dashboard",route:"staff-attendance-reports"},{menu_code:"EXCEPTION_APPROVALS",label:"Exception Approvals",route:"staff-attendance-exceptions"},{menu_code:"ATTENDANCE_COMPUTATION",label:"Attendance Computation",route:"staff-attendance-computation"}]},{section_code:"TASK_MANAGEMENT",section_label:"TASK MANAGEMENT",order:3,items:[{menu_code:"ASSIGNED_BY_ME",label:"Assigned By Me",route:"tasks-assigned"},{menu_code:"ASSIGNED_TO_ME",label:"Assigned To Me",route:"tasks-received"},{menu_code:"TEAM_ACTIVITIES",label:"Team Activities",route:"staff-team-activities"},{menu_code:"TASK_TRACKER",label:"Task Dashboard",route:"staff-task-tracker"},{menu_code:"TASK_REVIEWS",label:"Task Reviews",route:"staff-task-reviews"}]},{section_code:"KRA_MANAGEMENT",section_label:"KRA MANAGEMENT",order:4,items:[{menu_code:"MY_KRAS",label:"My KRAs",route:"kras"},{menu_code:"KRA_TEMPLATES",label:"KRA Templates",route:"staff-kra-templates"},{menu_code:"KRA_TRACKING_SHEET",label:"KRA Tracking Sheet",route:"staff-kra-tracking"},{menu_code:"KRA_REVIEW",label:"KRA Review",route:"staff-kra-review"}]},{section_code:"TIMESHEET",section_label:"TIMESHEET",order:5,items:[{menu_code:"MY_TIMESHEET",label:"My Timesheet",route:"timesheet"},{menu_code:"TIMESHEET_APPROVAL",label:"Timesheet Approval",route:"staff-timesheet-approval"}]},{section_code:"JOURNEY_TRACKING",section_label:"JOURNEY TRACKING",order:6,items:[{menu_code:"MY_JOURNEYS",label:"My Journeys",route:"journeys"},{menu_code:"TEAM_JOURNEYS",label:"Team Journeys",route:"team-journeys"},{menu_code:"ALL_JOURNEYS",label:"All Journeys",route:"staff-all-journeys"},{menu_code:"VGK4U_JOURNEYS",label:"VGK4U Journeys",route:"staff-vgk4u-journeys"}]},{section_code:"REIMBURSEMENT",section_label:"REIMBURSEMENT",order:7,items:[{menu_code:"MY_REIMBURSEMENT_CLAIMS",label:"My Reimbursement Claims",route:"reimbursements"},{menu_code:"REIMBURSEMENT_APPROVALS",label:"Reimbursement Approvals",route:"staff-reimbursement-approvals"}]},{section_code:"ACCOUNTS_EARNINGS",section_label:"FINANCE & EARNINGS",order:8,items:[{menu_code:"MY_EARNINGS",label:"My Earnings",route:"staff-my-incentives"},{menu_code:"PAYROLL_PROFILE",label:"Payroll Profile",route:"staff-payroll-profile"},{menu_code:"SALARY_SLIPS",label:"Salary Slips",route:"staff-salary-slips"}]},{section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:9,items:[{menu_code:"MY_LEADS",label:"My Leads",route:"staff-my-leads"},{menu_code:"LEADS_MASTER",label:"Leads Master",route:"staff-leads"},{menu_code:"BANK_WISE_LEADS",label:"Field staff leads",route:"staff-bank-wise-leads"},{menu_code:"TEAM_LEADS",label:"Team Leads",route:"staff-team-leads"},{menu_code:"AUTO_DIALER",label:"Auto Dialer",route:"auto-dialer"}]},{section_code:"WORKFLOWS",section_label:"WORK FLOWS",order:10,items:[{menu_code:"MNR_BANK_WISE_LEADS",label:"Field Sales",route:"staff-bank-wise-leads"},{menu_code:"SOLAR_LEADS",label:"Solar Leads",route:"staff-leads"},{menu_code:"ZYN_REAL_ESTATE",label:"Real Dreams Leads",route:"zynova-real-estate"},{menu_code:"EV_B2B_LEADS",label:"EV B2B Leads",route:"staff-leads"},{menu_code:"EV_B2C_LEADS",label:"EV B2C Leads",route:"staff-leads"},{menu_code:"EV_SPARES_LEADS",label:"EV Spares Leads",route:"staff-leads"},{menu_code:"ZYN_INSURANCE",label:"Insurance Leads",route:"zynova-insurance"},{menu_code:"ETC_LEADS",label:"ETC Leads",route:"staff-training-videos"},{menu_code:"MNR_LEADS",label:"MNR Leads",route:"staff-leads"},{menu_code:"EXECUTIVE_DASHBOARD",label:"Executive Dashboard",route:"dashboard"},{menu_code:"CATEGORY_LEADS_MASTER",label:"Category Leads Master",route:"staff-leads"}]},{section_code:"OPERATIONS",section_label:"OPERATIONS",order:11,items:[{menu_code:"CALL_TRACKING",label:"Call Tracking",route:"staff-call-tracking"},{menu_code:"VENDORS",label:"Vendors",route:"staff-vendors"},{menu_code:"ZYN",label:"Zynova Real Estate",route:"zynova-real-estate"},{menu_code:"ZYNOVA",label:"VGK4U",route:"staff-zynova"},{menu_code:"ZYN_INSURANCE",label:"Zynova Insurance",route:"zynova-insurance"}]}],B=[];class P{container=null;overlay=null;isOpen=!1;expandedSections=new Set;staffMenuTree=null;isStaffMenuLoaded=!1;constructor(){try{const e=localStorage.getItem("mnr_staff_menu_tree_cache");e&&(this.staffMenuTree=JSON.parse(e),this.isStaffMenuLoaded=!0)}catch{}this.createElements(),this.loadStaffMenus(),window.addEventListener("logout",()=>{this.staffMenuTree=null,this.isStaffMenuLoaded=!1;try{localStorage.removeItem("mnr_staff_menu_tree_cache")}catch{}}),window.addEventListener("auth-changed",()=>{this.loadStaffMenus()})}createElements(){if(this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),!document.getElementById("myntos-drawer-styles")){const e=document.createElement("style");e.id="myntos-drawer-styles",e.textContent=`
      ...
      `,document.head.appendChild(e)}this.attachEventListeners()}render(){const e=x.getPortal(),t=e==="vgk";let a=C;if(t)a=T;else if(e==="staff"){const o=m.getAuthState().user||{},r=(o.role_code||o.role?.role_code||"").toString().toLowerCase().trim(),l=(o.role_name||o.role?.role_name||"").toString().toUpperCase().trim(),c=(o.staff_type||"").toString().toUpperCase().trim(),i=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(r)||r.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(l)||l.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(c);o.staff_type==="FREELANCER"&&o.freelancer_access_mode==="only_leads"?a=[]:a=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...i?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-phone-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling Page',route:"softphone"}]}const s=t?B:e==="staff"?this.getStaffMenuMaster():M;return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab;a?g.navigate(t,{tab:a}):g.navigate(t),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await m.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){try{const e=await w.get("/staff/menu-settings/my-menus?unified=true");if(e.success&&e.data&&e.data.sidebar_tree){this.staffMenuTree=e.data.sidebar_tree,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_menu_tree_cache",JSON.stringify(this.staffMenuTree))}catch{}this.updateUI()}}catch(e){console.error("Failed to load dynamic staff menus:",e)}}getStaffMenuMaster(){if(!this.staffMenuTree)return M;const e={EXECUTIVE_DASHBOARD:1,staff_executive_dashboard:1,mnr_executive_dashboard:1,MNR_BANK_WISE_LEADS:2,BANK_WISE_LEADS:2,staff_bank_wise_leads:2,CATEGORY_LEADS_MASTER:3,mnr_leads_master:3,staff_mnr_leads_master:3,SOLAR_LEADS:4,staff_solar_leads:4,mnr_solar_leads:4,EV_B2B_LEADS:5,staff_ev_b2b_leads:5,mnr_ev_b2b_leads:5,EV_B2C_LEADS:6,staff_ev_b2c_leads:6,mnr_ev_b2c_leads:6,EV_SPARES_LEADS:7,staff_ev_spares_leads:7,mnr_ev_spares_leads:7,ZYN_REAL_ESTATE:8,staff_real_dreams_leads:8,mnr_real_dreams_leads:8,ZYN_INSURANCE:9,staff_insurance_leads:9,mnr_insurance_leads:9,ETC_LEADS:10,staff_etc_leads:10,mnr_etc_leads:10,MNR_LEADS:11,staff_mnr_leads:11,mnr_category_leads:11,AUTO_DIALER:12,staff_auto_dialer:12,"auto-dialer":12},t=new Map,a=[],s=(r,l,c,i)=>{const u=A[c]||A[c?.replace(/\/$/,"")]||(c?c.replace(/^\/staff\//,"").replace(/\//g,"-"):null);if(!u)return null;let d=l;(!d||d==="None"||d.trim()==="")&&(d=(r||"").replace(/^staff_|^_staff_|^mnr_/i,"").replace(/_/g," ").replace(/\b\w/g,I=>I.toUpperCase()));const p=(r||"").toUpperCase(),h=(c||"").toLowerCase();p.includes("AUTO_DIALER")||h.includes("auto-dialer")||p==="AUTO_DIALER"?d="Auto Dialer":p.includes("BANK_WISE_LEADS")||h.includes("bank-wise-leads")?d="Field staff leads":p.includes("REAL_DREAMS")||h.includes("real-dreams-leads")?d="Real Dreams Leads":p.includes("ETC_LEADS")||h.includes("etc-leads")?d="ETC Training Students":p.includes("CATEGORY_LEADS_MASTER")||p.includes("MNR_LEADS_MASTER")||h.includes("mnr-leads-master")?d="Category Lead Master":p.includes("WHATSAPP")||h.includes("whatsapp")?d="WhatsApp Center":(p.includes("SOFTPHONE")||p.includes("DIALER")||h.includes("softphone")||h.includes("dialer"))&&(d="Calling & Softphone");const v=i||(d.includes("WhatsApp")?"fab fa-whatsapp":d.includes("Auto Dialer")?"fas fa-phone-volume":d.includes("Softphone")||d.includes("Calling")?"fas fa-headset":d.includes("Field")?"fas fa-users-gear":"fas fa-file-alt"),y=d.includes("WhatsApp")?"color: #25d366;":d.includes("Auto Dialer")||d.includes("Softphone")||d.includes("Calling")?"color: #38bdf8;":"",L=`<i class="${v}" style="margin-right: 8px; width: 18px; text-align: center; ${y}"></i>`;return{menu_code:r,label:`${L}${d}`,route:u}};for(const r of this.staffMenuTree){if(r.id==="progress"||r.section_id==="progress"||(r.title||"").toUpperCase()==="PROGRESS")continue;const l=[],c=[];if(r.items)for(const i of r.items){const u=s(i.menu_code,i.menu_name||i.label||i.name||i.title,i.route_path,i.menu_icon);u&&l.push(u)}if(r.subSections)for(const i of r.subSections){const u=[];if(i.items)for(const p of i.items){const h=s(p.menu_code,p.menu_name||p.label||p.name||p.title,p.route_path,p.menu_icon);h&&u.push(h)}let d=i.title||i.name||i.id||"Subsection";(d==="None"||!d)&&(d=(i.id||"").replace(/^staff_|^vm_/i,"").replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase())),u.length>0&&c.push({sub_section_code:i.id||i.section_id||"sub",sub_section_label:d,items:u})}if(l.length>0||c.length>0){let i=(r.id||r.section_id||"other").toString().trim(),u=(r.title||r.name||"Other").toString().trim();(u==="None"||!u)&&(u=i.replace(/_/g," ").replace(/\b\w/g,h=>h.toUpperCase()));const d=i.toLowerCase(),p=u.toUpperCase();if((d==="mynt_real"||d==="myntreal"||d==="workflows"||p==="MYNT REAL"||p==="MYNTREAL"||p==="WORK FLOWS"||p==="WORKFLOWS")&&(i="WORKFLOWS",u="WORK FLOWS"),t.has(i)){const h=t.get(i);if(l.length>0){h.items=h.items||[];const v=new Set(h.items.map(y=>y.menu_code));for(const y of l)v.has(y.menu_code)||(h.items.push(y),v.add(y.menu_code))}c.length>0&&(h.subSections=h.subSections||[],h.subSections.push(...c))}else a.push(i),t.set(i,{section_code:i,section_label:u,order:r.order!==void 0?r.order:999,items:l.length>0?l:void 0,subSections:c.length>0?c:void 0})}}let n=t.get("CRM_MODULE")||t.get("CRM_LEADS")||t.get("WORKFLOWS");n&&(n.items=n.items||[],n.items.some(l=>l.route==="auto-dialer"||l.menu_code==="AUTO_DIALER")||n.items.push({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"auto-dialer"}));const o=a.map(r=>t.get(r));o.sort((r,l)=>r.order-l.order);for(const r of o)r.section_code==="WORKFLOWS"&&r.items&&r.items.sort((l,c)=>(e[l.menu_code]||99)-(e[c.menu_code]||99));return o}open(){if(this.isOpen)return;this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden",x.getPortal()==="staff"&&this.loadStaffMenus()}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let _=null;function N(){return _||(_=new P),_}class E{static render(e){let{title:t,showBack:a=!1,showLogout:s=!1,rightAction:n,subtitle:o,showMenu:r}=e;const l=x.getPortal(),c=g.getCurrentRoute(),i=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(c);if(r===void 0&&(r=i||!a),l==="vgk"&&(s=!0,!o)){const d=m.getAuthState().user||{},p=d.name||d.partner_name||"",h=d.partner_code||"";(p||h)&&(o=h?`${p} (${h})`:p)}return`
    ...
    `}static getPortalDashboard(){const e=x.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t=!1,showBack:a=!1,rightAction:s,showLogout:n=!1}=e;x.getPortal()==="vgk"&&(n=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{N().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{g.goBack()||g.navigate(E.getPortalDashboard())}),s&&document.getElementById("headerActionBtn")?.addEventListener("click",s.onClick),n&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await m.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{g.goBack()||g.navigate(E.getPortalDashboard())})}}class J{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
      ...
      `}
    `,this.addStyles(),this.attachEventListeners())}initMap(){if(this.trackPoints.length===0||!document.getElementById("leafletMapView"))return;const t=this.trackPoints[0];this.map=f.map("leafletMapView",{zoomControl:!1,attributionControl:!1}).setView([t.latitude,t.longitude],14),f.control.zoom({position:"topright"}).addTo(this.map),this.tileLayers={street:f.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{maxZoom:19}),satellite:f.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",{maxZoom:19}),terrain:f.tileLayer("https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png",{maxZoom:17})},this.tileLayers.street.addTo(this.map),this.drawRoute(),this.fitBounds()}drawRoute(){if(!this.map||this.trackPoints.length<2)return;const e=this.trackPoints.map(l=>[l.latitude,l.longitude]);this.routeLine=f.polyline(e,{color:"rgba(255,255,255,0.3)",weight:4,dashArray:"8, 8"}).addTo(this.map),this.progressLine=f.polyline([],{color:"#00d09c",weight:5,lineCap:"round",lineJoin:"round"}).addTo(this.map);const t=f.divIcon({className:"custom-marker start-marker",html:'<div class="marker-inner">S</div>',iconSize:[28,28],iconAnchor:[14,14]}),a=f.divIcon({className:"custom-marker end-marker",html:'<div class="marker-inner">E</div>',iconSize:[28,28],iconAnchor:[14,14]}),s=this.trackPoints[0],n=s.battery_percentage!==void 0?`<br>🔋 ${s.battery_percentage}%`:"";this.startMarker=f.marker([s.latitude,s.longitude],{icon:t}).bindPopup(`<b>Start Point</b><br>${s.address||"Journey Start"}${n}`).addTo(this.map);const o=this.trackPoints[this.trackPoints.length-1],r=o.battery_percentage!==void 0?`<br>🔋 ${o.battery_percentage}%`:"";this.endMarker=f.marker([o.latitude,o.longitude],{icon:a}).bindPopup(`<b>End Point</b><br>${o.address||"Journey End"}${r}`).addTo(this.map),this.stops.forEach((l,c)=>{const i=this.trackPoints[l.startIndex];if(i){const u=f.divIcon({className:"custom-marker stop-marker",html:`<div class="marker-inner">${c+1}</div>`,iconSize:[24,24],iconAnchor:[12,12]}),d=f.marker([i.latitude,i.longitude],{icon:u}).bindPopup(`<b>Stop ${c+1}</b><br>${l.address||"Unknown location"}<br>Duration: ${this.formatDuration(l.durationMinutes)}`).addTo(this.map);this.stopMarkers.push(d)}}),this.currentMarker=f.circleMarker([s.latitude,s.longitude],{radius:10,color:"#fff",weight:3,fillColor:"#ffc107",fillOpacity:1}).addTo(this.map)}fitBounds(){!this.map||!this.routeLine||this.map.fitBounds(this.routeLine.getBounds(),{padding:[30,30]})}switchView(e){!this.map||this.currentView===e||(this.tileLayers[this.currentView].remove(),this.tileLayers[e].addTo(this.map),this.currentView=e,document.querySelectorAll(".view-btn").forEach(t=>{t.classList.toggle("active",t.getAttribute("data-view")===e)}),this.onViewChange&&this.onViewChange(e))}attachEventListeners(){document.querySelectorAll(".view-btn").forEach(t=>{t.addEventListener("click",()=>{const a=t.getAttribute("data-view");this.switchView(a)})}),document.getElementById("playPauseBtn")?.addEventListener("click",()=>this.togglePlayback()),document.getElementById("resetPlayback")?.addEventListener("click",()=>this.resetPlayback());const e=document.getElementById("playbackSlider");e?.addEventListener("input",()=>{this.playbackIndex=parseInt(e.value),this.updatePlaybackUI()}),document.getElementById("speedBtn")?.addEventListener("click",()=>this.cycleSpeed())}togglePlayback(){const e=document.getElementById("playPauseBtn");this.isPlaying?(this.stopPlayback(),e&&(e.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>',e.classList.remove("pause"),e.classList.add("play"))):(this.startPlayback(),e&&(e.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',e.classList.remove("play"),e.classList.add("pause"))),this.isPlaying=!this.isPlaying}startPlayback(){const e=500/this.playbackSpeed;this.playbackInterval=setInterval(()=>{if(this.playbackIndex<this.trackPoints.length-1)this.playbackIndex++,this.updatePlaybackUI();else{this.stopPlayback(),this.isPlaying=!1;const t=document.getElementById("playPauseBtn");t&&(t.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>',t.classList.remove("pause"),t.classList.add("play"))}},e)}stopPlayback(){this.playbackInterval&&(clearInterval(this.playbackInterval),this.playbackInterval=null)}resetPlayback(){this.stopPlayback(),this.playbackIndex=0,this.isPlaying=!1;const e=document.getElementById("playPauseBtn");e&&(e.innerHTML='<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>',e.classList.remove("pause"),e.classList.add("play")),this.updatePlaybackUI()}cycleSpeed(){const e=[1,2,4,8],t=e.indexOf(this.playbackSpeed);this.playbackSpeed=e[(t+1)%e.length];const a=document.getElementById("speedBtn");a&&(a.textContent=`${this.playbackSpeed}x`),this.isPlaying&&(this.stopPlayback(),this.startPlayback())}updatePlaybackUI(){const e=document.getElementById("playbackSlider"),t=document.getElementById("playbackCounter"),a=document.getElementById("currentLocation"),s=document.getElementById("sliderProgress");e&&(e.value=String(this.playbackIndex)),t&&(t.textContent=`${this.playbackIndex+1} / ${this.trackPoints.length}`);const n=this.trackPoints[this.playbackIndex];a&&n&&(n.address?a.textContent=n.address:(a.textContent="Loading...",this.reverseGeocodeForPlayback(n.latitude,n.longitude,a)));const o=this.playbackIndex/(this.trackPoints.length-1)*100;if(s&&(s.style.width=`${o}%`),this.currentMarker&&n&&this.currentMarker.setLatLng([n.latitude,n.longitude]),this.progressLine){const r=this.trackPoints.slice(0,this.playbackIndex+1).map(l=>[l.latitude,l.longitude]);this.progressLine.setLatLngs(r)}this.map&&n&&this.map.panTo([n.latitude,n.longitude],{animate:!0,duration:.3})}async reverseGeocodeForPlayback(e,t,a){const s=`${e.toFixed(4)},${t.toFixed(4)}`;if(this.addressCache.has(s)){a.textContent=this.addressCache.get(s);return}try{const n=`https://nominatim.openstreetmap.org/reverse?format=json&lat=${e}&lon=${t}&zoom=18`,o=await fetch(n,{headers:{"User-Agent":"MyntReal-Mobile/1.0"}});if(o.ok){const l=(await o.json()).address||{},c=[];for(const u of["road","neighbourhood","suburb","city","town","village"])if(l[u]&&(c.push(l[u]),c.length>=2))break;const i=c.length>0?c.join(", "):`${e.toFixed(4)}, ${t.toFixed(4)}`;this.addressCache.set(s,i),a.textContent==="Loading..."&&(a.textContent=i)}}catch(n){console.warn("[DC_GEOCODE] Playback geocode failed:",n),a.textContent==="Loading..."&&(a.textContent=`${e.toFixed(4)}, ${t.toFixed(4)}`)}}formatDuration(e){if(e<60)return`${Math.round(e)}m`;const t=Math.floor(e/60),a=Math.round(e%60);return a>0?`${t}h ${a}m`:`${t}h`}addStyles(){if(document.getElementById("leaflet-journey-map-styles"))return;const e=document.createElement("style");e.id="leaflet-journey-map-styles",e.textContent=`
      .leaflet-journey-map {
        position: relative;
        border-radius: 12px;
        overflow: hidden;
...
${n} | MyntReal Workflows`}open(e){this.currentOptions=e,this.activeMode="scanned",this.render()}close(){this.modalEl&&(this.modalEl.remove(),this.modalEl=null)}render(){if(this.close(),!this.currentOptions)return;const{phone:e,name:t,context:a,defaultMessage:s}=this.currentOptions,n=(e||"").replace(/\D/g,"").slice(-10),o=this.getSenderSignature(),r=(s||k.greeting.text)+o;this.modalEl=document.createElement("div"),this.modalEl.id="unifiedWAModal",this.modalEl.className="uwa-modal-backdrop",this.modalEl.innerHTML=`
    ...
    `,document.body.appendChild(this.modalEl),this.attachEvents()}attachEvents(){this.modalEl&&(document.getElementById("uwaCloseBtn")?.addEventListener("click",()=>this.close()),document.getElementById("uwaCancelBtn")?.addEventListener("click",()=>this.close()),document.getElementById("uwaModeScannedBtn")?.addEventListener("click",()=>{this.activeMode="scanned",this.updateModeUI()}),document.getElementById("uwaModeMetaBtn")?.addEventListener("click",()=>{this.activeMode="meta_api",this.updateModeUI()}),this.modalEl.querySelectorAll(".uwa-chip-btn").forEach(e=>{e.addEventListener("click",t=>{const a=t.currentTarget.dataset.tplKey;if(a&&k[a]){const s=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=k[a].text+s,n.focus())}})}),document.getElementById("uwaSendBtn")?.addEventListener("click",()=>this.handleSend()))}updateModeUI(){const e=document.getElementById("uwaModeScannedBtn"),t=document.getElementById("uwaModeMetaBtn"),a=document.getElementById("uwaSendBtnLabel"),s=document.getElementById("uwaSendBtn");this.activeMode==="scanned"?(e?.classList.add("active"),t?.classList.remove("active"),a&&(a.textContent="Send via Scan WhatsApp"),s&&(s.style.background="#16a34a")):(e?.classList.remove("active"),t?.classList.add("active"),a&&(a.textContent="Send via WhatsApp API"),s&&(s.style.background="#2563eb"))}async handleSend(){if(!this.currentOptions)return;const e=document.getElementById("uwaMessageText"),t=document.getElementById("uwaSendBtn"),a=document.getElementById("uwaSendBtnLabel");let s=(e?.value||"").trim();if(!s){this.showFeedback("Please enter a message to send.","error");return}const n=this.getSenderSignature();s.indexOf("Regards,")===-1&&s.indexOf("MyntReal")===-1&&(s=s+n);const{phone:o,name:r,leadId:l}=this.currentOptions,c=(o||"").replace(/\D/g,"").slice(-10);if(!c||c.length<10){this.showFeedback("Invalid recipient phone number.","error");return}if(t&&(t.disabled=!0),this.activeMode==="meta_api"){a&&(a.innerHTML='<i class="fas fa-spinner fa-spin me-1"></i> Sending via Meta API...'),this.showFeedback("Dispatching via WhatsApp Cloud API...","info");try{const i=l&&l!=="new"?l:"direct",u=await w.post(`/whatsapp-config/crm-lead-send/${i}`,{phone:c,custom_message:s,send_mode:"company"});if(u.success)a&&(a.innerHTML='<i class="fas fa-check me-1"></i> Sent Successfully ✓'),this.showFeedback("✅ Dispatched via WhatsApp Meta Cloud API (Signed & Tracked)","success"),setTimeout(()=>this.close(),2500);else{const d=u.error||u.data?.reason||"Meta API not available. Switching to Scan WhatsApp...";this.showFeedback(`⚠️ ${d}`,"error"),setTimeout(()=>{this.activeMode="scanned",this.updateModeUI(),this.handleSend()},1500)}}catch(i){console.warn("[UnifiedWAModal] Meta API failed, fallback to scan:",i),this.showFeedback(`⚠️ Meta API failed: ${i.message||"Error"}. Falling back to Scan WhatsApp...`,"error"),setTimeout(()=>{this.activeMode="scanned",this.updateModeUI(),this.handleSend()},1500)}return}a&&(a.innerHTML='<i class="fas fa-spinner fa-spin me-1"></i> Sending via Common Bot...'),this.showFeedback("Connecting to Common Scan WhatsApp Bot on Port 5002...","info");try{const i=await w.post("/whatsapp/send-message",{recipient:c,message:s,recipient_type:"individual",recipient_name:r||"Customer",lead_id:l||null});if(i.success)a&&(a.innerHTML='<i class="fas fa-check me-1"></i> Sent Successfully ✓'),this.showFeedback(`✅ Dispatched via Scan WhatsApp (Common Number)! Sender: ${this.escapeHtml(m.getAuthState().user?.full_name||"Staff")}`,"success"),setTimeout(()=>this.close(),2500);else{const u=i.error||"Failed to dispatch via WhatsApp Gateway. Please verify the common QR bot is scanned.";this.showFeedback(`❌ ${u}`,"error"),t&&(t.disabled=!1),a&&(a.textContent="Retry Send")}}catch(i){console.error("[UnifiedWAModal] Send error:",i),this.showFeedback(`❌ Network error: ${i.message||"Server unreachable"}`,"error"),t&&(t.disabled=!1),a&&(a.textContent="Retry Send")}}showFeedback(e,t){const a=document.getElementById("uwaFeedbackBox");a&&(a.style.display="block",a.className=`uwa-feedback-box ${t}`,a.innerHTML=e)}escapeHtml(e){const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return(e||"").replace(/[&<>"']/g,a=>t[a])}}const Z=new O,$=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],D=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],U=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class V{container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
      ...
      <div class="mnr-drawer-content">
        ...
        <!-- Section menus -->
        ${D.map(s=>this.renderSection(s)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("mnrDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;g.navigate(t),this.close()})}),document.getElementById("mnrLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await m.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const X=new V;class Q{config;constructor(e){this.config=e}render(){if(this.config.loading)return`
      ...
      `;const e=s=>this.config.sortColumn===s?this.config.sortDirection==="asc"?" ↑":" ↓":"",t=this.config.columns.map(s=>{const n=s.sortable!==!1,o=e(s.key),r=s.width?`width: ${s.width};`:"",l=n?`data-sort-column="${s.key}"`:"";return`<th style="${r}${n?"cursor: pointer;":""}" ${l}>${s.label}${o}</th>`}).join(""),a=this.config.data.map(s=>`<tr>${this.config.columns.map(o=>{const r=s[o.key];return`<td>${o.render?o.render(r,s):r??"-"}</td>`}).join("")}</tr>`).join("");return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("partnerDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;g.navigate(t),this.close()})}),document.getElementById("partnerLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await m.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const ee=new K;class te{container;constructor(e){this.container=e}render(){const t=m.getAuthState().user?.portal||"staff",a=g.getTabRoutes(t),s=g.getCurrentRoute();this.container.innerHTML=`
    ...
    `,this.fab=this.container.querySelector("#vgk-mobile-fab"),this.modal=this.container.querySelector("#vgk-mobile-modal"),this.attachFabDrag(),this.container.querySelector("#vgk-close-btn")?.addEventListener("click",()=>this.close());const t=this.container.querySelector("#vgk-text-input");this.container.querySelector("#vgk-send-btn")?.addEventListener("click",()=>{t.value.trim()&&(this.send(t.value.trim()),t.value="")}),t?.addEventListener("keypress",a=>{a.key==="Enter"&&t.value.trim()&&(this.send(t.value.trim()),t.value="")}),this.container.querySelector("#vgk-mic-btn")?.addEventListener("click",()=>this.startVoice(t)),this.pushMessage("assistant","Hi! I'm VGK Assistant. How can I help you today?")}attachFabDrag(){if(!this.fab)return;let e=!1,t=0,a=0,s=0,n=0,o=!1;const r=i=>{const u=i.touches[0];t=u.clientX,a=u.clientY;const d=this.fab.getBoundingClientRect();s=d.left,n=d.top,e=!0,o=!1},l=i=>{if(!e)return;const u=i.touches[0],d=u.clientX-t,p=u.clientY-a;if(Math.abs(d)>5||Math.abs(p)>5){o=!0;const h=Math.max(10,Math.min(window.innerWidth-60,s+d)),v=Math.max(60,Math.min(window.innerHeight-100,n+p));this.fab.style.left=`${h}px`,this.fab.style.top=`${v}px`,this.fab.style.right="auto",this.fab.style.bottom="auto"}},c=()=>{e=!1,o||this.open()};this.fab.addEventListener("touchstart",r,{passive:!0}),this.fab.addEventListener("touchmove",l,{passive:!0}),this.fab.addEventListener("touchend",c),this.fab.addEventListener("click",i=>{o?(i.preventDefault(),i.stopPropagation()):this.open()})}open(){this.modal?.classList.add("open"),this.isOpen=!0,this.scrollToBottom()}close(){this.modal?.classList.remove("open"),this.isOpen=!1}pushMessage(e,t){this.messages.push({role:e,text:t}),this.renderMessages()}renderMessages(){const e=this.container.querySelector("#vgk-messages");e&&(e.innerHTML=this.messages.map(t=>`<div class="vgk-bubble ${t.role}">${t.text.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\n/g,"<br>")}</div>`).join(""),this.isLoading&&(e.innerHTML+='<div class="vgk-typing"><div class="vgk-dot"></div><div class="vgk-dot"></div><div class="vgk-dot"></div></div>'),this.scrollToBottom())}scrollToBottom(){const e=this.container.querySelector("#vgk-messages");e&&(e.scrollTop=e.scrollHeight)}async send(e){if(this.isLoading)return;this.pushMessage("user",e),this.isLoading=!0,this.renderMessages();const t=this.getEndpoint();if(!t){this.pushMessage("assistant","Not available for this portal."),this.isLoading=!1;return}try{const a=await w.getToken(),n=await(await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",...a?{Authorization:`Bearer ${a}`}:{}},body:JSON.stringify({user_message:e,conversation_history:this.conversationHistory.slice(-20),language:"en",company_id:null,allowed_intents:null})})).json();if(n.reply_text){if(this.conversationHistory.push({role:"user",text:e}),this.conversationHistory.push({role:"assistant",text:n.reply_text}),this.conversationHistory.length>20&&(this.conversationHistory=this.conversationHistory.slice(-20)),this.pushMessage("assistant",n.reply_text),n.speak_text&&"speechSynthesis"in window){const o=new SpeechSynthesisUtterance(n.speak_text);o.lang="en-IN",o.rate=1,window.speechSynthesis.speak(o)}}else this.pushMessage("assistant",n.detail||"Something went wrong.")}catch{this.pushMessage("assistant","Could not reach VGK server. Please try again.")}this.isLoading=!1,this.renderMessages()}startVoice(e){const t=window.SpeechRecognition||window.webkitSpeechRecognition;if(!t){alert("Voice input not supported on this device.");return}const a=this.container.querySelector("#vgk-mic-btn"),s=new t;s.lang="en-IN",s.continuous=!1,s.interimResults=!1,s.onstart=()=>a.classList.add("recording"),s.onresult=n=>{const o=n.results[0][0].transcript;e.value=o},s.onend=()=>a.classList.remove("recording"),s.onerror=()=>a.classList.remove("recording"),s.start()}}function se(){const b=x.getPortal();(b==="staff"||b==="partner")&&new W}export{te as B,J as L,Q as M,E as P,N as g,se as i,X as m,ee as p,ae as s,Z as u};
