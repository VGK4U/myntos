const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./services-BI6tu3P2.js","./vendor-capacitor-plugins-DTPsYLMi.js","./vendor-capacitor-core-zwN_Y1fq.js","./vendor-B1GRRwIS.js"])))=>i.map(i=>d[i]);
import{w as S,j as G,d as x,b as k,s as D,u as I,M as Z,a as X}from"./services-BI6tu3P2.js";import{L as M}from"./vendor-B1GRRwIS.js";import{_ as j}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as J}from"./services-gps-D5jcFs16.js";class ee{modalEl=null;uiState="CLOSED";currentOptions=null;enteredNumber="";rawNumber="";isPresetNumber=!1;isDtmfOpen=!1;unsubscribeTelephony=null;currentSession=null;floatingPos={x:0,y:0};pillPos={x:0,y:0};isDraggingWindow=!1;isDraggingPill=!1;dragStartPointer={x:0,y:0};dragStartPos={x:0,y:0};hasInitializedPosition=!1;lastNotifiedLeadId=null;constructor(){typeof window<"u"&&(window.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen()&&(this.uiState==="ACTIVE_FLOATING"?this.minimize():this.uiState==="DIALER"&&this.close())}),window.addEventListener("resize",()=>{this.isOpen()&&(this.clampPositions(),this.applyPositions())}))}isOpen(){return this.modalEl!==null&&document.body.contains(this.modalEl)&&this.uiState!=="CLOSED"}getUIState(){return this.uiState}open(e){this.currentOptions=e;const t=(e.phoneNumber||"").replace(/[^\d+]/g,"");this.enteredNumber=t,this.rawNumber=t,this.isPresetNumber=!!t,this.isDtmfOpen=!1,this.hasInitializedPosition=!1,this.unsubscribeTelephony&&this.unsubscribeTelephony(),this.unsubscribeTelephony=S.subscribe(i=>{this.currentSession=i,this.handleTelephonyStateUpdate(i)});const a=S.isCallActive();this.uiState=a?"ACTIVE_FLOATING":"DIALER",this.render(),this.loadLeadContext(e.entityId),e.autoStart&&this.enteredNumber&&this.startCall()}minimize(){this.uiState!=="CLOSED"&&(this.uiState="MINIMIZED",this.updateVisibility())}restore(){this.uiState!=="CLOSED"&&(this.uiState="ACTIVE_FLOATING",this.updateVisibility(),this.updateSessionUI())}close(){if(this.currentSession&&(S.isCallActive()||["connecting","ringing","connected","held"].includes(this.currentSession.state))){this.minimize();return}this.teardown()}forceCloseAndHangup(){this.currentSession&&S.isCallActive()&&S.endCall(),this.teardown()}teardown(){this.unsubscribeTelephony&&(this.unsubscribeTelephony(),this.unsubscribeTelephony=null),this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.uiState="CLOSED",this.currentOptions=null,this.currentSession=null,this.hasInitializedPosition=!1,this.lastNotifiedLeadId=null}handleTelephonyStateUpdate(e){if(!this.modalEl||!document.body.contains(this.modalEl))if(e.state!=="idle")this.render();else return;if(S.isCallActive()){this.uiState==="DIALER"&&(this.uiState="ACTIVE_FLOATING");const a=Number(this.currentOptions?.entityId);a&&(this.currentOptions?.entityType==="lead"||!this.currentOptions?.entityType)&&this.lastNotifiedLeadId!==a&&(this.lastNotifiedLeadId=a,G.notifyCallActive(a))}else if(this.lastNotifiedLeadId=null,e.state==="ended"){this.uiState="ENDED_SUMMARY";const a=this.currentOptions,i=e.durationSeconds||0;G.clearCallActive(),a?.entityId&&window.dispatchEvent(new CustomEvent("myntos:lead-call-ended",{detail:{leadId:a.entityId,name:a.name,phoneNumber:a.phoneNumber,durationSeconds:i,categoryName:a.categoryName,status:a.status}})),setTimeout(()=>{this.uiState==="ENDED_SUMMARY"&&this.teardown()},1600)}else if(e.state==="idle"&&this.uiState!=="DIALER"){G.clearCallActive(),this.teardown();return}this.updateVisibility(),this.updateSessionUI()}maskPhone(e){if(!e)return"—";const t=e.replace(/\D/g,"");if(t.length<6)return e;const a=t.slice(-10);return x.isMR10001()?a.length===10?`+91 ${a.slice(0,5)} ${a.slice(5)}`:e:`+91 ${a.slice(0,2)}••••${a.slice(-4)}`}getDialInputDisplay(){return!x.isMR10001()&&this.isPresetNumber&&this.enteredNumber?this.maskPhone(this.enteredNumber):this.enteredNumber}formatDuration(e){const t=Math.floor(e/60).toString().padStart(2,"0"),a=(e%60).toString().padStart(2,"0");return`${t}:${a}`}initPositions(){if(this.hasInitializedPosition||typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),i=440,n=Math.max(12,Math.round((e-a)/2)),s=Math.max(20,Math.round((t-i)/2));this.floatingPos={x:n,y:s},this.pillPos={x:Math.max(12,e-260),y:Math.max(20,t-100)},this.hasInitializedPosition=!0}clampPositions(){if(typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),i=440,n=12,s=Math.max(12,e-a-12),l=12,o=Math.max(12,t-i-12);this.floatingPos.x=Math.min(Math.max(this.floatingPos.x,n),s),this.floatingPos.y=Math.min(Math.max(this.floatingPos.y,l),o);const d=240,r=54,u=12,c=Math.max(12,e-d-12),m=12,g=Math.max(12,t-r-12);this.pillPos.x=Math.min(Math.max(this.pillPos.x,u),c),this.pillPos.y=Math.min(Math.max(this.pillPos.y,m),g)}applyPositions(){const e=this.modalEl?.querySelector("#spModalDialog");e&&(this.uiState==="ACTIVE_FLOATING"||this.uiState==="DIALER")&&(e.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`);const t=this.modalEl?.querySelector("#spMinimizedPill");t&&this.uiState==="MINIMIZED"&&(t.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`)}render(){this.modalEl&&this.modalEl.remove(),this.initPositions(),this.clampPositions();const{name:e,entityType:t}=this.currentOptions||{},a=e||"Customer Lead",i=t?t.toUpperCase():"LEAD";this.modalEl=document.createElement("div"),this.modalEl.id="myntosCentralSoftphoneModal",this.modalEl.style.cssText=`
          ...
          <div id="spInCallView" style="display: ${this.uiState==="ACTIVE_FLOATING"||this.uiState==="ENDED_SUMMARY"?"flex":"none"} !important; position: absolute !important; inset: 0 !important; background: linear-gradient(180deg, #0f172a 0%, #1e293b 100%) !important; color: #ffffff !important; padding: 18px 16px !important; z-index: 20 !important; flex-direction: column !important; justify-content: space-between !important; align-items: center !important;">
            ...
            <div style="display: flex !important; flex-direction: column !important; align-items: center !important; gap: 12px !important; width: 100% !important;">
              ...
              <div id="spInCallVolumeWrap" style="display: flex !important; align-items: center !important; justify-content: center !important; gap: 8px !important; width: 100% !important; max-width: 220px !important; padding: 4px 10px !important; background: rgba(255,255,255,0.06) !important; border-radius: 12px !important; border: 1px solid rgba(255,255,255,0.1) !important; box-sizing: border-box !important;">
                ...
                <input id="spInCallVolumeSlider" type="range" min="0" max="100" value="${Math.round(S.getVolume()*100)}" style="width: 100% !important; height: 4px !important; accent-color: #38bdf8 !important; cursor: pointer !important;" title="Adjust call volume" />
                <span style="color: #94a3b8 !important; font-size: 11px !important;">🔊</span>
              </div>
    ...
    `,document.body.appendChild(this.modalEl),this.attachEventListeners(),this.attachDragListeners(),this.updateVisibility(),this.updateSessionUI()}attachDragListeners(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spFloatingHeader"),t=this.modalEl.querySelector("#spModalDialog");if(e&&t){e.addEventListener("pointerdown",n=>{const s=n.target;if(!(s&&s.closest("button, input, a"))){this.isDraggingWindow=!0,this.dragStartPointer={x:n.clientX,y:n.clientY},this.dragStartPos={x:this.floatingPos.x,y:this.floatingPos.y};try{e.setPointerCapture(n.pointerId)}catch{}n.preventDefault(),n.stopPropagation()}}),e.addEventListener("pointermove",n=>{if(!this.isDraggingWindow)return;const s=n.clientX-this.dragStartPointer.x,l=n.clientY-this.dragStartPointer.y;this.floatingPos={x:this.dragStartPos.x+s,y:this.dragStartPos.y+l},this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`});const i=n=>{if(this.isDraggingWindow){this.isDraggingWindow=!1;try{e.releasePointerCapture(n.pointerId)}catch{}this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`}};e.addEventListener("pointerup",i),e.addEventListener("pointercancel",i)}const a=this.modalEl.querySelector("#spMinimizedPill");if(a){let i=!1;a.addEventListener("pointerdown",s=>{const l=s.target;if(!(l&&l.closest("#spPillRestoreBtn"))){this.isDraggingPill=!0,i=!1,this.dragStartPointer={x:s.clientX,y:s.clientY},this.dragStartPos={x:this.pillPos.x,y:this.pillPos.y};try{a.setPointerCapture(s.pointerId)}catch{}s.preventDefault(),s.stopPropagation()}}),a.addEventListener("pointermove",s=>{if(!this.isDraggingPill)return;const l=s.clientX-this.dragStartPointer.x,o=s.clientY-this.dragStartPointer.y;(Math.abs(l)>3||Math.abs(o)>3)&&(i=!0),this.pillPos={x:this.dragStartPos.x+l,y:this.dragStartPos.y+o},this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`});const n=s=>{if(this.isDraggingPill){this.isDraggingPill=!1;try{a.releasePointerCapture(s.pointerId)}catch{}this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`,i||this.restore()}};a.addEventListener("pointerup",n),a.addEventListener("pointercancel",n)}}attachEventListeners(){if(!this.modalEl)return;this.modalEl.querySelector("#spModalBackdrop")?.addEventListener("click",()=>{this.uiState==="DIALER"&&this.close()}),this.modalEl.querySelector("#spMinimizeBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.minimize()}),this.modalEl.querySelector("#spCloseBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.close()}),this.modalEl.querySelector("#spPillRestoreBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.restore()});const e=this.modalEl.querySelector("#spDialInput");e?.addEventListener("input",t=>{this.enteredNumber=t.target.value,this.rawNumber="",this.isPresetNumber=!1,this.updateCallerPhoneDisplay()}),this.modalEl.querySelector("#spBackspaceBtn")?.addEventListener("click",()=>{if(this.isPresetNumber){this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1),this.updateCallerPhoneDisplay();return}this.enteredNumber.length>0&&(this.enteredNumber=this.enteredNumber.slice(0,-1),e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),S.playKeyTone())}),this.modalEl.querySelectorAll(".sp-num-btn").forEach(t=>{t.addEventListener("click",a=>{const i=a.currentTarget.getAttribute("data-key");this.isPresetNumber&&(this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1)),i&&this.enteredNumber.length<15&&(this.enteredNumber+=i,e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),S.playKeyTone())})}),this.modalEl.querySelector("#spMainDialBtn")?.addEventListener("click",()=>{this.startCall()}),this.modalEl.querySelector("#spDirectSimBtn")?.addEventListener("click",()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}S.triggerDirectSimCall(this.enteredNumber)}),this.modalEl.querySelector("#spMyOperatorBtn")?.addEventListener("click",async()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}try{const t=this.currentOptions?.entityId?parseInt(String(this.currentOptions.entityId)):null;await S.triggerMyOperatorCall(this.enteredNumber,t),alert(`MyOperator call dispatched to ${this.enteredNumber}! Your office line will ring shortly.`)}catch(t){this.showError(`MyOperator error: ${t.message}`)}}),this.modalEl.querySelector("#spBtnMute")?.addEventListener("click",()=>{S.toggleMute()}),this.modalEl.querySelector("#spBtnSpeaker")?.addEventListener("click",()=>{S.toggleSpeaker()}),this.modalEl.querySelector("#spInCallVolumeSlider")?.addEventListener("input",t=>{const a=parseFloat(t.target.value)/100;S.setVolume(a)}),this.modalEl.querySelector("#spBtnHold")?.addEventListener("click",()=>{S.toggleHold()}),this.modalEl.querySelector("#spBtnKeypad")?.addEventListener("click",()=>{this.isDtmfOpen=!this.isDtmfOpen;const t=this.modalEl?.querySelector("#spDtmfGrid");t&&(t.style.display=this.isDtmfOpen?"grid":"none")}),this.modalEl.querySelectorAll(".sp-dtmf-btn").forEach(t=>{t.addEventListener("click",a=>{const i=a.currentTarget.getAttribute("data-dtmf");i&&S.sendDTMF(i)})}),this.modalEl.querySelector("#spBtnHangup")?.addEventListener("click",()=>{S.endCall()})}updateVisibility(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spModalBackdrop"),t=this.modalEl.querySelector("#spModalDialog"),a=this.modalEl.querySelector("#spMinimizedPill"),i=this.modalEl.querySelector("#spInCallView"),n=this.modalEl.querySelector("#spDialerView");this.uiState==="DIALER"?(e&&(e.style.display="block"),t&&(t.style.display="block"),a&&(a.style.display="none"),n&&(n.style.display="block"),i&&(i.style.display="none")):this.uiState==="ACTIVE_FLOATING"?(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="flex")):this.uiState==="MINIMIZED"?(e&&(e.style.display="none"),t&&(t.style.display="none"),a&&(a.style.display="flex")):this.uiState==="ENDED_SUMMARY"&&(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),n&&(n.style.display="none"),i&&(i.style.display="flex"))}updateCallerPhoneDisplay(){const e=this.modalEl?.querySelector("#spCallerPhoneDisplay");e&&(e.textContent=this.maskPhone(this.enteredNumber))}showError(e){const t=this.modalEl?.querySelector("#spErrorBanner");t&&(t.textContent=e,t.style.display="block")}hideError(){const e=this.modalEl?.querySelector("#spErrorBanner");e&&(e.style.display="none")}async startCall(){S.prepareAudioOnUserGesture(),this.hideError();const e=this.rawNumber||this.enteredNumber;if(!e){this.showError("Please enter a destination phone number.");return}const t=this.currentOptions?.name||"Contact Lead",a=this.currentOptions?.entityId||null;this.uiState="ACTIVE_FLOATING",this.updateVisibility();const i=await S.startCall(e,t,a);!i.success&&i.error&&(i.error==="A call is already in progress."?console.warn("[SoftphoneModal] Duplicate dial prevented; ignoring duplicate error toast"):this.showError(i.error))}updateSessionUI(){if(!this.modalEl||!this.currentSession)return;const e=this.currentSession.contactName||this.currentOptions?.name||"Contact Lead",t=this.currentSession.destinationPhone||this.enteredNumber,a=this.formatDuration(this.currentSession.durationSeconds),i=this.modalEl.querySelector("#spActiveCallerName");i&&(i.textContent=e);const n=this.modalEl.querySelector("#spActiveCallerPhone");n&&(n.textContent=this.maskPhone(t));const s=this.modalEl.querySelector("#spCallTimerDisplay");s&&(s.textContent=a);const l=this.modalEl.querySelector("#spPillCallerName");l&&(l.textContent=e);const o=this.modalEl.querySelector("#spPillTimerDisplay");o&&(o.textContent=a);const d=this.modalEl.querySelector("#spCallStateBadge");d&&(this.currentSession.state==="connected"?(d.textContent="🟢 Connected",d.style.background="#22c55e",d.style.color="#ffffff"):this.currentSession.state==="ringing"?(d.textContent="📞 Ringing...",d.style.background="#38bdf8",d.style.color="#000000"):this.currentSession.state==="connecting"?(d.textContent="⏳ Connecting...",d.style.background="#f59e0b",d.style.color="#000000"):this.currentSession.state==="ended"&&(d.textContent="🛑 Call Ended",d.style.background="#ef4444",d.style.color="#ffffff"));const r=this.modalEl.querySelector("#spBtnMute");r&&(r.style.background=this.currentSession.isMuted?"rgba(239,68,68,0.6)":"rgba(255,255,255,0.1)",r.style.borderColor=this.currentSession.isMuted?"#ef4444":"rgba(255,255,255,0.2)");const u=this.modalEl.querySelector("#spBtnSpeaker");u&&(u.style.background=this.currentSession.isSpeaker?"rgba(56,189,248,0.6)":"rgba(255,255,255,0.1)",u.style.borderColor=this.currentSession.isSpeaker?"#38bdf8":"rgba(255,255,255,0.2)");const c=this.modalEl.querySelector("#spBtnHold");c&&(c.style.background=this.currentSession.isHeld?"rgba(245,158,11,0.6)":"rgba(255,255,255,0.1)",c.style.borderColor=this.currentSession.isHeld?"#f59e0b":"rgba(255,255,255,0.2)")}async loadLeadContext(e){const t=this.modalEl?.querySelector("#spLeadContextBox");if(!t)return;if(this.currentOptions?.categoryName){const i=this.modalEl?.querySelector("#spMobileCatBadge");i&&(i.textContent=this.currentOptions.categoryName);const n=this.modalEl?.querySelector("#spHeaderCatBadge");n&&(n.textContent=`🏷️ ${this.currentOptions.categoryName}`,n.style.display="inline-block")}if(this.currentOptions?.status){const i=this.modalEl?.querySelector("#spMobileStatus");i&&(i.textContent=this.currentOptions.status.toUpperCase());const n=this.modalEl?.querySelector("#spHeaderStatusBadge");n&&(n.textContent=`📌 ${this.currentOptions.status}`,n.style.display="inline-block")}let a=e;if(!a&&this.currentOptions?.phoneNumber)try{const i=this.currentOptions.phoneNumber.replace(/\D/g,"").slice(-10);if(i.length>=10){const n=await k.get(`/telephony/calls/${i}/customer-history`),s=n?.data??n;s?.lead?.id&&(a=s.lead.id)}}catch(i){console.warn("[SoftphoneModal] Lead lookup by phone notice:",i)}if(!a){this.currentOptions?.categoryName||this.currentOptions?.status?t.style.display="block":t.style.display="none";return}try{const i=await k.get(`/crm/dialer/lead/${a}/detail`),n=i.data??i;if(!n||!n.lead)return;const s=n.lead;t.style.display="block";const l=this.modalEl?.querySelector("#spMobileCatBadge");l&&(l.textContent=s.category_name||"General");const o=this.modalEl?.querySelector("#spHeaderCatBadge");o&&(o.textContent=`🏷️ ${s.category_name||"General"}`,o.style.display="inline-block");const d=this.modalEl?.querySelector("#spMobileSource");d&&(d.textContent=s.source||"—");const r=this.modalEl?.querySelector("#spMobileCompany");r&&(r.textContent=s.company_name||"—");const u=this.modalEl?.querySelector("#spMobileStatus");u&&(u.textContent=(s.status||"—").toUpperCase(),u.style.color=s.status==="won"?"#22c55e":s.status==="lost"?"#ef4444":"#38bdf8");const c=this.modalEl?.querySelector("#spHeaderStatusBadge");c&&(c.textContent=`📌 ${s.status||"New"}`,c.style.display="inline-block");const m=this.modalEl?.querySelector("#spHeaderTempBadge");m&&(s.is_hot_lead?(m.textContent="🔥 HOT LEAD",m.style.background="rgba(239, 68, 68, 0.2)",m.style.color="#ef4444",m.style.border="1px solid rgba(239, 68, 68, 0.4)",m.style.display="inline-block"):s.is_fresh_lead?(m.textContent="🌱 FRESH LEAD",m.style.background="rgba(16, 185, 129, 0.2)",m.style.color="#10b981",m.style.border="1px solid rgba(16, 185, 129, 0.4)",m.style.display="inline-block"):m.style.display="none");const g=this.modalEl?.querySelector("#spMobileStatusUpdated");g&&(g.textContent=s.status_updated_at?new Date(s.status_updated_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"—");const b=this.modalEl?.querySelector("#spMobileBudget");b&&(b.textContent=s.budget_display||"—");const v=this.modalEl?.querySelector("#spMobileLastInteraction");v&&(v.textContent=s.last_interaction_date?new Date(s.last_interaction_date).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const R=this.modalEl?.querySelector("#spMobileInteractedBy");R&&(R.textContent=s.last_interacted_by||"—");const B=this.modalEl?.querySelector("#spMobileLastDialed");B&&(B.textContent=s.last_dialed_at?new Date(s.last_dialed_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const _=this.modalEl?.querySelector("#spMobileReqRow"),O=this.modalEl?.querySelector("#spMobileRequirements");_&&O&&(s.requirements?(O.textContent=s.requirements,_.style.display="block"):_.style.display="none");const P=this.modalEl?.querySelector("#spMobileNotesSection"),f=this.modalEl?.querySelector("#spMobileRecentNotes");if(P&&f){const E=(n.notes||[]).slice(0,2);E.length>0?(f.innerHTML=E.map(C=>`<div>• ${C.note}</div>`).join(""),P.style.display="block"):P.style.display="none"}}catch(i){console.warn("[SoftphoneModal] Could not fetch lead context:",i)}}}const Se=new ee,W={"/staff/my-tenant":"staff-my-tenant","/staff/tenant-users":"staff-tenant-users","/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-management":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance/sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance/summary":"staff-attendance-reports","/staff/team-attendance-summary":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"tasks","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra/my":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/field-appointments":"field-appointments","field-appointments":"field-appointments","staff-field-appointments":"field-appointments","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/team-live-tracker":"staff-team-live-tracker","/staff/team-location-tracker":"staff-team-live-tracker","/staff/all-location-tracker":"staff-all-location-tracker","/staff/all-location-history":"staff-all-location-tracker","team-live-tracker":"staff-team-live-tracker","all-location-tracker":"staff-all-location-tracker","/staff/vgk/members":"staff-vgk-members","/staff_vgk_members.html":"staff-vgk-members","/staff/incentives/vgk4u":"staff-incentives-vgk4u","/staff/vgk4u/real-estate":"staff-vgk4u-real-estate","/staff/vgk4u/insurance":"staff-vgk4u-insurance","/staff/vgk4u/etc-students":"staff-vgk4u-real-estate","/staff/incentives/points":"staff-incentives-points","/staff/incentives/approvals":"staff-incentives-approvals","/staff/vgk/income":"staff-vgk-income","/staff/vgk/income-unified":"vgk-income-unified","/staff/vgk/coupons/available":"staff-vgk-coupons","/staff/vgk/promo-codes":"staff-vgk-promo-codes","/staff/vgk/bonanza-management":"vgk-bonanza-rewards","/staff/vgk/bonanza-claims":"vgk-bonanza-rewards","/staff/vgk/vendors":"staff-vgk-vendors","/staff/vgk/vendor-categories":"staff-vgk-vendors","/staff/vgk/vendor-products":"staff-vgk-vendors","/staff/vgk/vendor-transactions":"staff-vgk-vendors","/staff/vgk/cash-income/sales":"staff-vgk-income","/staff/vgk/cash-income/accounts":"staff-vgk-income","/staff/vgk/wallet":"vgk-points-balance","/staff/vgk/config":"staff-vgk-members","/staff/vgk/partner-kyc-review":"staff-kyc-approvals","/staff/vgk/my-registrations":"vgk-my-registrations","/staff/vgk/media":"vgk-member-hub","/staff/vgk4u/purchase-orders":"staff-service-procurement","/rvz/real-dreams/marketplace":"real-dreams-marketplace","/rvz/real-dreams":"real-dreams-marketplace","/rvz/real-dreams/partners":"real-dreams-marketplace","/rvz/real-dreams-partners":"real-dreams-marketplace","/rvz/real-dreams/properties":"real-dreams-marketplace","/rvz/real-dreams-properties":"real-dreams-marketplace","/rvz/real-dreams-dashboard":"real-dreams-marketplace","/staff/mnr/real-dreams/marketplace":"real-dreams-marketplace","/staff/mnr/real-dreams":"real-dreams-marketplace","/staff/mnr/real-dreams/partners":"real-dreams-marketplace","/staff/mnr/real-dreams/properties":"real-dreams-marketplace","/staff/mnr/real-dreams-dashboard":"real-dreams-marketplace","/real-dreams/marketplace":"real-dreams-marketplace","/real-dreams/compare":"real-dreams-marketplace","/real-dreams/property":"real-dreams-marketplace","/staff/zynova/direct":"vgk-direct-summary","/staff/zynova/matching":"vgk-matching-summary","/staff/zynova/guru":"vgk-guru-summary","/staff/zynova/ved":"vgk-ved-summary","/staff/zynova/wallet":"vgk-points-balance","/staff/zynova/withdrawals":"vgk-points-balance","/staff/zynova/points":"vgk-points-balance","/staff/kra-status":"kras","/staff/timesheet":"timesheet","/staff/progress":"progress","/vgk/birthdays":"vgk-birthdays","/vgk/top-earners":"vgk-top-earners","/vgk/awards":"vgk-awards","/vgk/my-registrations":"vgk-my-registrations","/vgk/bonanza-rewards":"vgk-bonanza-rewards","/vgk/points-balance":"vgk-points-balance","/vgk/member-hub":"vgk-member-hub","/vgk/settings":"vgk-settings","/vgk/bank-details":"vgk-bank-details","/vgk/profile-edit":"vgk-profile-edit","/vgk/kyc":"vgk-kyc","/vgk/feedback":"vgk-feedback","/vgk/announcements":"vgk-announcements","/vgk/my-announcements":"vgk-my-announcements","/vgk/coupon-activate":"vgk-coupon-activate","/vgk/coupon-progress":"vgk-coupon-progress","/vgk/coupon-transfer":"vgk-coupon-transfer","/vgk/income-unified":"vgk-income-unified","/vgk/daywise-income":"vgk-daywise-income","/vgk/income-types":"vgk-income-types","/vgk/direct-summary":"vgk-direct-summary","/vgk/matching-summary":"vgk-matching-summary","/vgk/guru-summary":"vgk-guru-summary","/vgk/ved-summary":"vgk-ved-summary","/vgk/ev-benefits":"vgk-ev-benefits","/vgk/ev-discount":"vgk-ev-discount","/vgk/franchise-earnings":"vgk-franchise-earnings","/vgk/insurance":"vgk-insurance","/vgk/training":"vgk-training","/vgk/coupon-benefits":"vgk-coupon-benefits","/vgk/my-submissions":"vgk-my-submissions","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/field-sales":"staff-bank-wise-leads","/field-sales":"staff-bank-wise-leads","field-sales":"staff-bank-wise-leads","bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"category-leads-master","/staff/real-dreams-leads":"category-leads-master","/staff/insurance-leads":"category-leads-master","/staff/ev-b2b-leads":"category-leads-master","/staff/ev-b2c-leads":"category-leads-master","/staff/ev-spares-leads":"category-leads-master","/staff/etc-leads":"category-leads-master","/staff/mnr-leads":"category-leads-master","/staff/mnr-leads-master":"category-leads-master","/staff/executive-dashboard":"executive-dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/configuration/catalog":"digital-catalog","/staff/catalog-library":"digital-catalog","/staff/catalog":"digital-catalog","/catalog-library":"digital-catalog","catalog-library":"digital-catalog","/staff/catalog-library.html":"digital-catalog","/catalog-library.html":"digital-catalog","/catalog":"digital-catalog",catalog:"digital-catalog","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"auto-dialer","/staff/softphone":"softphone","/staff/calling-page":"softphone","/staff/calling":"softphone","/staff/phone-dialpad":"softphone","/staff/softphone-hub":"softphone","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},te={"/staff/solar-leads":"solar","/staff/ev-b2b-leads":"ev-b2b","/staff/ev-b2c-leads":"ev-b2c","/staff/ev-spares-leads":"ev-spares","/staff/real-dreams-leads":"real-dreams","/staff/insurance-leads":"insurance","/staff/etc-leads":"etc","/staff/mnr-leads":"mnr"},ae=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],ie=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],ne=[{section_code:"EARNINGS",section_label:"EARNINGS & INCOME",order:1,items:[{menu_code:"VGK_INCOME_UNIFIED",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Income Dashboard',route:"vgk-income-unified"},{menu_code:"VGK_DAYWISE_INCOME",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Daywise Income',route:"vgk-daywise-income"},{menu_code:"VGK_DIRECT_SUMMARY",label:'<i class="fas fa-users" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>Direct (L1)',route:"vgk-direct-summary"},{menu_code:"VGK_MATCHING_SUMMARY",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>Matching (L2)',route:"vgk-matching-summary"},{menu_code:"VGK_GURU_SUMMARY",label:'<i class="fas fa-graduation-cap" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Guru Summary',route:"vgk-guru-summary"},{menu_code:"VGK_VED_SUMMARY",label:'<i class="fas fa-brain" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Ved Summary',route:"vgk-ved-summary"},{menu_code:"VGK_FRANCHISE_EARNINGS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center; color: #14b8a6;"></i>Franchise Earnings',route:"vgk-franchise-earnings"}]},{section_code:"PROGRAMS",section_label:"PROGRAMS & BENEFITS",order:2,items:[{menu_code:"VGK_EV_BENEFITS",label:'<i class="fas fa-charging-station" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>EV Benefits',route:"vgk-ev-benefits"},{menu_code:"VGK_EV_DISCOUNT",label:'<i class="fas fa-percent" style="margin-right: 8px; width: 18px; text-align: center; color: #06b6d4;"></i>EV Discount',route:"vgk-ev-discount"},{menu_code:"VGK_INSURANCE",label:'<i class="fas fa-shield-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Insurance Policy',route:"vgk-insurance"},{menu_code:"VGK_TRAINING",label:'<i class="fas fa-chalkboard-teacher" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>Training Program',route:"vgk-training"},{menu_code:"VGK_BONANZA_REWARDS",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bonanza Rewards',route:"vgk-bonanza-rewards"},{menu_code:"VGK_AWARDS",label:'<i class="fas fa-award" style="margin-right: 8px; width: 18px; text-align: center; color: #eab308;"></i>Awards & Milestones',route:"vgk-awards"}]},{section_code:"COUPONS_PINS",section_label:"COUPONS & PINS",order:3,items:[{menu_code:"VGK_COUPON_ACTIVATE",label:'<i class="fas fa-key" style="margin-right: 8px; width: 18px; text-align: center; color: #6366f1;"></i>PIN Activation',route:"vgk-coupon-activate"},{menu_code:"VGK_COUPON_PROGRESS",label:'<i class="fas fa-tasks" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Coupon Progress',route:"vgk-coupon-progress"},{menu_code:"VGK_COUPON_TRANSFER",label:'<i class="fas fa-exchange-alt" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Coupon Transfer',route:"vgk-coupon-transfer"},{menu_code:"VGK_COUPON_BENEFITS",label:'<i class="fas fa-gift" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Coupon Benefits',route:"vgk-coupon-benefits"}]},{section_code:"PROFILE_SECURITY",section_label:"MY ACCOUNT",order:4,items:[{menu_code:"VGK_PROFILE_EDIT",label:'<i class="fas fa-user-edit" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Edit Profile',route:"vgk-profile-edit"},{menu_code:"VGK_KYC",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>KYC Verification',route:"vgk-kyc"},{menu_code:"VGK_BANK_DETAILS",label:'<i class="fas fa-university" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Bank Details',route:"vgk-bank-details"},{menu_code:"VGK_POINTS_BALANCE",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center; color: #eab308;"></i>Points Balance',route:"vgk-points-balance"},{menu_code:"VGK_FEEDBACK",label:'<i class="fas fa-comment-dots" style="margin-right: 8px; width: 18px; text-align: center; color: #06b6d4;"></i>Feedback',route:"vgk-feedback"},{menu_code:"VGK_SETTINGS",label:'<i class="fas fa-cog" style="margin-right: 8px; width: 18px; text-align: center; color: #64748b;"></i>Settings',route:"vgk-settings"}]},{section_code:"COMMUNITY",section_label:"COMMUNITY & TEAM",order:5,items:[{menu_code:"VGK_TOP_EARNERS",label:'<i class="fas fa-medal" style="margin-right: 8px; width: 18px; text-align: center; color: #f59e0b;"></i>Top Earners',route:"vgk-top-earners"},{menu_code:"VGK_BIRTHDAYS",label:'<i class="fas fa-birthday-cake" style="margin-right: 8px; width: 18px; text-align: center; color: #ec4899;"></i>Birthdays',route:"vgk-birthdays"},{menu_code:"VGK_ANNOUNCEMENTS",label:'<i class="fas fa-bullhorn" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i>Announcements',route:"vgk-announcements"},{menu_code:"VGK_MY_REGISTRATIONS",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>My Registrations',route:"vgk-my-registrations"},{menu_code:"VGK_MY_SUBMISSIONS",label:'<i class="fas fa-file-invoice" style="margin-right: 8px; width: 18px; text-align: center; color: #8b5cf6;"></i>My Submissions',route:"vgk-my-submissions"}]}];class se{container=null;overlay=null;isOpen=!1;expandedSections=new Set;allowedPaths="*";isSupremeStaff=!1;isStaffMenuLoaded=!1;constructor(){try{if(localStorage.getItem("mnr_staff_is_supreme_cache")==="true")this.isSupremeStaff=!0,this.allowedPaths="*",this.isStaffMenuLoaded=!0;else{const t=localStorage.getItem("mnr_staff_allowed_paths_cache");if(t){const a=JSON.parse(t);Array.isArray(a)&&(this.allowedPaths=new Set(a),this.isStaffMenuLoaded=!0)}}}catch{}this.createElements(),this.loadStaffMenus(),window.addEventListener("logout",()=>{this.allowedPaths="*",this.isSupremeStaff=!1,this.isStaffMenuLoaded=!1;try{localStorage.removeItem("mnr_staff_allowed_paths_cache"),localStorage.removeItem("mnr_staff_is_supreme_cache"),localStorage.removeItem("mnr_staff_menu_tree_cache")}catch{}this.updateUI()}),window.addEventListener("auth-changed",()=>{this.isStaffMenuLoaded=!1,this.loadStaffMenus()})}createElements(){if(this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),!document.getElementById("myntos-drawer-styles")){const e=document.createElement("style");e.id="myntos-drawer-styles",e.textContent=`
      ...
      `,document.head.appendChild(e)}this.attachEventListeners()}render(){const e=D.getPortal(),t=e==="vgk",i=x.getAuthState().user||{},n=(i.role_code||i.role?.role_code||i.user_type||"").toString().toLowerCase().trim(),s=(i.role_name||i.role?.role_name||"").toString().toUpperCase().trim(),l=(i.staff_type||"").toString().toUpperCase().trim();["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin","manager","director","admin"].includes(n)||n.includes("vgk")||n.includes("manager")||n.includes("lead")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER"].includes(s)||s.includes("VGK")||s.includes("MANAGER")||["VGK4U","VGK4U SUPREME"].includes(l)||(i.is_manager||i.is_admin||i.is_super_admin);const o=(i.emp_code||i.employee_code||"").toString().toUpperCase().trim(),r=!(["MR10018","MR10001","MR10025","MR10016"].includes(o)||["SAAS_SEGMENT_ADMIN","SUPER_ADMIN","VGK4U_SUPREME"].includes(l)||["super_admin","saas_segment_admin","key_leadership","vgk4u"].includes(n))&&(n==="tenant_admin"||l==="TENANT_ADMIN"||l==="SAAS_CLIENT"||l==="SAAS_TENANT"||i?.company_segment==="SEGMENT_B_SAAS");let u=ae;if(t)u=ie;else if(e==="staff"){const m=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(n)||n.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(s)||s.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(l);i.staff_type==="FREELANCER"&&i.freelancer_access_mode==="only_leads"||r?u=[]:u=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...m?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i> Auto Dialer',route:"auto-dialer"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling & Softphone',route:"softphone"}]}["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(m=>n.includes(m))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(m=>s.includes(m))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(m=>l.includes(m))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(m=>(i.department||i.department_name||"").toString().toUpperCase().includes(m));const c=t?ne:this.getStaffMenuMaster();return`
      ...
      <div class="drawer-content">
        ...
        <div class="top-menu-items">
          ${u.map(m=>`
            <div class="menu-item top-item" data-route="${m.route}" ${m.tab?`data-tab="${m.tab}"`:""}>
              <span class="menu-label">${m.label}</span>
            </div>
          `).join("")}
        </div>
        <!-- Section menus -->
        ${c.map(m=>this.renderSection(m)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab,i=(e.querySelector(".menu-label")?.textContent||"").trim();let n=W[t]||W[t.replace(/\/$/,"")];!n&&!t.startsWith("/")&&(n=t),n?a?I.navigate(n,{tab:a}):I.navigate(n):I.navigate("embed-view",{url:t,title:i||"Staff Portal",tab:a||""}),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await x.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){const t=x.getAuthState().user||{},a=(t.staff_type||"").toString().toUpperCase().trim(),i=(t.emp_code||t.employee_code||"").toString().toUpperCase().trim(),n=(t.role_code||t.role?.role_code||t.user_type||"").toString().toLowerCase().trim(),s=(t.role_name||t.role?.role_name||"").toString().toUpperCase().trim(),l=["VGK4U_SUPREME","RVZ_SUPREME","VGK4U","VGK4U SUPREME","VGK4U_EA","KEY_LEADERSHIP","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER","DIRECTOR","SUPER_ADMIN","ADMIN"];if(l.includes(a)||["MR10018","MR10001","MR10016","MR10025"].includes(i)||["key_leadership","vgk4u","ea","vgk4u_supreme","executive_admin","manager","director","admin","super_admin"].includes(n)||l.includes(s)||(t.is_manager||t.is_admin||t.is_super_admin)){this.isSupremeStaff=!0,this.allowedPaths="*",this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_is_supreme_cache","true")}catch{}this.updateUI();return}try{const o=await k.get("/staff/menu-settings/my-menus?unified=true");if(o.success&&o.data){const d=o.data.menus||[],r=new Set(d.map(u=>u.route_path).filter(u=>!!u));if(!o.data.is_saas_tenant){r.add("/staff/whatsapp-center"),r.add("/staff/crm/whatsapp-inbox"),r.add("/staff/crm/whatsapp-bot"),r.add("/staff/softphone-center"),r.add("/staff/softphone-hub"),r.add("/staff/softphone"),r.add("/staff/dialer"),r.add("/staff/auto-dialer"),r.add("auto-dialer"),r.add("softphone"),r.add("/staff/my-leads"),r.add("/staff/configuration/catalog"),r.add("/staff/catalog-library"),r.add("/staff/catalog");const u=Number(t.department_id||0),c=(t.department||t.department_name||"").toString().toLowerCase().trim(),m=(t.role_code||t.role?.role_code||t.user_type||"").toString().toLowerCase().trim(),g=(t.role_name||t.role?.role_name||"").toString().toUpperCase().trim(),b=(t.emp_code||t.employee_code||"").toString().toUpperCase().trim();(u===13||u===19||c.includes("sale")||m.includes("sale")||g.includes("SALE")||b==="MN10019")&&(r.add("/staff/executive-dashboard"),r.add("/staff/mnr-leads"),r.add("/staff/mnr-leads-master"),r.add("/staff/solar-vendors"),r.add("/staff/solar-leads"),r.add("/staff/ev-b2b-leads"),r.add("/staff/ev-b2c-leads"),r.add("/staff/ev-spares-leads"),r.add("/staff/real-dreams-leads"),r.add("/staff/insurance-leads"),r.add("/staff/etc-leads"),r.add("/staff/bank-wise-leads"),r.add("/staff/field-sales"),r.add("/staff/leads"),r.add("/staff/crm/leads"),r.add("/staff/crm/dashboard"),r.add("/staff/crm/team-leads"))}this.allowedPaths=r,this.isSupremeStaff=!1,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_is_supreme_cache","false"),localStorage.setItem("mnr_staff_allowed_paths_cache",JSON.stringify(Array.from(r)))}catch{}this.updateUI()}}catch(o){console.error("Failed to load dynamic staff menus:",o),this.allowedPaths="*",this.updateUI()}}getItemIcon(e,t){const a=(e||"").toUpperCase(),i=(t||"").toLowerCase();return a.includes("WHATSAPP")||i.includes("whatsapp")?"fab fa-whatsapp":a.includes("AUTO_DIALER")||i.includes("auto dialer")?"fas fa-phone-volume":a.includes("SOFTPHONE")||i.includes("calling")||i.includes("softphone")?"fas fa-headset":a.includes("CATALOG")||i.includes("catalog")?"fas fa-book-open":a.includes("FIELD_SALES")||i.includes("field sales")||a.includes("BANK_WISE_LEADS")?"fas fa-users-gear":a.includes("SOLAR")||i.includes("solar")?"fas fa-solar-panel":a.includes("EV_")||i.includes("ev ")?"fas fa-car":a.includes("INSURANCE")||i.includes("care")||i.includes("insurance")?"fas fa-shield-alt":a.includes("REAL_DREAMS")||a.includes("REAL_ESTATE")||i.includes("real dreams")||i.includes("real estate")||i.includes("property")?"fas fa-building":a.includes("ETC")||i.includes("training")||i.includes("student")?"fas fa-graduation-cap":a.includes("BONANZA")||i.includes("bonanza")?"fas fa-trophy":a.includes("COUPON")||a.includes("PIN")||i.includes("coupon")||i.includes("pin")?"fas fa-ticket-alt":a.includes("PROMO")||i.includes("promo")?"fas fa-tags":a.includes("VENDOR")||i.includes("vendor")?"fas fa-store":a.includes("WALLET")||i.includes("wallet")?"fas fa-wallet":a.includes("INCOME")||i.includes("earnings")||i.includes("income")?"fas fa-hand-holding-usd":a.includes("POINTS")||i.includes("points")?"fas fa-coins":a.includes("APPROVAL")||i.includes("approval")?"fas fa-clipboard-check":a.includes("KYC")||i.includes("kyc")?"fas fa-id-card":a.includes("TRANSACTION")||i.includes("transaction")?"fas fa-receipt":a.includes("MEMBER")||a.includes("TEAM")||i.includes("member")||i.includes("team")?"fas fa-users":a.includes("ATTENDANCE")||i.includes("attendance")?"fas fa-clock":a.includes("LEAVE")||i.includes("leave")?"fas fa-calendar-times":a.includes("TASK")||i.includes("task")?"fas fa-tasks":a.includes("KRA")||i.includes("kra")?"fas fa-chart-line":a.includes("JOURNEY")||i.includes("journey")?"fas fa-route":a.includes("TICKET")||i.includes("ticket")||i.includes("service")?"fas fa-tools":"fas fa-circle"}getItemIconColor(e,t){const a=(e||"").toUpperCase(),i=(t||"").toLowerCase();return a.includes("WHATSAPP")||i.includes("whatsapp")?"color: #25d366;":a.includes("AUTO_DIALER")||i.includes("auto dialer")||a.includes("SOFTPHONE")||i.includes("softphone")?"color: #38bdf8;":a.includes("CATALOG")||i.includes("catalog")?"color: #10b981;":a.includes("FIELD_SALES")||i.includes("field sales")||a.includes("BANK_WISE_LEADS")?"color: #38bdf8;":a.includes("SOLAR")||i.includes("solar")?"color: #f59e0b;":a.includes("EV_")||i.includes("ev ")?"color: #10b981;":a.includes("INSURANCE")||i.includes("care")||i.includes("insurance")?"color: #059669;":a.includes("REAL_DREAMS")||a.includes("REAL_ESTATE")||i.includes("real dreams")||i.includes("property")?"color: #2563eb;":a.includes("ETC")||i.includes("training")?"color: #8b5cf6;":a.includes("BONANZA")||i.includes("bonanza")?"color: #f59e0b;":a.includes("COUPON")||a.includes("PIN")||i.includes("coupon")||i.includes("pin")?"color: #6366f1;":a.includes("PROMO")||i.includes("promo")?"color: #ec4899;":a.includes("VENDOR")||i.includes("vendor")?"color: #0284c7;":a.includes("WALLET")||i.includes("wallet")||a.includes("INCOME")||i.includes("earnings")||i.includes("income")?"color: #10b981;":a.includes("POINTS")||i.includes("points")?"color: #f59e0b;":a.includes("APPROVAL")||i.includes("approval")?"color: #10b981;":a.includes("KYC")||i.includes("kyc")?"color: #3b82f6;":a.includes("TRANSACTION")||i.includes("transaction")?"color: #0284c7;":a.includes("MEMBER")||a.includes("TEAM")||i.includes("member")||i.includes("team")?"color: #7c3aed;":""}getStaffMenuMaster(){const t=x.getAuthState().user||{},a=(t.emp_code||t.employee_code||"").toString().toUpperCase().trim(),i=(t.role_code||t.role?.role_code||t.user_type||"").toString().toLowerCase().trim(),n=(t.role_name||t.role?.role_name||"").toString().toUpperCase().trim(),s=(t.staff_type||"").toString().toUpperCase().trim(),l=["VGK4U_SUPREME","RVZ_SUPREME","VGK4U","VGK4U SUPREME","VGK4U_EA","KEY_LEADERSHIP","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER","DIRECTOR","SUPER_ADMIN","ADMIN"],o=["MR10018","MR10001","MR10025","MR10016"].includes(a)||["SAAS_SEGMENT_ADMIN","SUPER_ADMIN","VGK4U_SUPREME"].includes(s)||["super_admin","saas_segment_admin","key_leadership","vgk4u"].includes(i),d=this.isSupremeStaff||l.includes(s)||["MR10018","MR10001","MR10016","MR10025"].includes(a)||["key_leadership","vgk4u","ea","vgk4u_supreme"].includes(i)||!!(t.is_manager||t.is_admin||t.is_super_admin),r=["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(f=>i.includes(f))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(f=>n.includes(f))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(f=>s.includes(f))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(f=>(t.department||t.department_name||"").toString().toUpperCase().includes(f)),u=d||r,c=["MR10022","MR10036","MR10027","MN10017","MN10016"].includes(a),m=Number(t.department_id||0),g=(t.department||t.department_name||"").toString().toLowerCase().trim(),b=(t.role_code||t.role?.role_code||t.user_type||"").toString().toLowerCase().trim(),v=(t.role_name||t.role?.role_name||"").toString().toUpperCase().trim(),R=m===13||m===19||g.includes("sale")||b.includes("sale")||v.includes("SALE")||a==="MN10019",B=["/staff/executive-dashboard","/staff/mnr-leads","/staff/mnr-leads-master","/staff/solar-vendors","/staff/solar-leads","/staff/ev-b2b-leads","/staff/ev-b2c-leads","/staff/ev-spares-leads","/staff/real-dreams-leads","/staff/insurance-leads","/staff/etc-leads","/staff/crm/leads","/staff/leads","/staff/crm/dashboard","/staff/crm/team-leads"];t?.base_company_id&&[1,2,3,4,88].includes(Number(t.base_company_id));const _=!o&&(i==="tenant_admin"||s==="TENANT_ADMIN"||s==="SAAS_CLIENT"||s==="SAAS_TENANT"||t?.company_segment==="SEGMENT_B_SAAS"),O=f=>{if(f.route!=="/staff/my-tenant"){if(f.route==="/staff/tenant-users"){if(!(i==="tenant_admin"||s==="TENANT_ADMIN"||o))return null}else if(!d&&this.allowedPaths!=="*"){const h=f.route.replace(/\/$/,"");if(!(!_&&(["/staff/dialer","/staff/auto-dialer","auto-dialer","/staff/softphone","softphone","/staff/whatsapp-center","/staff/configuration/catalog","/staff/catalog-library","/staff/catalog","/staff/bank-wise-leads","/staff/field-sales","/staff/my-leads",...R?B:[]].includes(f.route)||f.route.startsWith("/staff/vgk/")))&&!this.allowedPaths.has(f.route)&&!this.allowedPaths.has(h))return null}}if(f.route==="/staff/configuration/razorpay"||f.route==="/staff/configuration/a1top"){const h=t.emp_code||t.employee_code||t.employee_id||"",T=(t.department||t.department_name||"").toLowerCase();if(!(h==="MR10001"||T==="accounts"))return null}if(c&&(f.route==="/staff/leads"||f.menu_code==="STAFF_LEADS"||f.menu_code==="LEADS_MASTER"))return null;const E=f.route,C=f.label;let A=te[f.route];if(!A){const h=(f.menu_code||"").toUpperCase();h.includes("SOLAR_LEADS")?A="solar":h.includes("EV_B2B")?A="ev-b2b":h.includes("EV_B2C")?A="ev-b2c":h.includes("EV_SPARES")?A="ev-spares":h.includes("REAL_DREAMS")||h.includes("ZYN_REAL_ESTATE")?A="real-dreams":h.includes("INSURANCE")||h.includes("ZYN_INSURANCE")?A="insurance":h.includes("ETC_LEADS")?A="etc":h.includes("MNR_LEADS")&&(A="mnr")}let H="";if(!C.startsWith("<i class=")){const h=f.icon||this.getItemIcon(f.menu_code,C),T=this.getItemIconColor(f.menu_code,C);H=`<i class="${h}" style="margin-right: 8px; width: 18px; text-align: center; ${T}"></i>`}return{menu_code:f.menu_code,label:`${H}${C}`,route:E,tab:A}},P=[];for(const f of Z){if(f.section_code==="PROGRESS")continue;const E=(f.section_code||"").toUpperCase(),C=(f.section_label||"").toUpperCase(),A=E==="VGK_SAAS"||E==="MYNTOS_SAAS"||C.includes("MYNTOS SAAS");if(_&&!(E==="CORE_WORKSPACE"||C==="CORE WORKSPACE")){const w=Array.isArray(t.entitled_modules)&&(t.entitled_modules.includes("STAFF_HRMS")||t.entitled_modules.includes("STAFF_HR"))||!!(this.allowedPaths!=="*"&&this.allowedPaths instanceof Set&&(this.allowedPaths.has("/staff/attendance-sheet")||this.allowedPaths.has("/staff/my-attendance")||this.allowedPaths.has("/staff/employees"))),z=["HR","TASK_MANAGEMENT","KRA_MANAGEMENT","FIELD_LOCATION_TRACKING"],$=["MNR","MYNT","VGK","META","CONFIG","NOT IN USE","NOT_IN_USE","PARTNER","INTERNAL","VGK_SAAS","PROGRESS","STAFF_DASHBOARD","BUSINESS_PARTNERS","CONFIGURATION","META_ADS","MNR_USER_SIDEBAR","VGK_TEAM"];if(w||$.push(...z),$.some(L=>E===L||E.includes(L)||C===L||C.includes(L)))continue}if(!u&&(E.includes("ACCOUNT")||C.includes("ACCOUNT")||E.includes("FINANCE")))continue;if(o){if(a!=="MR10001"&&a!=="MR10025"&&["META","INTERNAL"].some(w=>E.includes(w)||C.includes(w)))continue}else if(_){if(E==="VGK_SAAS"||C.includes("MYNTOS SAAS"))continue}else if(["META","CONFIG","SAAS","INTERNAL"].some(w=>E.includes(w)||C.includes(w))){if(this.allowedPaths!=="*"&&this.allowedPaths instanceof Set){const w=this.allowedPaths;if(![...(f.items||[]).map(L=>L.route),...(f.subSections||[]).flatMap(L=>L.items.map(Q=>Q.route))].some(L=>w.has(L)||w.has(L.replace(/\/$/,""))))continue}else if(!d)continue}if(a==="MR10018"&&["NOT IN USE","NOT_IN_USE","MNR","NDA","ZYNOVA","ZINOVA"].some(w=>(E.includes(w)||C.includes(w))&&!A)||E==="NOT_IN_USE"||C==="NOT IN USE")continue;const h=[],T=[];if(f.items)for(const y of f.items){const w=O(y);w&&h.push(w)}if(E==="CRM_LEADS"&&!_&&(h.some(y=>y.route==="auto-dialer"||y.route==="/staff/dialer")||h.unshift({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"/staff/dialer"}),h.some(y=>y.route==="softphone"||y.route==="/staff/softphone")||h.push({menu_code:"SOFTPHONE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Calling & Softphone',route:"/staff/softphone"}),h.some(y=>y.route==="digital-catalog"||y.route==="/staff/catalog-library"||y.route==="/staff/configuration/catalog")||h.push({menu_code:"DIGITAL_CATALOG",label:'<i class="fas fa-book-open" style="margin-right: 8px; width: 18px; text-align: center; color: #10b981;"></i>Digital Catalog',route:"/staff/catalog-library"})),f.subSections)for(const y of f.subSections){const w=[];for(const z of y.items){const $=O(z);$&&w.push($)}w.length>0&&T.push({sub_section_code:y.sub_section_code,sub_section_label:y.sub_section_label,items:w})}if(h.length>0||T.length>0){const y=_&&(f.section_code==="SOLAR_EV"||(f.section_label||"").toUpperCase().includes("SOLAR"))?"WORKFLOWS":_&&(f.section_code==="SERVICE_TICKETS"||(f.section_label||"").toUpperCase().includes("SERVICE"))?"SERVICE":_&&f.section_code==="ACCOUNTS"?"ACCOUNTS & GST":_&&f.section_code==="HR"?"HRMS":f.section_label;P.push({section_code:f.section_code,section_label:y,order:f.order,items:h.length>0?h:void 0,subSections:T.length>0?T:void 0})}}return P}open(){if(this.isOpen)return;D.getPortal()==="staff"&&this.loadStaffMenus(),this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden"}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let F=null;function oe(){return F||(F=new se),F}class K{static render(e){let{title:t,showBack:a=!1,showLogout:i=!1,rightAction:n,subtitle:s,showMenu:l}=e;const o=D.getPortal(),d=I.getCurrentRoute(),r=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(d);if(l===void 0&&(l=r||!a),o==="vgk"&&(i=!0,!s)){const c=x.getAuthState().user||{},m=c.name||c.partner_name||"",g=c.partner_code||"";(m||g)&&(s=g?`${m} (${g})`:m)}return`
    ...
    `}static getPortalDashboard(){const e=D.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t,showBack:a=!1,rightAction:i,showLogout:n=!1}=e;t===void 0&&(t=!!document.getElementById("hamburgerBtn")),D.getPortal()==="vgk"&&(n=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{oe().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{I.goBack()||I.navigate(K.getPortalDashboard())}),i&&document.getElementById("headerActionBtn")?.addEventListener("click",i.onClick),n&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await x.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{I.goBack()||I.navigate(K.getPortalDashboard())})}}class Ee{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
...
పై లింక్ ఓపెన్ చేసి మీ ఇంటి కరెంట్ బిల్లుకు సరిపోయే ప్లాన్ మరియు సేవింగ్స్ కాలిక్యులేట్ చేసుకోగలరు.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to calculate your recommended capacity, savings & instant quotation.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करें और अपनी मासिक बचत की गणना करें।`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
ఉచిత VIP సైట్ విజిట్ కోసం సంప్రదించండి.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Complimentary chauffeur AC cab pickup available for site visits!`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
ई-कॉमर्स पर प्लॉट्स देखें: https://www.myntreal.com/ecom?vertical=real-dreams`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
పై లింక్ క్లిక్ చేసి మోడల్-వైజ్ ధరలు, స్పెసిఫికేషన్లు & అధికారిక వీడియో చూడగలరు. ఉచిత టెస్ట్ డ్రైవ్ బుక్ చేసుకోండి!`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to explore model-wise prices, interactive savings calculator & official video showcase. Book your free test ride today!`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके मॉडल-वाइज कीमतें और वीडियो देखें। आज ही फ्री टेस्ट ड्राइव बुक करें!`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
పై లింక్ క్లిక్ చేసి B2B ఫ్లీట్ మోడల్స్ మరియు ROI కాలిక్యులేటర్ చూడండి.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to review vehicle specifications & calculate fleet ROI.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके कमर्शियल वाहन विवरण देखें।`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
24 గంటల్లో దేశవ్యాప్త డెలివరీ & అధికారిక GST ఇన్వాయిసింగ్.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Immediate 24-Hour Pan-India Dispatch | Full GST Invoicing.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
ई-कॉमर्स पर ऑर्डर करने के लिए: https://www.myntreal.com/ecom?vertical=ev&category=spares`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
పై లింక్ క్లిక్ చేసి సిలబస్ మరియు తదుపరి బ్యాచ్ వివరాలు చూడండి.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to view curriculum, batch dates & reserve your seat.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके बैच डेट्स और सीट रिजर्व करें।`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
மேலே உள்ள இணைப்பைக் கிளிக் செய்து பாடத்திட்டம் மற்றும் சேர்க்கை விவரங்களை அறிக.`}},insurance:{name:"Comprehensive Insurance Advisory",btnLabel:"Insurance",segmentSlug:"insurance",catalogSlug:"comprehensive-insurance-advisory",brochureUrl:"/public/hub/Assets/myntreal_insurance_guide.pdf",desc:"Sends Insurance catalog with complete risk protection for EV fleets, solar rooftop plants, health & life.",messages:{te:(p,e)=>`నమస్కారం ${p} గారు! 🙏
...
పై లింక్ ద్వారా ప్రీమియం కాలిక్యులేట్ చేసుకోండి మరియు తక్షణ పాలసీ పొందండి.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to calculate customized premiums and issue policies on spot.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके बीमा योजनाओं की तुलना करें और कोटेशन पाएं।`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
పై లింక్ క్లిక్ చేసి పూర్తి ప్రాస్పెక్టస్, ROI మోడల్ & వివరాలు చూడగలరు.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to review complete deliverables, financial models & territory rights.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया ऊपर दिए गए लिंक पर क्लिक करके पूरी जानकारी और आरओआई मॉडल देखें।`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
పై లింక్ క్లిక్ చేసి పూర్తి హోల్‌సేల్ కాస్ట్ షీట్ & ROI వివరాలు వెంటనే చూడగలరు.`,en:(p,e)=>`Namaskaram ${p}! 🙏
...
Click the link above to review wholesale cost sheets & calculate your net returns.`,hi:(p,e)=>`नमस्ते ${p} जी! 🙏
...
कृपया तुरंत ऊपर दिए गए लिंक पर क्लिक करके पूरी कॉस्ट शीट देखें।`,ta:(p,e)=>`வணக்கம் ${p}! 🙏
...
முழு விலை மற்றும் வருவாய் விவரங்களை அறிய மேலே உள்ள இணைப்பை கிளிக் செய்யவும்.`}}};class re{modalEl=null;currentOptions=null;activeMode="scanned";selectedCatalogKey="solar";selectedCatalogLang="te";allCanonicalTemplates=[];canonicalTemplates=[];selectedCanonicalBody="";getSenderSignature(){const t=x.getAuthState().user||{},a=t.full_name||t.name||`${t.first_name||""} ${t.last_name||""}`.trim()||"Staff",i=String(t.emp_code||"").trim().toUpperCase(),n=i==="MR10001"||a.toUpperCase().includes("SYSTEM ADMINISTRATOR");let s=null;if(!n&&(s=t.extension||t.ext||(typeof window<"u"?window.__STAFF_EXTENSION__:null),!s&&i)){const l=i.match(/(\d{1,4})$/);if(l){const o=parseInt(l[1],10),d=String(o%100).padStart(2,"0");i.startsWith("MR")?s="1"+d:i.startsWith("MN")?s="2"+d:i.startsWith("FL")?s="4"+d:s="8"+d}}return s&&String(s).trim()&&!["none","null","undefined","n/a"].includes(String(s).trim().toLowerCase())?`
...
👉 ${r}`}return d}applyDigitalCatalog(e){e&&(this.selectedCatalogLang=e,this.modalEl?.querySelectorAll(".uwa-cat-lang-btn")?.forEach(l=>{const o=l.getAttribute("data-lang")===e;l.style.background=o?"#16a34a":"#fff",l.style.color=o?"#fff":"#334155",l.style.borderColor=o?"#16a34a":"#cbd5e1",l.style.fontWeight=o?"700":"600"}));const t=document.getElementById("uwaDigitalCatSel");t&&t.value&&(this.selectedCatalogKey=t.value);const a=this.getDigitalCatalogMessage(this.selectedCatalogKey,this.selectedCatalogLang),i=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=a+i,n.focus())}detectCatalogKey(){if(this.currentOptions?.catalogKey&&N[this.currentOptions.catalogKey])return this.currentOptions.catalogKey;const e=(this.currentOptions?.context||"").toLowerCase(),t=(this.currentOptions?.segment||"").toLowerCase();return e.includes("solar")||t==="solar"?"solar":e.includes("real")||e.includes("property")||e.includes("estate")||t==="myntreal_real"?"real_estate":e.includes("spare")||t==="ev_spares"?"ev_spares":e.includes("cargo")||e.includes("fleet")||e.includes("b2b")||t==="ev_b2b"?"ev_b2b":e.includes("ev")||e.includes("zynova")||e.includes("vehicle")||t==="ev_b2c"?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")||t==="etc_training"?"etc_training":e.includes("insur")||e.includes("policy")||e.includes("care")?"insurance":e.includes("pricing")||e.includes("margin")||e.includes("commercial")||t==="hub_pricing"?"hub_pricing":e.includes("hub")||e.includes("franchise")?"industrial_hub":"solar"}async loadCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;t.innerHTML='<option value="">— Loading templates… —</option>',a&&(a.style.display="none");const i=this.activeMode==="scanned"?"scanned":"company";let n=`/whatsapp-config/templates?mode=${encodeURIComponent(i)}`;try{const s=await k.get(n),l=s?.templates||s?.data||s||[];this.allCanonicalTemplates=Array.isArray(l)?l:[],this.filterCanonicalTemplates(e)}catch{t.innerHTML='<option value="">— Error loading templates —</option>'}}filterCanonicalTemplates(e){const t=document.getElementById("uwaCanonicalTpl"),a=document.getElementById("uwaNoTplNotice");if(!t)return;const i=document.getElementById("uwaCanonicalSeg"),n=document.getElementById("uwaCanonicalCat"),s=document.getElementById("uwaCanonicalSearch"),l=(i?.value||"").toLowerCase().trim(),o=(n?.value||"").toUpperCase().trim(),d=(s?.value||"").toLowerCase().trim();let r=this.allCanonicalTemplates||[];if(l&&(r=r.filter(c=>(c.segment||"").toLowerCase()===l)),o&&(r=r.filter(c=>(c.category||"").toUpperCase()===o)),d&&(r=r.filter(c=>{const m=(c.template_name||c.name||"").toLowerCase(),g=(c.body_text||c.content||c.body||"").toLowerCase(),b=(c.slug||"").toLowerCase();return m.includes(d)||g.includes(d)||b.includes(d)})),this.canonicalTemplates=r,!r.length){t.innerHTML=`
      ...
      `,a&&(a.style.display="block"),this.onCanonicalTplChange();return}a&&(a.style.display="none");let u=`<option value="">— Select template (${r.length} available) —</option>`;u+='<option value="__create_new__" style="color:#16a34a; font-weight:700;">➕ Create / Add Template for this Segment...</option>',r.forEach(c=>{const m=c.segment?`[${c.segment}] `:"";u+=`<option value="${c.id}">${m}${this.escapeHtml(c.template_name||c.name||"Template #"+c.id)} (${c.category||"MARKETING"})</option>`}),t.innerHTML=u,e&&(t.value=String(e),this.onCanonicalTplChange())}toggleAddTemplateCard(e){const t=document.getElementById("uwaAddTplCard");if(!t)return;const a=t.style.display!=="none",i=e!==void 0?e:!a;if(t.style.display=i?"block":"none",i){const n=document.getElementById("uwaCanonicalSeg")?.value||this.detectSegment(),s=document.getElementById("uwaNewTplSeg");s&&n&&(s.value=n),document.getElementById("uwaNewTplName")?.focus()}}async saveNewTemplate(){const e=document.getElementById("uwaNewTplName"),t=document.getElementById("uwaNewTplSeg"),a=document.getElementById("uwaNewTplBody"),i=document.getElementById("uwaSaveNewTplBtn"),n=(e?.value||"").trim(),s=t?.value||"general",l=(a?.value||"").trim();if(!n){this.showFeedback("Please enter a template name.","error");return}if(!l){this.showFeedback("Please enter the template message body.","error");return}i&&(i.disabled=!0);const o=n.toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,40);try{const d=await k.post("/whatsapp-config/templates",{name:n,slug:o,category:"MARKETING",segment:s,body_text:l,language:"en",usage_scope:"all"});if(d?.success){this.showFeedback(`✅ Template "${n}" created & approved for WhatsApp API!`,"success"),this.toggleAddTemplateCard(!1),e&&(e.value=""),a&&(a.value="");const r=document.getElementById("uwaCanonicalSeg");r&&(r.value=s);const u=d.template?.id||d.id||o;await this.loadCanonicalTemplates(u)}else this.showFeedback(d?.error||"Failed to create template","error")}catch(d){this.showFeedback(`Error creating template: ${d.message||"Server error"}`,"error")}finally{i&&(i.disabled=!1)}}detectSegment(){if(this.currentOptions?.segment)return this.currentOptions.segment;const e=(this.currentOptions?.context||"").toLowerCase();return e.includes("solar")?"solar":e.includes("real")||e.includes("property")||e.includes("estate")?"myntreal_real":e.includes("spare")?"EV_SPARES":e.includes("ev")||e.includes("vehicle")||e.includes("zynova")?"ev_b2c":e.includes("train")||e.includes("skill")||e.includes("etc")?"etc_training":e.includes("partner")?"partner":e.includes("staff")?"staff":e.includes("vgk")?"vgk":"general"}onCanonicalTplChange(){const e=document.getElementById("uwaCanonicalTpl"),t=document.getElementById("uwaCanonicalVarsWrap"),a=document.getElementById("uwaCanonicalVarsBox"),i=e?.value;if(i==="__create_new__"){this.toggleAddTemplateCard(!0),e.value="";return}if(!i){t&&(t.style.display="none"),a&&(a.innerHTML="");return}this.activeMode!=="scanned"&&(this.activeMode="scanned",this.updateModeUI());const n=this.canonicalTemplates.find(o=>String(o.id)===String(i)||String(o.slug)===String(i));if(!n)return;this.selectedCanonicalBody=n.body_text||n.content||n.body||"";const s=this.selectedCanonicalBody.match(/\{\{(\d+)\}\}/g)||[],l=[];if(s.forEach(o=>{const d=o.replace(/[\{\}]/g,"");l.includes(d)||l.push(d)}),l.sort((o,d)=>Number(o)-Number(d)),l.length&&a&&t){t.style.display="block";let o="";l.forEach(d=>{const r=d==="1"&&this.currentOptions?.name||"";o+=`
      ...
      <div class="uwa-modal-sheet">
        ...
        <div class="uwa-chips-row">
          ${Object.entries(q).map(([m,g])=>`
            <button class="uwa-chip-btn" data-tpl-key="${m}">
              ${g.label}
            </button>
          `).join("")}
        </div>
    ...
    `,document.body.appendChild(this.modalEl);const d=this.detectSegment(),r=document.getElementById("uwaCanonicalSeg");r&&d&&(r.value=d);const u=this.detectCatalogKey(),c=document.getElementById("uwaDigitalCatSel");c&&u&&(c.value=u),this.onDigitalCatalogSelect(u),this.attachEvents(),this.updateModeUI(),this.checkBotStatus(),this.loadCanonicalTemplates()}async checkBotStatus(){try{const e=await k.get("/whatsapp/bot-status"),t=e?.success&&(e.data?.connected===!0||e.data?.status==="connected"),a=this.modalEl?.querySelector("#uwaModeScannedBtn span:last-child"),i=document.getElementById("uwaScanBotBadge");t?(a&&(a.textContent="● Active & Ready",a.style.background="#10b981"),i&&(i.textContent="● Active & Ready",i.style.background="#047857")):(a&&(a.textContent="● Connecting / QR",a.style.background="#f59e0b"),i&&(i.textContent="● Connecting / QR",i.style.background="#d97706"))}catch{}}attachEvents(){this.modalEl&&(document.getElementById("uwaCloseBtn")?.addEventListener("click",()=>this.close()),document.getElementById("uwaCancelBtn")?.addEventListener("click",()=>this.close()),document.getElementById("uwaQuickThanksBtn")?.addEventListener("click",()=>this.applyVerticalQuick("thanks_connecting")),document.getElementById("uwaQuickReachBtn")?.addEventListener("click",()=>this.applyVerticalQuick("trying_to_reach")),document.getElementById("uwaDigitalCatSel")?.addEventListener("change",e=>{this.onDigitalCatalogSelect(e.target.value)}),this.modalEl.querySelectorAll(".uwa-cat-lang-btn").forEach(e=>{e.addEventListener("click",t=>{const a=t.currentTarget.getAttribute("data-lang")||"te";this.applyDigitalCatalog(a)})}),document.getElementById("uwaInsertDigitalCatBtn")?.addEventListener("click",()=>{this.applyDigitalCatalog()}),document.getElementById("uwaCanonicalSeg")?.addEventListener("change",()=>this.filterCanonicalTemplates()),document.getElementById("uwaCanonicalCat")?.addEventListener("change",()=>this.filterCanonicalTemplates()),document.getElementById("uwaCanonicalSearch")?.addEventListener("input",()=>this.filterCanonicalTemplates()),document.getElementById("uwaCanonicalTpl")?.addEventListener("change",()=>this.onCanonicalTplChange()),document.getElementById("uwaToggleAddTplBtn")?.addEventListener("click",()=>this.toggleAddTemplateCard()),document.getElementById("uwaCancelAddTplBtn")?.addEventListener("click",()=>this.toggleAddTemplateCard(!1)),document.getElementById("uwaSaveNewTplBtn")?.addEventListener("click",()=>this.saveNewTemplate()),document.getElementById("uwaModeScannedBtn")?.addEventListener("click",()=>{this.activeMode="scanned",this.updateModeUI(),this.loadCanonicalTemplates()}),document.getElementById("uwaModeMetaBtn")?.addEventListener("click",()=>{this.activeMode="meta_api",this.updateModeUI(),this.loadCanonicalTemplates()}),this.modalEl.querySelectorAll(".uwa-chip-btn").forEach(e=>{e.addEventListener("click",t=>{const a=t.currentTarget.dataset.tplKey;if(a&&q[a]){const i=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=q[a].text+i,n.focus())}})}),document.getElementById("uwaSendScanBtn")?.addEventListener("click",()=>{this.activeMode="scanned",this.updateModeUI(),this.handleSend()}),document.getElementById("uwaSendApiBtn")?.addEventListener("click",()=>{this.activeMode="meta_api",this.updateModeUI(),this.handleSend()}),document.getElementById("uwaSendBtn")?.addEventListener("click",()=>this.handleSend()))}updateModeUI(){const e=document.getElementById("uwaModeScannedBtn"),t=document.getElementById("uwaModeMetaBtn"),a=document.getElementById("uwaSendScanBtn"),i=document.getElementById("uwaSendApiBtn");this.activeMode==="scanned"?(e?.classList.add("active"),t?.classList.remove("active"),a&&(a.style.background="#10b981",a.style.color="#fff",a.style.border="2px solid #059669",a.style.boxShadow="0 0 0 3px rgba(16,185,129,0.25)",a.style.opacity="1"),i&&(i.style.background="#1e293b",i.style.color="#94a3b8",i.style.border="1px solid rgba(255,255,255,0.15)",i.style.boxShadow="none",i.style.opacity="0.85")):(e?.classList.remove("active"),t?.classList.add("active"),i&&(i.style.background="#2563eb",i.style.color="#fff",i.style.border="2px solid #1d4ed8",i.style.boxShadow="0 0 0 3px rgba(37,99,235,0.25)",i.style.opacity="1"),a&&(a.style.background="#1e293b",a.style.color="#94a3b8",a.style.border="1px solid rgba(255,255,255,0.15)",a.style.boxShadow="none",a.style.opacity="0.85"))}async handleSend(){if(!this.currentOptions)return;const e=document.getElementById("uwaMessageText"),t=document.getElementById("uwaSendScanBtn"),a=document.getElementById("uwaSendApiBtn"),i=document.getElementById("uwaSendBtn");let n=(e?.value||"").trim();if(!n){this.showFeedback("Please enter a message to send.","error");return}const s=this.getSenderSignature();n.toLowerCase().includes("regards,")||(n=n+s);const{phone:l,name:o,leadId:d}=this.currentOptions,r=(l||"").replace(/\D/g,"").slice(-10),u=!!(d&&d!=="new"&&!isNaN(Number(d)));if((!r||r.length<10)&&!u){this.showFeedback("Invalid recipient phone number.","error");return}if(t&&(t.disabled=!0),a&&(a.disabled=!0),i&&(i.disabled=!0),this.activeMode==="meta_api"){a&&(a.innerHTML='<i class="fas fa-spinner fa-spin me-1"></i> Sending API...'),this.showFeedback("Dispatching via WhatsApp Cloud API...","info");try{const c=u?Number(d):0,m=await k.post(`/whatsapp-config/crm-lead-send/${c}`,{phone:r.length>=10?r:void 0,custom_message:n,send_mode:"company"});if(m.success)this.currentOptions.catalogId&&k.post(`/digital-catalogs/${this.currentOptions.catalogId}/log-dispatch`,{lead_id:u?Number(d):null,phone:r,name:o||null,channel:"whatsapp",mode:"company",send_status:"sent"}).catch(g=>console.warn("[UnifiedWAModal] log-dispatch error:",g)),a&&(a.innerHTML='<i class="fas fa-check me-1"></i> Sent API ✓'),this.showFeedback("✅ Dispatched via WhatsApp Meta Cloud API (Official Business)","success"),setTimeout(()=>this.close(),2e3);else{const g=m.error||m.data?.reason||"Meta API not available.";this.showFeedback(`❌ Meta API Error: ${g}`,"error"),a&&(a.disabled=!1,a.innerHTML='<i class="fas fa-cloud"></i> <span>API</span> <span id="uwaApiBotBadge" style="background:#1e40af; color:#fff; font-size:9.5px; padding:1px 6px; border-radius:10px; font-weight:600;">Meta</span>'),t&&(t.disabled=!1)}}catch(c){console.warn("[UnifiedWAModal] Meta API failed:",c),this.showFeedback(`❌ Meta API Network error: ${c.message||"Server unreachable"}`,"error"),a&&(a.disabled=!1,a.innerHTML='<i class="fas fa-cloud"></i> <span>API</span> <span id="uwaApiBotBadge" style="background:#1e40af; color:#fff; font-size:9.5px; padding:1px 6px; border-radius:10px; font-weight:600;">Meta</span>'),t&&(t.disabled=!1)}return}t&&(t.innerHTML='<i class="fas fa-spinner fa-spin me-1"></i> Sending Scan...'),this.showFeedback("Connecting to WhatsApp Bot Gateway...","info");try{const c=await k.post("/whatsapp/send-message",{recipient:r.length>=10?r:"LEAD_RESOLVE",message:n,recipient_type:"individual",recipient_name:o||"Customer",lead_id:u?Number(d):d||null});if(c.success)this.currentOptions.catalogId&&k.post(`/digital-catalogs/${this.currentOptions.catalogId}/log-dispatch`,{lead_id:u?Number(d):null,phone:r,name:o||null,channel:"whatsapp",mode:"scanned",send_status:"sent"}).catch(m=>console.warn("[UnifiedWAModal] log-dispatch error:",m)),t&&(t.innerHTML='<i class="fas fa-check me-1"></i> Sent Scan ✓'),this.showFeedback(`✅ Dispatched via Personal Scanned WhatsApp! Sender: ${this.escapeHtml(x.getAuthState().user?.full_name||"Staff")}`,"success"),setTimeout(()=>this.close(),2e3);else{const m=c.error||"Personal WhatsApp Web is disconnected or unlinked.";this.showFeedback(`❌ Personal WA: ${m}. You can switch to "API" mode to send via Official Meta Business.`,"error"),t&&(t.disabled=!1,t.innerHTML='<i class="fas fa-qrcode"></i> <span>Scan</span> <span id="uwaScanBotBadge" style="background:#047857; color:#fff; font-size:9.5px; padding:1px 6px; border-radius:10px; font-weight:700;">● Active</span>'),a&&(a.disabled=!1)}}catch(c){console.error("[UnifiedWAModal] Send error:",c),this.showFeedback('❌ Personal WhatsApp Gateway offline. You can switch to "API" to send via Meta Cloud.',"error"),t&&(t.disabled=!1,t.innerHTML='<i class="fas fa-qrcode"></i> <span>Scan</span> <span id="uwaScanBotBadge" style="background:#047857; color:#fff; font-size:9.5px; padding:1px 6px; border-radius:10px; font-weight:700;">● Active</span>'),a&&(a.disabled=!1)}}showFeedback(e,t){const a=document.getElementById("uwaFeedbackBox");a&&(a.style.display="block",a.className=`uwa-feedback-box ${t}`,a.innerHTML=e)}maskPhone(e){if(!e)return"-";const t=String(e).replace(/\D/g,"");return t.length>=10?"+91 "+t.slice(-10,-8)+"••••"+t.slice(-4):t.length>=4?"••••"+t.slice(-4):"••••"}escapeHtml(e){const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"};return(e||"").replace(/[&<>"']/g,a=>t[a])}}const Ce=new re;class le{modalEl=null;currentOptions=null;staffList=[];isLoadingStaff=!1;async open(e){this.currentOptions=e,this.render(),await this.loadStaff()}close(){this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.currentOptions=null}escapeHtml(e){const t=document.createElement("div");return t.textContent=e||"",t.innerHTML}maskPhone(e){const t=(e||"").replace(/\D/g,"");return t.length<6?e||"":t.slice(0,2)+"••••"+t.slice(-4)}async loadStaff(){const e=document.getElementById("usmStaffSelect");if(e){e.innerHTML='<option value="">— Loading staff members… —</option>',this.isLoadingStaff=!0;try{const t=await k.get("/crm/leads/shareable-staff"),a=t?.staff||t?.data?.staff||[];this.staffList=a;const n=(x.getAuthState().user||{}).id;if(!a.length){e.innerHTML='<option value="">No active staff members found</option>';return}let s='<option value="">— Select Staff Member for Follow-up —</option>';a.forEach(l=>{const o=n&&l.id===n,d=[l.role,l.department].filter(Boolean).join(" · ");s+=`<option value="${l.id}" data-phone="${l.phone||""}">${this.escapeHtml(l.name)} (${l.emp_code})${d?" — "+this.escapeHtml(d):""}${o?" [You]":""}</option>`}),e.innerHTML=s}catch(t){console.error("[UnifiedShareLeadModal] Failed to load staff:",t),e.innerHTML='<option value="">Failed to load staff list</option>'}finally{this.isLoadingStaff=!1,this.updatePreview()}}}render(){this.modalEl&&this.modalEl.remove();const e=this.currentOptions;if(!e)return;const t=document.createElement("div");t.id="unifiedShareLeadModal",t.style.cssText=["position: fixed","inset: 0","z-index: 100000","background: rgba(0, 0, 0, 0.75)","display: flex","align-items: flex-end","justify-content: center",'font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif'].join(";");const a=this.maskPhone(e.phone);t.innerHTML=`
    ...
    `,document.body.appendChild(t),this.modalEl=t,document.getElementById("usmCloseBtn")?.addEventListener("click",()=>this.close()),t.addEventListener("click",l=>{l.target===t&&this.close()}),document.getElementById("usmStaffSelect")?.addEventListener("change",()=>this.updatePreview()),document.getElementById("usmFollowupType")?.addEventListener("change",()=>this.updatePreview()),document.getElementById("usmNotes")?.addEventListener("input",()=>this.updatePreview()),document.getElementById("usmWaOnlyBtn")?.addEventListener("click",()=>this.executeShare("wa_only")),document.getElementById("usmCrmOnlyBtn")?.addEventListener("click",()=>this.executeShare("crm_only")),document.getElementById("usmCombinedBtn")?.addEventListener("click",()=>this.executeShare("combined"))}updatePreview(){const e=document.getElementById("usmMessagePreview");if(!e||!this.currentOptions)return;const a=document.getElementById("usmStaffSelect")?.value;this.staffList.find(g=>String(g.id)===String(a));const i=document.getElementById("usmFollowupType")?.value||"secondary_followup",n=document.getElementById("usmNotes")?.value||"",s=x.getAuthState().user||{},l=s.full_name||s.name||"Telecaller",o=this.currentOptions,d={site_visit:"Site Visit / Field Inspection",secondary_followup:"Secondary Follow-Up Call",quotation:"Quotation & Pricing Discussion",technical:"Technical / Rooftop Feasibility",escalation:"Senior Escalation / Special Handling",general:"General Lead Follow-Up"}[i]||"Secondary Follow-Up",r=o.budgetMin||o.budgetMax?`₹${((o.budgetMin||0)/1e5).toFixed(1)}L - ₹${((o.budgetMax||o.budgetMin||0)/1e5).toFixed(1)}L`:"",u=`https://www.myntreal.com/staff/softphone?lead_id=${o.leadId}&auto_dial=1`,c=`https://www.myntreal.com/staff/leads?lead_id=${o.leadId}`,m=["📢 *LEAD DETAILS FOR SECONDARY FOLLOW-UP*","",`👤 *Customer*: ${o.name}`,`📱 *Phone*: ${o.phone}`,o.area||o.city?`📍 *Location*: ${[o.area,o.city].filter(Boolean).join(", ")}`:null,o.category?`🏷️ *Category*: ${o.category}`:null,`🎯 *Purpose*: ${d}`,o.requirements?`📝 *Requirement*: ${o.requirements}`:null,r?`💰 *Budget*: ${r}`:null,n?`💬 *Notes*: ${n}`:null,`👉 *Shared by*: ${l}`,"",`📞 *Call via Softphone*: ${u}`,`🔗 *View Lead in CRM*: ${c}`].filter(Boolean).join(`
`);e.textContent=m}async executeShare(e){const t=document.getElementById("usmStaffSelect"),a=parseInt(t?.value||"0",10);if(!a){alert("Please select a staff member to share details with."),t?.focus();return}const i=this.staffList.find(c=>c.id===a);if(!i){alert("Selected staff member is invalid.");return}const n=document.getElementById("usmFollowupType")?.value||"secondary_followup",s=document.getElementById("usmNotes")?.value.trim()||"",l=document.getElementById("usmAssignCheck")?.checked||!1,o=this.currentOptions;if(!o)return;const d=document.getElementById("usmCombinedBtn"),r=document.getElementById("usmCrmOnlyBtn"),u=document.getElementById("usmWaOnlyBtn");[d,r,u].forEach(c=>{c&&(c.disabled=!0)});try{let c="",m="";if(e==="crm_only"||e==="combined"||l){const b={target_staff_id:a,followup_type:n,notes:s,assign_as_secondary:l},v=await k.post(`/crm/leads/${o.leadId}/share-details`,b);if(v&&v.success)c=v.wa_url||"",m=v.wa_message||"",o.onShared&&o.onShared(v);else throw new Error(v?.detail||v?.message||"Failed to assign lead in CRM")}if(e==="wa_only"||e==="combined"){if(!c){const b=(i.phone||"").replace(/\D/g,"").slice(-10);if(!b)alert(`Colleague ${i.name} does not have a valid mobile number for WhatsApp.`);else{const v=document.getElementById("usmMessagePreview")?.textContent||"";c=`https://wa.me/91${b}?text=${encodeURIComponent(v)}`}}c&&window.open(c,"_blank")}const g=e==="crm_only"?`Lead successfully assigned to ${i.name} in CRM!`:e==="wa_only"?`WhatsApp launched for ${i.name}!`:`Lead assigned in CRM and WhatsApp opened for ${i.name}!`;alert(`✅ ${g}`),this.close()}catch(c){console.error("[UnifiedShareLeadModal] Share failed:",c),alert(`⚠️ Could not complete lead share: ${c.message||c}`)}finally{[d,r,u].forEach(c=>{c&&(c.disabled=!1)})}}}const _e=new le;class Y{static open(e){V.open(e)}static close(){V.close()}currentReview=null;onSavedCallback=null;scores={script_adherence_score:5,tone_attitude_score:5,info_accuracy_score:5,objection_handling_score:5,closing_technique_score:5,disposition_accuracy_score:5};async open(e){this.injectDOM(),this.onSavedCallback=e.onSaved||null;const t=document.getElementById("mobileUqrRoot"),a=document.getElementById("mobileUqrContent");if(!(!t||!a)){t.style.display="flex",a.innerHTML=`
    ...
    `;try{const i=await k.post("/api/v1/call-quality/reviews/open-or-create",{call_log_id:Number(e.callLogId)||null,call_session_id:e.callSessionId||null,phone:e.phone||null,lead_id:Number(e.leadId)||null});if(!i||!i.success){a.innerHTML=`
          <div style="text-align:center; padding:30px 16px; color:#ef4444;">
            ...
            <div style="font-size:11.5px; color:#64748b; margin-top:4px;">${this.escape(i?.error||i?.detail||"Call record not found")}</div>
        ...
        `,document.getElementById("mobileUqrCloseErrBtn")?.addEventListener("click",()=>this.close());return}this.currentReview=i.data?.review||i.data,this.initScores(this.currentReview),this.renderReviewView(this.currentReview)}catch(i){a.innerHTML=`
        <div style="text-align:center; padding:30px 16px; color:#ef4444;">
          <i class="fas fa-exclamation-triangle" style="font-size:24px; margin-bottom:8px;"></i>
          <div style="font-size:13px; font-weight:700;">Error opening review</div>
          <div style="font-size:11.5px; color:#64748b; margin-top:4px;">${this.escape(i.message||String(i))}</div>
          <button id="mobileUqrCloseErrBtn" style="margin-top:14px; background:#f1f5f9; border:1px solid #cbd5e1; border-radius:6px; padding:6px 16px; font-size:12px; cursor:pointer;">Close</button>
        </div>
      `,document.getElementById("mobileUqrCloseErrBtn")?.addEventListener("click",()=>this.close())}}}close(){const e=document.getElementById("mobileUqrRoot");e&&(e.style.display="none");const t=e?.querySelector("audio");if(t)try{t.pause()}catch{}this.currentReview=null}initScores(e){this.scores={script_adherence_score:Number(e.script_adherence_score)||5,tone_attitude_score:Number(e.tone_attitude_score)||5,info_accuracy_score:Number(e.info_accuracy_score)||5,objection_handling_score:Number(e.objection_handling_score)||5,closing_technique_score:Number(e.closing_technique_score)||5,disposition_accuracy_score:Number(e.disposition_accuracy_score)||5}}calcOverallScore(){const e=Object.values(this.scores).reduce((a,i)=>a+i,0),t=Math.round(e/30*100);return t>=85?{score:t,label:"Excellent",bg:"#ecfdf5",color:"#047857"}:t>=70?{score:t,label:"Good",bg:"#eff6ff",color:"#1d4ed8"}:t>=50?{score:t,label:"Average",bg:"#fef3c7",color:"#b45309"}:{score:t,label:"Needs Improvement",bg:"#fef2f2",color:"#b91c1c"}}formatCallDuration(e){const t=parseInt(String(e),10)||0;if(t<=0)return"0s";const a=Math.floor(t/3600),i=Math.floor(t%3600/60),n=t%60;return a>0?`${a}h ${i>0?i+"m ":""}${n>0?n+"s":""}`.trim():i>0?`${i}m ${n>0?n+"s":""}`.trim():`${n}s`}renderReviewView(e){const t=document.getElementById("mobileUqrContent");if(!t)return;const a=e.call_identity||{},i=a.caller_name||e.staff_name||"Staff",n=a.recipient_name||e.customer_name||"Customer",s=a.customer_phone||e.phone_number||e.customer_phone||"—",l=(a.direction||e.direction||"outbound").toLowerCase(),o=this.formatCallDuration(a.duration_seconds||e.duration_seconds||0),d=e.sample_date||e.call_datetime||"—",r=e.recording_url||a.recording_url,u=this.calcOverallScore();t.innerHTML=`
      <!-- Header Call Info -->
      <div style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; padding:12px; margin-bottom:14px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
          <div style="display:flex; align-items:center; gap:6px;">
            <span style="background:${l==="outbound"?"#dbeafe":"#e0e7ff"}; color:${l==="outbound"?"#1d4ed8":"#4338ca"}; font-size:10px; font-weight:800; padding:2px 8px; border-radius:4px; text-transform:uppercase;">
              ${l==="outbound"?"↗ Outbound":"↙ Inbound"}
            </span>
            <span style="font-size:11px; font-weight:700; color:#334155;">${this.escape(o)}</span>
          </div>
          <div id="mobileUqrScoreBadge" style="background:${u.bg}; color:${u.color}; border:1px solid currentColor; font-size:11px; font-weight:800; padding:2px 8px; border-radius:12px;">
            ${u.score}% · ${u.label}
          </div>
        </div>

        <div style="display:flex; justify-content:space-between; align-items:center; font-size:12px; margin-bottom:4px;">
          <div><strong style="color:#0f172a;">${this.escape(i)}</strong> <span style="font-size:10px; color:#64748b;">(Caller)</span></div>
          <i class="fas fa-arrow-right" style="color:#94a3b8; font-size:10px;"></i>
          <div><strong style="color:#0f172a;">${this.escape(n)}</strong> <span style="font-size:10px; color:#64748b;">(Recipient)</span></div>
        </div>
        ...
        <div style="font-size:11px; color:#64748b; display:flex; justify-content:space-between; align-items:center; margin-top:6px; border-top:1px dashed #e2e8f0; padding-top:6px;">
          <div><i class="fas fa-phone-alt me-1" style="color:#3b82f6;"></i>${this.escape(s)}</div>
          <div><i class="fas fa-clock me-1"></i>${this.escape(d)}</div>
        </div>

        ${r?`
          <div style="margin-top:10px; padding-top:8px; border-top:1px solid #e2e8f0;">
            <audio controls style="width:100%; height:32px;" preload="metadata">
              <source src="${this.escape(r)}" type="audio/mpeg">
              <source src="${this.escape(r)}" type="audio/wav">
      ...
      <div style="margin-bottom:14px;">
        ...
        <textarea id="mobileUqrRemarks" rows="2" placeholder="Enter quality feedback, strengths, or training points..." style="width:100%; box-sizing:border-box; font-size:12px; padding:8px 10px; border:1px solid #cbd5e1; border-radius:8px; resize:vertical;">${this.escape(e.remarks||"")}</textarea>
      </div>
    ...
    `,this.bindStarEvents(),document.getElementById("mobileUqrSaveBtn")?.addEventListener("click",()=>this.submitReview()),document.getElementById("mobileUqrCancelBtn")?.addEventListener("click",()=>this.close())}renderStarRow(e,t,a){const i=this.scores[e]||5;let n="";for(let s=1;s<=5;s++){const l=s<=i;n+=`
        <button type="button" class="uqr-star-btn" data-key="${e}" data-val="${s}" style="background:none; border:none; padding:2px; font-size:18px; cursor:pointer; color:${l?"#f59e0b":"#cbd5e1"};">
          ★
        </button>
      `}return`
      <div style="background:#ffffff; border:1px solid #e2e8f0; border-radius:8px; padding:8px 10px; display:flex; justify-content:space-between; align-items:center;">
        <div style="max-width:60%;">
          ...
          <div style="font-size:10px; color:#64748b;">${a}</div>
        </div>
        <div style="display:flex; align-items:center;">
          ${n}
          <span class="uqr-star-val" data-val-for="${e}" style="font-size:11px; font-weight:800; color:#0f172a; margin-left:6px; min-width:14px; text-align:right;">${i}</span>
        </div>
      </div>
    `}bindStarEvents(){const e=document.getElementById("mobileUqrContent");e&&e.querySelectorAll(".uqr-star-btn").forEach(t=>{t.addEventListener("click",a=>{const i=a.currentTarget,n=i.dataset.key,s=Number(i.dataset.val);if(!n||!s)return;this.scores[n]=s;const l=i.closest("div");if(l){l.querySelectorAll(".uqr-star-btn").forEach(u=>{const c=Number(u.dataset.val);u.style.color=c<=s?"#f59e0b":"#cbd5e1"});const r=l.querySelector(`[data-val-for="${n}"]`);r&&(r.textContent=String(s))}const o=this.calcOverallScore(),d=document.getElementById("mobileUqrScoreBadge");d&&(d.style.background=o.bg,d.style.color=o.color,d.textContent=`${o.score}% · ${o.label}`)})})}async submitReview(){if(!this.currentReview||!this.currentReview.id)return;const e=document.getElementById("mobileUqrSaveBtn");e&&(e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> Saving…');const a=document.getElementById("mobileUqrRemarks")?.value?.trim()||"";try{const i={script_adherence_score:this.scores.script_adherence_score,tone_attitude_score:this.scores.tone_attitude_score,info_accuracy_score:this.scores.info_accuracy_score,objection_handling_score:this.scores.objection_handling_score,closing_technique_score:this.scores.closing_technique_score,disposition_accuracy_score:this.scores.disposition_accuracy_score,remarks:a},n=await k.post(`/api/v1/call-quality/reviews/${this.currentReview.id}/submit`,i);n&&n.success?(alert("Quality review saved successfully!"),this.onSavedCallback&&this.onSavedCallback(n.data?.review||n.data),this.close(),typeof window.refreshCrmQualityData=="function"&&window.refreshCrmQualityData()):(alert("Failed to save review: "+(n?.error||n?.detail||"Unknown error")),e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> Save Quality Review'))}catch(i){alert("Error saving review: "+(i.message||String(i))),e&&(e.disabled=!1,e.innerHTML='<i class="fas fa-save"></i> Save Quality Review')}}injectDOM(){if(document.getElementById("mobileUqrRoot"))return;const e=document.createElement("div");e.id="mobileUqrRoot",e.style.cssText=`
      position: fixed;
      inset: 0;
    ...
    `,e.addEventListener("click",t=>{t.target===e&&this.close()}),document.body.appendChild(e),document.getElementById("mobileUqrCloseTopBtn")?.addEventListener("click",()=>this.close())}escape(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}}const V=new Y;typeof window<"u"&&(window.openUniversalQualityReview=p=>V.open(p),window.closeUniversalQualityReview=()=>V.close());class de{static open(e){U.open(e)}static close(){U.close()}currentEntity=null;activeTab="calls";changesSubfilter="all";activeAudio=null;cache={calls:null,messages:null,changes:{}};open(e){if(!e||!e.entityId&&!e.leadId&&!e.memberId&&!e.phone){console.warn("[UniversalLeadHistoryModal] Invalid options:",e);return}this.injectDOM(),this.stopAudio();const t=e.entityType||(e.memberId?"vgk_member":"crm_lead"),a=parseInt(String(e.entityId||e.leadId||e.memberId||0),10)||0;this.currentEntity={entityType:t,entityId:a,name:e.name||"",phone:e.phone||"",category:e.category||"",status:e.status||"",stage:e.stage||"",assignedTo:e.assignedTo||""},this.cache={calls:null,messages:null,changes:{}},this.activeTab="calls",this.changesSubfilter="all",this.populateHeader();const i=document.getElementById("mobileUhmRoot");i&&(i.style.display="flex"),this.switchTab("calls"),this.fetchSummary()}close(){this.stopAudio();const e=document.getElementById("mobileUhmRoot");e&&(e.style.display="none")}switchTab(e){this.activeTab=e,this.stopAudio(),["Calls","Messages","Changes"].forEach(a=>{const i=document.getElementById("muhmTab"+a);i&&(a.toLowerCase()===e.toLowerCase()?i.classList.add("active"):i.classList.remove("active"))});const t=document.getElementById("muhmSubfilterBar");t&&(t.style.display=e==="changes"?"flex":"none"),this.loadTabData(e)}setSubfilter(e){this.changesSubfilter=e,document.querySelectorAll("#muhmSubfilterBar .muhm-subchip").forEach(a=>{a.classList.remove("active");const i=(a.textContent||"").toLowerCase();(i.includes(e.toLowerCase())||e==="all"&&i.includes("all")||e==="audit"&&i.includes("field"))&&a.classList.add("active")}),this.loadTabData("changes")}stopAudio(){if(this.activeAudio){try{this.activeAudio.pause()}catch{}this.activeAudio=null}document.querySelectorAll("#mobileUhmRoot audio").forEach(t=>{try{t.pause()}catch{}})}populateHeader(){const e=document.getElementById("muhmName");e&&(e.textContent=this.currentEntity.name||(this.currentEntity.entityType==="vgk_member"?"Channel Partner":`Lead #${this.currentEntity.entityId}`));const t=document.getElementById("muhmBadge");t&&(this.currentEntity.entityType==="vgk_member"?(t.textContent="VGK Member",t.className="muhm-badge muhm-badge-vgk"):(t.textContent="CRM Lead",t.className="muhm-badge muhm-badge-lead"));const a=document.getElementById("muhmPhone");a&&(a.textContent=this.currentEntity.phone||"—");const i=document.getElementById("muhmMeta");if(i){const n=[];this.currentEntity.category&&n.push(this.currentEntity.category),(this.currentEntity.stage||this.currentEntity.status)&&n.push(this.currentEntity.stage||this.currentEntity.status),this.currentEntity.assignedTo&&n.push(`Assigned: ${this.currentEntity.assignedTo}`),i.textContent=n.join(" • ")||"—"}["Calls","Messages","Changes"].forEach(n=>{const s=document.getElementById("muhmCount"+n);s&&(s.textContent="…")})}async fetchSummary(){try{const e=await k.get(`/api/v1/crm/universal-history/entity-summary?entity_type=${this.currentEntity.entityType}&entity_id=${this.currentEntity.entityId||0}&phone=${encodeURIComponent(this.currentEntity.phone||"")}&name=${encodeURIComponent(this.currentEntity.name||"")}`);if(e&&e.success&&e.entity){const t=document.getElementById("muhmName");t&&e.entity.name&&(t.textContent=e.entity.name);const a=document.getElementById("muhmPhone");if(a&&(a.textContent=e.entity.display_phone||e.entity.primary_phone||"—"),e.counts){const i=document.getElementById("muhmCountCalls");i&&(i.textContent=String(e.counts.calls||0));const n=document.getElementById("muhmCountMessages");n&&(n.textContent=String(e.counts.messages||0));const s=document.getElementById("muhmCountChanges");s&&(s.textContent=String(e.counts.changes||0))}}}catch(e){console.warn("[UniversalHistory] Failed to fetch mobile entity summary:",e)}}async loadTabData(e){const t=document.getElementById("muhmContent");if(!(!t||!this.currentEntity)){if(e==="calls"){const a=i=>{t.innerHTML=this.renderCalls(i),t.querySelectorAll(".muhm-review-call-btn").forEach(n=>{n.addEventListener("click",s=>{const l=s.currentTarget,o=Number(l.dataset.callid)||0,d=l.dataset.sessionid||"",r=l.dataset.phone||"",u=Number(l.dataset.leadid)||0;Y.open({callLogId:o,callSessionId:d,phone:r,leadId:u,onSaved:()=>{this.cache.calls=null,this.loadTabData("calls")}})})})};if(this.cache.calls){a(this.cache.calls.items);return}t.innerHTML='<div class="muhm-loading">Loading calls & recordings…</div>';try{const i=await k.get(`/api/v1/crm/universal-history/calls?entity_type=${this.currentEntity.entityType}&entity_id=${this.currentEntity.entityId||0}&phone=${encodeURIComponent(this.currentEntity.phone||"")}&name=${encodeURIComponent(this.currentEntity.name||"")}&limit=100`);if(i&&i.success){this.cache.calls=i;const n=document.getElementById("muhmCountCalls");n&&(n.textContent=String(i.total_calls||0)),a(i.items)}else t.innerHTML=`<div class="muhm-empty">${this.escape(i?.detail||"Failed to load calls")}</div>`}catch(i){t.innerHTML=`<div class="muhm-empty">Error loading calls: ${this.escape(i.message)}</div>`}}else if(e==="messages"){if(this.cache.messages){t.innerHTML=this.renderMessages(this.cache.messages.items);return}t.innerHTML='<div class="muhm-loading">Loading messages & chat…</div>';try{const a=await k.get(`/api/v1/crm/universal-history/messages?entity_type=${this.currentEntity.entityType}&entity_id=${this.currentEntity.entityId||0}&phone=${encodeURIComponent(this.currentEntity.phone||"")}&name=${encodeURIComponent(this.currentEntity.name||"")}&limit=100`);if(a&&a.success){this.cache.messages=a;const i=document.getElementById("muhmCountMessages");i&&(i.textContent=String(a.total_messages||0)),t.innerHTML=this.renderMessages(a.items)}else t.innerHTML=`<div class="muhm-empty">${this.escape(a?.detail||"Failed to load messages")}</div>`}catch(a){t.innerHTML=`<div class="muhm-empty">Error loading messages: ${this.escape(a.message)}</div>`}}else if(e==="changes"){const a=this.changesSubfilter||"all";if(this.cache.changes[a]){t.innerHTML=this.renderChanges(this.cache.changes[a].items);return}t.innerHTML='<div class="muhm-loading">Loading change history…</div>';try{const i=await k.get(`/api/v1/crm/universal-history/changes?entity_type=${this.currentEntity.entityType}&entity_id=${this.currentEntity.entityId||0}&phone=${encodeURIComponent(this.currentEntity.phone||"")}&name=${encodeURIComponent(this.currentEntity.name||"")}&subfilter=${a}&limit=100`);if(i&&i.success){if(this.cache.changes[a]=i,a==="all"){const n=document.getElementById("muhmCountChanges");n&&(n.textContent=String(i.total_changes||0))}t.innerHTML=this.renderChanges(i.items)}else t.innerHTML=`<div class="muhm-empty">${this.escape(i?.detail||"Failed to load changes")}</div>`}catch(i){t.innerHTML=`<div class="muhm-empty">Error loading changes: ${this.escape(i.message)}</div>`}}}}renderCallFromBadge(e){const t=(e.dialed_page||e.call_from||e.source||"").trim(),a=t.toLowerCase(),i=(e.device_call_id||e.call_session_id||"").toLowerCase(),n=(e.call_type||e.direction||"").toUpperCase();return a.includes("auto")||a.includes("dialer")||i.includes("cda_")||n==="DIALER"?'<span style="background:#f5f3ff;color:#6b21a8;border:1px solid #ddd6fe;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-robot" style="color:#6b21a8;margin-right:4px;"></i>Auto Dialer</span>':a.includes("my lead")||a==="my leads"?'<span style="background:#eff6ff;color:#1d4ed8;border:1px solid #bfdbfe;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-user-check" style="color:#1d4ed8;margin-right:4px;"></i>My Leads</span>':a.includes("staff lead")||a==="staff leads"?'<span style="background:#f0fdf4;color:#15803d;border:1px solid #bbf7d0;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-users" style="color:#15803d;margin-right:4px;"></i>Staff Leads</span>':a.includes("crm dashboard")||a.includes("dashboard")?'<span style="background:#fdf2f8;color:#be185d;border:1px solid #fbcfe8;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-chart-line" style="color:#be185d;margin-right:4px;"></i>CRM Dashboard</span>':a.includes("softphone center")||a.includes("softphone hub")||a==="softphone"||a==="plivo webrtc"?'<span style="background:#e0f2fe;color:#0369a1;border:1px solid #bae6fd;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-headset" style="color:#0369a1;margin-right:4px;"></i>Softphone Center</span>':a.includes("operator")?'<span style="background:#fffbeb;color:#b45309;border:1px solid #fde68a;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-head-side-headphones" style="color:#b45309;margin-right:4px;"></i>Operator Calls</span>':a.includes("whatsapp")?'<span style="background:#f0fdf4;color:#16a34a;border:1px solid #86efac;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fab fa-whatsapp" style="color:#16a34a;margin-right:4px;"></i>WhatsApp Center</span>':a.includes("planner")?'<span style="background:#faf5ff;color:#7e22ce;border:1px solid #e9d5ff;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-calendar-day" style="color:#7e22ce;margin-right:4px;"></i>Day Planner</span>':a.includes("task")?'<span style="background:#f1f5f9;color:#334155;border:1px solid #cbd5e1;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-tasks" style="color:#334155;margin-right:4px;"></i>Tasks</span>':a.includes("master")?'<span style="background:#fef3c7;color:#92400e;border:1px solid #fcd34d;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-database" style="color:#92400e;margin-right:4px;"></i>Master Leads</span>':a.includes("bank")?'<span style="background:#ecfdf5;color:#065f46;border:1px solid #a7f3d0;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-landmark" style="color:#065f46;margin-right:4px;"></i>Bank Wise Leads</span>':a.includes("inbound")||a.includes("did")||n==="INCOMING"||n==="INBOUND"?'<span style="background:#ecfdf5;color:#047857;border:1px solid #a7f3d0;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-phone-arrow-down-left" style="color:#047857;margin-right:4px;"></i>Inbound DID</span>':a.includes("mobile")||a.includes("sim")||a.includes("native")?'<span style="background:#ecfdf5;color:#047857;border:1px solid #a7f3d0;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-sim-card" style="color:#047857;margin-right:4px;"></i>Native SIM</span>':`<span style="background:#f8fafc;color:#475569;border:1px solid #cbd5e1;font-size:10.5px;font-weight:600;padding:2px 6px;border-radius:4px;display:inline-flex;align-items:center;"><i class="fas fa-file-alt" style="margin-right:4px;color:#94a3b8;"></i>${this.escape(t||"My Leads")}</span>`}renderCalls(e){return!e||!e.length?'<div class="muhm-empty">No call records or recordings found.</div>':e.map(t=>{(t.direction||"").toLowerCase();const a=this.formatDuration(t.duration_seconds),i=Number(t.duration_seconds||0);let n="";t.has_recording&&t.recording_url?n=`
          <div style="margin-top:6px;padding-top:6px;border-top:1px dashed #e2e8f0;">
            <audio controls style="width:100%;height:32px" preload="none">
              <source src="${this.escape(t.recording_url)}" type="audio/mpeg">
              <source src="${this.escape(t.recording_url)}" type="audio/wav">
              Audio not supported.
            </audio>
          </div>
        `:i===0?n=`
        ...
        `;const s=t.id&&String(t.id).startsWith("scl_")&&t.raw_id||0,l=t.call_session_id||"",o=this.escape(t.phone||this.currentEntity&&this.currentEntity.phone||""),d=this.currentEntity&&this.currentEntity.entityId?this.currentEntity.entityId:0;let r="";t.quality_score!=null&&t.quality_score!==void 0&&(r=`<span style="font-size:10px;font-weight:700;padding:2px 6px;border-radius:4px;background:#ecfdf5;color:#047857;border:1px solid #a7f3d0;display:inline-flex;align-items:center;">★ ${t.quality_score}% QA</span>`);const u=!!(t.has_recording&&t.recording_url);let c="";return(u||t.quality_score!=null)&&(c=`
          <button class="muhm-review-call-btn" data-callid="${s}" data-sessionid="${this.escape(l)}" data-phone="${o}" data-leadid="${d}" style="background:#fef3c7;color:#92400e;border:1px solid #fde68a;border-radius:4px;padding:2px 8px;font-size:10.5px;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;">
            <i class="fas fa-clipboard-check me-1"></i>${t.quality_score!=null?"QA Reviewed":"Review Call"}
          </button>
        `),`
        <div class="muhm-card">
          <div style="display:flex;justify-content:space-between;align-items:flex-start">
            <div>
              <div style="font-weight:600;font-size:13px;color:#0f172a">${this.escape(t.details||"Call")}</div>
              <div style="font-size:11px;color:#475569;margin-top:2px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
                ...
                <span style="font-weight:700;background:#e0f2fe;color:#0369a1;padding:1px 6px;border-radius:4px;font-size:10.5px;">
                  Handled by: ${this.escape(t.handled_by||t.staff_name||"Staff")}
                </span>
              </div>
            </div>
            <div style="text-align:right">
              ${this.renderCallFromBadge(t)}
              <div style="font-size:11px;color:#334155;margin-top:2px;font-weight:500">${this.escape(t.status||a)}</div>
            </div>
          </div>
          ${r||c?`
      ...
      `}).join("")}renderMessages(e){return!e||!e.length?'<div class="muhm-empty">No messages or chat history found.</div>':'<div style="display:flex;flex-direction:column;gap:12px">'+e.map(t=>{const a=(t.direction||"").toLowerCase()==="outbound",i=a?"outbound":"inbound";let n="";const s=t.media_url||"",l=(t.media_type||"").toLowerCase(),o=t.media_name||"Attachment",d=(t.media_mime_type||"").toLowerCase();if(s){const g=l==="document"&&(o.toLowerCase().endsWith(".pdf")||d.includes("pdf"))||s.toLowerCase().includes(".pdf"),b=l==="image"||d.startsWith("image/")||/\.(jpg|jpeg|png|webp|gif)(\?.*)?$/i.test(s),v=l==="audio"||d.startsWith("audio/")||/\.(mp3|ogg|wav|aac|m4a)(\?.*)?$/i.test(s);b?n=`
              <div class="muhm-media-img-box">
                <a href="${this.escape(s)}" target="_blank" rel="noopener noreferrer">
                  <img src="${this.escape(s)}" alt="${this.escape(o)}" onerror="this.style.display='none';this.parentElement.nextElementSibling.querySelector('.muhm-media-name').textContent='[Image attachment]';" />
                </a>
                <div class="muhm-media-img-bar">
                  <span class="muhm-media-name" title="${this.escape(o)}">${this.escape(o)}</span>
                  <a href="${this.escape(s)}" download="${this.escape(o)}" class="muhm-dl-btn" title="Download Image">
                    ⬇ Download
                  </a>
                </div>
              </div>
            `:v?n=`
              <div style="margin-top:6px">
                <audio controls style="width:100%;height:32px" preload="none">
                  <source src="${this.escape(s)}" type="${this.escape(d||"audio/mpeg")}">
                  Audio not supported.
                </audio>
              </div>
            `:n=`
              <div class="muhm-media-doc-box">
                <div style="display:flex;align-items:center;gap:6px;min-width:0;flex:1;">
                  <span style="font-size:18px;color:${g?"#ef4444":"#2563eb"};flex-shrink:0;">${g?"📄":"📁"}</span>
                  <div style="min-width:0;flex:1;">
                    <div class="muhm-media-name" title="${this.escape(o)}">${this.escape(o)}</div>
                    <div style="font-size:9.5px;color:#64748b;">${this.escape(d||(g?"PDF Document":"Document"))}</div>
                  </div>
                </div>
                <div style="display:flex;align-items:center;gap:4px;flex-shrink:0;">
                  <a href="${this.escape(s)}" target="_blank" rel="noopener noreferrer" class="muhm-doc-view-btn" title="View">View</a>
                  <a href="${this.escape(s)}" download="${this.escape(o)}" class="muhm-dl-btn" title="Download">⬇</a>
                </div>
              </div>
            `}const r=(t.status||"").toLowerCase();let u="";a?r==="failed"?u=`<span class="muhm-status-failed" title="${this.escape(t.failure_reason||t.error_message||"Delivery failed")}">⚠ Failed${t.error_code?" ("+this.escape(t.error_code)+")":""}</span>`:r==="read"?u=`<span class="muhm-status-badge" style="color:#0284c7" title="Read ${this.formatDate(t.read_at||t.timestamp)}"><span style="letter-spacing:-1px">✓✓</span> Read</span>`:r==="delivered"?u=`<span class="muhm-status-badge" style="color:#64748b" title="Delivered ${this.formatDate(t.delivered_at||t.timestamp)}"><span style="letter-spacing:-1px">✓✓</span> Delivered</span>`:r==="queued"?u='<span class="muhm-status-badge" style="color:#d97706" title="Queued">⏳ Queued</span>':u='<span class="muhm-status-badge" style="color:#64748b" title="Sent">✓ Sent</span>':u='<span class="muhm-status-badge" style="color:#059669" title="Received">↙ Received</span>';let c="";a&&r==="failed"&&(t.failure_reason||t.error_message)&&(c=`<div class="muhm-error-snippet">ℹ ${this.escape(t.failure_reason||t.error_message)}</div>`);const m=t.message_text?`<div style="white-space:pre-wrap">${this.escape(t.message_text)}</div>`:"";return`
          <div class="muhm-chat-row ${i}">
            <div style="font-size:10.5px;color:#64748b;margin-bottom:2px;display:flex;align-items:center;gap:4px;${a?"justify-content:flex-end":""}">
              <span>${this.escape(t.sender_name||(a?"Staff":"Customer"))}</span>
              <span style="font-weight:normal;opacity:0.75">• ${this.escape(t.channel||"WA")}</span>
            </div>
            <div class="muhm-bubble">
              ...
              <div class="muhm-chat-meta-bar">
                <span style="font-size:9.5px;color:#64748b">${this.formatDate(t.timestamp)}</span>
                ${u}
              </div>
            </div>
          </div>
        `}).join("")+"</div>"}renderChanges(e){if(!e||!e.length)return'<div class="muhm-empty">No change history or notes found.</div>';const t=[],a={};return e.forEach(i=>{let n="General History";if(i.timestamp)try{const l=new Date(i.timestamp);isNaN(l.getTime())||(n=l.toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"}))}catch{}const s=n;a[s]||(a[s]={dateKey:n,items:[]},t.push(a[s])),a[s].items.push(i)}),'<div style="padding-left:14px;border-left:2px solid #e2e8f0;display:flex;flex-direction:column;gap:12px">'+t.map(i=>{let n="";return i.items.forEach(s=>{let l="";(s.old_val||s.new_val)&&(l=`
              <div style="font-size:11px;margin-top:3px;word-break:break-word;">
                ${s.old_val?`<span style="color:#ef4444;text-decoration:line-through;margin-right:4px">${this.escape(s.old_val)}</span> → `:""}
                <span style="color:#10b981;font-weight:600">${this.escape(s.new_val||"")}</span>
              </div>
            `);const o=s.category==="call",d=s.category==="note",r=s.category==="assignment",u=s.category==="followup";let c="#f8fafc",m="#e2e8f0",g="#0f172a",b="✏️ ";o?(c="#f0fdf4",m="#bbf7d0",g="#166534",b="📞 "):d?(c="#fffbeb",m="#fde68a",g="#92400e",b="📝 "):u?(c="#f5f3ff",m="#ddd6fe",g="#5b21b6",b="📅 "):r&&(c="#eff6ff",m="#bfdbfe",g="#1e40af",b="👤 ");let v="";o&&s.has_recording&&s.recording_url&&(v=`
              <div style="margin-top:6px;padding-top:6px;border-top:1px dashed #cbd5e1;">
                <audio controls style="width:100%;height:30px" preload="none">
                  <source src="${this.escape(s.recording_url)}" type="audio/mpeg">
                  <source src="${this.escape(s.recording_url)}" type="audio/wav">
                  Audio not supported.
                </audio>
              </div>
            `);let R="";o?R=`<span style="font-size:10px;font-weight:700;color:#15803d;background:#dcfce7;padding:1px 5px;border-radius:4px;">Handled by: ${this.escape(s.handled_by||s.author_name||"Staff")}</span>`:R=`<span style="font-size:10px;font-weight:600;color:#475569;background:#e2e8f0;padding:1px 5px;border-radius:4px;">By: ${this.escape(s.author_name||s.handled_by||"Staff")}</span>`;let B="";if(s.timestamp)try{const _=new Date(s.timestamp);isNaN(_.getTime())||(B=_.toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit"}))}catch{}n+=`
            <div style="background:${c};border:1px solid ${m};border-radius:6px;padding:8px 10px;margin-bottom:6px;">
              <div style="display:flex;justify-content:space-between;align-items:center;gap:4px;flex-wrap:wrap;">
                <span style="font-size:12px;font-weight:600;color:${g}">${b}${this.escape(s.title||s.event_type||"Change")}</span>
                <div style="display:flex;align-items:center;gap:4px;">
                  ${R}
                  ${B?`<span style="font-size:10px;color:#94a3b8">${this.escape(B)}</span>`:""}
                </div>
              </div>
              ${s.details?`<div style="font-size:11px;color:#475569;margin-top:2px;word-break:break-word;">${this.escape(s.details)}</div>`:""}
              ${l}
              ${v}
            </div>
          `}),`
          <div style="position:relative">
            ...
            <div class="muhm-card" style="margin:0;border:1px solid #cbd5e1;background:#ffffff;padding:10px 12px;">
              <div style="display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid #f1f5f9;padding-bottom:6px;margin-bottom:8px;flex-wrap:wrap;gap:4px;">
                <div style="display:flex;align-items:center;gap:6px;">
                  <span style="font-size:12.5px;font-weight:700;color:#0f172a">📅 ${this.escape(i.dateKey)}</span>
                  <span style="font-size:9.5px;font-weight:700;padding:1px 5px;border-radius:8px;background:#e0f2fe;color:#0369a1;">
                    ${i.items.length} ${i.items.length===1?"change":"changes"}
                  </span>
                </div>
              </div>
        ...
        `}).join("")+"</div>"}injectDOM(){if(document.getElementById("mobileUhmRoot"))return;const e=document.createElement("style");e.id="mobileUhmStyles",e.textContent=`
      #mobileUhmRoot {
        position: fixed;
        inset: 0;
        z-index: 100000001;
    ...
    `,document.head.appendChild(e);const t=document.createElement("div");t.id="mobileUhmRoot",t.innerHTML=`
    ...
    `,t.addEventListener("click",a=>{a.target===t&&this.close()}),document.body.appendChild(t),document.getElementById("muhmCloseBtn")?.addEventListener("click",()=>this.close()),document.getElementById("muhmTabCalls")?.addEventListener("click",()=>this.switchTab("calls")),document.getElementById("muhmTabMessages")?.addEventListener("click",()=>this.switchTab("messages")),document.getElementById("muhmTabChanges")?.addEventListener("click",()=>this.switchTab("changes")),document.querySelectorAll("#muhmSubfilterBar .muhm-subchip").forEach(a=>{a.addEventListener("click",i=>{const n=i.currentTarget.getAttribute("data-sub")||"all";this.setSubfilter(n)})})}formatDate(e){if(!e)return"—";try{return new Date(e).toLocaleDateString("en-IN",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"})}catch{return String(e)}}formatDuration(e){const t=parseInt(String(e),10)||0;if(t<=0)return"0s";const a=Math.floor(t/3600),i=Math.floor(t%3600/60),n=t%60;return a>0?`${a}h ${i>0?i+"m ":""}${n>0?n+"s":""}`.trim():i>0?`${i}m ${n>0?n+"s":""}`.trim():`${n}s`}escape(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}}const U=new de;typeof window<"u"&&(window.openUniversalHistory=p=>U.open(p),window.closeUniversalHistory=()=>U.close());const ce=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],pe=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],ue=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class me{container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
      ...
      <div class="mnr-drawer-content">
        ...
        <!-- Section menus -->
        ${pe.map(i=>this.renderSection(i)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("mnrDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;I.navigate(t),this.close()})}),document.getElementById("mnrLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await x.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const Me=new me;class Ie{config;constructor(e){this.config=e}render(){if(this.config.loading)return`
    ...
    `,document.head.appendChild(e)}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',package:'<line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/>',tool:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||this.user?.partner_name||"Partner",t=this.user?.partner_id||this.user?.partner_code||"PARTNER",a=this.user?.partner_type||this.user?.type||"Partner";return`
      ...
      <div class="partner-drawer-content">
        ...
        ${ge.map(n=>this.renderSection(n)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("partnerDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;I.navigate(t),this.close()})}),document.getElementById("partnerLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await x.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const Ae=new he;class Le{container;constructor(e){this.container=e}render(){const t=x.getAuthState().user?.portal||"staff",a=I.getTabRoutes(t),i=I.getCurrentRoute();this.container.innerHTML=`
    ...
    `,this.attachListeners()}attachListeners(){this.container.querySelectorAll(".tab-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-route");t&&I.navigate(t)})})}getIcon(e){const t={home:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      </svg>`};return t[e]||t.home}}class be{isShowing=!1;unsubscribe=null;checkInterval=null;init(){this.unsubscribe&&this.unsubscribe(),this.checkInterval&&clearInterval(this.checkInterval),this.unsubscribe=k.onSessionExpired(e=>{console.log("[SessionBanner] Session expired detected, endpoint:",e),x.getAuthState().isLoggedIn||this.show()}),this.checkInterval=setInterval(()=>{if(x.getAuthState().isLoggedIn){this.isShowing&&this.hide();return}const t=J.getTrackingStatus();t.isSessionExpired&&!this.isShowing?this.show():!t.isSessionExpired&&this.isShowing&&this.hide()},5e3)}cleanup(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null),this.hide()}show(){if(!x.getAuthState().isLoggedIn||this.isShowing||document.getElementById("globalSessionBanner"))return;this.isShowing=!0;const e=document.createElement("div");e.id="globalSessionBanner",e.className="global-session-banner",e.innerHTML=`
