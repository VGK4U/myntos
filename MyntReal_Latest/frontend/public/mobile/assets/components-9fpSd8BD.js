...
import{t as x,j as L,d as y,b as S,n as M,r as w}from"./services-C4JTqdwG.js";import{L as v}from"./vendor-B1GRRwIS.js";import{_ as N}from"./vendor-capacitor-plugins-DTPsYLMi.js";import{gpsService as O}from"./services-gps-Cv9LiyeS.js";class ${modalEl=null;uiState="CLOSED";currentOptions=null;enteredNumber="";rawNumber="";isPresetNumber=!1;isDtmfOpen=!1;unsubscribeTelephony=null;currentSession=null;floatingPos={x:0,y:0};pillPos={x:0,y:0};isDraggingWindow=!1;isDraggingPill=!1;dragStartPointer={x:0,y:0};dragStartPos={x:0,y:0};hasInitializedPosition=!1;lastNotifiedLeadId=null;constructor(){typeof window<"u"&&(window.addEventListener("keydown",e=>{e.key==="Escape"&&this.isOpen()&&(this.uiState==="ACTIVE_FLOATING"?this.minimize():this.uiState==="DIALER"&&this.close())}),window.addEventListener("resize",()=>{this.isOpen()&&(this.clampPositions(),this.applyPositions())}))}isOpen(){return this.modalEl!==null&&document.body.contains(this.modalEl)&&this.uiState!=="CLOSED"}getUIState(){return this.uiState}open(e){this.currentOptions=e;const t=(e.phoneNumber||"").replace(/[^\d+]/g,"");this.enteredNumber=t,this.rawNumber=t,this.isPresetNumber=!!t,this.isDtmfOpen=!1,this.hasInitializedPosition=!1,this.unsubscribeTelephony&&this.unsubscribeTelephony(),this.unsubscribeTelephony=x.subscribe(n=>{this.currentSession=n,this.handleTelephonyStateUpdate(n)});const a=x.isCallActive();this.uiState=a?"ACTIVE_FLOATING":"DIALER",this.render(),this.loadLeadContext(e.entityId),e.autoStart&&this.enteredNumber&&this.startCall()}minimize(){this.uiState!=="CLOSED"&&(this.uiState="MINIMIZED",this.updateVisibility())}restore(){this.uiState!=="CLOSED"&&(this.uiState="ACTIVE_FLOATING",this.updateVisibility(),this.updateSessionUI())}close(){if(this.currentSession&&(x.isCallActive()||["connecting","ringing","connected","held"].includes(this.currentSession.state))){this.minimize();return}this.teardown()}forceCloseAndHangup(){this.currentSession&&x.isCallActive()&&x.endCall(),this.teardown()}teardown(){this.unsubscribeTelephony&&(this.unsubscribeTelephony(),this.unsubscribeTelephony=null),this.modalEl&&(this.modalEl.remove(),this.modalEl=null),this.uiState="CLOSED",this.currentOptions=null,this.currentSession=null,this.hasInitializedPosition=!1,this.lastNotifiedLeadId=null}handleTelephonyStateUpdate(e){if(!this.modalEl||!document.body.contains(this.modalEl))if(e.state!=="idle")this.render();else return;if(x.isCallActive()){this.uiState==="DIALER"&&(this.uiState="ACTIVE_FLOATING");const a=Number(this.currentOptions?.entityId);a&&(this.currentOptions?.entityType==="lead"||!this.currentOptions?.entityType)&&this.lastNotifiedLeadId!==a&&(this.lastNotifiedLeadId=a,L.notifyCallActive(a))}else if(this.lastNotifiedLeadId=null,e.state==="ended"){this.uiState="ENDED_SUMMARY";const a=this.currentOptions,n=e.durationSeconds||0;L.clearCallActive(),a?.entityId&&window.dispatchEvent(new CustomEvent("myntos:lead-call-ended",{detail:{leadId:a.entityId,name:a.name,phoneNumber:a.phoneNumber,durationSeconds:n,categoryName:a.categoryName,status:a.status}})),setTimeout(()=>{this.uiState==="ENDED_SUMMARY"&&this.teardown()},1600)}else if(e.state==="idle"&&this.uiState!=="DIALER"){L.clearCallActive(),this.teardown();return}this.updateVisibility(),this.updateSessionUI()}maskPhone(e){if(!e)return"—";const t=e.replace(/\D/g,"");if(t.length<6)return e;const a=t.slice(-10);return y.isMR10001()?a.length===10?`+91 ${a.slice(0,5)} ${a.slice(5)}`:e:`+91 ${a.slice(0,2)}••••${a.slice(-4)}`}getDialInputDisplay(){return!y.isMR10001()&&this.isPresetNumber&&this.enteredNumber?this.maskPhone(this.enteredNumber):this.enteredNumber}formatDuration(e){const t=Math.floor(e/60).toString().padStart(2,"0"),a=(e%60).toString().padStart(2,"0");return`${t}:${a}`}initPositions(){if(this.hasInitializedPosition||typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=Math.max(12,Math.round((e-a)/2)),s=Math.max(20,Math.round((t-n)/2));this.floatingPos={x:i,y:s},this.pillPos={x:Math.max(12,e-260),y:Math.max(20,t-100)},this.hasInitializedPosition=!0}clampPositions(){if(typeof window>"u")return;const e=window.innerWidth,t=window.innerHeight,a=Math.min(400,e-24),n=440,i=12,s=Math.max(12,e-a-12),p=12,o=Math.max(12,t-n-12);this.floatingPos.x=Math.min(Math.max(this.floatingPos.x,i),s),this.floatingPos.y=Math.min(Math.max(this.floatingPos.y,p),o);const r=240,d=54,c=12,l=Math.max(12,e-r-12),h=12,u=Math.max(12,t-d-12);this.pillPos.x=Math.min(Math.max(this.pillPos.x,c),l),this.pillPos.y=Math.min(Math.max(this.pillPos.y,h),u)}applyPositions(){const e=this.modalEl?.querySelector("#spModalDialog");e&&(this.uiState==="ACTIVE_FLOATING"||this.uiState==="DIALER")&&(e.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`);const t=this.modalEl?.querySelector("#spMinimizedPill");t&&this.uiState==="MINIMIZED"&&(t.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`)}render(){this.modalEl&&this.modalEl.remove(),this.initPositions(),this.clampPositions();const{name:e,entityType:t}=this.currentOptions||{},a=e||"Customer Lead",n=t?t.toUpperCase():"LEAD";this.modalEl=document.createElement("div"),this.modalEl.id="myntosCentralSoftphoneModal",this.modalEl.style.cssText=`
    ...
    `,document.body.appendChild(this.modalEl),this.attachEventListeners(),this.attachDragListeners(),this.updateVisibility(),this.updateSessionUI()}attachDragListeners(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spFloatingHeader"),t=this.modalEl.querySelector("#spModalDialog");if(e&&t){e.addEventListener("pointerdown",i=>{const s=i.target;if(!(s&&s.closest("button, input, a"))){this.isDraggingWindow=!0,this.dragStartPointer={x:i.clientX,y:i.clientY},this.dragStartPos={x:this.floatingPos.x,y:this.floatingPos.y};try{e.setPointerCapture(i.pointerId)}catch{}i.preventDefault(),i.stopPropagation()}}),e.addEventListener("pointermove",i=>{if(!this.isDraggingWindow)return;const s=i.clientX-this.dragStartPointer.x,p=i.clientY-this.dragStartPointer.y;this.floatingPos={x:this.dragStartPos.x+s,y:this.dragStartPos.y+p},this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`});const n=i=>{if(this.isDraggingWindow){this.isDraggingWindow=!1;try{e.releasePointerCapture(i.pointerId)}catch{}this.clampPositions(),t.style.transform=`translate3d(${this.floatingPos.x}px, ${this.floatingPos.y}px, 0)`}};e.addEventListener("pointerup",n),e.addEventListener("pointercancel",n)}const a=this.modalEl.querySelector("#spMinimizedPill");if(a){let n=!1;a.addEventListener("pointerdown",s=>{const p=s.target;if(!(p&&p.closest("#spPillRestoreBtn"))){this.isDraggingPill=!0,n=!1,this.dragStartPointer={x:s.clientX,y:s.clientY},this.dragStartPos={x:this.pillPos.x,y:this.pillPos.y};try{a.setPointerCapture(s.pointerId)}catch{}s.preventDefault(),s.stopPropagation()}}),a.addEventListener("pointermove",s=>{if(!this.isDraggingPill)return;const p=s.clientX-this.dragStartPointer.x,o=s.clientY-this.dragStartPointer.y;(Math.abs(p)>3||Math.abs(o)>3)&&(n=!0),this.pillPos={x:this.dragStartPos.x+p,y:this.dragStartPos.y+o},this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`});const i=s=>{if(this.isDraggingPill){this.isDraggingPill=!1;try{a.releasePointerCapture(s.pointerId)}catch{}this.clampPositions(),a.style.transform=`translate3d(${this.pillPos.x}px, ${this.pillPos.y}px, 0)`,n||this.restore()}};a.addEventListener("pointerup",i),a.addEventListener("pointercancel",i)}}attachEventListeners(){if(!this.modalEl)return;this.modalEl.querySelector("#spModalBackdrop")?.addEventListener("click",()=>{this.uiState==="DIALER"&&this.close()}),this.modalEl.querySelector("#spMinimizeBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.minimize()}),this.modalEl.querySelector("#spCloseBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.close()}),this.modalEl.querySelector("#spPillRestoreBtn")?.addEventListener("click",t=>{t.stopPropagation(),this.restore()});const e=this.modalEl.querySelector("#spDialInput");e?.addEventListener("input",t=>{this.enteredNumber=t.target.value,this.rawNumber="",this.isPresetNumber=!1,this.updateCallerPhoneDisplay()}),this.modalEl.querySelector("#spBackspaceBtn")?.addEventListener("click",()=>{if(this.isPresetNumber){this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1),this.updateCallerPhoneDisplay();return}this.enteredNumber.length>0&&(this.enteredNumber=this.enteredNumber.slice(0,-1),e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),x.playKeyTone())}),this.modalEl.querySelectorAll(".sp-num-btn").forEach(t=>{t.addEventListener("click",a=>{const n=a.currentTarget.getAttribute("data-key");this.isPresetNumber&&(this.isPresetNumber=!1,this.rawNumber="",this.enteredNumber="",e&&(e.value="",e.readOnly=!1)),n&&this.enteredNumber.length<15&&(this.enteredNumber+=n,e&&(e.value=this.enteredNumber),this.updateCallerPhoneDisplay(),x.playKeyTone())})}),this.modalEl.querySelector("#spMainDialBtn")?.addEventListener("click",()=>{this.startCall()}),this.modalEl.querySelector("#spDirectSimBtn")?.addEventListener("click",()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}x.triggerDirectSimCall(this.enteredNumber)}),this.modalEl.querySelector("#spMyOperatorBtn")?.addEventListener("click",async()=>{if(!this.enteredNumber){this.showError("Please enter a phone number.");return}try{const t=this.currentOptions?.entityId?parseInt(String(this.currentOptions.entityId)):null;await x.triggerMyOperatorCall(this.enteredNumber,t),alert(`MyOperator call dispatched to ${this.enteredNumber}! Your office line will ring shortly.`)}catch(t){this.showError(`MyOperator error: ${t.message}`)}}),this.modalEl.querySelector("#spBtnMute")?.addEventListener("click",()=>{x.toggleMute()}),this.modalEl.querySelector("#spBtnSpeaker")?.addEventListener("click",()=>{x.toggleSpeaker()}),this.modalEl.querySelector("#spInCallVolumeSlider")?.addEventListener("input",t=>{const a=parseFloat(t.target.value)/100;x.setVolume(a)}),this.modalEl.querySelector("#spBtnHold")?.addEventListener("click",()=>{x.toggleHold()}),this.modalEl.querySelector("#spBtnKeypad")?.addEventListener("click",()=>{this.isDtmfOpen=!this.isDtmfOpen;const t=this.modalEl?.querySelector("#spDtmfGrid");t&&(t.style.display=this.isDtmfOpen?"grid":"none")}),this.modalEl.querySelectorAll(".sp-dtmf-btn").forEach(t=>{t.addEventListener("click",a=>{const n=a.currentTarget.getAttribute("data-dtmf");n&&x.sendDTMF(n)})}),this.modalEl.querySelector("#spBtnHangup")?.addEventListener("click",()=>{x.endCall()})}updateVisibility(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#spModalBackdrop"),t=this.modalEl.querySelector("#spModalDialog"),a=this.modalEl.querySelector("#spMinimizedPill"),n=this.modalEl.querySelector("#spInCallView"),i=this.modalEl.querySelector("#spDialerView");this.uiState==="DIALER"?(e&&(e.style.display="block"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="block"),n&&(n.style.display="none")):this.uiState==="ACTIVE_FLOATING"?(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="flex")):this.uiState==="MINIMIZED"?(e&&(e.style.display="none"),t&&(t.style.display="none"),a&&(a.style.display="flex")):this.uiState==="ENDED_SUMMARY"&&(e&&(e.style.display="none"),t&&(t.style.display="block"),a&&(a.style.display="none"),i&&(i.style.display="none"),n&&(n.style.display="flex"))}updateCallerPhoneDisplay(){const e=this.modalEl?.querySelector("#spCallerPhoneDisplay");e&&(e.textContent=this.maskPhone(this.enteredNumber))}showError(e){const t=this.modalEl?.querySelector("#spErrorBanner");t&&(t.textContent=e,t.style.display="block")}hideError(){const e=this.modalEl?.querySelector("#spErrorBanner");e&&(e.style.display="none")}async startCall(){x.prepareAudioOnUserGesture(),this.hideError();const e=this.rawNumber||this.enteredNumber;if(!e){this.showError("Please enter a destination phone number.");return}const t=this.currentOptions?.name||"Contact Lead",a=this.currentOptions?.entityId||null;this.uiState="ACTIVE_FLOATING",this.updateVisibility();const n=await x.startCall(e,t,a);!n.success&&n.error&&(n.error==="A call is already in progress."?console.warn("[SoftphoneModal] Duplicate dial prevented; ignoring duplicate error toast"):this.showError(n.error))}updateSessionUI(){if(!this.modalEl||!this.currentSession)return;const e=this.currentSession.contactName||this.currentOptions?.name||"Contact Lead",t=this.currentSession.destinationPhone||this.enteredNumber,a=this.formatDuration(this.currentSession.durationSeconds),n=this.modalEl.querySelector("#spActiveCallerName");n&&(n.textContent=e);const i=this.modalEl.querySelector("#spActiveCallerPhone");i&&(i.textContent=this.maskPhone(t));const s=this.modalEl.querySelector("#spCallTimerDisplay");s&&(s.textContent=a);const p=this.modalEl.querySelector("#spPillCallerName");p&&(p.textContent=e);const o=this.modalEl.querySelector("#spPillTimerDisplay");o&&(o.textContent=a);const r=this.modalEl.querySelector("#spCallStateBadge");r&&(this.currentSession.state==="connected"?(r.textContent="🟢 Connected",r.style.background="#22c55e",r.style.color="#ffffff"):this.currentSession.state==="ringing"?(r.textContent="📞 Ringing...",r.style.background="#38bdf8",r.style.color="#000000"):this.currentSession.state==="connecting"?(r.textContent="⏳ Connecting...",r.style.background="#f59e0b",r.style.color="#000000"):this.currentSession.state==="ended"&&(r.textContent="🛑 Call Ended",r.style.background="#ef4444",r.style.color="#ffffff"));const d=this.modalEl.querySelector("#spBtnMute");d&&(d.style.background=this.currentSession.isMuted?"rgba(239,68,68,0.6)":"rgba(255,255,255,0.1)",d.style.borderColor=this.currentSession.isMuted?"#ef4444":"rgba(255,255,255,0.2)");const c=this.modalEl.querySelector("#spBtnSpeaker");c&&(c.style.background=this.currentSession.isSpeaker?"rgba(56,189,248,0.6)":"rgba(255,255,255,0.1)",c.style.borderColor=this.currentSession.isSpeaker?"#38bdf8":"rgba(255,255,255,0.2)");const l=this.modalEl.querySelector("#spBtnHold");l&&(l.style.background=this.currentSession.isHeld?"rgba(245,158,11,0.6)":"rgba(255,255,255,0.1)",l.style.borderColor=this.currentSession.isHeld?"#f59e0b":"rgba(255,255,255,0.2)")}async loadLeadContext(e){const t=this.modalEl?.querySelector("#spLeadContextBox");if(t){if(!e){t.style.display="none";return}try{const a=await S.get(`/crm/dialer/lead/${e}/detail`),n=a.data??a;if(!n||!n.lead)return;const i=n.lead;t.style.display="block";const s=this.modalEl?.querySelector("#spMobileCatBadge");s&&(s.textContent=i.category_name||"General");const p=this.modalEl?.querySelector("#spHeaderCatBadge");p&&(p.textContent=`🏷️ ${i.category_name||"General"}`,p.style.display="inline-block");const o=this.modalEl?.querySelector("#spMobileSource");o&&(o.textContent=i.source||"—");const r=this.modalEl?.querySelector("#spMobileCompany");r&&(r.textContent=i.company_name||"—");const d=this.modalEl?.querySelector("#spMobileStatus");d&&(d.textContent=(i.status||"—").toUpperCase(),d.style.color=i.status==="won"?"#22c55e":i.status==="lost"?"#ef4444":"#38bdf8");const c=this.modalEl?.querySelector("#spHeaderStatusBadge");c&&(c.textContent=`📌 ${i.status||"New"}`,c.style.display="inline-block");const l=this.modalEl?.querySelector("#spHeaderTempBadge");l&&(i.is_hot_lead?(l.textContent="🔥 HOT LEAD",l.style.background="rgba(239, 68, 68, 0.2)",l.style.color="#ef4444",l.style.border="1px solid rgba(239, 68, 68, 0.4)",l.style.display="inline-block"):i.is_fresh_lead?(l.textContent="🌱 FRESH LEAD",l.style.background="rgba(16, 185, 129, 0.2)",l.style.color="#10b981",l.style.border="1px solid rgba(16, 185, 129, 0.4)",l.style.display="inline-block"):l.style.display="none");const h=this.modalEl?.querySelector("#spMobileStatusUpdated");h&&(h.textContent=i.status_updated_at?new Date(i.status_updated_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"—");const u=this.modalEl?.querySelector("#spMobileBudget");u&&(u.textContent=i.budget_display||"—");const f=this.modalEl?.querySelector("#spMobileLastInteraction");f&&(f.textContent=i.last_interaction_date?new Date(i.last_interaction_date).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const m=this.modalEl?.querySelector("#spMobileInteractedBy");m&&(m.textContent=i.last_interacted_by||"—");const g=this.modalEl?.querySelector("#spMobileLastDialed");g&&(g.textContent=i.last_dialed_at?new Date(i.last_dialed_at).toLocaleDateString("en-IN",{day:"numeric",month:"short"}):"Never");const b=this.modalEl?.querySelector("#spMobileReqRow"),k=this.modalEl?.querySelector("#spMobileRequirements");b&&k&&(i.requirements?(k.textContent=i.requirements,b.style.display="block"):b.style.display="none");const _=this.modalEl?.querySelector("#spMobileNotesSection"),A=this.modalEl?.querySelector("#spMobileRecentNotes");if(_&&A){const C=(n.notes||[]).slice(0,2);C.length>0?(A.innerHTML=C.map(D=>`<div>• ${D.note}</div>`).join(""),_.style.display="block"):_.style.display="none"}}catch(a){console.warn("[SoftphoneModal] Could not fetch lead context:",a)}}}}const oe=new $,P={"/staff/dashboard":"dashboard","/staff/my-attendance":"attendance","/staff/my-leaves":"leaves","/staff/leave-approvals":"staff-leave-approvals","/staff/attendance-records":"team-attendance","/staff/attendance-sheet":"staff-attendance-sheet","/staff/attendance-reports":"staff-attendance-reports","/staff/attendance-exceptions":"staff-attendance-exceptions","/staff/attendance-computation":"staff-attendance-computation","/staff/tasks/assigned-by-me":"tasks-assigned","/staff/tasks/assigned-by-me-v2":"tasks-assigned","/staff/tasks/assigned-to-me":"tasks-received","/staff/tasks/team-activities":"staff-team-activities","/staff/tasks/task-tracker":"staff-task-tracker","/staff/tasks/task-reviews":"staff-task-reviews","/staff/task-review":"staff-task-reviews","/staff/my-kras":"kras","/staff/kra-templates":"staff-kra-templates","/staff/kra-tracking-sheet":"staff-kra-tracking","/staff/kra-review":"staff-kra-review","/staff/my-timesheet":"timesheet","/staff/timesheet-approval":"staff-timesheet-approval","/staff/my-journeys":"journeys","/staff/team-journeys":"team-journeys","/staff/all-journeys":"staff-all-journeys","/staff/vgk4u-journeys":"staff-vgk4u-journeys","/staff/vgk/members":"staff-vgk-members","/staff_vgk_members.html":"staff-vgk-members","/staff/my-reimbursement-claims":"reimbursements","/staff/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/my-reimbursements":"reimbursements","/staff/accounts/reimbursement-approvals":"staff-reimbursement-approvals","/staff/accounts/expense-entries":"staff-expense-entries","/staff/my-earnings":"staff-my-earnings","/staff/payroll-profile":"staff-payroll-profile","/staff/salary-slips":"staff-salary-slips","/staff/my-leads":"staff-my-leads","/staff/leads":"staff-leads","/staff/team-leads":"staff-team-leads","/staff/lead-sources":"staff-lead-sources","/staff/bank-wise-leads":"staff-bank-wise-leads","/staff/crm/bank-wise-leads":"staff-bank-wise-leads","/staff/solar-leads":"staff-leads","/staff/real-dreams-leads":"zynova-real-estate","/staff/insurance-leads":"zynova-insurance","/staff/ev-b2b-leads":"staff-leads","/staff/ev-b2c-leads":"staff-leads","/staff/ev-spares-leads":"staff-leads","/staff/etc-leads":"staff-training-videos","/staff/mnr-leads":"staff-leads","/staff/mnr-leads-master":"staff-leads","/staff/executive-dashboard":"dashboard","/staff/crm/whatsapp-inbox":"staff-whatsapp","/staff/crm/wa-inbox":"staff-whatsapp","/staff/whatsapp":"staff-whatsapp","/staff/whatsapp-inbox":"staff-whatsapp","/staff/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp-center":"staff-whatsapp","/staff/crm/whatsapp":"staff-whatsapp","/staff/configuration/catalog":"digital-catalog","/staff/catalog-library":"digital-catalog","/staff/catalog":"digital-catalog","/staff/call-tracking":"staff-call-tracking","/staff/vendors":"staff-vendors","/staff/zynova-real-estate":"staff-zynova-real-estate","/staff/zynova":"staff-zynova","/staff/zynova-insurance":"staff-zynova-insurance","/staff/settings":"settings","/staff/change-password":"change-password","/staff/employees":"staff-employees","/staff/training-videos":"staff-training-videos","/staff/employee-directory":"staff-directory","/staff/kyc-approvals":"staff-kyc-approvals","/staff/manager-review":"staff-review","/staff/auto-dialer":"auto-dialer","/staff/call-history":"call-history","/staff/operator-calls":"operator-calls","/staff/day-planner":"day-planner","/staff/tasks/day-planner":"day-planner","/staff/service":"staff-service","/staff/crm":"staff-crm","/staff/crm/dashboard":"staff-crm","/staff/crm/team-leads":"staff-team-leads","/staff/crm/lead-sources":"staff-lead-sources","/staff/call-management":"staff-call-tracking","/staff/dialer":"auto-dialer","/staff/softphone":"softphone","/staff/calling-page":"softphone","/staff/calling":"softphone","/staff/phone-dialpad":"softphone","/staff/softphone-hub":"softphone","/staff/tasks/tracker":"staff-task-tracker","/staff/service-tickets/dashboard":"staff-service","/staff/service-tickets/performance":"staff-service-performance","/staff/service-tickets/procurement":"staff-service-procurement","/staff/service-tickets/procurement-queue":"staff-service-procurement-queue","/staff/service-tickets/raise":"staff-tickets","/staff/service-tickets/reports":"staff-service-reports","/staff/service-tickets/queue":"staff-service-queue","/staff/service-center-revenue":"staff-service-revenue"},U=[{menu_code:"HOME",label:"Home",route:"dashboard"},{menu_code:"PROGRESS_DASHBOARD",label:"Progress Dashboard",route:"progress"},{menu_code:"DAY_PLANNER",label:"Day Planner",route:"day-planner"}],z=[{menu_code:"VGK_DASHBOARD",label:'<i class="fas fa-home" style="margin-right: 8px; width: 18px; text-align: center;"></i> Dashboard',route:"vgk-member-hub",tab:"earnings"},{menu_code:"VGK_PROFILE",label:'<i class="fas fa-user" style="margin-right: 8px; width: 18px; text-align: center;"></i> Profile',route:"vgk-member-hub",tab:"profile"},{menu_code:"VGK_MYCARD",label:'<i class="fas fa-id-card" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Card &amp; Progress',route:"vgk-member-hub",tab:"mycard"},{menu_code:"VGK_ADDMEMBER",label:'<i class="fas fa-user-plus" style="margin-right: 8px; width: 18px; text-align: center;"></i> Add Channel Partner',route:"vgk-member-hub",tab:"addmember"},{menu_code:"VGK_COUPONS",label:'<i class="fas fa-ticket-alt" style="margin-right: 8px; width: 18px; text-align: center;"></i> Coupons',route:"vgk-member-hub",tab:"coupons"},{menu_code:"VGK_NETWORK",label:'<i class="fas fa-sitemap" style="margin-right: 8px; width: 18px; text-align: center;"></i> Team',route:"vgk-member-hub",tab:"network"},{menu_code:"VGK_POINTS",label:'<i class="fas fa-coins" style="margin-right: 8px; width: 18px; text-align: center;"></i> Points Balance',route:"vgk-member-hub",tab:"points"},{menu_code:"VGK_LEDGER",label:'<i class="fas fa-rupee-sign" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Earnings',route:"vgk-member-hub",tab:"ledger"},{menu_code:"VGK_LEADS",label:'<i class="fas fa-user-tag" style="margin-right: 8px; width: 18px; text-align: center;"></i> My Leads',route:"vgk-member-hub",tab:"leads"},{menu_code:"VGK_TICKETS",label:'<i class="fas fa-tools" style="margin-right: 8px; width: 18px; text-align: center;"></i> Service Tickets',route:"vgk-member-hub",tab:"tickets"},{menu_code:"VGK_BONANZA",label:'<i class="fas fa-trophy" style="margin-right: 8px; width: 18px; text-align: center;"></i> Bonanza Rewards',route:"vgk-member-hub",tab:"bonanza"},{menu_code:"VGK_VENDORS",label:'<i class="fas fa-store" style="margin-right: 8px; width: 18px; text-align: center;"></i> Vendor Shops',route:"vgk-member-hub",tab:"vendors"},{menu_code:"VGK_MEDIA",label:'<i class="fas fa-photo-video" style="margin-right: 8px; width: 18px; text-align: center;"></i> Media Hub',route:"vgk-member-hub",tab:"media"},{menu_code:"VGK_ORDERS",label:'<i class="fas fa-box" style="margin-right: 8px; width: 18px; text-align: center;"></i> Orders',route:"vgk-member-hub",tab:"orders"}],B=[{section_code:"ATTENDANCE",section_label:"ATTENDANCE",order:1,items:[{menu_code:"IN_OUT_TIME",label:"In/Out Time",route:"attendance"},{menu_code:"MY_LEAVES",label:"My Leaves",route:"leaves"},{menu_code:"LEAVE_APPROVALS",label:"Leave Approvals",route:"staff-leave-approvals"},{menu_code:"IN_OUT_RECORDS_ADMIN",label:"In/Out Records - Admin",route:"team-attendance"},{menu_code:"ATTENDANCE_RECORDS",label:"Attendance Records",route:"staff-attendance-sheet"},{menu_code:"ATTENDANCE_DASHBOARD",label:"Attendance Dashboard",route:"staff-attendance-reports"},{menu_code:"EXCEPTION_APPROVALS",label:"Exception Approvals",route:"staff-attendance-exceptions"},{menu_code:"ATTENDANCE_COMPUTATION",label:"Attendance Computation",route:"staff-attendance-computation"}]},{section_code:"TASK_MANAGEMENT",section_label:"TASK MANAGEMENT",order:3,items:[{menu_code:"ASSIGNED_BY_ME",label:"Assigned By Me",route:"tasks-assigned"},{menu_code:"ASSIGNED_TO_ME",label:"Assigned To Me",route:"tasks-received"},{menu_code:"TEAM_ACTIVITIES",label:"Team Activities",route:"staff-team-activities"},{menu_code:"TASK_TRACKER",label:"Task Dashboard",route:"staff-task-tracker"},{menu_code:"TASK_REVIEWS",label:"Task Reviews",route:"staff-task-reviews"}]},{section_code:"KRA_MANAGEMENT",section_label:"KRA MANAGEMENT",order:4,items:[{menu_code:"MY_KRAS",label:"My KRAs",route:"kras"},{menu_code:"KRA_TEMPLATES",label:"KRA Templates",route:"staff-kra-templates"},{menu_code:"KRA_TRACKING_SHEET",label:"KRA Tracking Sheet",route:"staff-kra-tracking"},{menu_code:"KRA_REVIEW",label:"KRA Review",route:"staff-kra-review"}]},{section_code:"TIMESHEET",section_label:"TIMESHEET",order:5,items:[{menu_code:"MY_TIMESHEET",label:"My Timesheet",route:"timesheet"},{menu_code:"TIMESHEET_APPROVAL",label:"Timesheet Approval",route:"staff-timesheet-approval"}]},{section_code:"JOURNEY_TRACKING",section_label:"JOURNEY TRACKING",order:6,items:[{menu_code:"MY_JOURNEYS",label:"My Journeys",route:"journeys"},{menu_code:"TEAM_JOURNEYS",label:"Team Journeys",route:"team-journeys"},{menu_code:"ALL_JOURNEYS",label:"All Journeys",route:"staff-all-journeys"},{menu_code:"VGK4U_JOURNEYS",label:"VGK4U Journeys",route:"staff-vgk4u-journeys"}]},{section_code:"REIMBURSEMENT",section_label:"REIMBURSEMENT",order:7,items:[{menu_code:"MY_REIMBURSEMENT_CLAIMS",label:"My Reimbursement Claims",route:"reimbursements"},{menu_code:"REIMBURSEMENT_APPROVALS",label:"Reimbursement Approvals",route:"staff-reimbursement-approvals"}]},{section_code:"ACCOUNTS_EARNINGS",section_label:"FINANCE & EARNINGS",order:8,items:[{menu_code:"MY_EARNINGS",label:"My Earnings",route:"staff-my-incentives"},{menu_code:"PAYROLL_PROFILE",label:"Payroll Profile",route:"staff-payroll-profile"},{menu_code:"SALARY_SLIPS",label:"Salary Slips",route:"staff-salary-slips"}]},{section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[{menu_code:"MY_CRM_DASHBOARD",label:"CRM Dashboard",route:"staff-crm"},{menu_code:"MY_LEADS",label:"My Leads",route:"staff-my-leads"},{menu_code:"AUTO_DIALER",label:"Auto Dialer",route:"auto-dialer"},{menu_code:"SOFTPHONE",label:"Calling & Softphone",route:"softphone"},{menu_code:"BANK_WISE_LEADS",label:"Field staff leads",route:"staff-bank-wise-leads"},{menu_code:"TEAM_LEADS",label:"Team Leads",route:"staff-team-leads"},{menu_code:"LEADS_MASTER",label:"Staff Leads",route:"staff-leads"},{menu_code:"VGK_TEAM_MEMBERS",label:"VGK Channel Partners",route:"staff-vgk-members"}]},{section_code:"WORKFLOWS",section_label:"WORK FLOWS",order:10,items:[{menu_code:"MNR_BANK_WISE_LEADS",label:"Field Sales",route:"staff-bank-wise-leads"},{menu_code:"SOLAR_LEADS",label:"Solar Leads",route:"staff-leads"},{menu_code:"ZYN_REAL_ESTATE",label:"Real Dreams Leads",route:"zynova-real-estate"},{menu_code:"EV_B2B_LEADS",label:"EV B2B Leads",route:"staff-leads"},{menu_code:"EV_B2C_LEADS",label:"EV B2C Leads",route:"staff-leads"},{menu_code:"EV_SPARES_LEADS",label:"EV Spares Leads",route:"staff-leads"},{menu_code:"ZYN_INSURANCE",label:"Insurance Leads",route:"zynova-insurance"},{menu_code:"ETC_LEADS",label:"ETC Leads",route:"staff-training-videos"},{menu_code:"MNR_LEADS",label:"MNR Leads",route:"staff-leads"},{menu_code:"EXECUTIVE_DASHBOARD",label:"Executive Dashboard",route:"dashboard"},{menu_code:"CATEGORY_LEADS_MASTER",label:"Category Leads Master",route:"staff-leads"}]},{section_code:"OPERATIONS",section_label:"OPERATIONS",order:11,items:[{menu_code:"CALL_TRACKING",label:"Call Tracking",route:"staff-call-tracking"},{menu_code:"VENDORS",label:"Vendors",route:"staff-vendors"},{menu_code:"ZYN",label:"Zynova Real Estate",route:"zynova-real-estate"},{menu_code:"ZYNOVA",label:"VGK4U",route:"staff-zynova"},{menu_code:"ZYN_INSURANCE",label:"Zynova Insurance",route:"zynova-insurance"}]}],V=[];class H{container=null;overlay=null;isOpen=!1;expandedSections=new Set;staffMenuTree=null;isStaffMenuLoaded=!1;constructor(){try{const e=localStorage.getItem("mnr_staff_menu_tree_cache");e&&(this.staffMenuTree=JSON.parse(e),this.isStaffMenuLoaded=!0)}catch{}this.createElements(),this.loadStaffMenus(),window.addEventListener("logout",()=>{this.staffMenuTree=null,this.isStaffMenuLoaded=!1;try{localStorage.removeItem("mnr_staff_menu_tree_cache")}catch{}this.updateUI()}),window.addEventListener("auth-changed",()=>{this.isStaffMenuLoaded=!1,this.loadStaffMenus()})}createElements(){if(this.overlay=document.createElement("div"),this.overlay.className="drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),!document.getElementById("myntos-drawer-styles")){const e=document.createElement("style");e.id="myntos-drawer-styles",e.textContent=`
      ...
      `,document.head.appendChild(e)}this.attachEventListeners()}render(){const e=M.getPortal(),t=e==="vgk",n=y.getAuthState().user||{},i=(n.role_code||n.role?.role_code||n.user_type||"").toString().toLowerCase().trim(),s=(n.role_name||n.role?.role_name||"").toString().toUpperCase().trim(),p=(n.staff_type||"").toString().toUpperCase().trim(),o=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin","manager","director","admin"].includes(i)||i.includes("vgk")||i.includes("manager")||i.includes("lead")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN","MANAGER"].includes(s)||s.includes("VGK")||s.includes("MANAGER")||["VGK4U","VGK4U SUPREME"].includes(p)||!!(n.is_manager||n.is_admin||n.is_super_admin);let r=U;if(t)r=z;else if(e==="staff"){const u=["vgk4u","vgk4u_supreme","key_leadership","ea","executive_admin"].includes(i)||i.includes("vgk")||["VGK4U","VGK4U SUPREME","VGK MENTOR","KEY LEADERSHIP","EA","EXECUTIVE ADMIN"].includes(s)||s.includes("VGK")||["VGK4U","VGK4U SUPREME"].includes(p);n.staff_type==="FREELANCER"&&n.freelancer_access_mode==="only_leads"?r=[]:r=[{menu_code:"PROGRESS",label:'<i class="fas fa-chart-line" style="margin-right: 8px; width: 18px; text-align: center;"></i> Progress',route:"progress"},...u?[{menu_code:"OVERVIEW",label:'<i class="fas fa-th" style="margin-right: 8px; width: 18px; text-align: center;"></i> Overview',route:"dashboard"}]:[],{menu_code:"TASK_PLANNER",label:'<i class="fas fa-calendar-day" style="margin-right: 8px; width: 18px; text-align: center;"></i> Task Planner',route:"day-planner"},{menu_code:"KRA_STATUS",label:'<i class="fas fa-chart-bar" style="margin-right: 8px; width: 18px; text-align: center;"></i> KRA Status',route:"kras"},{menu_code:"TIME_SHEET",label:'<i class="fas fa-clock" style="margin-right: 8px; width: 18px; text-align: center;"></i> Time Sheet',route:"timesheet"},{menu_code:"WHATSAPP_CENTER",label:'<i class="fab fa-whatsapp" style="margin-right: 8px; width: 18px; text-align: center; color: #25d366;"></i> WhatsApp Center',route:"staff-whatsapp"},{menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i> Auto Dialer',route:"auto-dialer"},{menu_code:"CALLING_PAGE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #3b82f6;"></i> Calling & Softphone',route:"softphone"}]}const d=["account","accounts","finance","payroll","billing","bookkeeper","auditor"].some(u=>i.includes(u))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(u=>s.includes(u))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL","BILLING","BOOKKEEPER","AUDITOR"].some(u=>p.includes(u))||["ACCOUNT","ACCOUNTS","FINANCE","PAYROLL"].some(u=>(n.department||n.department_name||"").toString().toUpperCase().includes(u)),c=o||d,l=t?V:e==="staff"?this.getStaffMenuMaster():B,h=e==="staff"?this.filterMenusForRole(l,o,c):l;return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("drawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route,a=e.dataset.tab;a?w.navigate(t,{tab:a}):w.navigate(t),this.close()})}),document.getElementById("drawerLogout")?.addEventListener("click",async()=>{this.close(),confirm("Are you sure you want to logout?")&&await y.logout()}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}async loadStaffMenus(){try{const e=await S.get("/staff/menu-settings/my-menus?unified=true");if(e.success&&e.data&&e.data.sidebar_tree){this.staffMenuTree=e.data.sidebar_tree,this.isStaffMenuLoaded=!0;try{localStorage.setItem("mnr_staff_menu_tree_cache",JSON.stringify(this.staffMenuTree))}catch{}this.updateUI()}}catch(e){console.error("Failed to load dynamic staff menus:",e)}}filterMenusForRole(e,t,a=!1){const i=y.getAuthState().user||{},s=(i.emp_code||i.employee_code||"").toString().toUpperCase().trim(),p=["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(s);if(t&&!p)return e;const o=new Set(["SAAS","SAAS_MANAGEMENT","SAAS CONFIGURATION","CONFIGURATION","SYSTEM_CONFIGURATION","SYSTEM CONFIG","META_ADS","META ADS","VENDOR_MANAGEMENT","VENDOR MANAGEMENT","VENDORS","HR","HR_MANAGEMENT","ZYNOVA","ZYNOVA_REAL_ESTATE","MNR","MNR_USER_SIDEBAR","MNR USER SIDEBAR","MNR_USER","MNR USER"]);a||(o.add("ACCOUNTS"),o.add("ACCOUNTS_EARNINGS"),o.add("ACCOUNTS & EARNINGS"),o.add("FINANCE"),o.add("FINANCE & EARNINGS"),o.add("FINANCE_EARNINGS"),o.add("ACCOUNTS_MANAGEMENT"));const r=new Set(["EXECUTIVE_DASHBOARD","CATEGORY_LEADS_MASTER","SAAS_CONFIG","SYSTEM_CONFIG"]);(!t||p)&&(r.add("LEADS_MASTER"),r.add("STAFF_LEADS"),r.add("staff_leads")),a||(r.add("PAYROLL_PROFILE"),r.add("SALARY_SLIPS"),r.add("EXPENSE_ENTRIES"));const d=[];for(const c of e){const l=(c.section_code||"").toUpperCase().trim(),h=(c.section_label||"").toUpperCase().trim();if(o.has(l)||o.has(h))continue;let u=c.items;u&&u.length>0&&(u=u.filter(b=>{const k=(b.menu_code||"").toUpperCase().trim();return!r.has(k)}));let f=c.subSections;f&&f.length>0&&(f=f.map(b=>({...b,items:b.items.filter(k=>{const _=(k.menu_code||"").toUpperCase().trim();return!r.has(_)})})).filter(b=>b.items.length>0));const m=u&&u.length>0,g=f&&f.length>0;(m||g)&&d.push({...c,items:m?u:void 0,subSections:g?f:void 0})}return d}getStaffMenuMaster(){if(!this.staffMenuTree)return B;const e={EXECUTIVE_DASHBOARD:1,staff_executive_dashboard:1,mnr_executive_dashboard:1,MNR_BANK_WISE_LEADS:2,BANK_WISE_LEADS:2,staff_bank_wise_leads:2,CATEGORY_LEADS_MASTER:3,mnr_leads_master:3,staff_mnr_leads_master:3,SOLAR_LEADS:4,staff_solar_leads:4,mnr_solar_leads:4,EV_B2B_LEADS:5,staff_ev_b2b_leads:5,mnr_ev_b2b_leads:5,EV_B2C_LEADS:6,staff_ev_b2c_leads:6,mnr_ev_b2c_leads:6,EV_SPARES_LEADS:7,staff_ev_spares_leads:7,mnr_ev_spares_leads:7,ZYN_REAL_ESTATE:8,staff_real_dreams_leads:8,mnr_real_dreams_leads:8,ZYN_INSURANCE:9,staff_insurance_leads:9,mnr_insurance_leads:9,ETC_LEADS:10,staff_etc_leads:10,mnr_etc_leads:10,MNR_LEADS:11,staff_mnr_leads:11,mnr_category_leads:11,AUTO_DIALER:12,staff_auto_dialer:12,"auto-dialer":12},t={MY_CRM_DASHBOARD:1,staff_crm_dashboard:1,"staff-crm":1,MY_LEADS:2,staff_my_leads:2,"staff-my-leads":2,AUTO_DIALER:3,staff_auto_dialer:3,staff_dialer:3,"auto-dialer":3,SOFTPHONE:4,staff_softphone:4,softphone:4,CALLING_PAGE:4,calling:4,"phone-dialpad":4,BANK_WISE_LEADS:5,staff_bank_wise_leads:5,"staff-bank-wise-leads":5,TEAM_LEADS:6,staff_team_leads:6,"staff-team-leads":6,WHATSAPP_CENTER:7,staff_crm_whatsapp_inbox:7,"staff-whatsapp":7,CALL_TRACKING:8,call_tracking_dashboard:8,"staff-call-tracking":8,OPERATOR_CALLS:9,staff_operator_calls:9,"operator-calls":9,VGK_TEAM_MEMBERS:10,staff_vgk_members:10,"staff-vgk-members":10,STAFF_LEADS:11,staff_leads:11,LEADS_MASTER:11,leads_master:11},a=new Map,n=[],i=(o,r,d,c)=>{const l=P[d]||P[d?.replace(/\/$/,"")]||(d?d.replace(/^\/staff\//,"").replace(/\//g,"-"):null);if(!l)return null;const u=y.getAuthState().user||{},f=(u.emp_code||u.employee_code||"").toString().toUpperCase().trim();if(["MN10009","MR10022","MR10036","MR10027","MN10017","MN10016"].includes(f)&&(l==="staff-leads"||d&&d.toLowerCase()==="/staff/leads"||o&&["staff_leads","STAFF_LEADS","LEADS_MASTER","staff_leads_master"].includes(o)))return null;let m=r;(!m||m==="None"||m.trim()==="")&&(m=(o||"").replace(/^staff_|^_staff_|^mnr_/i,"").replace(/_/g," ").replace(/\b\w/g,C=>C.toUpperCase()));const g=(o||"").toUpperCase(),b=(d||"").toLowerCase();g.includes("AUTO_DIALER")||b.includes("auto-dialer")||b==="/staff/dialer"||g==="STAFF_AUTO_DIALER"||g==="AUTO_DIALER"||g==="STAFF_DIALER"||g==="DIALER"?m="Auto Dialer":g.includes("BANK_WISE_LEADS")||b.includes("bank-wise-leads")?m="Field staff leads":g.includes("REAL_DREAMS")||b.includes("real-dreams-leads")?m="Real Dreams Leads":g.includes("ETC_LEADS")||b.includes("etc-leads")?m="ETC Training Students":g.includes("CATEGORY_LEADS_MASTER")||g.includes("MNR_LEADS_MASTER")||b.includes("mnr-leads-master")?m="Category Lead Master":g.includes("WHATSAPP")||b.includes("whatsapp")?m="WhatsApp Center":g.includes("SOFTPHONE")||g==="PHONE_DIALPAD"||g==="CALLING_PAGE"||b.includes("softphone")||b.includes("calling")||b.includes("phone-dialpad")?m="Calling & Softphone":(g.includes("VGK_TEAM_MEMBERS")||g==="STAFF_VGK_MEMBERS"||b.includes("vgk/members"))&&(m="VGK Channel Partners");const k=c||(m.includes("WhatsApp")?"fab fa-whatsapp":m.includes("Auto Dialer")?"fas fa-phone-volume":m.includes("Softphone")||m.includes("Calling")?"fas fa-headset":m.includes("VGK")||m.includes("Channel")?"fas fa-users":m.includes("Field")?"fas fa-users-gear":"fas fa-file-alt"),_=m.includes("WhatsApp")?"color: #25d366;":m.includes("Auto Dialer")||m.includes("Softphone")||m.includes("Calling")?"color: #38bdf8;":m.includes("VGK")||m.includes("Channel")?"color: #7c3aed;":"",A=`<i class="${k}" style="margin-right: 8px; width: 18px; text-align: center; ${_}"></i>`;return{menu_code:o,label:`${A}${m}`,route:l}};for(const o of this.staffMenuTree){if(o.id==="progress"||o.section_id==="progress"||(o.title||"").toUpperCase()==="PROGRESS")continue;const r=[],d=[];if(o.items)for(const c of o.items){const l=i(c.menu_code,c.menu_name||c.label||c.name||c.title,c.route_path,c.menu_icon);l&&r.push(l)}if(o.subSections)for(const c of o.subSections){const l=[];if(c.items)for(const u of c.items){const f=i(u.menu_code,u.menu_name||u.label||u.name||u.title,u.route_path,u.menu_icon);f&&l.push(f)}let h=c.title||c.name||c.id||"Subsection";(h==="None"||!h)&&(h=(c.id||"").replace(/^staff_|^vm_/i,"").replace(/_/g," ").replace(/\b\w/g,u=>u.toUpperCase())),l.length>0&&d.push({sub_section_code:c.id||c.section_id||"sub",sub_section_label:h,items:l})}if(r.length>0||d.length>0){let c=(o.id||o.section_id||"other").toString().trim(),l=(o.title||o.name||"Other").toString().trim();(l==="None"||!l)&&(l=c.replace(/_/g," ").replace(/\b\w/g,f=>f.toUpperCase()));const h=c.toLowerCase(),u=l.toUpperCase();if((h==="mynt_real"||h==="myntreal"||h==="workflows"||u==="MYNT REAL"||u==="MYNTREAL"||u==="WORK FLOWS"||u==="WORKFLOWS")&&(c="WORKFLOWS",l="WORK FLOWS"),(h==="crm"||h==="crm_module"||h==="crm_leads"||h==="crm & leads"||u.includes("CRM"))&&(c="CRM_MODULE",l="CRM & LEADS"),a.has(c)){const f=a.get(c);if(r.length>0){f.items=f.items||[];const m=new Set(f.items.map(g=>g.menu_code));for(const g of r)m.has(g.menu_code)||(f.items.push(g),m.add(g.menu_code))}d.length>0&&(f.subSections=f.subSections||[],f.subSections.push(...d))}else n.push(c),a.set(c,{section_code:c,section_label:l,order:c==="CRM_MODULE"?4:o.order!==void 0?o.order:999,items:r.length>0?r:void 0,subSections:d.length>0?d:void 0})}}let s=a.get("CRM_MODULE")||a.get("CRM_LEADS")||a.get("crm")||a.get("CRM");if(s||(s={section_code:"CRM_MODULE",section_label:"CRM & LEADS",order:4,items:[]},a.set("CRM_MODULE",s),n.push("CRM_MODULE")),s){if(s.items=s.items||[],!s.items.some(d=>d.route==="auto-dialer"||d.menu_code&&(d.menu_code.toUpperCase().includes("AUTO_DIALER")||d.menu_code.toUpperCase().includes("DIALER"))))s.items.push({menu_code:"AUTO_DIALER",label:'<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer',route:"auto-dialer"});else for(const d of s.items)(d.route==="auto-dialer"||d.menu_code&&(d.menu_code.toUpperCase().includes("AUTO_DIALER")||d.menu_code.toUpperCase().includes("DIALER")))&&(d.label='<i class="fas fa-phone-volume" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Auto Dialer');s.items.some(d=>d.route==="softphone"||d.menu_code&&(d.menu_code.toUpperCase().includes("SOFTPHONE")||d.menu_code.toUpperCase().includes("CALLING")))||s.items.push({menu_code:"SOFTPHONE",label:'<i class="fas fa-headset" style="margin-right: 8px; width: 18px; text-align: center; color: #38bdf8;"></i>Calling & Softphone',route:"softphone"})}const p=n.map(o=>a.get(o));p.sort((o,r)=>o.order-r.order);for(const o of p)o.section_code==="WORKFLOWS"&&o.items&&o.items.sort((r,d)=>(e[r.menu_code]||99)-(e[d.menu_code]||99)),o.section_code==="CRM_MODULE"&&o.items&&o.items.sort((r,d)=>(t[r.menu_code]||t[r.route]||99)-(t[d.menu_code]||t[d.route]||99));return p}open(){if(this.isOpen)return;M.getPortal()==="staff"&&!this.isStaffMenuLoaded&&this.loadStaffMenus(),this.updateUI(),this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden"}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}}let I=null;function F(){return I||(I=new H),I}class T{static render(e){let{title:t,showBack:a=!1,showLogout:n=!1,rightAction:i,subtitle:s,showMenu:p}=e;const o=M.getPortal(),r=w.getCurrentRoute(),d=["progress","dashboard","attendance","journeys","announcements","profile","mnr-dashboard","partner-dashboard","vgk-member-hub"].includes(r);if(p===void 0&&(p=d||!a),o==="vgk"&&(n=!0,!s)){const l=y.getAuthState().user||{},h=l.name||l.partner_name||"",u=l.partner_code||"";(h||u)&&(s=u?`${h} (${u})`:h)}return`
    ...
    `}static getPortalDashboard(){const e=M.getPortal();return e==="mnr"?"mnr-dashboard":e==="partner"?"partner-dashboard":e==="vgk"?"vgk-member-hub":"progress"}static attachListeners(e){let{showMenu:t,showBack:a=!1,rightAction:n,showLogout:i=!1}=e;t===void 0&&(t=!!document.getElementById("hamburgerBtn")),M.getPortal()==="vgk"&&(i=!0),t&&document.getElementById("hamburgerBtn")?.addEventListener("click",()=>{F().open()}),a&&document.getElementById("backBtn")?.addEventListener("click",()=>{w.goBack()||w.navigate(T.getPortalDashboard())}),n&&document.getElementById("headerActionBtn")?.addEventListener("click",n.onClick),i&&document.getElementById("logoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&await y.logout()})}static attachBackHandler(){document.getElementById("backBtn")?.addEventListener("click",()=>{w.goBack()||w.navigate(T.getPortalDashboard())})}}class se{constructor(e){this.options=e,this.trackPoints=e.trackPoints,this.stops=e.stops||[],this.onViewChange=e.onViewChange}options;map=null;container=null;trackPoints=[];stops=[];routeLine=null;progressLine=null;currentMarker=null;startMarker=null;endMarker=null;stopMarkers=[];currentView="street";tileLayers={};playbackIndex=0;isPlaying=!1;playbackInterval=null;playbackSpeed=2;onViewChange;addressCache=new Map;mount(){if(this.container=document.getElementById(this.options.containerId),!this.container){console.error("[LeafletMap] Container not found:",this.options.containerId);return}this.render(),this.initMap()}render(){this.container&&(this.container.innerHTML=`
...
మీకు అనుకూలమైన సమయంలో దయచేసి ఇక్కడ మెసేజ్ చేయండి లేదా కాల్ బ్యాక్ చేయగలరు!`}}applyVerticalQuick(e){const t=this.getVerticalQuickMessage(e),a=this.getSenderSignature(),n=document.getElementById("uwaMessageText");n&&(n.value=t+a,n.focus())}async loadCanonicalTemplates(){const e=document.getElementById("uwaCanonicalTpl"),t=document.getElementById("uwaNoTplNotice");if(!e)return;e.innerHTML='<option value="">— Loading templates… —</option>',t&&(t.style.display="none");const a=document.getElementById("uwaCanonicalSeg"),n=document.getElementById("uwaCanonicalCat"),i=a?.value||"",s=n?.value||"",p=this.activeMode==="scanned"?"scanned":"company";let o=`/whatsapp-config/templates?mode=${encodeURIComponent(p)}`;i&&(o+=`&segment=${encodeURIComponent(i)}`),s&&(o+=`&category=${encodeURIComponent(s)}`);try{const r=await S.get(o),d=r?.templates||r?.data||r||[];if(this.canonicalTemplates=Array.isArray(d)?d:[],!this.canonicalTemplates.length){e.innerHTML='<option value="">— No approved templates found —</option>',t&&(t.style.display="block");return}let c=`<option value="">— Select template (${this.canonicalTemplates.length} available) —</option>`;this.canonicalTemplates.forEach(l=>{c+=`<option value="${l.id}">${this.escapeHtml(l.template_name||l.name||"Template #"+l.id)} (${l.category||"MARKETING"})</option>`}),e.innerHTML=c}catch{e.innerHTML='<option value="">— Error loading templates —</option>'}}onCanonicalTplChange(){const e=document.getElementById("uwaCanonicalTpl"),t=document.getElementById("uwaCanonicalVarsWrap"),a=document.getElementById("uwaCanonicalVarsBox"),n=e?.value;if(!n){t&&(t.style.display="none"),a&&(a.innerHTML="");return}const i=this.canonicalTemplates.find(o=>String(o.id)===String(n));if(!i)return;this.selectedCanonicalBody=i.body_text||i.content||i.body||"";const s=this.selectedCanonicalBody.match(/\{\{(\d+)\}\}/g)||[],p=[];if(s.forEach(o=>{const r=o.replace(/[\{\}]/g,"");p.includes(r)||p.push(r)}),p.sort((o,r)=>Number(o)-Number(r)),p.length&&a&&t){t.style.display="block";let o="";p.forEach(r=>{const d=r==="1"&&this.currentOptions?.name||"";o+=`
      ...
      <div class="uwa-modal-sheet">
        ...
        <div class="uwa-chips-row">
          ${Object.entries(R).map(([o,r])=>`
            <button class="uwa-chip-btn" data-tpl-key="${o}">
              ${r.label}
            </button>
          `).join("")}
        </div>
...
`);e.textContent=h}async executeShare(e){const t=document.getElementById("usmStaffSelect"),a=parseInt(t?.value||"0",10);if(!a){alert("Please select a staff member to share details with."),t?.focus();return}const n=this.staffList.find(l=>l.id===a);if(!n){alert("Selected staff member is invalid.");return}const i=document.getElementById("usmFollowupType")?.value||"secondary_followup",s=document.getElementById("usmNotes")?.value.trim()||"",p=document.getElementById("usmAssignCheck")?.checked||!1,o=this.currentOptions;if(!o)return;const r=document.getElementById("usmCombinedBtn"),d=document.getElementById("usmCrmOnlyBtn"),c=document.getElementById("usmWaOnlyBtn");[r,d,c].forEach(l=>{l&&(l.disabled=!0)});try{let l="",h="";if(e==="crm_only"||e==="combined"||p){const f={target_staff_id:a,followup_type:i,notes:s,assign_as_secondary:p},m=await S.post(`/crm/leads/${o.leadId}/share-details`,f);if(m&&m.success)l=m.wa_url||"",h=m.wa_message||"",o.onShared&&o.onShared(m);else throw new Error(m?.detail||m?.message||"Failed to assign lead in CRM")}if(e==="wa_only"||e==="combined"){if(!l){const f=(n.phone||"").replace(/\D/g,"").slice(-10);if(!f)alert(`Colleague ${n.name} does not have a valid mobile number for WhatsApp.`);else{const m=document.getElementById("usmMessagePreview")?.textContent||"";l=`https://wa.me/91${f}?text=${encodeURIComponent(m)}`}}l&&window.open(l,"_blank")}const u=e==="crm_only"?`Lead successfully assigned to ${n.name} in CRM!`:e==="wa_only"?`WhatsApp launched for ${n.name}!`:`Lead assigned in CRM and WhatsApp opened for ${n.name}!`;alert(`✅ ${u}`),this.close()}catch(l){console.error("[UnifiedShareLeadModal] Share failed:",l),alert(`⚠️ Could not complete lead share: ${l.message||l}`)}finally{[r,d,c].forEach(l=>{l&&(l.disabled=!1)})}}}const le=new j,K=[{menu_code:"HOME_DASHBOARD",label:"Home Dashboard",route:"mnr-dashboard",icon:"home"},{menu_code:"VIEW_PROFILE",label:"View Profile",route:"mnr-profile",icon:"user"},{menu_code:"ADD_MEMBER",label:"Add Member",route:"mnr-add-member",icon:"user-plus"}],q=[{section_code:"ANNOUNCEMENTS",section_label:"📢 Community Updates",icon:"bullhorn",order:1,items:[{menu_code:"PUBLIC_ANNOUNCEMENTS",label:"📢 Official Updates",route:"mnr-announcements"},{menu_code:"MY_SUBMISSIONS",label:"📋 My Submissions",route:"mnr-my-announcements"},{menu_code:"PENDING",label:"⏳ Pending",route:"mnr-announcements-pending"},{menu_code:"APPROVED",label:"✅ Approved",route:"mnr-announcements-approved"},{menu_code:"REJECTED",label:"❌ Rejected",route:"mnr-announcements-rejected"}]},{section_code:"COUPON_MODULES",section_label:"🎫 Coupon Modules",icon:"ticket",order:2,items:[{menu_code:"BUY_COUPON",label:"🛒 Buy Coupon",route:"mnr-coupon-buy"},{menu_code:"ACTIVATE_COUPON",label:"✅ Activate Coupon",route:"mnr-coupon-activate"},{menu_code:"COUPON_STATUS",label:"🎫 Coupon Status",route:"mnr-coupon-status"},{menu_code:"COUPON_PROGRESS",label:"📊 Coupon Progress",route:"mnr-coupon-progress"},{menu_code:"COUPON_TRANSFER",label:"🔄 Coupon Transfer",route:"mnr-coupon-transfer"}]},{section_code:"MEMBERS",section_label:"👥 My Connections",icon:"users",order:3,items:[{menu_code:"ALL_MEMBERS",label:"👥 All Connections",route:"mnr-members-all"},{menu_code:"DIRECT_REFERRALS",label:"🔗 Direct Connections",route:"mnr-referrals"},{menu_code:"PICTURE_VIEW",label:"🌳 Connections Gallery",route:"mnr-members-picture"},{menu_code:"VED_TEAM",label:"👑 Leadership Group (VED)",route:"mnr-members-ved"}]},{section_code:"MNR",section_label:"💰 Facilitation & Recognition",icon:"coins",order:4,items:[{menu_code:"EARNINGS_SUMMARY",label:"📊 Earnings Overview",route:"mnr-earnings-summary"},{menu_code:"DIRECT_REFERRAL",label:"💰 Direct Business Facilitation",route:"mnr-income-direct"},{menu_code:"MATCHING_REFERRAL",label:"🤝 Group Performance Recognition",route:"mnr-income-matching"},{menu_code:"VED_INCOME",label:"👑 VED Leadership Recognition",route:"mnr-income-ved"},{menu_code:"GURUDAKSHINA",label:"🙏 Mentorship Contribution Benefit",route:"mnr-income-guru"},{menu_code:"FIELD_ALLOWANCE",label:"🚗 Field Allowances",route:"mnr-income-field"},{menu_code:"WITHDRAWALS",label:"💸 Withdrawals",route:"mnr-withdrawals"},{menu_code:"COUPON_BENEFITS",label:"🎁 Coupon Benefits",route:"mnr-benefits"},{menu_code:"MNR_POINTS",label:"🎯 Points Utilisation",route:"mnr-points"}]},{section_code:"MYNTREAL",section_label:"💎 MyntReal",icon:"gem",order:5,items:[{menu_code:"MY_LEADS",label:"📋 My Leads",route:"mnr-my-leads"},{menu_code:"FRANCHISE_EARNINGS",label:"🏪 Franchise Earnings",route:"mnr-franchise-earnings"}]},{section_code:"ZYNOVA",section_label:"⭐ Zynova",icon:"crown",order:6,items:[{menu_code:"VGK_REAL_DREAMS",label:"🏠 VGK Real Dreams (Real Estate)",route:"zynova-real-estate"},{menu_code:"VGK_CARE",label:"🛡️ VGK Care (Insurance)",route:"zynova-insurance"},{menu_code:"ETC",label:"🎓 EVolution Training Center (ETC)",route:"zynova-training"}]},{section_code:"AWARDS_BONANZA",section_label:"🏆 Awards & Bonanza",icon:"trophy",order:7,items:[{menu_code:"AWARDS",label:"🏆 Awards",route:"mnr-awards"},{menu_code:"BONANZA_AWARDS",label:"🎉 Bonanza Awards",route:"mnr-bonanza"}]}],W=[{menu_code:"THEME_MODE",label:"Theme Mode",route:"mnr-settings",icon:"headset"},{menu_code:"SECURITY_SETTINGS",label:"Security Settings",route:"mnr-change-password",icon:"headset"}];class Y{container=null;overlay=null;isOpen=!1;expandedSections=new Set;user=null;constructor(){this.createElements()}createElements(){this.overlay=document.createElement("div"),this.overlay.className="mnr-drawer-overlay",this.overlay.addEventListener("click",()=>this.close()),document.body.appendChild(this.overlay),this.container=document.createElement("div"),this.container.className="mnr-side-drawer",this.container.innerHTML=this.render(),document.body.appendChild(this.container),this.attachEventListeners()}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',"user-plus":'<path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/>',bullhorn:'<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/>',ticket:'<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',gem:'<polygon points="12 2 2 12 12 22 22 12 12 2"/><polyline points="12 2 12 22"/>',crown:'<path d="m2 4 3 12h14l3-12-6 7-4-7-4 7-6-7zm3 16h14"/>',trophy:'<path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||"MNR Member",t=this.user?.mnr_id||"";return`
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("mnrDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;w.navigate(t),this.close()})}),document.getElementById("mnrLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await y.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const de=new Y;class ce{config;constructor(e){this.config=e}render(){if(this.config.loading)return`
    ...
    `,document.head.appendChild(e)}setUser(e){this.user=e,this.updateUI()}getIcon(e){return`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${{home:'<path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>',user:'<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',package:'<line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/>',tool:'<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>',coins:'<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1 1 10.34 18"/><path d="M7 6h1v4"/><path d="m16.71 13.88.7.71-2.82 2.82"/>',users:'<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',headset:'<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>',logout:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>'}[e]||""}</svg>`}render(){const e=this.user?.name||this.user?.partner_name||"Partner",t=this.user?.partner_id||this.user?.partner_code||"PARTNER",a=this.user?.partner_type||this.user?.type||"Partner";return`
      ...
      <div class="partner-drawer-content">
        ...
        ${X.map(i=>this.renderSection(i)).join("")}
    ...
    `}attachEventListeners(){this.container&&(document.getElementById("partnerDrawerClose")?.addEventListener("click",()=>this.close()),this.container.querySelectorAll("[data-toggle]").forEach(e=>{e.addEventListener("click",t=>{const a=e.dataset.toggle;this.toggleSection(a),t.stopPropagation()})}),this.container.querySelectorAll("[data-route]").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.route;w.navigate(t),this.close()})}),document.getElementById("partnerLogoutBtn")?.addEventListener("click",async()=>{confirm("Are you sure you want to logout?")&&(await y.logout(),window.dispatchEvent(new CustomEvent("logout")),this.close())}))}toggleSection(e){this.expandedSections.has(e)?this.expandedSections.delete(e):this.expandedSections.add(e),this.updateUI()}updateUI(){this.container&&(this.container.innerHTML=this.render(),this.attachEventListeners())}open(){this.isOpen||(this.isOpen=!0,this.container?.classList.add("open"),this.overlay?.classList.add("visible"),document.body.style.overflow="hidden")}close(){this.isOpen&&(this.isOpen=!1,this.container?.classList.remove("open"),this.overlay?.classList.remove("visible"),document.body.style.overflow="")}toggle(){this.isOpen?this.close():this.open()}destroy(){this.container?.remove(),this.overlay?.remove()}}const pe=new Q;class ue{container;constructor(e){this.container=e}render(){const t=y.getAuthState().user?.portal||"staff",a=w.getTabRoutes(t),n=w.getCurrentRoute();this.container.innerHTML=`
    ...
    `,this.attachListeners()}attachListeners(){this.container.querySelectorAll(".tab-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-route");t&&w.navigate(t)})})}getIcon(e){const t={home:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      </svg>`};return t[e]||t.home}}class J{isShowing=!1;unsubscribe=null;checkInterval=null;init(){this.unsubscribe&&this.unsubscribe(),this.checkInterval&&clearInterval(this.checkInterval),this.unsubscribe=S.onSessionExpired(e=>{console.log("[SessionBanner] Session expired detected, endpoint:",e),y.getAuthState().isLoggedIn&&this.show()}),this.checkInterval=setInterval(()=>{if(!y.getAuthState().isLoggedIn){this.isShowing&&this.hide();return}const t=O.getTrackingStatus();t.isSessionExpired&&!this.isShowing?this.show():!t.isSessionExpired&&this.isShowing&&this.hide()},2e3)}cleanup(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null),this.checkInterval&&(clearInterval(this.checkInterval),this.checkInterval=null),this.hide()}show(){if(!y.getAuthState().isLoggedIn||this.isShowing||document.getElementById("globalSessionBanner"))return;this.isShowing=!0;const e=document.createElement("div");e.id="globalSessionBanner",e.className="global-session-banner",e.innerHTML=`
